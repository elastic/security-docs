...
* When adding a rule exception, you can not select value lists with the `ip_range`. Any `ip_range` values will not appear in the dropdown even if you uploaded a value list with `ip_range` ({pull}79511[#79511]).
