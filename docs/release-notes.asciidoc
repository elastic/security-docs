...
* Shellcode telemetry update for schema adjustment ({pull}93143[#93143]).
* Fixes bug in the allowlist layout for security telemetry  ({pull}92850[#92850]).
* Updates exceptions modal to use existing lists plugin useApi hook ({pull}92348[#92348]).
...
* Fixes issues with searching the exceptions table by name ({pull}88701[#88701]).
* Threshold rule fixes ({pull}93553[#93553]).
* Critical threshold rule fixes ({pull}92667[#92667]).
