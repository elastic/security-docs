...
* If you edit a rule while that rule is running, the rule fails. The rule will sometimes succeed even if the detection engine indicates a failure ({pull}82320[#82320]).
+
[role="screenshot"]
