...
[[features-7.13.0]]
==== Features
* Fixes Live query form errors handling {kibana-pull}99015[#99015].
* Fixes UI capabilities validation {kibana-pull}97663[#97663].
* Agent picker follow up {kibana-pull}97357[#97357].
* Adds pre-packaged rule updates through the "Prebuilt Security Detection Rules" Fleet integration {kibana-pull}96698[#96698].
* Filters alerts table by presence of threat (elastic/security-team {kibana-pull}96096[#96096].
* Populates threat.indicator.event with _source.event {kibana-pull}95697[#95697].
* Adds Threat Summary and Threat Details tabs to Alert Side Panel {kibana-pull}95604[#95604].
* Adds live query history table {kibana-pull}94536[#94536].
...
* Updates Beats fields metadata {kibana-pull}97719[#97719].
* Fixes UI capabilities validation {kibana-pull}97663[#97663].
* Osquery agent picker tests/fixes {kibana-pull}97580[#97580].
* Update detection alert mappings to ECS 1.9 {kibana-pull}97573[#97573].
* Agent picker follow up {kibana-pull}97357[#97357].
* ML Rules accept multiple ML Job IDs {kibana-pull}97073[#97073].
* Adds Security Network ML Module to list of available jobs {kibana-pull}97014[#97014].
* Updates MITRE Tactics, Techniques, and Subtechniques for 7.13 {kibana-pull}97011[#97011].
* Improves rule duplication user experience {kibana-pull}96760[#96760].
* Adds pre-packaged rule updates through the "Prebuilt Security Detection Rules" Fleet integration {kibana-pull}96698[#96698].
* Adds Nested CTI row renderer {kibana-pull}96275[#96275].
* Rebuild nested fields structure from fields response {kibana-pull}96187[#96187].
* Filters alerts table by presence of threat (elastic/security-team {kibana-pull}96096[#96096].
* Combine multiple timestamp searches into single request {kibana-pull}96078[#96078].
* Adds Indicator Match Timeline Template {kibana-pull}95840[#95840]
* Updated osquery autocomplete to v4.7.0 schema {kibana-pull}95741[#95741].
* Populates threat.indicator.event with _source.event {kibana-pull}95697[#95697].
* Detection Rule Adoption {kibana-pull}95659[#95659].
* Adds Threat Summary and Threat Details tabs to Alert Side Panel {kibana-pull}95604[#95604].
* Timeline http endpoints {kibana-pull}95036[#95036].
* Osquery agent picker {kibana-pull}94541[#94541].
* Adds live query history table {kibana-pull}94536[#94536].
* Osquery autocomplete {kibana-pull}94255[#94255].
* Adds support for Live queries in Osquery {kibana-pull}89889[#89889].
* Update agent status labels and colors {kibana-pull}99314[#99314]
* Fixes an issue where many `OR` clauses take up too much vertical space {kibana-pull}98706[#98706].
* Text updates {kibana-pull}98192[#98192].
* Critical bug to add network responses to error toasters {kibana-pull}97945[#97945].
* Breaks very long hostnames so they are readable {kibana-pull}97253[#97253].
* Fixes failed to query DNS data - too_many_buckets_exception {kibana-pull}97069[#97069].
* Enable preview when only filters used {kibana-pull}94018[#94018].
* Fixes rule details activate switch {kibana-pull}94010[#94010].
* Sets our default date time to be "today" instead of "Last 24 hours" to enable cachability and fixes one date math bug in the URL {kibana-pull}93548[#93548].
* Update Cloud plugin to handle new config in kibana.yml {kibana-pull}95569[#95569].
