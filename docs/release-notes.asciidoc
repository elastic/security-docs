...
* Filters the Alerts table by threat presence of threat ({pull}96096[#96096]).
...
[[known-issues-7.13.0]]
==== Known issues
* A histogram cannot be generated for these fields because their mappings have changed ({pull}670[#670]): 
