...
[[known-issue-7.14.0]]
==== Known issues
* In order to use osquery in 7.14, you need to upgrade the {agent} to the newest version. Go to {ref}/upgrade-elastic-agent.html[Upgrade Elastic Agent] for instructions.
