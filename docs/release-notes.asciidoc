...
* Update text in Endpoint Admin pages ({pull}104649[#104649])
...
* Show case names in isolation success message ({pull}102664[#102664]).
* Implements best effort merging of constant_keyword, runtime fields, aliases, and copy_to fields ({pull}102280[#102280]).
* Paginate actions log with infinite scroll ({pull}102261[#102261]).
...
* Implement "select all" rules ({pull}100554[#100554]).
...
* Allow wildcard in trusted app paths ({pull}97623[#97623]).
...
* Make Endpoint Exception field options aware of OS, introduce OS selection to Endpoint Exceptions flow ({pull}95014[#95014]).
...
* Include actions and responses for endpoints only ({pull}103159[#103159]).
* Osquery telemetry usage bug ({pull}102762[#102762]).
* Fixes empty exceptions filter bug ({pull}102583[#102583]).
* Remove search bar on activity log ({pull}102550[#102550]).
* Do not show activity log error popups ({pull}102450[#102450]).
...
* Update help text for common repository settings ({pull}97652[#97652]).
* Collect all documents that fail to transform before stopping the migration ({pull}96986[#96986]).
* Provide guidance of "Custom" allocation behavior in ILM ({pull}96111[#96111]).
* Fixed remote clusters details flyout for long strings ({pull}105592[#105592]).
