...
* A warning displays for Endgame rules indicating that the timestamp override field is missing. This warning can be ignored as the rule still functions correctly ({pull}91597[#91597]).
