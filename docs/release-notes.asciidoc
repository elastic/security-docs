...
==== Breaking changes
* With the new ECS updates, threat fields are outdated and threat intelligence data will not display on enriched detection alerts. To ensure threat intelligence data properly displays, users will need to migrate their alerts.
...
** Adds a reason field to Alerts details flyout ({pull}#108449[#108449], {pull}#107532[#107532]).
...
** Adds actions to fields in the Alert details flyout ({pull}#106362[#106362]).
