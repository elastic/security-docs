...
[[known-issues-7.11.2]]
==== Known issues
* Jira connector migration between 7.11.0 to 7.11.2 will fail to due a missing tag for the right version https://github.com/elastic/sdh-kibana/issues/1320[(#1320)].
