...
* For {stack} version >= 7.15.0, host isolation is supported for endpoints in Windows, macOS, and these Linux distributions ({pull}108230[#108230]):
...
* Implement the accordion view on the *Threat Intel* tab so that threat matches and their details can be easily viewed ({pull}106609[#106609]).
