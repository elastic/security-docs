...
[[features-7.14.0]]
==== Features
* Host Isolation is a way for Security users to isolate hosts from their networks while investigating a potential attack.  It stops a possibly infected host from infecting other hosts on the network.
