...
* Fixes the JavaScript error that occurred when users opened the detailed view of an alert while the detailed view of an event was still open ({pull}103970[#103970]).
