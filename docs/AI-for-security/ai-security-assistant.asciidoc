...
// {kibana-ref}/elastic-managed-llm.html[Elastic Managed LLM]
...
// {kibana-ref}/elastic-managed-llm.html[connector documentation]
To learn more about security, data privacy, and early access to the Elastic Managed LLM, refer to the connector documentation and https://raw.githubusercontent.com/elastic/kibana/refs/heads/main/docs/reference/resources/Elastic_Managed_LLM_model_card.pdf[download the model card].
