...
[sidebar]
--
While AI Assistant is compatible with many different models, we recommend you refer to the <<llm-performance-matrix>> to select models that perform well with your desired use cases.
--
