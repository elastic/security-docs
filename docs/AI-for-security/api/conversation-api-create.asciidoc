...
|`category` |String |Could be 'assistant' or 'insights' or not defined. |No
|`isDefault` |Boolean |Define if conversation is a system conversation. |No
|`excludeFromLastConversationStorage` |Boolean |Defines if conversation should be displayed as the latest used conversation if it was used. |No
