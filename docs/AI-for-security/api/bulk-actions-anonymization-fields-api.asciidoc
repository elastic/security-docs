...
| `create` | <<bulk-create-object-schema, BulkCreateAction[]>> |  Array of anonymization fields objects to create. | No
| `delete` | String[] |  Array of anonymization fields IDs to which a bulk action will be applied. | No
| `update` | <<bulk-update-object-schema, BulkUpdateAction[]>> |  Array of anonymization fields objects with the fields to update. | No
