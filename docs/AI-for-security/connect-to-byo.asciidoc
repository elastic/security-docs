...
NOTE: For information about the performance of open-source models on tasks within {elastic-sec}, refer to the <<security-llm-performance-matrix,LLM performance matrix>>.
