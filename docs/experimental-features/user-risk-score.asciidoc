...
. Stop and delete the user risk score transforms. You can do this through the {kib} UI or using the {ref}/stop-transform.html[Stop transform API] and {ref}/delete-transform.html[Delete transform API].
** To delete the user risk score transforms through the {kib} UI:
...
----------------------------------
. Delete the user risk score ingest pipeline. You can do this through the {kib} UI or using the {ref}/delete-pipeline-api.html[Delete pipeline API].
** To delete the user risk score ingest pipeline through the {kib} UI:
