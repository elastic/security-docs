...
If you previously enabled host risk score and are upgrading to {stack} versions 8.5–8.10, there'll be an **Upgrade** button for host risk score instead of **Enable**. If you're upgrading to {stack} version 8.11 or newer, you can upgrade to the latest risk scoring engine.
