...
*Note*: A user with these cluster and index privileges can enable the Detections feature in any Kibana space by visiting the Detections page once in the Kibana space they want to enable the feature in.
