...
- `13.0` and above: You cannot install the sensor without allowing it to load a <<system-extension-ven, system extension>>. During installation, you'll be prompted to go to System Preferences and approve it. Upon approval, a second prompt appears to enable Network Filtering. Approve it to proceed.
+
