...
- `11.0` (Big Sur): Users cannot proceed with installation without first granting the sensor the ability to load <<system-extension>>. During installation, you will be prompted to go to **System preferences** and approve loading the system extension. Upon approval, installtion proceeds. 
+
...
- `11.0` (Big Sur): <<system-extension>>, as well as `com.endgame.systemextension`.
