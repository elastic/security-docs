...
NOTE: You cannot update the data view for the Alerts page, e.g. to enable it to reference a cross-cluster search (CCS) data view. It always shows data from `.alerts-security.alerts-default`.
