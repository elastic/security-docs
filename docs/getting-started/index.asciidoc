...
include::endgame-sensor-reqs.asciidoc[leveloffset=+2]
include::endgame-sensor-FDA.asciidoc[leveloffset=+3]
include::endgame-sensor-FDA-ven.asciidoc[leveloffset=+3]
