...
Looking to get started with {elastic-sec}? This section describes the {elastic-sec} UI in Kibana, the system requirements required to run the {agent} with the Elastic {endpoint-cloud-sec} integration, and instructions on how to configure and install {elastic-sec} on your host.
