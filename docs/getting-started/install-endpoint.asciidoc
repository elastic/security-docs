...
[discrete]
[[configure-malware]]
== Configure Malware detection or prevent

After you have created an agent, you can configure malware protection on protected hosts.
...
a. **Detect**: Detects malware on the host and generates an alert.
