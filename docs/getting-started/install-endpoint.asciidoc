...
* You must have the *{elastic-defend} Policy Management* <<endpoint-management-req,privilege>>to configure an integration policy, and the *Endpoint List* <<endpoint-management-req,privilege>> to access the **Endpoints** page in the {security-app}.
--
