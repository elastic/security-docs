...
WARNING: The early release of {ingest-management} is experimental. We invite you to
...
+
--
include::{beats-root}/x-pack/elastic-agent/docs/tab-widgets/enroll-widget.asciidoc[]
--
+
