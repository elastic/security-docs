...
+
2. On the Endpoints page of the {security-app} or the Endpoint Security integration page in Fleet, select **Add Endpoint Security**. The integration configuration page appears.
...
+
5. After you have enrolled the {agent} on your host, select **Continue**. The host now appears on the **Administration** page in the {security-app}.
