...
Ransomware is a paid feature and is enabled by default if you have a Platinum+ license. If you upgrade to a Platinum+ license from Basic or Gold, ransomware will be disabled by default.
