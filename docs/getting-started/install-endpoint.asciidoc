...
|Both cloud Workload presets have <<session-view,Session data>> collection enabled by default, which increases data throughput. All preventions are disabled by default.
