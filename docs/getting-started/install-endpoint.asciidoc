...
. Next, select a configuration preset. Each preset comes with different default settings for {agent} — you can further customize these later. For more information, refer to {fleet-guide}/agent-policy.html[{agent} policies].
