...
4. You should receive an output similar to `149    0 0xffffff7f82e7b000 0x21000    0x21000    co.elastic.kendpoint (7.11.0) BD152A57-ABD3-370A-BBE8-D15A0FCBD19A <6 5 2 1>`. If you receive this output, the kernal extension is enabled.

[discrete]
[[configure-security-policy]]
== Configure an Integration Policy (optional)

After the {agent} is installed successfully, malware prevention is automatically enabled on protected hosts. If needed, you can update the Integration Policy to configure malware protection, event collection, and anti-virus settings to meet your company's security needs.
...
Click **Save** to save changes to the Policy.
...
Once you have your desired policy settings click **Save** to save changes to the Policy.
