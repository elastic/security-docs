...
When running the {agent} with endpoint integrated on macOS 11 or greater, you might be prompted to approve a kernel extension from "Endgame, Inc". To approve the extension:
