...
If you download the Elastic Agent on Windows 10 or above, you can Elastic Security as your antivirus software. To enable Elastic Security as antivirus: 
...
4. On the Integration Edit page, look for the **Protections** section and find **Type: Register as antivirus**. Toggle this option on. 
+
[role="screenshot"]
