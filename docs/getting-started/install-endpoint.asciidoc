...
. Select an agent policy for the {agent}. You can select the default policy, an existing custom policy, or select **Create agent policy** to create a new one. For more details on {agent} configuration settings, refer to {fleet-guide}/agent-policy.html[{agent} policies].
...
. Select an agent policy for the {agent}. You can select the default policy, an existing custom policy, or select **Create new agent policy** to create a new one. For more details on {agent} configuration settings, refer to {fleet-guide}/agent-policy.html[{agent} policies].
+
