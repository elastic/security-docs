...
The `securitySolution:enableGroupedNav` setting enables a new navigation UI that groups related pages and highlights commonly visited pages for a streamlined experience.
