...
Set the `excludedDataTiersForRuleExecution` field to ensure that events from cold and frozen {ref}/data-tiers.html[data tiers] aren't searched during rule executions. Excluding data from cold and frozen tiers might help to improve rule performance or reduce execution time. 
