...
The {security-app} contains seven pages that enable analysts to view, analyze, and manage security data:
...
From the *Overview* page, you can also quickly access recently created cases, favorited timelines, and the latest {elastic-sec} news by going to the live feed.
