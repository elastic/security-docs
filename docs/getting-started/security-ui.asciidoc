...
The Rules page allows you to view and manage all detection rules. See <<drules-ui-management, Manage detection rules>> for more information about prebuilt and custom rules.
