...
Investigate alerts and complex threats, such as lateral movement of malware across hosts in your network. Timelines are interactive and allow you to share your findings with other team members. Refer to <<timelines-ui>> to learn more.
...
View a quick shortcut to add security integrations, which you can use to monitor your hosts and ingest data.
