...
* *Manage*: View and manage hosts that are running {elastic-defend}.
...
The Endpoints page allows you to view and manage hosts running {elastic-defend}. Refer to <<admin-page-ov, Endpoints>> for more information.
...
The Policies page lists all of the integration policies configured for {elastic-defend}.  Refer to <<policies-page-ov, Policies>> for more information.
...
The Blocklist page allows you to prevent specified applications from running on hosts, extending the list of processes that {elastic-defend} considers malicious. Refer to <<blocklist, Blocklist>> for more information.
