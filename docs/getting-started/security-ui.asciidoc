...
- If the Filebeat agent hasn't ingested Threat Intel module data yet, the **View dashboard** button greys out and threat indicator event counts won't load. You can wait for data to generate or reach out to your administrator for help resolving this.
