...
The {security-app} is a highly interactive workspace designed for security
...
Select the collapsable *Timeline* button on the rightmost side of the {security-app} to start an investigation. See <<timeline-ui-overview,>> for more information.
...
The Detections page allows you to view and manage all alerts and detection rules to monitor activity within your network. See <<detection-engine-intro>> for more information about detections, prebuilt rules, and alerts.
...
in your network. Timelines are responsive and allow you to share your findings among other team members. See <<timeline-ui-overview>> for information about getting started with Timelines.
