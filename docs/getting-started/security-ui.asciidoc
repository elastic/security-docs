...
NOTE: You can connect to threat intelligence sources using {agent} integrations, the {filebeat-ref}/filebeat-module-threatintel.html[Threat Intel module], or custom integrations. Refer to Enable threat intelligence integrations for more information.
