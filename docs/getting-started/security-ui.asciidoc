...
* Press the `Tab` key to navigate a page or use a mouse to select a draggable element and give it keyboard focus.
...
* Press *Enter* on an element with keyboard focus to display its menu and to enable the `f`, `o`, `a`, `t`, `c` hotkeys. Apply focus to menu options, and elements throughout the UI, by pressing the `Tab` key.

[role="screenshot"]
image::images/timeline-ui-accessiblity-display-menu.gif[width=100%][height=100%][Demo that shows how to display an element's menu]

* Press the spacebar on your keyboard to begin dragging a field to a different location and the directional keys to move it to a drop area. Press the spacebar again to drop the field.
...
Use your keyboard to navigate through rows, columns, and menu options of elements in the Elastic Security UI:

* Use the directional arrows to move keyboard focus right, left, up, and down.

[role="screenshot"]
image::images/timeline-ui-accessiblity-directional-arrows.gif[width=100%][height=100%][Demo that shows how to drag and drop an element to another location in the Elastic Security UI]
...
[role="screenshot"]
image::images/timeline-ui-accessiblity-shift-keyboard-focus.gif[width=100%][height=100%][Demo that shows how to drag and drop an element to another location in the Elastic Security UI]

* Use the *Page Up* and *Page Down* keys to scroll through the page.

[role="screenshot"]
image::images/timeline-ui-accessiblity-page-up-and-down.gif[width=100%][height=100%][Demo that shows how to drag and drop an element to another location in the Elastic Security UI]
