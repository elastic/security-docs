...
The Blocklist page allows you to prevent specified applications or files from running if you're certain they should never run in a host environment. Refer to <<blocklist, Blocklist>> for more information.
