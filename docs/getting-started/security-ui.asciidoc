...
[role="screenshot"]
image::images/inline-actions-menu.png[Inline additional actions menu,50%]

Inline actions include the following (depending on the context, some actions might not be available):
