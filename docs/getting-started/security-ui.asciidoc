...
The Threat Intelligence card shows the total number of threat indicators collected by the {ref}/filebeat-module-threatintel.html[Threat Intel Filebeat module]. Clicking **View dashboard** opens the module in {kib} and clicking **View source dashboard** allows you to further inspect threat intel datasets as {kib} dashboards.
