...
The Endpoints page allows you to view and manage hosts that are running {endpoint-sec}. Refer to <<admin-page-ov, Endpoints>> for more information.
...
The Policy List page lists all of the integration policies configured for {endpoint-sec}.  Refer to <<policy-list, Policy List>> for more information.

[role="screenshot"]
image::management/admin/images/policy-list.png[Policy List page]
