...
Pages are grouped into four main sections within the navigation pane -- *Detect*, *Explore*, *Investigate*, and *Manage*. Each section supports a different part of your workflow and provides actions you can perform in the {security-app}.

From the *Detect* section, access pages that allow you to view, create, and manage alerts, rules, and rule exceptions.

Under *Explore*, access pages that provide key metrics about your hosts and networks.

The *Investigate* section gives you access to Timelines and cases.

Pages under the *Manage* section allow you to view and manage hosts that are running Endpoint Security. You can also view and manage trusted applications and event filters from pages in this section.
...
The Hosts page provides key metrics for host-related security events and a set of interactive data tables. Refer to <<hosts-overview, Hosts page overview>> for more information.
