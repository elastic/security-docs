...
The Findings page provides an overview of your Kubernetes infrastructure configuration's performance on a range of security benchmarks. Refer to <<kspm, Kubernetes security posture management>>.
