...
The Blocklist page allows you to block specified applications or files from running if you are certain they should never run in an environment. Refer to <<blocklist, Blocklist>> for more information.
