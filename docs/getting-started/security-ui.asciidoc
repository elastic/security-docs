...
The Detections page allows you to view and manage all alerts and detection rules to monitor activity within your network. See <<ddetection-engine-overview>> for more information about detections, prebuilt rules, and alerts.
...
[[admin-ui]]
=== Administration page
The Administration page allows you to view and manage hosts that are running Elastic Endpoint Security. You can also manage agent integration and monitor the configuration status of your hosts to ensure they are protected. See <<admin-pg-ov>> for more information.
