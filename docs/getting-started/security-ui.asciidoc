...
[role="screenshot"]
image::images/trusted-apps-list.png[Shows the Trusted applications page]
...
[role="screenshot"]
image::images/event-filters-list.png[Shows the Event filters page]
