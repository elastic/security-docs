...
* *A link to a dashboard that allows you to inspect data from the ingested threat intelligence source.* In the *Indicator* column, click *Source* for the appropriate source to open the dashboard.
+
...
+
NOTE: The message warning you that some threat intel sources are disabled will continue to display until you've enabled all of the available {elastic-sec} threat intelligence integrations.

. Complete the integration's installation steps.
. Return to the Threat Intelligence view on the Overview page. Refresh the page if you do not see indicator data in the Threat Intelligence view. 
