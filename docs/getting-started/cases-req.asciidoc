...
To grant access to cases, set the {kib} space privileges for *Cases* and *Actions and Connectors* feature. More information about the minimum privileges needed to use cases is below:
