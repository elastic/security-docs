...
To grant access to cases, set the {kib} space privileges for the *Cases* and *Actions and Connectors* features. More information about the minimum privileges needed to use cases is below:
