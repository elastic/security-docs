...
NOTE: To create a new trusted application, you have to go to **Manage** -> **Trusted applications**. You can't create new trusted applications while configuring an integration policy.
