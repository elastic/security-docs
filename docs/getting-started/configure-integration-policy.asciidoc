...
TIP: In addition to configuring an {elastic-defend} policy through the {elastic-sec} UI, you can <<create-defend-policy-api,create and customize an {elastic-defend} policy through the API>>.
