...
[discrete]
[[register-as-antivirus]]
== Register {es-sec} as antivirus (optional)

If you download the {agent} version 7.10 or later on Windows 7 or above, you can configure {es-sec} as your antivirus software by switching the **Register as antivirus** toggle on.
