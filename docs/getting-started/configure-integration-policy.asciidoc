...
The quarantine folder location depends varies by operating system:
...
- Windows - {agent} versions 8.4 and earlier: `[DriveLetter:]\.quarantine`, regardless of the files' original drive
