...
+
image::images/security-siem-migration-1.png[automatic migration setup page,150]
+
.NOTE
[sidebar] 
--
...
image::images/security-siem-migration-processed-rules.png[automatic migrations processed rules page,150]
...
image::images/security-siem-migration-edit-rule.png[automatic migration edit interface,150]
...
IMPORTANT: All the details about your migrations is stored in the `.kibana-siem-rule-migrations-rules-default` index. You can use (/explore-analyze/discover.md)[Discover] to review a variety of metrics, analyze metrics, and more.
...
Rules that fall into this category will typically appear with a status of partially translated. You can use the (elasticsearch://reference/query-languages/esql/esql-lookup-join.md)[`LOOKUP JOIN`] capability to help in this situation. 