...
The Data Quality dashboard doesn't show data from cold or frozen [data tiers](((ref))/data-tiers.html). It also doesn't display data from remote clusters using cross-cluster search. To view data from another cluster, log in to that cluster.
</DocCallOut>
