...
For more information about connecting to threat intelligence sources, visit <DocLink id="serverlessSecurityEsThreatIntelIntegrations">Enable threat intelligence integrations</DocLink>.
</DocCallOut>
