...
The Kubernetes dashboard provides insight into Linux process data from your Kubernetes clusters. It shows sessions and alerts in detail and in the context of your monitored infrastructure.
