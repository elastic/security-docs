...
[discrete]
== Setup
To get data for this dashboard, set up <<d4c-get-started, Cloud Workload Protection for Kubernetes>> for the clusters you want to appear on the dashboard.

.Requirements
[sidebar]
--
- Kubernetes node operating systems must have Linux kernels 5.10.16 or higher.
- Elastic Stack version 8.8 or higher.
--
