---
id: enSecurityDetectionEntityDashboard
...
* To display host and user risk scores, the host risk score and user risk score features must be enabled. You can do this directly from the dashboard by clicking the **Enable** button. For more information, refer to the <DocLink id="enSecurityHostRiskScore" section="enable-host-risk-score">Enable host risk score</DocLink> and <DocLink id="enSecurityUserRiskScore" section="enable-user-risk-score">Enable user risk score</DocLink> instructions.
...
* <DocLink id="enSecurityDetectionEntityDashboard" section="entity-kpis-key-performance-indicators">Entity KPIs (key performance indicators)</DocLink>
* <DocLink id="enSecurityDetectionEntityDashboard" section="host-risk-scores">Host Risk Scores</DocLink>
* <DocLink id="enSecurityDetectionEntityDashboard" section="user-risk-scores">User Risk Scores</DocLink>
* <DocLink id="enSecurityDetectionEntityDashboard" section="anomalies">Anomalies</DocLink> 
...
For more information about host risk scores, click the **Learn more** link in the table, or refer to <DocLink id="enSecurityHostRiskScore">Host risk score</DocLink>. 
