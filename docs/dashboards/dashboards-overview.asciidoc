...
The {security-app}'s default dashboards provide useful visualizations of your security environment. To view them in {security-app}, select *Dashboards* from the navigation menu.
