...
description: The Cloud Posture dashboard summarizes your cloud security posture.
tags: [ 'serverless', 'security', 'how-to', 'cloud-security' ]
status: in review
---
...
* The Cloud Posture dashboard is available to all Elastic Cloud users. 
...
![A row representing a single cluster in the Cloud Posture dashboard](../images/cloud-posture-dashboard/-dashboards-cloud-sec-dashboard-individual-row.png)
