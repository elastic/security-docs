...
For help enabling Full Disk Access on macOS Mojave (10.14) or later, go to https://www.elastic.co/guide/en/endpoint/master/sensor-full-disk-access.html[Enable Full Disk Access].
