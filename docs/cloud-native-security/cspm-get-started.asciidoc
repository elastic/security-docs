...
*Next, attach your new IAM role to an EC2 instance:*
...
+
. On the "Mofify IAM role" page, search for and select your new IAM role.
. Click *Update IAM role*.
. Return to {kib} and <<cspm-finish-setup, continue setup>>, making sure to deploy the CSPM integration to this EC2 instance.
