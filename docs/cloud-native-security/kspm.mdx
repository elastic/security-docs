...
1. After each evaluation, the integration sends findings to ((es)). Findings appear on the <DocLink id="serverlessSecurityCloudPostureDashboardDash">Cloud Security Posture dashboard</DocLink> and the <DocLink id="serverlessSecurityCspmFindingsPage">findings</DocLink> page.
...
1. Go to the <DocLink id="serverlessSecurityCloudPostureDashboardDash">Cloud Security Posture dashboard</DocLink>.
...
1. Go to the <DocLink id="serverlessSecurityCloudPostureDashboardDash">Cloud Security Posture dashboard</DocLink> (**Dashboards -> Cloud Security Posture**).
