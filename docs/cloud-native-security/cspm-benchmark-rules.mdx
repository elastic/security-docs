...
slug: /serverless/security/cspm-benchmark-rules
title: Benchmark rules
# description: Description to be written
tags: []
---

<div id="cspm-benchmark-rules"></div>

The Benchmark Integrations page lets you view the cloud security posture (CSP) benchmark rules for the <DocLink id="serverlessSecurityCspm">Cloud security posture mangaement</DocLink> (CSPM) and <DocLink id="serverlessSecurityKspm">Kubernetes security posture management</DocLink> (KSPM) integrations.
...
When benchmark rules are evaluated, the resulting <DocLink id="serverlessSecurityFindingsPage">findings</DocLink> data appears on the <DocLink id="serverlessSecurityCloudPostureDashboard">Cloud Posture dashboard</DocLink>.
...
![Benchmark rules page](../images/cspm-benchmark-rules/-cloud-native-security-benchmark-rules.png)
