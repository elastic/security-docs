...
When benchmark rules are evaluated, the resulting <DocLink id="serverlessSecurityCspmFindingsPage">findings</DocLink> data appears on the <DocLink id="serverlessSecurityCloudPostureDashboard">Cloud Posture dashboard</DocLink>.
