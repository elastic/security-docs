...
description: Review the cloud security benchmarks used by the CSPM and KSPM integrations.
...
When benchmark rules are evaluated, the resulting <DocLink id="serverlessSecurityCspmFindingsPage">findings</DocLink> data appears on the <DocLink id="serverlessSecurityCloudPostureDashboardDash">Cloud Security Posture dashboard</DocLink>.
