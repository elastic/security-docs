---
id: enSecurityCspmBenchmarkRules
...
The Benchmark Integrations page lets you view the cloud security posture (CSP) benchmark rules for the <DocLink id="enSecurityCspm">Cloud security posture mangaement</DocLink> (CSPM) and <DocLink id="enSecurityKspm">Kubernetes security posture management</DocLink> (KSPM) integrations.
...
When benchmark rules are evaluated, the resulting <DocLink id="enSecurityFindingsPage">findings</DocLink> data appears on the <DocLink id="enSecurityCloudPostureDashboard">Cloud Posture dashboard</DocLink>.
