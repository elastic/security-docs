...
AWS & GCP are currently supported. Support for Azure is coming soon.
...
Yes, you can monitor more than one cloud account. <DocLink id="serverlessSecurityCspmGetStarted">Add the CSPM integration</DocLink> again for each additional account you want to monitor.
