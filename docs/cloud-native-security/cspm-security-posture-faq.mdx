---
id: enSecurityCspmSecurityPostureFaq
...
Yes, you can monitor more than one cloud account. <DocLink id="enSecurityCspmGetStarted">Add the CSPM integration</DocLink> again for each additional account you want to monitor.
...
Yes. There are different sets of benchmark rules for self-managed and third party-managed deployments. Refer to <DocLink id="enSecurityGetStartedWithKspm">Get started with KSPM</DocLink> for more information about setting up each deployment type.
