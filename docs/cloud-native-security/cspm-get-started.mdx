...
After creating the necessary roles, authenticate using the <DocLink id="serverlessSecurityCspmGetStarted" section="option-1-default-instance-role">default instance role</DocLink> method.
