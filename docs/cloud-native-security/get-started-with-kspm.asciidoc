...
1. Install on EKS-managed clusters:
  * <<kspm-setup-eks,Start configuring the KSPM integration>>
  * <<kspm-setup-eks-step-2,Authenticate to AWS>>
  * <<kspm-setup-eks-step-3,Finish configuring the KSPM integration>>
  * <<kspm-setup-eks-step-4,Modify and deploy the DaemonSet to your clusters>>
...
[discrete]
==== Finish configuring the KSPM integration
