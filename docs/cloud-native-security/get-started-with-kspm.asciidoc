...
3. Read the integration's description to understand how it works. Then, click *Add {integrations-docs}/cloud_security_posture[Kubernetes Security Posture Management]*.
