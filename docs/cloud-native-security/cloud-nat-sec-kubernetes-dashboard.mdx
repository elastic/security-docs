---
id: serverlessSecurityCloudNatSecKubernetesDashboard
...
When running within Kubernetes, ((elastic-endpoint))'s <DocLink id="serverlessSecurityHostIsolationOv">host isolation</DocLink> and <DocLink id="serverlessSecurityConfigureEndpointIntegrationPolicy" section="malware-protection">malware protection</DocLink> features are disabled.
</DocCallOut>
