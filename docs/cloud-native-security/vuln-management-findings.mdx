...
The **Vulnerabilities** tab on the Findings page displays the vulnerabilities detected by the <DocLink id="serverlessSecurityVulnManagementOverview">CNVM integration</DocLink>. 
