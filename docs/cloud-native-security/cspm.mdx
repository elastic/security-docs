...
This feature currently supports Amazon Web Services (AWS). For a step-by-step getting started guide, refer to <DocLink id="enSecurityCspmGetStarted">Get started with CSPM</DocLink>.
...
After each evaluation, the integration sends findings to Elastic. A high-level summary of the findings appears on the <DocLink id="enSecurityCloudNatSecPostureDashboard">Cloud posture dashboard</DocLink>, and detailed findings appear on the <DocLink id="enSecurityFindingsPage">Findings page</DocLink>.
