...
To learn more about D4C policies, including how to create your own, refer to the <DocLink id="enSecurityD4cPolicyGuide">D4C policies guide</DocLink>.
</DocCallOut>
