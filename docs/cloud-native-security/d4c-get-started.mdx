...
1. Optional — make any desired changes to the integration's policy by adjusting the **Selectors** and **Responses** sections. (For more information, refer to the <DocLink id="enSecurityD4cPolicyGuide">Defend for Containers policy guide</DocLink>). You can also change these later.
...
In order to detect threats using this data, you'll need active <DocLink id="serverlessSecurityDetectionEngineOverview">detection rules</DocLink>. Elastic has prebuilt detection rules designed for this data. (You can also create your own <DocLink id="enSecurityRulesUiCreate">custom rules</DocLink>.)
