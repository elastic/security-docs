...
+
. Google has deprecated its old Cloud Shell editor. If you continue to use it, you may encounter the following pop-up:
+
image::images/cspm-cloudshell-old-editor.png[The cloud shell switch editor popup]
+
Click the "X" button or "Try the new editor" and follow the next steps. If you choose to switch to the new editor, your context should remain unchanged.
