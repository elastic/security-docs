...
+
NOTE: Google has deprecated its old Cloud Shell editor. If you continue to use it, you may encounter the following pop-up:
+
image::images/cspm-cloudshell-old-editor.png[The cloud shell switch editor popup]
+
If the popup appears, click **X** or **Try the new editor** and follow the next steps. When you switch to the new editor, your context should remain unchanged.
...
NOTE: If you encounter any issues running the command, return to Kibana and navigate again to Google Cloud Shell.
