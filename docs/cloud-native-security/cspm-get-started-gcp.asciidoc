...
To authenticate manually, you'll first need to generate credentials for a new GCP service account with the necessary permissions, then provide those credentials to the CSPM integration.
