...
![A row representing a single cluster in the Cloud Security Posture dashboard](../images/cloud-nat-sec-posture-dashboard/-dashboards-cloud-sec-dashboard-individual-row.png)
