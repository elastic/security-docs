---
id: serverlessSecurityVulnManagementDashboard2
slug: /serverless/security/vuln-management-dashboard2
...
* To collect this data, install the <DocLink id="serverlessSecurityVulnManagementGetStarted">Cloud Native Vulnerability Management</DocLink> integration.
...
Click **View all vulnerabilities** at the bottom of a table to open the <DocLink id="serverlessSecurityVulnManagementFindings">Vulnerabilities Findings</DocLink> page, where you can view additional details.
