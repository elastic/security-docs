---
id: enSecurityVulnManagementDashboardDash
...
* To collect this data, install the <DocLink id="enSecurityVulnManagementGetStarted">Cloud Native Vulnerability Management</DocLink> integration.
...
Click **View all vulnerabilities** at the bottom of a table to open the <DocLink id="enSecurityVulnManagementFindings">Vulnerabilities Findings</DocLink> page, where you can view additional details.
