...
<DocLink id="serverlessSecurityD4cOverview">Read the Container workload protection docs</DocLink>.
...
<DocLink id="serverlessSecurityCloudWorkloadProtection">Read the Cloud workload protection docs</DocLink>.
