...
* Host isolation requires the Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/>. 
...
The response console requires the Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
</DocCallOut>
...
<DocCallOut title="Note">
The host isolation endpoint response action requires the Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/>. 
</DocCallOut>
