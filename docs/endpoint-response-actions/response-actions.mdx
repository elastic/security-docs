...
* Response actions and the response console UI require the Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
...
Required role: <DocBadge><DocIcon size="s" type="warning" title="coming soon"/> Information coming soon</DocBadge> {/* **Host Isolation** */}
...
Required role: <DocBadge><DocIcon size="s" type="warning" title="coming soon"/> Information coming soon</DocBadge>  {/* **Process Operations** */}
...
Required role: <DocBadge><DocIcon size="s" type="warning" title="coming soon"/> Information coming soon</DocBadge>  {/* **File Operations** */}
...
Required role: <DocBadge><DocIcon size="s" type="warning" title="coming soon"/> Information coming soon</DocBadge>  {/* **Execute Operations** */}
