...
For detailed information about which ECS fields can appear in each Endpoint document type, refer to the https://github.com/elastic/endpoint-package/tree/main/custom_documentation/doc/endpoint[Endpoint event documentation].
