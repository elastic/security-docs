...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-utility-launched-via-proxychains.html
---

# Suspicious Utility Launched via ProxyChains [suspicious-utility-launched-via-proxychains]
...
## Investigation guide [_investigation_guide_1039]
