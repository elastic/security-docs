...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/process-spawned-from-message-of-the-day-motd.html
---

# Process Spawned from Message-of-the-Day (MOTD) [process-spawned-from-message-of-the-day-motd]
...
## Investigation guide [_investigation_guide_838]
