...
# Credential Acquisition via Registry Hive Dumping [credential-acquisition-via-registry-hive-dumping]
...
## Investigation guide [_investigation_guide_247]
