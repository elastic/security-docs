---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/linux-user-added-to-privileged-group.html
---

# Linux User Added to Privileged Group [linux-user-added-to-privileged-group]
...
## Investigation guide [_investigation_guide_479]
