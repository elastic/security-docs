---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/network-activity-detected-via-cat.html
---

# Network Activity Detected via cat [network-activity-detected-via-cat]
...
## Investigation guide [_investigation_guide_573]
