...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/aws-cloudwatch-log-stream-deletion.html
---

# AWS CloudWatch Log Stream Deletion [aws-cloudwatch-log-stream-deletion]
...
## Investigation guide [_investigation_guide_16]
