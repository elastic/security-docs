---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-process-for-a-windows-host.html
---

# Unusual Process For a Windows Host [unusual-process-for-a-windows-host]
...
## Investigation guide [_investigation_guide_1146]
