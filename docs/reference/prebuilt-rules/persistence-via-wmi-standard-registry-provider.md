...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/persistence-via-wmi-standard-registry-provider.html
---

# Persistence via WMI Standard Registry Provider [persistence-via-wmi-standard-registry-provider]
...
## Investigation guide [_investigation_guide_631]
