...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/remotely-started-services-via-rpc.html
---

# Remotely Started Services via RPC [remotely-started-services-via-rpc]
...
## Investigation guide [_investigation_guide_880]
