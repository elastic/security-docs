...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/windows-event-logs-cleared.html
---

# Windows Event Logs Cleared [windows-event-logs-cleared]
...
## Investigation guide [_investigation_guide_1201]
