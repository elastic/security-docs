---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/renamed-autoit-scripts-interpreter.html
---

# Renamed AutoIt Scripts Interpreter [renamed-autoit-scripts-interpreter]
...
## Investigation guide [_investigation_guide_881]
