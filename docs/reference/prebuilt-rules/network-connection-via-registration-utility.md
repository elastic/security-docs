...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/network-connection-via-registration-utility.html
---

# Network Connection via Registration Utility [network-connection-via-registration-utility]
...
## Investigation guide [_investigation_guide_581]
