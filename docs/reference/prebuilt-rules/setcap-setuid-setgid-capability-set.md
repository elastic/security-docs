...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/setcap-setuid-setgid-capability-set.html
---

# Setcap setuid/setgid Capability Set [setcap-setuid-setgid-capability-set]
...
## Investigation guide [_investigation_guide_924]
