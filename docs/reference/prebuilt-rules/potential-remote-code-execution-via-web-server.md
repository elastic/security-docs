...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-remote-code-execution-via-web-server.html
---

# Potential Remote Code Execution via Web Server [potential-remote-code-execution-via-web-server]
...
## Investigation guide [_investigation_guide_755]
