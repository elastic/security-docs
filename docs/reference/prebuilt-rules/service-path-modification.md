...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/service-path-modification.html
---

# Service Path Modification [service-path-modification]
