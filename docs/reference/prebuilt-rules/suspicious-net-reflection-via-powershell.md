...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-net-reflection-via-powershell.html
---

# Suspicious .NET Reflection via PowerShell [suspicious-net-reflection-via-powershell]
...
## Investigation guide [_investigation_guide_961]
