...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/remote-file-download-via-powershell.html
---

# Remote File Download via PowerShell [remote-file-download-via-powershell]
...
## Investigation guide [_investigation_guide_872]
