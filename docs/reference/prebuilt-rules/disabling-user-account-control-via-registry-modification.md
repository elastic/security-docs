...
# Disabling User Account Control via Registry Modification [disabling-user-account-control-via-registry-modification]
...
* [https://www.elastic.co/security-labs/dissecting-remcos-rat-part-four](https://www.elastic.co/security-labs/dissecting-remcos-rat-part-four)
...
## Investigation guide [_investigation_guide_271]
