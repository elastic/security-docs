---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-aws-command-for-a-user.html
---

# Unusual AWS Command for a User [unusual-aws-command-for-a-user]
...
## Investigation guide [_investigation_guide_1100]
