...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-zoom-child-process.html
---

# Suspicious Zoom Child Process [suspicious-zoom-child-process]
...
## Investigation guide [_investigation_guide_1050]
