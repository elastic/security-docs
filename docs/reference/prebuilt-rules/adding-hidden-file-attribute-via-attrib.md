...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/adding-hidden-file-attribute-via-attrib.html
---

# Adding Hidden File Attribute via Attrib [adding-hidden-file-attribute-via-attrib]
...
## Investigation guide [_investigation_guide_122]
