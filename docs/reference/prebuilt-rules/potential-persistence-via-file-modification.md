...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-persistence-via-file-modification.html
---
...
## Investigation guide [_investigation_guide_721]
