...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-network-connection-via-rundll32.html
---

# Unusual Network Connection via RunDLL32 [unusual-network-connection-via-rundll32]
...
## Investigation guide [_investigation_guide_1136]
