---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/startup-folder-persistence-via-unsigned-process.html
---

# Startup Folder Persistence via Unsigned Process [startup-folder-persistence-via-unsigned-process]
...
## Investigation guide [_investigation_guide_948]
