...
# Windows Defender Exclusions Added via PowerShell [windows-defender-exclusions-added-via-powershell]
...
## Investigation guide [_investigation_guide_1200]
