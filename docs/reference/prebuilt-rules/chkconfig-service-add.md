...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/chkconfig-service-add.html
---

# Chkconfig Service Add [chkconfig-service-add]
...
## Investigation guide [_investigation_guide_217]
