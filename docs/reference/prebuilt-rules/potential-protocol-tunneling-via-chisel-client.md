...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-protocol-tunneling-via-chisel-client.html
---

# Potential Protocol Tunneling via Chisel Client [potential-protocol-tunneling-via-chisel-client]
...
## Investigation guide [_investigation_guide_748]
