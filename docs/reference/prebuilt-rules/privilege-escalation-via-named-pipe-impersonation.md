...
# Privilege Escalation via Named Pipe Impersonation [privilege-escalation-via-named-pipe-impersonation]
...
## Investigation guide [_investigation_guide_819]
