...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/anomalous-process-for-a-windows-population.html
---

# Anomalous Process For a Windows Population [anomalous-process-for-a-windows-population]
...
## Investigation guide [_investigation_guide_134]
