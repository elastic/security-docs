---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/execution-from-unusual-directory-command-line.html
---

# Execution from Unusual Directory - Command Line [execution-from-unusual-directory-command-line]
...
## Investigation guide [_investigation_guide_308]
