...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/powershell-psreflect-script.html
---

# PowerShell PSReflect Script [powershell-psreflect-script]
...
## Investigation guide [_investigation_guide_802]
