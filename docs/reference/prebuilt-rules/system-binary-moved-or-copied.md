---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/system-binary-moved-or-copied.html
---

# System Binary Moved or Copied [system-binary-moved-or-copied]
...
## Investigation guide [_investigation_guide_1057]
