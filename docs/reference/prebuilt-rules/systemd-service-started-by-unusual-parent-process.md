...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/systemd-service-started-by-unusual-parent-process.html
---

# Systemd Service Started by Unusual Parent Process [systemd-service-started-by-unusual-parent-process]
...
## Investigation guide [_investigation_guide_1066]
