---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/multiple-okta-user-auth-events-with-same-device-token-hash-behind-a-proxy.html
---

# Multiple Okta User Auth Events with Same Device Token Hash Behind a Proxy [multiple-okta-user-auth-events-with-same-device-token-hash-behind-a-proxy]
...
## Investigation guide [_investigation_guide_561]
