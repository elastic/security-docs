...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-high-word-policy-blocks-detected.html
---

# Unusual High Word Policy Blocks Detected [unusual-high-word-policy-blocks-detected]
...
## Investigation guide [_investigation_guide_1119]
