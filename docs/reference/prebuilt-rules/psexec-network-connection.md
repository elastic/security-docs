...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/psexec-network-connection.html
---

# PsExec Network Connection [psexec-network-connection]
...
## Investigation guide [_investigation_guide_845]
