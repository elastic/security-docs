...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-pdf-reader-child-process.html
---

# Suspicious PDF Reader Child Process [suspicious-pdf-reader-child-process]
...
## Investigation guide [_investigation_guide_1013]
