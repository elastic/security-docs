...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/spike-in-network-traffic-to-a-country.html
---

# Spike in Network Traffic To a Country [spike-in-network-traffic-to-a-country]
...
## Investigation guide [_investigation_guide_942]
