---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/powershell-mailbox-collection-script.html
---

# PowerShell Mailbox Collection Script [powershell-mailbox-collection-script]
...
## Investigation guide [_investigation_guide_800]
