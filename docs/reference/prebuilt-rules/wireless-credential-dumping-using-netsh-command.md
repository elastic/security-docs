...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/wireless-credential-dumping-using-netsh-command.html
---

# Wireless Credential Dumping using Netsh Command [wireless-credential-dumping-using-netsh-command]
...
## Investigation guide [_investigation_guide_1210]
