---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/network-connection-via-signed-binary.html
---

# Network Connection via Signed Binary [network-connection-via-signed-binary]
...
## Investigation guide [_investigation_guide_582]
