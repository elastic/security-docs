---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/aws-config-resource-deletion.html
---

# AWS Config Resource Deletion [aws-config-resource-deletion]
...
## Investigation guide [_investigation_guide_17]
