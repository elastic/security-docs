...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/command-prompt-network-connection.html
---
...
## Investigation guide [_investigation_guide_225]
