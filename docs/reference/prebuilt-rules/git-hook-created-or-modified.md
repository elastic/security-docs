...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/git-hook-created-or-modified.html
---
...
## Investigation guide [_investigation_guide_380]
