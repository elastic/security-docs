...
# Suspicious Image Load (taskschd.dll) from MS Office [suspicious-image-load-taskschd-dll-from-ms-office]
...
## Investigation guide [_investigation_guide_994]
