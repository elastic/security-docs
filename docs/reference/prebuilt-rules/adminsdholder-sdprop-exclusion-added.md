---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/adminsdholder-sdprop-exclusion-added.html
---

# AdminSDHolder SDProp Exclusion Added [adminsdholder-sdprop-exclusion-added]
...
## Investigation guide [_investigation_guide_124]
