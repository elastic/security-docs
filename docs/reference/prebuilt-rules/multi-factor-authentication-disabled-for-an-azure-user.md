...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/multi-factor-authentication-disabled-for-an-azure-user.html
---

# Multi-Factor Authentication Disabled for an Azure User [multi-factor-authentication-disabled-for-an-azure-user]
...
## Investigation guide [_investigation_guide_554]
