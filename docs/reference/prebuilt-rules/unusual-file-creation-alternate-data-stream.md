...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-file-creation-alternate-data-stream.html
---

# Unusual File Creation - Alternate Data Stream [unusual-file-creation-alternate-data-stream]
...
## Investigation guide [_investigation_guide_1114]
