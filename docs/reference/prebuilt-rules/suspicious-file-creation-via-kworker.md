---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-file-creation-via-kworker.html
---

# Suspicious File Creation via Kworker [suspicious-file-creation-via-kworker]
...
## Investigation guide [_investigation_guide_989]
