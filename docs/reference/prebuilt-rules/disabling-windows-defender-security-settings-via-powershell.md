...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/disabling-windows-defender-security-settings-via-powershell.html
---

# Disabling Windows Defender Security Settings via PowerShell [disabling-windows-defender-security-settings-via-powershell]
...
## Investigation guide [_investigation_guide_272]
