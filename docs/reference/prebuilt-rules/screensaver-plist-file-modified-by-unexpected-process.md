...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/screensaver-plist-file-modified-by-unexpected-process.html
---

# Screensaver Plist File Modified by Unexpected Process [screensaver-plist-file-modified-by-unexpected-process]
...
## Investigation guide [_investigation_guide_907]
