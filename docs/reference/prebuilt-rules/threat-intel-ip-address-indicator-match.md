---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/threat-intel-ip-address-indicator-match.html
---

# Threat Intel IP Address Indicator Match [threat-intel-ip-address-indicator-match]
...
## Investigation guide [_investigation_guide_1077]
