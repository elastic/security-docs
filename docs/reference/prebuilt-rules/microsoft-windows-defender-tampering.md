...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/microsoft-windows-defender-tampering.html
---

# Microsoft Windows Defender Tampering [microsoft-windows-defender-tampering]
...
## Investigation guide [_investigation_guide_535]
