...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/kerberos-pre-authentication-disabled-for-user.html
---

# Kerberos Pre-authentication Disabled for User [kerberos-pre-authentication-disabled-for-user]
...
## Investigation guide [_investigation_guide_443]
