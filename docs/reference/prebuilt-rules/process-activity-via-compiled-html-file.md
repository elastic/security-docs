...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/process-activity-via-compiled-html-file.html
---

# Process Activity via Compiled HTML File [process-activity-via-compiled-html-file]
...
## Investigation guide [_investigation_guide_827]
