...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-masquerading-as-system32-executable.html
---

# Potential Masquerading as System32 Executable [potential-masquerading-as-system32-executable]
