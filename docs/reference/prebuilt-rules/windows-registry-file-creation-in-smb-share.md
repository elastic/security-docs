...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/windows-registry-file-creation-in-smb-share.html
---

# Windows Registry File Creation in SMB Share [windows-registry-file-creation-in-smb-share]
...
## Investigation guide [_investigation_guide_1204]
