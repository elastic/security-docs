...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/encrypting-files-with-winrar-or-7z.html
---

# Encrypting Files with WinRar or 7z [encrypting-files-with-winrar-or-7z]
...
## Investigation guide [_investigation_guide_293]
