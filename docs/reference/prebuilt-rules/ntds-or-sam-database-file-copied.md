...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/ntds-or-sam-database-file-copied.html
---

# NTDS or SAM Database File Copied [ntds-or-sam-database-file-copied]
...
## Investigation guide [_investigation_guide_567]
