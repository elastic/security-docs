...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/behavior-detected-elastic-defend.html
---

# Behavior - Detected - Elastic Defend [behavior-detected-elastic-defend]
...
## Investigation guide [_investigation_guide_211]
