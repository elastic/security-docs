---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/adobe-hijack-persistence.html
---

# Adobe Hijack Persistence [adobe-hijack-persistence]
...
## Investigation guide [_investigation_guide_127]
