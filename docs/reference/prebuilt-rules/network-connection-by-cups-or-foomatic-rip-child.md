...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/network-connection-by-cups-or-foomatic-rip-child.html
---

# Network Connection by Cups or Foomatic-rip Child [network-connection-by-cups-or-foomatic-rip-child]
...
## Investigation guide [_investigation_guide_575]
