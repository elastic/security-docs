...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/networkmanager-dispatcher-script-creation.html
---
...
## Investigation guide [_investigation_guide_588]
