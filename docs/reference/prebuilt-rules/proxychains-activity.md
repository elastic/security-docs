...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/proxychains-activity.html
---

# ProxyChains Activity [proxychains-activity]
...
## Investigation guide [_investigation_guide_844]
