...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/clearing-windows-console-history.html
---
...
## Investigation guide [_investigation_guide_218]
