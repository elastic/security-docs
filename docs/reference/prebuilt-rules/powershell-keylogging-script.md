---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/powershell-keylogging-script.html
---

# PowerShell Keylogging Script [powershell-keylogging-script]
...
## Investigation guide [_investigation_guide_799]
