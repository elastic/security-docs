...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/executable-bit-set-for-potential-persistence-script.html
---

# Executable Bit Set for Potential Persistence Script [executable-bit-set-for-potential-persistence-script]
...
## Investigation guide [_investigation_guide_305]
