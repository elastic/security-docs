---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/unusual-windows-remote-user.html
---

# Unusual Windows Remote User [unusual-windows-remote-user]
...
## Investigation guide [_investigation_guide_1166]
