...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-remote-registry-access-via-sebackupprivilege.html
---

# Suspicious Remote Registry Access via SeBackupPrivilege [suspicious-remote-registry-access-via-sebackupprivilege]
...
## Investigation guide [_investigation_guide_1027]
