...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/svchost-spawning-cmd.html
---

# Svchost spawning Cmd [svchost-spawning-cmd]
...
## Investigation guide [_investigation_guide_1055]
