...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/creation-or-modification-of-root-certificate.html
---

# Creation or Modification of Root Certificate [creation-or-modification-of-root-certificate]
...
## Investigation guide [_investigation_guide_245]
