---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/remote-file-copy-via-teamviewer.html
---

# Remote File Copy via TeamViewer [remote-file-copy-via-teamviewer]
...
## Investigation guide [_investigation_guide_869]
