---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/suspicious-ms-outlook-child-process.html
---

# Suspicious MS Outlook Child Process [suspicious-ms-outlook-child-process]
...
## Investigation guide [_investigation_guide_1003]
