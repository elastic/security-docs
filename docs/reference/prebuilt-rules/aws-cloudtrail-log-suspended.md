---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/aws-cloudtrail-log-suspended.html
---

# AWS CloudTrail Log Suspended [aws-cloudtrail-log-suspended]
...
## Investigation guide [_investigation_guide_12]
