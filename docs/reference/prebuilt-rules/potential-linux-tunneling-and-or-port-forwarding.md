...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-linux-tunneling-and-or-port-forwarding.html
---

# Potential Linux Tunneling and/or Port Forwarding [potential-linux-tunneling-and-or-port-forwarding]
...
## Investigation guide [_investigation_guide_705]
