---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/aws-ec2-snapshot-activity.html
---

# AWS EC2 Snapshot Activity [aws-ec2-snapshot-activity]
...
## Investigation guide [_investigation_guide_34]
