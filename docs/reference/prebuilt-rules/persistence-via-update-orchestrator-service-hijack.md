---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/persistence-via-update-orchestrator-service-hijack.html
---

# Persistence via Update Orchestrator Service Hijack [persistence-via-update-orchestrator-service-hijack]
...
## Investigation guide [_investigation_guide_629]
