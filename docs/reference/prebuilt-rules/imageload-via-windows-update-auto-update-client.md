...
# ImageLoad via Windows Update Auto Update Client [imageload-via-windows-update-auto-update-client]
...
## Investigation guide [_investigation_guide_423]
