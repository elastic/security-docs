...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/potential-powershell-hacktool-script-by-function-names.html
---

# Potential PowerShell HackTool Script by Function Names [potential-powershell-hacktool-script-by-function-names]
...
## Investigation guide [_investigation_guide_727]
