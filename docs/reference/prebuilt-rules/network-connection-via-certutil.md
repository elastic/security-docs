---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/network-connection-via-certutil.html
---

# Network Connection via Certutil [network-connection-via-certutil]
...
## Investigation guide [_investigation_guide_577]
