...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-mimikatz-memssp-log-file-detected.html
---

# Mimikatz Memssp Log File Detected [prebuilt-rule-8-3-3-mimikatz-memssp-log-file-detected]
...
## Investigation guide [_investigation_guide_3020]
