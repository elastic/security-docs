---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-unusual-network-connection-via-dllhost.html
---

# Unusual Network Connection via DllHost [prebuilt-rule-1-0-2-unusual-network-connection-via-dllhost]
