...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-dns-over-https-enabled-via-registry.html
---

# DNS-over-HTTPS Enabled via Registry [prebuilt-rule-8-4-1-dns-over-https-enabled-via-registry]
...
## Investigation guide [_investigation_guide_2726]



## Rule query [_rule_query_3118]
