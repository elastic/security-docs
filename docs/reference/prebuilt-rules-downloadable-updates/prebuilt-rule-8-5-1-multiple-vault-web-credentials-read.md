...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-multiple-vault-web-credentials-read.html
---

# Multiple Vault Web Credentials Read [prebuilt-rule-8-5-1-multiple-vault-web-credentials-read]
...
## Investigation guide [_investigation_guide_3693]



## Rule query [_rule_query_4474]
