...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-default-cobalt-strike-team-server-certificate.html
---

# Default Cobalt Strike Team Server Certificate [prebuilt-rule-8-4-2-default-cobalt-strike-team-server-certificate]
...
## Investigation guide [_investigation_guide_3327]
