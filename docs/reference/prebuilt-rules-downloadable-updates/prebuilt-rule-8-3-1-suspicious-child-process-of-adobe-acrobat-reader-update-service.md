...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-suspicious-child-process-of-adobe-acrobat-reader-update-service.html
---

# Suspicious Child Process of Adobe Acrobat Reader Update Service [prebuilt-rule-8-3-1-suspicious-child-process-of-adobe-acrobat-reader-update-service]
