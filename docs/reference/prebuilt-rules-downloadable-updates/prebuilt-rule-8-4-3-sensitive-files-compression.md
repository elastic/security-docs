---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-sensitive-files-compression.html
---

# Sensitive Files Compression [prebuilt-rule-8-4-3-sensitive-files-compression]
