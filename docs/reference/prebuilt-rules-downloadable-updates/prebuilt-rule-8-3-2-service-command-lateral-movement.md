---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-service-command-lateral-movement.html
---

# Service Command Lateral Movement [prebuilt-rule-8-3-2-service-command-lateral-movement]
