...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-lsass-memory-dump-creation.html
---

# LSASS Memory Dump Creation [prebuilt-rule-8-4-1-lsass-memory-dump-creation]
...
## Investigation guide [_investigation_guide_2692]



## Rule query [_rule_query_3082]
