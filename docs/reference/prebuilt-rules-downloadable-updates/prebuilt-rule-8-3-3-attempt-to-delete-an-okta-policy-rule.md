---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-delete-an-okta-policy-rule.html
---

# Attempt to Delete an Okta Policy Rule [prebuilt-rule-8-3-3-attempt-to-delete-an-okta-policy-rule]
...
## Investigation guide [_investigation_guide_2924]



## Rule query [_rule_query_3345]
