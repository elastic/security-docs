...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-administrator-privileges-assigned-to-an-okta-group.html
---

# Administrator Privileges Assigned to an Okta Group [prebuilt-rule-8-4-1-administrator-privileges-assigned-to-an-okta-group]
...
## Investigation guide [_investigation_guide_2648]



## Rule query [_rule_query_3034]
