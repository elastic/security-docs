...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-suspicious-path-invocation-from-command-line.html
---

# Suspicious Path Invocation from Command Line [prebuilt-rule-8-17-3-suspicious-path-invocation-from-command-line]
