---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-2-aws-ec2-full-network-packet-capture-detected.html
---

# AWS EC2 Full Network Packet Capture Detected [prebuilt-rule-0-13-2-aws-ec2-full-network-packet-capture-detected]
...
## Investigation guide [_investigation_guide_1227]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1272]
