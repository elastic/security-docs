...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-unusual-process-for-a-windows-host.html
---

# Unusual Process For a Windows Host [prebuilt-rule-8-4-1-unusual-process-for-a-windows-host]
...
## Investigation guide [_investigation_guide_2662]
