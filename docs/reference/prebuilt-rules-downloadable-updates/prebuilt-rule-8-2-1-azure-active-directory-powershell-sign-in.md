...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-azure-active-directory-powershell-sign-in.html
---

# Azure Active Directory PowerShell Sign-in [prebuilt-rule-8-2-1-azure-active-directory-powershell-sign-in]
...
## Investigation guide [_investigation_guide_1911]
