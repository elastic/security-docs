---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-hosts-file-modified.html
---

# Hosts File Modified [prebuilt-rule-8-1-1-hosts-file-modified]
...
## Investigation guide [_investigation_guide_1688]
