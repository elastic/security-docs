...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-potential-credential-access-via-windows-utilities.html
---

# Potential Credential Access via Windows Utilities [prebuilt-rule-8-4-1-potential-credential-access-via-windows-utilities]
...
## Investigation guide [_investigation_guide_2681]
