---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-networkmanager-dispatcher-script-creation.html
---

# NetworkManager Dispatcher Script Creation [prebuilt-rule-8-17-3-networkmanager-dispatcher-script-creation]
