---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-esxi-discovery-via-find.html
---

# ESXI Discovery via Find [prebuilt-rule-8-17-3-esxi-discovery-via-find]
