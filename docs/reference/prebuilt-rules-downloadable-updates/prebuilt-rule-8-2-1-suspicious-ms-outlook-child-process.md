...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-ms-outlook-child-process.html
---

# Suspicious MS Outlook Child Process [prebuilt-rule-8-2-1-suspicious-ms-outlook-child-process]
...
## Investigation guide [_investigation_guide_2191]
