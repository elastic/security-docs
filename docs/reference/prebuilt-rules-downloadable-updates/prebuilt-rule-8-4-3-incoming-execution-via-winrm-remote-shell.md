...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-incoming-execution-via-winrm-remote-shell.html
---

# Incoming Execution via WinRM Remote Shell [prebuilt-rule-8-4-3-incoming-execution-via-winrm-remote-shell]
