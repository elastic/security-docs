...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-aws-security-group-configuration-change-detection.html
---

# AWS Security Group Configuration Change Detection [prebuilt-rule-0-14-2-aws-security-group-configuration-change-detection]
...
## Investigation guide [_investigation_guide_1309]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1406]
