...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-proxychains-activity.html
---

# ProxyChains Activity [prebuilt-rule-8-17-3-proxychains-activity]
...
## Investigation guide [_investigation_guide_3918]
