...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-scheduled-tasks-at-command-enabled.html
---

# Scheduled Tasks AT Command Enabled [prebuilt-rule-8-3-3-scheduled-tasks-at-command-enabled]
...
## Investigation guide [_investigation_guide_3079]



## Rule query [_rule_query_3590]
