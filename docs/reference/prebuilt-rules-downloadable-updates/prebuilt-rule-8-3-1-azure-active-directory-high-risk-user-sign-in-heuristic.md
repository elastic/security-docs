...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-azure-active-directory-high-risk-user-sign-in-heuristic.html
---

# Azure Active Directory High Risk User Sign-in Heuristic [prebuilt-rule-8-3-1-azure-active-directory-high-risk-user-sign-in-heuristic]
...
## Investigation guide [_investigation_guide_2283]
