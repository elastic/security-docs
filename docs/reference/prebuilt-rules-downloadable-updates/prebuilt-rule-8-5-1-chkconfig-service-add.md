...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-chkconfig-service-add.html
---

# Chkconfig Service Add [prebuilt-rule-8-5-1-chkconfig-service-add]
