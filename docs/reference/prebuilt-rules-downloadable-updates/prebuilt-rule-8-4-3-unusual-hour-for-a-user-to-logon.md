...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-unusual-hour-for-a-user-to-logon.html
---

# Unusual Hour for a User to Logon [prebuilt-rule-8-4-3-unusual-hour-for-a-user-to-logon]
...
## Investigation guide [_investigation_guide_3596]
