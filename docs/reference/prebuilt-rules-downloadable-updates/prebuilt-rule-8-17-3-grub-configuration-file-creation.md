---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-grub-configuration-file-creation.html
---

# GRUB Configuration File Creation [prebuilt-rule-8-17-3-grub-configuration-file-creation]
