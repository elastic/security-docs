...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-2-smb-windows-file-sharing-activity-to-the-internet.html
---

# SMB (Windows File Sharing) Activity to the Internet [prebuilt-rule-0-13-2-smb-windows-file-sharing-activity-to-the-internet]
