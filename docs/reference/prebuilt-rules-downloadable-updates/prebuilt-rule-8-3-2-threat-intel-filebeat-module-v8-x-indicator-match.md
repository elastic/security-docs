...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-threat-intel-filebeat-module-v8-x-indicator-match.html
---

# Threat Intel Filebeat Module (v8.x) Indicator Match [prebuilt-rule-8-3-2-threat-intel-filebeat-module-v8-x-indicator-match]
...
## Investigation guide [_investigation_guide_2357]
