...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-kerberos-traffic-from-unusual-process.html
---

# Kerberos Traffic from Unusual Process [prebuilt-rule-8-4-1-kerberos-traffic-from-unusual-process]
...
## Investigation guide [_investigation_guide_2690]
