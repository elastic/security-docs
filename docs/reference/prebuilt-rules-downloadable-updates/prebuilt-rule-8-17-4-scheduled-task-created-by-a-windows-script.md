...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-scheduled-task-created-by-a-windows-script.html
---

# Scheduled Task Created by a Windows Script [prebuilt-rule-8-17-4-scheduled-task-created-by-a-windows-script]
...
## Investigation guide [_investigation_guide_4913]
