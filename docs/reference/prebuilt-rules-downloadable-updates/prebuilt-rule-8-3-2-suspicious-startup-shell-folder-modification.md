...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-suspicious-startup-shell-folder-modification.html
---

# Suspicious Startup Shell Folder Modification [prebuilt-rule-8-3-2-suspicious-startup-shell-folder-modification]
...
## Investigation guide [_investigation_guide_2534]
