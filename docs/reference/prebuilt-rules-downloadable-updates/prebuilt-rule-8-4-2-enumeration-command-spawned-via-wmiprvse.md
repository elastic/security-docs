...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-enumeration-command-spawned-via-wmiprvse.html
---

# Enumeration Command Spawned via WMIPrvSE [prebuilt-rule-8-4-2-enumeration-command-spawned-via-wmiprvse]
...
## Investigation guide [_investigation_guide_3463]



## Rule query [_rule_query_4125]
