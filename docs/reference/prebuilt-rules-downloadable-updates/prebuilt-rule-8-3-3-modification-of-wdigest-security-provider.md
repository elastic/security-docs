...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-modification-of-wdigest-security-provider.html
---

# Modification of WDigest Security Provider [prebuilt-rule-8-3-3-modification-of-wdigest-security-provider]
...
## Investigation guide [_investigation_guide_3022]
