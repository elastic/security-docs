...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-persistence-via-powershell-profile.html
---

# Persistence via PowerShell profile [prebuilt-rule-8-4-2-persistence-via-powershell-profile]
