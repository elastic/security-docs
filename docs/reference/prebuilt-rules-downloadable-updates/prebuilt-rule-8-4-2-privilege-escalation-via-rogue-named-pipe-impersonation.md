...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-privilege-escalation-via-rogue-named-pipe-impersonation.html
---

# Privilege Escalation via Rogue Named Pipe Impersonation [prebuilt-rule-8-4-2-privilege-escalation-via-rogue-named-pipe-impersonation]
...
## Investigation guide [_investigation_guide_3571]
