...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-process-execution-from-an-unusual-directory.html
---

# Process Execution from an Unusual Directory [prebuilt-rule-8-17-4-process-execution-from-an-unusual-directory]
...
## Investigation guide [_investigation_guide_4767]
