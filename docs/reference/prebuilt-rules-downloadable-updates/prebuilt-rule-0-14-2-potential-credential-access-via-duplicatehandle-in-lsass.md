...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-potential-credential-access-via-duplicatehandle-in-lsass.html
---

# Potential Credential Access via DuplicateHandle in LSASS [prebuilt-rule-0-14-2-potential-credential-access-via-duplicatehandle-in-lsass]
