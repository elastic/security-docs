...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-suspicious-execution-via-windows-subsystem-for-linux.html
---

# Suspicious Execution via Windows Subsystem for Linux [prebuilt-rule-8-7-1-suspicious-execution-via-windows-subsystem-for-linux]
