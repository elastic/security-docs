...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-microsoft-exchange-server-um-writing-suspicious-files.html
---

# Microsoft Exchange Server UM Writing Suspicious Files [prebuilt-rule-1-0-2-microsoft-exchange-server-um-writing-suspicious-files]
...
## Investigation guide [_investigation_guide_1612]
