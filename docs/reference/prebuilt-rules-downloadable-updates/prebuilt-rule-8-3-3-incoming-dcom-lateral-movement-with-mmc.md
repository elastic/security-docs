...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-incoming-dcom-lateral-movement-with-mmc.html
---

# Incoming DCOM Lateral Movement with MMC [prebuilt-rule-8-3-3-incoming-dcom-lateral-movement-with-mmc]
