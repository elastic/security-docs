---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-chkconfig-service-add.html
---

# Chkconfig Service Add [prebuilt-rule-8-2-1-chkconfig-service-add]
