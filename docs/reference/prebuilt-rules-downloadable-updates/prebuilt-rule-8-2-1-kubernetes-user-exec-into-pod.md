...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-kubernetes-user-exec-into-pod.html
---

# Kubernetes User Exec into Pod [prebuilt-rule-8-2-1-kubernetes-user-exec-into-pod]
...
## Investigation guide [_investigation_guide_1962]



## Rule query [_rule_query_2247]
