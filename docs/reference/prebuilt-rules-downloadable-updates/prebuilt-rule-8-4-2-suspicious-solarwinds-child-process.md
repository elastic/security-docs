...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-solarwinds-child-process.html
---

# Suspicious SolarWinds Child Process [prebuilt-rule-8-4-2-suspicious-solarwinds-child-process]
...
## Investigation guide [_investigation_guide_3458]



## Rule query [_rule_query_4119]
