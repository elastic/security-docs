...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-execution-via-local-sxs-shared-module.html
---

# Execution via local SxS Shared Module [prebuilt-rule-8-3-3-execution-via-local-sxs-shared-module]
...
## Investigation guide [_investigation_guide_3122]
