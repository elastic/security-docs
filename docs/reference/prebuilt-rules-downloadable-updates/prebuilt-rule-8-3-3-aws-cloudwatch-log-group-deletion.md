...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-aws-cloudwatch-log-group-deletion.html
---

# AWS CloudWatch Log Group Deletion [prebuilt-rule-8-3-3-aws-cloudwatch-log-group-deletion]
...
## Investigation guide [_investigation_guide_2890]
