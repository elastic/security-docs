...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-potential-openssh-backdoor-logging-activity.html
---

# Potential OpenSSH Backdoor Logging Activity [prebuilt-rule-8-2-1-potential-openssh-backdoor-logging-activity]
...
## Investigation guide [_investigation_guide_2027]



## Rule query [_rule_query_2312]
