...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-kubernetes-pod-created-with-hostnetwork.html
---

# Kubernetes Pod Created With HostNetwork [prebuilt-rule-8-4-2-kubernetes-pod-created-with-hostnetwork]
...
## Investigation guide [_investigation_guide_3284]



## Rule query [_rule_query_3848]
