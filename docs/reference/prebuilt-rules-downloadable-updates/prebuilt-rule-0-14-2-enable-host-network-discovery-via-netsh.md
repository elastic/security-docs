---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-enable-host-network-discovery-via-netsh.html
---

# Enable Host Network Discovery via Netsh [prebuilt-rule-0-14-2-enable-host-network-discovery-via-netsh]
