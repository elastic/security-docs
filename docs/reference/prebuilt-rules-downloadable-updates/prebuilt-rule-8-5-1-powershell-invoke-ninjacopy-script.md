...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-powershell-invoke-ninjacopy-script.html
---

# PowerShell Invoke-NinjaCopy script [prebuilt-rule-8-5-1-powershell-invoke-ninjacopy-script]
