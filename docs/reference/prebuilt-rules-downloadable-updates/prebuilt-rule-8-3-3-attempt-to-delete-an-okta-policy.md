...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-delete-an-okta-policy.html
---

# Attempt to Delete an Okta Policy [prebuilt-rule-8-3-3-attempt-to-delete-an-okta-policy]
...
## Investigation guide [_investigation_guide_2923]



## Rule query [_rule_query_3344]
