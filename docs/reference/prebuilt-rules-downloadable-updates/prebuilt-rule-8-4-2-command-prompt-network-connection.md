...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-command-prompt-network-connection.html
---

# Command Prompt Network Connection [prebuilt-rule-8-4-2-command-prompt-network-connection]
