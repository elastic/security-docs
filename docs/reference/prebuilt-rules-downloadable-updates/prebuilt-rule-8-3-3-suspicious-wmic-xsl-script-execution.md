---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-suspicious-wmic-xsl-script-execution.html
---

# Suspicious WMIC XSL Script Execution [prebuilt-rule-8-3-3-suspicious-wmic-xsl-script-execution]
