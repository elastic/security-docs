...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-group-policy-discovery-via-microsoft-gpresult-utility.html
---

# Group Policy Discovery via Microsoft GPResult Utility [prebuilt-rule-8-7-1-group-policy-discovery-via-microsoft-gpresult-utility]
