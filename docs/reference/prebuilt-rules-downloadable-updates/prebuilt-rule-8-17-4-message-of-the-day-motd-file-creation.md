...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-message-of-the-day-motd-file-creation.html
---

# Message-of-the-Day (MOTD) File Creation [prebuilt-rule-8-17-4-message-of-the-day-motd-file-creation]
...
## Investigation guide [_investigation_guide_4472]
