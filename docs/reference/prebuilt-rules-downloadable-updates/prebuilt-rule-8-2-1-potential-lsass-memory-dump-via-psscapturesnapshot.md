...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-potential-lsass-memory-dump-via-psscapturesnapshot.html
---

# Potential LSASS Memory Dump via PssCaptureSnapShot [prebuilt-rule-8-2-1-potential-lsass-memory-dump-via-psscapturesnapshot]
...
## Investigation guide [_investigation_guide_2091]



## Rule query [_rule_query_2381]
