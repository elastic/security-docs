...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-suspicious-zoom-child-process.html
---

# Suspicious Zoom Child Process [prebuilt-rule-8-17-4-suspicious-zoom-child-process]
...
## Investigation guide [_investigation_guide_4808]
