...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-network-connection-via-compiled-html-file.html
---

# Network Connection via Compiled HTML File [prebuilt-rule-8-3-3-network-connection-via-compiled-html-file]
