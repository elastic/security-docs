---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-initramfs-extraction-via-cpio.html
---

# Initramfs Extraction via CPIO [prebuilt-rule-8-17-3-initramfs-extraction-via-cpio]
