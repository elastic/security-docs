...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-web-server-spawned-via-python.html
---

# Web Server Spawned via Python [prebuilt-rule-8-17-3-web-server-spawned-via-python]
