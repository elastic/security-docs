...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-uac-bypass-attempt-via-privileged-ifileoperation-com-interface.html
---

# UAC Bypass Attempt via Privileged IFileOperation COM Interface [prebuilt-rule-8-4-1-uac-bypass-attempt-via-privileged-ifileoperation-com-interface]
...
## Investigation guide [_investigation_guide_2850]



## Rule query [_rule_query_3255]
