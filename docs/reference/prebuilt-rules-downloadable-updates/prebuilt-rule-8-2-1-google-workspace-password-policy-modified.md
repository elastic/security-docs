...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-google-workspace-password-policy-modified.html
---

# Google Workspace Password Policy Modified [prebuilt-rule-8-2-1-google-workspace-password-policy-modified]
...
## Investigation guide [_investigation_guide_1958]
