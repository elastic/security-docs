...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-remote-windows-service-installed.html
---

# Remote Windows Service Installed [prebuilt-rule-8-4-2-remote-windows-service-installed]
