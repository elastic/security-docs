...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-psexec-network-connection.html
---

# PsExec Network Connection [prebuilt-rule-8-3-3-psexec-network-connection]
...
## Investigation guide [_investigation_guide_3121]
