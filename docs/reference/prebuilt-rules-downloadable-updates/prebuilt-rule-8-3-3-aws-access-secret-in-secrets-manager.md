...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-aws-access-secret-in-secrets-manager.html
---

# AWS Access Secret in Secrets Manager [prebuilt-rule-8-3-3-aws-access-secret-in-secrets-manager]
...
## Investigation guide [_investigation_guide_2881]
