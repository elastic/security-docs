...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-unusual-country-for-an-aws-command.html
---

# Unusual Country For an AWS Command [prebuilt-rule-8-4-1-unusual-country-for-an-aws-command]
...
## Investigation guide [_investigation_guide_2604]
