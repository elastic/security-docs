...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-modification-of-boot-configuration.html
---

# Modification of Boot Configuration [prebuilt-rule-8-4-1-modification-of-boot-configuration]
...
## Investigation guide [_investigation_guide_2806]
