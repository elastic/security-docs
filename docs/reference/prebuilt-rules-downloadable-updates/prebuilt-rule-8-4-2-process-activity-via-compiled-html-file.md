---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-process-activity-via-compiled-html-file.html
---

# Process Activity via Compiled HTML File [prebuilt-rule-8-4-2-process-activity-via-compiled-html-file]
...
## Investigation guide [_investigation_guide_3476]



## Rule query [_rule_query_4141]
