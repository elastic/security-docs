---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-rare-user-logon.html
---

# Rare User Logon [prebuilt-rule-8-5-1-rare-user-logon]
...
## Investigation guide [_investigation_guide_3675]
