...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-google-workspace-mfa-enforcement-disabled.html
---

# Google Workspace MFA Enforcement Disabled [prebuilt-rule-8-3-3-google-workspace-mfa-enforcement-disabled]
...
## Investigation guide [_investigation_guide_2913]
