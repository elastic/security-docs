...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-aws-elasticache-security-group-modified-or-deleted.html
---

# AWS ElastiCache Security Group Modified or Deleted [prebuilt-rule-1-0-2-aws-elasticache-security-group-modified-or-deleted]
...
## Investigation guide [_investigation_guide_1393]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1626]
