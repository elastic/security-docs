...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-service-control-spawned-via-script-interpreter.html
---

# Service Control Spawned via Script Interpreter [prebuilt-rule-8-17-4-service-control-spawned-via-script-interpreter]
...
## Investigation guide [_investigation_guide_4976]
