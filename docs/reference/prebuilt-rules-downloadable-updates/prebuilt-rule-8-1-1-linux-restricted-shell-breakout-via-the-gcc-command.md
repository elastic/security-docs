---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-linux-restricted-shell-breakout-via-the-gcc-command.html
---

# Linux Restricted Shell Breakout via the gcc command [prebuilt-rule-8-1-1-linux-restricted-shell-breakout-via-the-gcc-command]
