---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-remote-windows-service-installed.html
---

# Remote Windows Service Installed [prebuilt-rule-8-6-1-remote-windows-service-installed]
