...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-screensaver-plist-file-modified-by-unexpected-process.html
---

# Screensaver Plist File Modified by Unexpected Process [prebuilt-rule-8-2-1-screensaver-plist-file-modified-by-unexpected-process]
...
## Investigation guide [_investigation_guide_2052]
