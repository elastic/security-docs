...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-aws-root-login-without-mfa.html
---

# AWS Root Login Without MFA [prebuilt-rule-8-3-3-aws-root-login-without-mfa]
...
## Investigation guide [_investigation_guide_2900]
