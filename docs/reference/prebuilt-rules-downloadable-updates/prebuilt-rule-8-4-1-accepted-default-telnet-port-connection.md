...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-accepted-default-telnet-port-connection.html
---

# Accepted Default Telnet Port Connection [prebuilt-rule-8-4-1-accepted-default-telnet-port-connection]
