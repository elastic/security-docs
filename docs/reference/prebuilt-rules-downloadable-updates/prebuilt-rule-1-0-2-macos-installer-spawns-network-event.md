---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-macos-installer-spawns-network-event.html
---

# macOS Installer Spawns Network Event [prebuilt-rule-1-0-2-macos-installer-spawns-network-event]
