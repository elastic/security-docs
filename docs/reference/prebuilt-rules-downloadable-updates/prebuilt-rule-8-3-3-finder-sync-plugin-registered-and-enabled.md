...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-finder-sync-plugin-registered-and-enabled.html
---

# Finder Sync Plugin Registered and Enabled [prebuilt-rule-8-3-3-finder-sync-plugin-registered-and-enabled]
