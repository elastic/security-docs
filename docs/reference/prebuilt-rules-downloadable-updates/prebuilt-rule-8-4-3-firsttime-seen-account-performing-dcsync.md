...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-firsttime-seen-account-performing-dcsync.html
---

# FirstTime Seen Account Performing DCSync [prebuilt-rule-8-4-3-firsttime-seen-account-performing-dcsync]
...
## Investigation guide [_investigation_guide_3573]



## Rule query [_rule_query_4277]
