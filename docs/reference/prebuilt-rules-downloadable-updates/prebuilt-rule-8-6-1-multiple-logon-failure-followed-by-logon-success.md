...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-multiple-logon-failure-followed-by-logon-success.html
---

# Multiple Logon Failure Followed by Logon Success [prebuilt-rule-8-6-1-multiple-logon-failure-followed-by-logon-success]
...
## Investigation guide [_investigation_guide_3763]
