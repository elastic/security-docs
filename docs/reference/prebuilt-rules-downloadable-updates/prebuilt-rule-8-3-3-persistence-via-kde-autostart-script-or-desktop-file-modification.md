---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-persistence-via-kde-autostart-script-or-desktop-file-modification.html
---

# Persistence via KDE AutoStart Script or Desktop File Modification [prebuilt-rule-8-3-3-persistence-via-kde-autostart-script-or-desktop-file-modification]
...
## Investigation guide [_investigation_guide_2958]



## Rule query [_rule_query_3402]
