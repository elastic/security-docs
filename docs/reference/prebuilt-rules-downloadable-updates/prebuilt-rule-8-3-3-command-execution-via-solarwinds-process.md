---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-command-execution-via-solarwinds-process.html
---

# Command Execution via SolarWinds Process [prebuilt-rule-8-3-3-command-execution-via-solarwinds-process]
...
## Investigation guide [_investigation_guide_3109]



## Rule query [_rule_query_3625]
