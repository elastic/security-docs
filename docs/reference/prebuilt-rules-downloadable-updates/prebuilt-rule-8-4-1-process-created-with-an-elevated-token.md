...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-process-created-with-an-elevated-token.html
---

# Process Created with an Elevated Token [prebuilt-rule-8-4-1-process-created-with-an-elevated-token]
