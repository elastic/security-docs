...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-potential-abuse-of-repeated-mfa-push-notifications.html
---

# Potential Abuse of Repeated MFA Push Notifications [prebuilt-rule-8-2-1-potential-abuse-of-repeated-mfa-push-notifications]
...
## Investigation guide [_investigation_guide_1999]



## Rule query [_rule_query_2284]
