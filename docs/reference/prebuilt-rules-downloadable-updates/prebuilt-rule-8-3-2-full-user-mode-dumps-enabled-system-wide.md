---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-full-user-mode-dumps-enabled-system-wide.html
---

# Full User-Mode Dumps Enabled System-Wide [prebuilt-rule-8-3-2-full-user-mode-dumps-enabled-system-wide]
