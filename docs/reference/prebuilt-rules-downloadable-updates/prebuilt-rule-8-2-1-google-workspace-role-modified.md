...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-google-workspace-role-modified.html
---

# Google Workspace Role Modified [prebuilt-rule-8-2-1-google-workspace-role-modified]
...
## Investigation guide [_investigation_guide_1959]
