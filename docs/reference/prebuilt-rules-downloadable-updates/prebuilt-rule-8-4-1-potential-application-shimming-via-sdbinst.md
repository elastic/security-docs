...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-potential-application-shimming-via-sdbinst.html
---

# Potential Application Shimming via Sdbinst [prebuilt-rule-8-4-1-potential-application-shimming-via-sdbinst]
...
## Investigation guide [_investigation_guide_2838]



## Rule query [_rule_query_3241]
