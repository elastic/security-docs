...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-dynamic-linker-ld-so-creation.html
---

# Dynamic Linker (ld.so) Creation [prebuilt-rule-8-17-3-dynamic-linker-ld-so-creation]
