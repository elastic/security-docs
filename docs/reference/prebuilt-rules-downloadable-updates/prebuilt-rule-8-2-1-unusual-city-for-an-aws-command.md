...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-unusual-city-for-an-aws-command.html
---

# Unusual City For an AWS Command [prebuilt-rule-8-2-1-unusual-city-for-an-aws-command]
...
## Investigation guide [_investigation_guide_1868]
