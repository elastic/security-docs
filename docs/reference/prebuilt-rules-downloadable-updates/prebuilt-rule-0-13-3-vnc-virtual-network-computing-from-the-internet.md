...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-3-vnc-virtual-network-computing-from-the-internet.html
---

# VNC (Virtual Network Computing) from the Internet [prebuilt-rule-0-13-3-vnc-virtual-network-computing-from-the-internet]
