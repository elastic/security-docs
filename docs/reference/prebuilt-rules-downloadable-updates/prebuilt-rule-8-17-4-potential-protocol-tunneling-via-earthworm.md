...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-protocol-tunneling-via-earthworm.html
---

# Potential Protocol Tunneling via EarthWorm [prebuilt-rule-8-17-4-potential-protocol-tunneling-via-earthworm]
...
## Investigation guide [_investigation_guide_4313]
