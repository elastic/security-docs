---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-connection-to-external-network-via-telnet.html
---

# Connection to External Network via Telnet [prebuilt-rule-0-13-1-connection-to-external-network-via-telnet]
