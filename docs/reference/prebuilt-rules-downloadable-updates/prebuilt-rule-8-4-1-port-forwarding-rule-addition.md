...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-port-forwarding-rule-addition.html
---

# Port Forwarding Rule Addition [prebuilt-rule-8-4-1-port-forwarding-rule-addition]
...
## Investigation guide [_investigation_guide_2673]
