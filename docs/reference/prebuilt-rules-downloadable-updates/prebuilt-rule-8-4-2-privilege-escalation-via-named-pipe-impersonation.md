---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-privilege-escalation-via-named-pipe-impersonation.html
---

# Privilege Escalation via Named Pipe Impersonation [prebuilt-rule-8-4-2-privilege-escalation-via-named-pipe-impersonation]
...
## Investigation guide [_investigation_guide_3552]



## Rule query [_rule_query_4245]
