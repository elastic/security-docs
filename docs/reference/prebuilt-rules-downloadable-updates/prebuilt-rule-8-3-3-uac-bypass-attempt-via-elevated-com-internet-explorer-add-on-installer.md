...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-uac-bypass-attempt-via-elevated-com-internet-explorer-add-on-installer.html
---

# UAC Bypass Attempt via Elevated COM Internet Explorer Add-On Installer [prebuilt-rule-8-3-3-uac-bypass-attempt-via-elevated-com-internet-explorer-add-on-installer]
...
## Investigation guide [_investigation_guide_3210]



## Rule query [_rule_query_3760]
