...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-high-number-of-okta-user-password-reset-or-unlock-attempts.html
---

# High Number of Okta User Password Reset or Unlock Attempts [prebuilt-rule-8-3-3-high-number-of-okta-user-password-reset-or-unlock-attempts]
...
## Investigation guide [_investigation_guide_2928]



## Rule query [_rule_query_3349]
