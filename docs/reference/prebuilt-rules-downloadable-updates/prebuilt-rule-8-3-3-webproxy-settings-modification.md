...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-webproxy-settings-modification.html
---

# WebProxy Settings Modification [prebuilt-rule-8-3-3-webproxy-settings-modification]
