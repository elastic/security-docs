...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-rdp-activex-client-loaded.html
---

# Suspicious RDP ActiveX Client Loaded [prebuilt-rule-8-4-2-suspicious-rdp-activex-client-loaded]
...
## Investigation guide [_investigation_guide_3509]



## Rule query [_rule_query_4185]
