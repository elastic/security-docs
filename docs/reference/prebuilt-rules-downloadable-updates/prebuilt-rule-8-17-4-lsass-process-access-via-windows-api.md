...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-lsass-process-access-via-windows-api.html
---

# LSASS Process Access via Windows API [prebuilt-rule-8-17-4-lsass-process-access-via-windows-api]
...
## Investigation guide [_investigation_guide_4724]
