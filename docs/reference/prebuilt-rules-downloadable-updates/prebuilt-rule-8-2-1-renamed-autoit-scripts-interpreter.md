...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-renamed-autoit-scripts-interpreter.html
---

# Renamed AutoIt Scripts Interpreter [prebuilt-rule-8-2-1-renamed-autoit-scripts-interpreter]
...
## Investigation guide [_investigation_guide_2125]



## Rule query [_rule_query_2415]
