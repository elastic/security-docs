...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-attempt-to-reset-mfa-factors-for-an-okta-user-account.html
---

# Attempt to Reset MFA Factors for an Okta User Account [prebuilt-rule-8-4-1-attempt-to-reset-mfa-factors-for-an-okta-user-account]
...
## Investigation guide [_investigation_guide_2652]



## Rule query [_rule_query_3038]
