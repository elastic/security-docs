---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-roshal-archive-rar-or-powershell-file-downloaded-from-the-internet.html
---

# Roshal Archive (RAR) or PowerShell File Downloaded from the Internet [prebuilt-rule-8-4-2-roshal-archive-rar-or-powershell-file-downloaded-from-the-internet]
...
## Investigation guide [_investigation_guide_3328]

## Threat intel

This activity has been observed in FIN7 campaigns.

## Rule query [_rule_query_3962]
