...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-network-connection-via-signed-binary.html
---

# Network Connection via Signed Binary [prebuilt-rule-0-14-3-network-connection-via-signed-binary]
