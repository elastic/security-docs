...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-suspicious-file-creation-via-kworker.html
---

# Suspicious File Creation via Kworker [prebuilt-rule-8-17-4-suspicious-file-creation-via-kworker]
...
## Investigation guide [_investigation_guide_4464]
