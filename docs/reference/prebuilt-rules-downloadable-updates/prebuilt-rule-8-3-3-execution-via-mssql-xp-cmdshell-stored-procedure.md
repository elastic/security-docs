...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-execution-via-mssql-xp-cmdshell-stored-procedure.html
---

# Execution via MSSQL xp_cmdshell Stored Procedure [prebuilt-rule-8-3-3-execution-via-mssql-xp-cmdshell-stored-procedure]
...
## Investigation guide [_investigation_guide_3130]
