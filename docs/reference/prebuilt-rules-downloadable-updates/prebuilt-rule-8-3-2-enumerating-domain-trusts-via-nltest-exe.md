...
# Enumerating Domain Trusts via NLTEST.EXE [prebuilt-rule-8-3-2-enumerating-domain-trusts-via-nltest-exe]
...
## Investigation guide [_investigation_guide_2481]



## Rule query [_rule_query_2854]
