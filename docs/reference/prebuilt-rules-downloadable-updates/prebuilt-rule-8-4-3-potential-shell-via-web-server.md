...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-potential-shell-via-web-server.html
---

# Potential Shell via Web Server [prebuilt-rule-8-4-3-potential-shell-via-web-server]
...
## Investigation guide [_investigation_guide_3593]
