...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-exporting-exchange-mailbox-via-powershell.html
---

# Exporting Exchange Mailbox via PowerShell [prebuilt-rule-0-14-3-exporting-exchange-mailbox-via-powershell]
