---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-aws-ec2-vm-export-failure.html
---

# AWS EC2 VM Export Failure [prebuilt-rule-8-2-1-aws-ec2-vm-export-failure]
...
## Investigation guide [_investigation_guide_1849]



## Rule query [_rule_query_2139]
