...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-system-service-discovery-through-built-in-windows-utilities.html
---

# System Service Discovery through built-in Windows Utilities [prebuilt-rule-8-6-1-system-service-discovery-through-built-in-windows-utilities]
