...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-unusual-file-modification-by-dns-exe.html
---

# Unusual File Modification by dns.exe [prebuilt-rule-8-2-1-unusual-file-modification-by-dns-exe]
...
## Investigation guide [_investigation_guide_2193]
