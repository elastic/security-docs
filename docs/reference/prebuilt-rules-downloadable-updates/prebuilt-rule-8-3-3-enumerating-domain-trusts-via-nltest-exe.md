---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-enumerating-domain-trusts-via-nltest-exe.html
---

# Enumerating Domain Trusts via NLTEST.EXE [prebuilt-rule-8-3-3-enumerating-domain-trusts-via-nltest-exe]
...
## Investigation guide [_investigation_guide_3099]



## Rule query [_rule_query_3615]
