...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-suspicious-zoom-child-process.html
---

# Suspicious Zoom Child Process [prebuilt-rule-8-4-1-suspicious-zoom-child-process]
...
## Investigation guide [_investigation_guide_2760]



## Rule query [_rule_query_3158]
