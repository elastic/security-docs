...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-aws-cloudtrail-log-updated.html
---

# AWS CloudTrail Log Updated [prebuilt-rule-8-4-2-aws-cloudtrail-log-updated]
...
## Investigation guide [_investigation_guide_3253]
