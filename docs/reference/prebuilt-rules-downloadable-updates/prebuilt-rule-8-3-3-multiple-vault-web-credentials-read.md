---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-multiple-vault-web-credentials-read.html
---

# Multiple Vault Web Credentials Read [prebuilt-rule-8-3-3-multiple-vault-web-credentials-read]
...
## Investigation guide [_investigation_guide_3028]



## Rule query [_rule_query_3525]
