...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-potential-sharprdp-behavior.html
---

# Potential SharpRDP Behavior [prebuilt-rule-0-14-3-potential-sharprdp-behavior]
