---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-uac-bypass-via-diskcleanup-scheduled-task-hijack.html
---

# UAC Bypass via DiskCleanup Scheduled Task Hijack [prebuilt-rule-8-2-1-uac-bypass-via-diskcleanup-scheduled-task-hijack]
...
## Investigation guide [_investigation_guide_2245]



## Rule query [_rule_query_2535]
