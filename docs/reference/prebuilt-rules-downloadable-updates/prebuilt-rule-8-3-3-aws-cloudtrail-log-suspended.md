...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-aws-cloudtrail-log-suspended.html
---

# AWS CloudTrail Log Suspended [prebuilt-rule-8-3-3-aws-cloudtrail-log-suspended]
...
## Investigation guide [_investigation_guide_2883]
