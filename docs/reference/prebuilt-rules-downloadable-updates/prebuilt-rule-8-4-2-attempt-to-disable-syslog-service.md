...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-attempt-to-disable-syslog-service.html
---

# Attempt to Disable Syslog Service [prebuilt-rule-8-4-2-attempt-to-disable-syslog-service]
