...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-virtual-machine-fingerprinting.html
---

# Virtual Machine Fingerprinting [prebuilt-rule-8-4-3-virtual-machine-fingerprinting]
