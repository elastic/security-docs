...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-reverse-shell-created-via-named-pipe.html
---

# Reverse Shell Created via Named Pipe [prebuilt-rule-8-4-3-reverse-shell-created-via-named-pipe]
