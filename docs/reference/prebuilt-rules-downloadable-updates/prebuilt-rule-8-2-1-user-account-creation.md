...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-user-account-creation.html
---

# User Account Creation [prebuilt-rule-8-2-1-user-account-creation]
...
## Investigation guide [_investigation_guide_2222]
