...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-threat-intel-indicator-match.html
---

# Threat Intel Indicator Match [prebuilt-rule-8-3-3-threat-intel-indicator-match]
...
## Investigation guide [_investigation_guide_2877]
