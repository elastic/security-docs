...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-outbound-scheduled-task-activity-via-powershell.html
---

# Outbound Scheduled Task Activity via PowerShell [prebuilt-rule-8-2-1-outbound-scheduled-task-activity-via-powershell]
