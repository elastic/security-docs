...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-adfind-command-activity.html
---

# AdFind Command Activity [prebuilt-rule-8-4-1-adfind-command-activity]
...
## Investigation guide [_investigation_guide_2769]
