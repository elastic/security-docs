...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-potential-credential-access-via-renamed-com-services-dll.html
---

# Potential Credential Access via Renamed COM+ Services DLL [prebuilt-rule-8-4-2-potential-credential-access-via-renamed-com-services-dll]
...
## Investigation guide [_investigation_guide_3379]



## Rule query [_rule_query_4020]
