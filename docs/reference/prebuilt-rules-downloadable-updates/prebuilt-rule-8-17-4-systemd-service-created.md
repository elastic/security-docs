...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-systemd-service-created.html
---

# Systemd Service Created [prebuilt-rule-8-17-4-systemd-service-created]
...
## Investigation guide [_investigation_guide_4500]
