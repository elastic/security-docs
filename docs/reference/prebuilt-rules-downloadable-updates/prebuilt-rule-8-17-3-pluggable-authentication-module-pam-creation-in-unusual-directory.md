...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-pluggable-authentication-module-pam-creation-in-unusual-directory.html
---

# Pluggable Authentication Module (PAM) Creation in Unusual Directory [prebuilt-rule-8-17-3-pluggable-authentication-module-pam-creation-in-unusual-directory]
