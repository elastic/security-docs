...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-execution-via-tsclient-mountpoint.html
---

# Execution via TSClient Mountpoint [prebuilt-rule-8-4-2-execution-via-tsclient-mountpoint]
...
## Investigation guide [_investigation_guide_3500]



## Rule query [_rule_query_4171]
