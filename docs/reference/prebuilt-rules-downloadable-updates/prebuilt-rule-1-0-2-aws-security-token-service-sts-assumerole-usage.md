---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-aws-security-token-service-sts-assumerole-usage.html
---

# AWS Security Token Service (STS) AssumeRole Usage [prebuilt-rule-1-0-2-aws-security-token-service-sts-assumerole-usage]
...
## Investigation guide [_investigation_guide_1417]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1648]
