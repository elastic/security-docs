---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-aws-s3-bucket-configuration-deletion.html
---

# AWS S3 Bucket Configuration Deletion [prebuilt-rule-1-0-2-aws-s3-bucket-configuration-deletion]
...
## Investigation guide [_investigation_guide_1395]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1628]
