...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-disabling-windows-defender-security-settings-via-powershell.html
---

# Disabling Windows Defender Security Settings via PowerShell [prebuilt-rule-0-14-3-disabling-windows-defender-security-settings-via-powershell]
