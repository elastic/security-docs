...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-powershell-minidump-script.html
---

# PowerShell MiniDump Script [prebuilt-rule-8-3-2-powershell-minidump-script]
...
## Investigation guide [_investigation_guide_2425]
