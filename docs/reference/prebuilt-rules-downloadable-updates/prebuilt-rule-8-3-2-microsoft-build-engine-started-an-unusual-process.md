---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-microsoft-build-engine-started-an-unusual-process.html
---

# Microsoft Build Engine Started an Unusual Process [prebuilt-rule-8-3-2-microsoft-build-engine-started-an-unusual-process]
...
## Investigation guide [_investigation_guide_2454]



## Rule query [_rule_query_2821]
