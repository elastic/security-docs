...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-enable-host-network-discovery-via-netsh.html
---

# Enable Host Network Discovery via Netsh [prebuilt-rule-8-1-1-enable-host-network-discovery-via-netsh]
...
## Investigation guide [_investigation_guide_1754]
