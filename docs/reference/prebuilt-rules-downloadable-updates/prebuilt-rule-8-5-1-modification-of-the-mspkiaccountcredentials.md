...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-modification-of-the-mspkiaccountcredentials.html
---

# Modification of the msPKIAccountCredentials [prebuilt-rule-8-5-1-modification-of-the-mspkiaccountcredentials]
...
## Investigation guide [_investigation_guide_3723]



## Rule query [_rule_query_4514]
