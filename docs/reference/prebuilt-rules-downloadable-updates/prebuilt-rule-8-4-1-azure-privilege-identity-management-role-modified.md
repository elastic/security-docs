...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-azure-privilege-identity-management-role-modified.html
---

# Azure Privilege Identity Management Role Modified [prebuilt-rule-8-4-1-azure-privilege-identity-management-role-modified]
...
## Investigation guide [_investigation_guide_2614]
