...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-scheduled-task-execution-at-scale-via-gpo.html
---

# Scheduled Task Execution at Scale via GPO [prebuilt-rule-1-0-2-scheduled-task-execution-at-scale-via-gpo]
...
* [https://github.com/SigmaHQ/sigma/blob/master/rules/windows/builtin/win_gpo_scheduledtasks.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/builtin/win_gpo_scheduledtasks.yml)
...
## Investigation guide [_investigation_guide_1660]
