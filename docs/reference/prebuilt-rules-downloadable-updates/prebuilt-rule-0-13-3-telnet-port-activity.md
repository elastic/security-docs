---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-3-telnet-port-activity.html
---

# Telnet Port Activity [prebuilt-rule-0-13-3-telnet-port-activity]
