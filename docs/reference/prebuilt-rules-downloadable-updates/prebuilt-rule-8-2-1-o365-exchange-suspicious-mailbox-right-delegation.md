...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-o365-exchange-suspicious-mailbox-right-delegation.html
---

# O365 Exchange Suspicious Mailbox Right Delegation [prebuilt-rule-8-2-1-o365-exchange-suspicious-mailbox-right-delegation]
...
## Investigation guide [_investigation_guide_1989]



## Rule query [_rule_query_2274]
