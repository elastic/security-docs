...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-disable-windows-firewall-rules-via-netsh.html
---

# Disable Windows Firewall Rules via Netsh [prebuilt-rule-8-1-1-disable-windows-firewall-rules-via-netsh]
...
## Investigation guide [_investigation_guide_1750]
