---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-external-ip-lookup-from-non-browser-process.html
---

# External IP Lookup from Non-Browser Process [prebuilt-rule-0-14-1-external-ip-lookup-from-non-browser-process]
