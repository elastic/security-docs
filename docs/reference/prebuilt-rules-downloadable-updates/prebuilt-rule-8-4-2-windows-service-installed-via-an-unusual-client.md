---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-windows-service-installed-via-an-unusual-client.html
---

# Windows Service Installed via an Unusual Client [prebuilt-rule-8-4-2-windows-service-installed-via-an-unusual-client]
...
## Investigation guide [_investigation_guide_3572]



## Rule query [_rule_query_4271]
