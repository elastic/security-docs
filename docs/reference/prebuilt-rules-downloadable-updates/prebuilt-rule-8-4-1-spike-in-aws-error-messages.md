...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-spike-in-aws-error-messages.html
---

# Spike in AWS Error Messages [prebuilt-rule-8-4-1-spike-in-aws-error-messages]
...
## Investigation guide [_investigation_guide_2601]
