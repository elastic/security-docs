...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-potential-persistence-via-time-provider-modification.html
---

# Potential Persistence via Time Provider Modification [prebuilt-rule-8-4-2-potential-persistence-via-time-provider-modification]
