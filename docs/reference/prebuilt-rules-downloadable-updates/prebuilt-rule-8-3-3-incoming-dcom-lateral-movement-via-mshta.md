---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-incoming-dcom-lateral-movement-via-mshta.html
---

# Incoming DCOM Lateral Movement via MSHTA [prebuilt-rule-8-3-3-incoming-dcom-lateral-movement-via-mshta]
