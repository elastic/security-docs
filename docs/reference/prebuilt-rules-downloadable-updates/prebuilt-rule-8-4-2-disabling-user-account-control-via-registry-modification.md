...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-disabling-user-account-control-via-registry-modification.html
---

# Disabling User Account Control via Registry Modification [prebuilt-rule-8-4-2-disabling-user-account-control-via-registry-modification]
...
## Investigation guide [_investigation_guide_3547]
