...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-suspicious-process-access-via-direct-system-call.html
---

# Suspicious Process Access via Direct System Call [prebuilt-rule-8-4-1-suspicious-process-access-via-direct-system-call]
...
## Investigation guide [_investigation_guide_2757]
