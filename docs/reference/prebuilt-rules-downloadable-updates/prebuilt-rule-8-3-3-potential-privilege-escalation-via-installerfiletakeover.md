...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-privilege-escalation-via-installerfiletakeover.html
---

# Potential Privilege Escalation via InstallerFileTakeOver [prebuilt-rule-8-3-3-potential-privilege-escalation-via-installerfiletakeover]
...
## Investigation guide [_investigation_guide_3201]
