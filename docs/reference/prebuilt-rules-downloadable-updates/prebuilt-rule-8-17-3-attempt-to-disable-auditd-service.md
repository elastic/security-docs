...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-attempt-to-disable-auditd-service.html
---

# Attempt to Disable Auditd Service [prebuilt-rule-8-17-3-attempt-to-disable-auditd-service]
