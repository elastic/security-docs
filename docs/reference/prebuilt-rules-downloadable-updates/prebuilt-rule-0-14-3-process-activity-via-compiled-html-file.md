---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-process-activity-via-compiled-html-file.html
---

# Process Activity via Compiled HTML File [prebuilt-rule-0-14-3-process-activity-via-compiled-html-file]
