---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-git-hook-command-execution.html
---

# Git Hook Command Execution [prebuilt-rule-8-17-3-git-hook-command-execution]
