...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-aws-management-console-root-login.html
---

# AWS Management Console Root Login [prebuilt-rule-8-4-2-aws-management-console-root-login]
...
## Investigation guide [_investigation_guide_3257]
