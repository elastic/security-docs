...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-creation-of-hidden-launch-agent-or-daemon.html
---

# Creation of Hidden Launch Agent or Daemon [prebuilt-rule-8-4-2-creation-of-hidden-launch-agent-or-daemon]
...
## Investigation guide [_investigation_guide_3319]



## Rule query [_rule_query_3943]
