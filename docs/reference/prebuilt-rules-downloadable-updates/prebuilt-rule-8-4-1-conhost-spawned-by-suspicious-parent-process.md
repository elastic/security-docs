...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-conhost-spawned-by-suspicious-parent-process.html
---

# Conhost Spawned By Suspicious Parent Process [prebuilt-rule-8-4-1-conhost-spawned-by-suspicious-parent-process]
...
## Investigation guide [_investigation_guide_2802]
