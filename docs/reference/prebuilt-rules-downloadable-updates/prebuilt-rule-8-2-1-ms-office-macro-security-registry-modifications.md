...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-ms-office-macro-security-registry-modifications.html
---

# MS Office Macro Security Registry Modifications [prebuilt-rule-8-2-1-ms-office-macro-security-registry-modifications]
...
## Investigation guide [_investigation_guide_2129]
