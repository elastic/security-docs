---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-powershell-invoke-ninjacopy-script.html
---

# PowerShell Invoke-NinjaCopy script [prebuilt-rule-8-6-1-powershell-invoke-ninjacopy-script]
