...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-volume-shadow-copy-deletion-via-wmic.html
---

# Volume Shadow Copy Deletion via WMIC [prebuilt-rule-8-4-1-volume-shadow-copy-deletion-via-wmic]
...
## Investigation guide [_investigation_guide_2810]
