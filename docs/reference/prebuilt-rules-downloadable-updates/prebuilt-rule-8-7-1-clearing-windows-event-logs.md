...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-clearing-windows-event-logs.html
---

# Clearing Windows Event Logs [prebuilt-rule-8-7-1-clearing-windows-event-logs]
...
## Investigation guide [_investigation_guide_3855]
