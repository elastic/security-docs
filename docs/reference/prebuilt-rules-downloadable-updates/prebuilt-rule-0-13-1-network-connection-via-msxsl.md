---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-network-connection-via-msxsl.html
---

# Network Connection via MsXsl [prebuilt-rule-0-13-1-network-connection-via-msxsl]
