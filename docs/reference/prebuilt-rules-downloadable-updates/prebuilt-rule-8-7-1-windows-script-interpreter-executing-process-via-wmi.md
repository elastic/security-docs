...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-windows-script-interpreter-executing-process-via-wmi.html
---

# Windows Script Interpreter Executing Process via WMI [prebuilt-rule-8-7-1-windows-script-interpreter-executing-process-via-wmi]
