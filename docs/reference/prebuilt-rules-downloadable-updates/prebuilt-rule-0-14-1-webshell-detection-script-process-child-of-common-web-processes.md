...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-webshell-detection-script-process-child-of-common-web-processes.html
---

# Webshell Detection: Script Process Child of Common Web Processes [prebuilt-rule-0-14-1-webshell-detection-script-process-child-of-common-web-processes]
...
## Investigation guide [_investigation_guide_1256]
