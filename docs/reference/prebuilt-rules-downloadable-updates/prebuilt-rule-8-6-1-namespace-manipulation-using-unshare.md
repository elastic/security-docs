---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-namespace-manipulation-using-unshare.html
---

# Namespace Manipulation Using Unshare [prebuilt-rule-8-6-1-namespace-manipulation-using-unshare]
