...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-malicious-file-detected-elastic-defend.html
---

# Malicious File - Detected - Elastic Defend [prebuilt-rule-8-17-4-malicious-file-detected-elastic-defend]
...
## Investigation guide [_investigation_guide_4153]
