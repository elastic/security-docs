---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-iis-http-logging-disabled.html
---

# IIS HTTP Logging Disabled [prebuilt-rule-0-14-2-iis-http-logging-disabled]
