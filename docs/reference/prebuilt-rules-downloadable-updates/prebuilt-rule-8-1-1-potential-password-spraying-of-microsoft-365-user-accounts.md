...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-potential-password-spraying-of-microsoft-365-user-accounts.html
---

# Potential Password Spraying of Microsoft 365 User Accounts [prebuilt-rule-8-1-1-potential-password-spraying-of-microsoft-365-user-accounts]
...
## Investigation guide [_investigation_guide_1694]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1970]
