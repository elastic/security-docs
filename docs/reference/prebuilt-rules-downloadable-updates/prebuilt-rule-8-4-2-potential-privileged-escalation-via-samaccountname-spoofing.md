...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-potential-privileged-escalation-via-samaccountname-spoofing.html
---

# Potential Privileged Escalation via SamAccountName Spoofing [prebuilt-rule-8-4-2-potential-privileged-escalation-via-samaccountname-spoofing]
...
## Investigation guide [_investigation_guide_3558]



## Rule query [_rule_query_4254]
