...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-sensitive-privilege-seenabledelegationprivilege-assigned-to-a-user.html
---

# Sensitive Privilege SeEnableDelegationPrivilege assigned to a User [prebuilt-rule-8-5-1-sensitive-privilege-seenabledelegationprivilege-assigned-to-a-user]
...
## Investigation guide [_investigation_guide_3694]
