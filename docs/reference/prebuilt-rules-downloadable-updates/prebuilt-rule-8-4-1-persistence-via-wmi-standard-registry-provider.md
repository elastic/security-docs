...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-persistence-via-wmi-standard-registry-provider.html
---

# Persistence via WMI Standard Registry Provider [prebuilt-rule-8-4-1-persistence-via-wmi-standard-registry-provider]
