...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-creation-of-hidden-login-item-via-apple-script.html
---

# Creation of Hidden Login Item via Apple Script [prebuilt-rule-8-4-1-creation-of-hidden-login-item-via-apple-script]
...
## Investigation guide [_investigation_guide_2660]



## Rule query [_rule_query_3049]
