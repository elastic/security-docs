...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-suspicious-lsass-access-via-malseclogon.html
---

# Suspicious LSASS Access via MalSecLogon [prebuilt-rule-8-3-3-suspicious-lsass-access-via-malseclogon]
...
## Investigation guide [_investigation_guide_3017]



## Rule query [_rule_query_3512]
