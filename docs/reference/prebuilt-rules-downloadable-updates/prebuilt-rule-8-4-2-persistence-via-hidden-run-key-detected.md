---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-persistence-via-hidden-run-key-detected.html
---

# Persistence via Hidden Run Key Detected [prebuilt-rule-8-4-2-persistence-via-hidden-run-key-detected]
...
## Investigation guide [_investigation_guide_3539]



## Rule query [_rule_query_4229]
