...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-microsoft-exchange-server-um-spawning-suspicious-processes.html
---

# Microsoft Exchange Server UM Spawning Suspicious Processes [prebuilt-rule-8-4-2-microsoft-exchange-server-um-spawning-suspicious-processes]
...
## Investigation guide [_investigation_guide_3489]



## Rule query [_rule_query_4155]
