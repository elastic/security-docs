---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-potential-credential-access-via-lsass-memory-dump.html
---

# Potential Credential Access via LSASS Memory Dump [prebuilt-rule-8-4-2-potential-credential-access-via-lsass-memory-dump]
...
## Investigation guide [_investigation_guide_3380]



## Rule query [_rule_query_4021]
