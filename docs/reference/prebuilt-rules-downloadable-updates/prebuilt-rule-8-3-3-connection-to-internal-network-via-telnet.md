---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-connection-to-internal-network-via-telnet.html
---

# Connection to Internal Network via Telnet [prebuilt-rule-8-3-3-connection-to-internal-network-via-telnet]
