...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-system-v-init-script-created.html
---

# System V Init Script Created [prebuilt-rule-8-17-4-system-v-init-script-created]
...
## Investigation guide [_investigation_guide_4458]
