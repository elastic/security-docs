---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-potential-persistence-via-periodic-tasks.html
---

# Potential Persistence via Periodic Tasks [prebuilt-rule-8-4-2-potential-persistence-via-periodic-tasks]
