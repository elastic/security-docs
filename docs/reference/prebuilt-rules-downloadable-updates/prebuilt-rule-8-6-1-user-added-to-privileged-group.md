...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-user-added-to-privileged-group.html
---

# User Added to Privileged Group [prebuilt-rule-8-6-1-user-added-to-privileged-group]
...
## Investigation guide [_investigation_guide_3799]
