...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-suspicious-wmi-image-load-from-ms-office.html
---

# Suspicious WMI Image Load from MS Office [prebuilt-rule-8-3-3-suspicious-wmi-image-load-from-ms-office]
...
## Investigation guide [_investigation_guide_3124]



## Rule query [_rule_query_3644]
