...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-msbuild-making-network-connections.html
---

# MsBuild Making Network Connections [prebuilt-rule-8-17-4-msbuild-making-network-connections]
...
## Investigation guide [_investigation_guide_4780]
