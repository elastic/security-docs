...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-remote-file-download-via-powershell.html
---

# Remote File Download via PowerShell [prebuilt-rule-8-17-4-remote-file-download-via-powershell]
...
## Investigation guide [_investigation_guide_4694]
