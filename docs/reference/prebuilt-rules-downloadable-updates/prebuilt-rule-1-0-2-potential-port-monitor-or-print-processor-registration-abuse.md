...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-potential-port-monitor-or-print-processor-registration-abuse.html
---

# Potential Port Monitor or Print Processor Registration Abuse [prebuilt-rule-1-0-2-potential-port-monitor-or-print-processor-registration-abuse]
