...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-network-activity-detected-via-cat.html
---

# Network Activity Detected via cat [prebuilt-rule-8-17-4-network-activity-detected-via-cat]
...
## Investigation guide [_investigation_guide_4301]
