...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-remote-registry-access-via-sebackupprivilege.html
---

# Suspicious Remote Registry Access via SeBackupPrivilege [prebuilt-rule-8-2-1-suspicious-remote-registry-access-via-sebackupprivilege]
...
## Investigation guide [_investigation_guide_2092]
