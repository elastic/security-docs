...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-file-creation-alternate-data-stream.html
---

# Unusual File Creation - Alternate Data Stream [prebuilt-rule-8-3-2-unusual-file-creation-alternate-data-stream]
...
## Investigation guide [_investigation_guide_2472]
