---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-aws-security-group-configuration-change-detection.html
---

# AWS Security Group Configuration Change Detection [prebuilt-rule-1-0-2-aws-security-group-configuration-change-detection]
...
## Investigation guide [_investigation_guide_1409]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1640]
