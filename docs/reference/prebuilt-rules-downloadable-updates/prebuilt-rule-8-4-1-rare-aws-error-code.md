---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-rare-aws-error-code.html
---

# Rare AWS Error Code [prebuilt-rule-8-4-1-rare-aws-error-code]
...
## Investigation guide [_investigation_guide_2602]
