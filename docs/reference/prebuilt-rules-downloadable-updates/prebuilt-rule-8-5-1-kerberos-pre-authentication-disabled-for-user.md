...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-kerberos-pre-authentication-disabled-for-user.html
---

# Kerberos Pre-authentication Disabled for User [prebuilt-rule-8-5-1-kerberos-pre-authentication-disabled-for-user]
...
## Investigation guide [_investigation_guide_3689]
