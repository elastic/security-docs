...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-network-connection-via-registration-utility.html
---

# Network Connection via Registration Utility [prebuilt-rule-1-0-2-network-connection-via-registration-utility]
