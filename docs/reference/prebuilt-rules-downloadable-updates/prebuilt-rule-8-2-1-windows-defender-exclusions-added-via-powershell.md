...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-windows-defender-exclusions-added-via-powershell.html
---

# Windows Defender Exclusions Added via PowerShell [prebuilt-rule-8-2-1-windows-defender-exclusions-added-via-powershell]
...
## Investigation guide [_investigation_guide_2102]
