---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-2-simple-http-web-server-connection.html
---

# Simple HTTP Web Server Connection [prebuilt-rule-8-17-2-simple-http-web-server-connection]
