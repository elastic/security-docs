...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-encrypting-files-with-winrar-or-7z.html
---

# Encrypting Files with WinRar or 7z [prebuilt-rule-8-5-1-encrypting-files-with-winrar-or-7z]
...
## Investigation guide [_investigation_guide_3683]
