...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-unusual-parent-child-relationship.html
---

# Unusual Parent-Child Relationship [prebuilt-rule-8-4-2-unusual-parent-child-relationship]
...
## Investigation guide [_investigation_guide_3568]
