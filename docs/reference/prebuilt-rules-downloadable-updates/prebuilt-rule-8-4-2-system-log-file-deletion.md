...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-system-log-file-deletion.html
---

# System Log File Deletion [prebuilt-rule-8-4-2-system-log-file-deletion]
...
## Investigation guide [_investigation_guide_3298]



## Rule query [_rule_query_3870]
