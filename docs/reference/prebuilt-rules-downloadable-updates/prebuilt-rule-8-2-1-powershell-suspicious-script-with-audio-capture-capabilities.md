...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-powershell-suspicious-script-with-audio-capture-capabilities.html
---

# PowerShell Suspicious Script with Audio Capture Capabilities [prebuilt-rule-8-2-1-powershell-suspicious-script-with-audio-capture-capabilities]
...
## Investigation guide [_investigation_guide_2056]
