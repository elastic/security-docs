...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-aws-cloudwatch-alarm-deletion.html
---

# AWS CloudWatch Alarm Deletion [prebuilt-rule-8-3-2-aws-cloudwatch-alarm-deletion]
...
## Investigation guide [_investigation_guide_2364]
