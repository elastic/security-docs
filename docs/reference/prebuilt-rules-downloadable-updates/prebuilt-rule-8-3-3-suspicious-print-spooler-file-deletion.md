...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-suspicious-print-spooler-file-deletion.html
---

# Suspicious Print Spooler File Deletion [prebuilt-rule-8-3-3-suspicious-print-spooler-file-deletion]
...
## Investigation guide [_investigation_guide_3206]



## Rule query [_rule_query_3754]
