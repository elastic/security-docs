...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-potential-command-and-control-via-internet-explorer.html
---

# Potential Command and Control via Internet Explorer [prebuilt-rule-0-14-2-potential-command-and-control-via-internet-explorer]
