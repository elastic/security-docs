...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-incoming-execution-via-powershell-remoting.html
---

# Incoming Execution via PowerShell Remoting [prebuilt-rule-1-0-2-incoming-execution-via-powershell-remoting]
