...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-remote-file-download-via-script-interpreter.html
---

# Remote File Download via Script Interpreter [prebuilt-rule-8-4-2-remote-file-download-via-script-interpreter]
...
## Investigation guide [_investigation_guide_3346]
