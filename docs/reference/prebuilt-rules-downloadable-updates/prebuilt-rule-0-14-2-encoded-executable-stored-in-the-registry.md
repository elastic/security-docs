...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-encoded-executable-stored-in-the-registry.html
---

# Encoded Executable Stored in the Registry [prebuilt-rule-0-14-2-encoded-executable-stored-in-the-registry]
