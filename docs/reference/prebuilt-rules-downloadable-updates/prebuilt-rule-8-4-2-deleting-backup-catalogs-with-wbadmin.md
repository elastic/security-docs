...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-deleting-backup-catalogs-with-wbadmin.html
---

# Deleting Backup Catalogs with Wbadmin [prebuilt-rule-8-4-2-deleting-backup-catalogs-with-wbadmin]
...
## Investigation guide [_investigation_guide_3480]
