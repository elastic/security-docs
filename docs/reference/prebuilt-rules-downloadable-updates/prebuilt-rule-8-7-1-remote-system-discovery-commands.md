...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-remote-system-discovery-commands.html
---

# Remote System Discovery Commands [prebuilt-rule-8-7-1-remote-system-discovery-commands]
...
## Investigation guide [_investigation_guide_3864]
