...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-unusual-windows-network-activity.html
---

# Unusual Windows Network Activity [prebuilt-rule-8-2-1-unusual-windows-network-activity]
...
## Investigation guide [_investigation_guide_2262]
