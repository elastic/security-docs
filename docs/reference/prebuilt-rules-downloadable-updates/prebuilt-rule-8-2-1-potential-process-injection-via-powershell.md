...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-potential-process-injection-via-powershell.html
---

# Potential Process Injection via PowerShell [prebuilt-rule-8-2-1-potential-process-injection-via-powershell]
...
## Investigation guide [_investigation_guide_2132]
