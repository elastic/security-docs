...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-macos-installer-spawns-network-event.html
---

# macOS Installer Spawns Network Event [prebuilt-rule-0-13-1-macos-installer-spawns-network-event]
