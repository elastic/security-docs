...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-potential-hidden-process-via-mount-hidepid.html
---

# Potential Hidden Process via Mount Hidepid [prebuilt-rule-8-17-3-potential-hidden-process-via-mount-hidepid]
