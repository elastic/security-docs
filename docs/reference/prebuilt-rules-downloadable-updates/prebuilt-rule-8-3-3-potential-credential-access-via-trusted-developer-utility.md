...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-credential-access-via-trusted-developer-utility.html
---

# Potential Credential Access via Trusted Developer Utility [prebuilt-rule-8-3-3-potential-credential-access-via-trusted-developer-utility]
...
## Investigation guide [_investigation_guide_3009]
