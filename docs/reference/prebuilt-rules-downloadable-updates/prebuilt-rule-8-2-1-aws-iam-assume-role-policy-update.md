...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-aws-iam-assume-role-policy-update.html
---

# AWS IAM Assume Role Policy Update [prebuilt-rule-8-2-1-aws-iam-assume-role-policy-update]
...
## Investigation guide [_investigation_guide_1887]
