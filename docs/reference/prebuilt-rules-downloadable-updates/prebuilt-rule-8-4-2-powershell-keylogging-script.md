...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-powershell-keylogging-script.html
---

# PowerShell Keylogging Script [prebuilt-rule-8-4-2-powershell-keylogging-script]
...
## Investigation guide [_investigation_guide_3334]
