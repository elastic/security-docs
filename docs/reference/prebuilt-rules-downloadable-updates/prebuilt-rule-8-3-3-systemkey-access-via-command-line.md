...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-systemkey-access-via-command-line.html
---

# SystemKey Access via Command Line [prebuilt-rule-8-3-3-systemkey-access-via-command-line]
