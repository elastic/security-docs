...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-apple-script-execution-followed-by-network-connection.html
---

# Apple Script Execution followed by Network Connection [prebuilt-rule-0-13-1-apple-script-execution-followed-by-network-connection]
