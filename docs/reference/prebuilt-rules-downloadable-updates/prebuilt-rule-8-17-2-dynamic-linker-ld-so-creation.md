---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-2-dynamic-linker-ld-so-creation.html
---

# Dynamic Linker (ld.so) Creation [prebuilt-rule-8-17-2-dynamic-linker-ld-so-creation]
