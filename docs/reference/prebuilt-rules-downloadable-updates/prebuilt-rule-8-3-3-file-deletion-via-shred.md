...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-file-deletion-via-shred.html
---

# File Deletion via Shred [prebuilt-rule-8-3-3-file-deletion-via-shred]
