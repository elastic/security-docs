...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-unsigned-dll-side-loading-from-a-suspicious-folder.html
---

# Unsigned DLL Side-Loading from a Suspicious Folder [prebuilt-rule-8-4-3-unsigned-dll-side-loading-from-a-suspicious-folder]
...
## Investigation guide [_investigation_guide_3575]



## Rule query [_rule_query_4286]
