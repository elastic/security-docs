...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-powershell-hacktool-script-by-function-names.html
---

# Potential PowerShell HackTool Script by Function Names [prebuilt-rule-8-17-4-potential-powershell-hacktool-script-by-function-names]
...
## Investigation guide [_investigation_guide_4849]
