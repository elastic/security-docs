...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-suspicious-inter-process-communication-via-outlook.html
---

# Suspicious Inter-Process Communication via Outlook [prebuilt-rule-8-5-1-suspicious-inter-process-communication-via-outlook]
