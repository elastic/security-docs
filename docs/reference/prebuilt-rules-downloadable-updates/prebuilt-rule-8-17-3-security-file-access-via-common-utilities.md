...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-security-file-access-via-common-utilities.html
---

# Security File Access via Common Utilities [prebuilt-rule-8-17-3-security-file-access-via-common-utilities]
