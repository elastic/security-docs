---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-registry-persistence-via-appinit-dll.html
---

# Registry Persistence via AppInit DLL [prebuilt-rule-8-3-3-registry-persistence-via-appinit-dll]
...
## Investigation guide [_investigation_guide_3165]



## Rule query [_rule_query_3697]
