---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-signed-proxy-execution-via-ms-work-folders.html
---

# Signed Proxy Execution via MS Work Folders [prebuilt-rule-8-4-2-signed-proxy-execution-via-ms-work-folders]
...
## Investigation guide [_investigation_guide_3442]
