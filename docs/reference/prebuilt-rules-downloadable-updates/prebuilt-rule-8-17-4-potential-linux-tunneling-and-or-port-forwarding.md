...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-linux-tunneling-and-or-port-forwarding.html
---

# Potential Linux Tunneling and/or Port Forwarding [prebuilt-rule-8-17-4-potential-linux-tunneling-and-or-port-forwarding]
...
## Investigation guide [_investigation_guide_4311]
