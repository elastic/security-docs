...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-remote-logon-followed-by-scheduled-task-creation.html
---

# Remote Logon followed by Scheduled Task Creation [prebuilt-rule-8-5-1-remote-logon-followed-by-scheduled-task-creation]
...
## Investigation guide [_investigation_guide_3715]
