---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-startup-folder-persistence-via-unsigned-process.html
---

# Startup Folder Persistence via Unsigned Process [prebuilt-rule-8-3-1-startup-folder-persistence-via-unsigned-process]
...
## Investigation guide [_investigation_guide_2327]
