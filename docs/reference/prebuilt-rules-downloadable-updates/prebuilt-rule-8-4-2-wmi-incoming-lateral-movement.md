...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-wmi-incoming-lateral-movement.html
---

# WMI Incoming Lateral Movement [prebuilt-rule-8-4-2-wmi-incoming-lateral-movement]
