...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-control-panel-process-with-unusual-arguments.html
---

# Control Panel Process with Unusual Arguments [prebuilt-rule-8-2-1-control-panel-process-with-unusual-arguments]
...
## Investigation guide [_investigation_guide_2112]



## Rule query [_rule_query_2402]
