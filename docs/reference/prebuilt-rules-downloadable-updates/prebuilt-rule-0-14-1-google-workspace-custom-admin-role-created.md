...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-google-workspace-custom-admin-role-created.html
---

# Google Workspace Custom Admin Role Created [prebuilt-rule-0-14-1-google-workspace-custom-admin-role-created]
...
## Investigation guide [_investigation_guide_1274]
