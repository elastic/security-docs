...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-enumeration-of-kernel-modules.html
---

# Enumeration of Kernel Modules [prebuilt-rule-8-5-1-enumeration-of-kernel-modules]
