...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-remove-file-quarantine-attribute.html
---

# Attempt to Remove File Quarantine Attribute [prebuilt-rule-8-3-3-attempt-to-remove-file-quarantine-attribute]
...
## Investigation guide [_investigation_guide_2965]



## Rule query [_rule_query_3419]
