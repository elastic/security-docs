...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-adminsdholder-backdoor.html
---

# AdminSDHolder Backdoor [prebuilt-rule-8-4-2-adminsdholder-backdoor]
