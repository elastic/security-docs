...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-attempt-to-delete-an-okta-policy-rule.html
---

# Attempt to Delete an Okta Policy Rule [prebuilt-rule-8-4-1-attempt-to-delete-an-okta-policy-rule]
...
## Investigation guide [_investigation_guide_2635]



## Rule query [_rule_query_3021]
