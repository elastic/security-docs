...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-aws-ec2-snapshot-activity.html
---

# AWS EC2 Snapshot Activity [prebuilt-rule-8-4-1-aws-ec2-snapshot-activity]
...
## Investigation guide [_investigation_guide_2594]
