...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-anomalous-process-for-a-windows-population.html
---

# Anomalous Process For a Windows Population [prebuilt-rule-0-13-1-anomalous-process-for-a-windows-population]
...
## Investigation guide [_investigation_guide_1217]
