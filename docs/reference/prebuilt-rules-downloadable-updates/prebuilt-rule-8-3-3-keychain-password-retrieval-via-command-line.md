---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-keychain-password-retrieval-via-command-line.html
---

# Keychain Password Retrieval via Command Line [prebuilt-rule-8-3-3-keychain-password-retrieval-via-command-line]
...
## Investigation guide [_investigation_guide_2963]



## Rule query [_rule_query_3413]
