...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-unusual-aws-command-for-a-user.html
---

# Unusual AWS Command for a User [prebuilt-rule-8-2-1-unusual-aws-command-for-a-user]
...
## Investigation guide [_investigation_guide_1870]
