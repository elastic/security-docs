...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-azure-service-principal-addition.html
---

# Azure Service Principal Addition [prebuilt-rule-8-4-1-azure-service-principal-addition]
...
## Investigation guide [_investigation_guide_2609]
