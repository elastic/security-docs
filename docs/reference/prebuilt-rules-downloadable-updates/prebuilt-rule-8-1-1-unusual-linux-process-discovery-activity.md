...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-unusual-linux-process-discovery-activity.html
---

# Unusual Linux Process Discovery Activity [prebuilt-rule-8-1-1-unusual-linux-process-discovery-activity]
