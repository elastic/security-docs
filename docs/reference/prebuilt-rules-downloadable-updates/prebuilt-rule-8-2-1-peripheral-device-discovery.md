...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-peripheral-device-discovery.html
---

# Peripheral Device Discovery [prebuilt-rule-8-2-1-peripheral-device-discovery]
...
## Investigation guide [_investigation_guide_2154]
