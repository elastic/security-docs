...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-possible-consent-grant-attack-via-azure-registered-application.html
---

# Possible Consent Grant Attack via Azure-Registered Application [prebuilt-rule-8-5-1-possible-consent-grant-attack-via-azure-registered-application]
...
## Investigation guide [_investigation_guide_3656]
