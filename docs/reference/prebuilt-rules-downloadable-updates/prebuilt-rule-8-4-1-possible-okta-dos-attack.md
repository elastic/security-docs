...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-possible-okta-dos-attack.html
---

# Possible Okta DoS Attack [prebuilt-rule-8-4-1-possible-okta-dos-attack]
...
## Investigation guide [_investigation_guide_2644]



## Rule query [_rule_query_3030]
