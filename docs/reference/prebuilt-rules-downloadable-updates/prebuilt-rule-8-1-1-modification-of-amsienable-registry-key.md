...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-modification-of-amsienable-registry-key.html
---

# Modification of AmsiEnable Registry Key [prebuilt-rule-8-1-1-modification-of-amsienable-registry-key]
...
## Investigation guide [_investigation_guide_1742]
