...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-3-rare-aws-error-code.html
---

# Rare AWS Error Code [prebuilt-rule-0-13-3-rare-aws-error-code]
...
## Investigation guide [_investigation_guide_1241]
