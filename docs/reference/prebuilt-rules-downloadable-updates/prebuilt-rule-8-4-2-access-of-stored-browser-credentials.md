...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-access-of-stored-browser-credentials.html
---

# Access of Stored Browser Credentials [prebuilt-rule-8-4-2-access-of-stored-browser-credentials]
...
## Investigation guide [_investigation_guide_3306]



## Rule query [_rule_query_3898]
