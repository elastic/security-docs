...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-dynamic-linker-copy.html
---

# Dynamic Linker Copy [prebuilt-rule-8-4-2-dynamic-linker-copy]
