...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-cookies-theft-via-browser-debugging.html
---

# Potential Cookies Theft via Browser Debugging [prebuilt-rule-8-3-3-potential-cookies-theft-via-browser-debugging]
...
## Investigation guide [_investigation_guide_2866]



## Rule query [_rule_query_3282]
