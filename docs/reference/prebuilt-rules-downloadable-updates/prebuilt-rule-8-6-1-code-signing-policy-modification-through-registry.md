...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-code-signing-policy-modification-through-registry.html
---

# Code Signing Policy Modification Through Registry [prebuilt-rule-8-6-1-code-signing-policy-modification-through-registry]
