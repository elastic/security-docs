---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-2-persistence-via-folder-action-script.html
---

# Persistence via Folder Action Script [prebuilt-rule-0-13-2-persistence-via-folder-action-script]
