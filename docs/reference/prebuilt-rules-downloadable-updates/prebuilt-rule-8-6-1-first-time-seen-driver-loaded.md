...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-first-time-seen-driver-loaded.html
---

# First Time Seen Driver Loaded [prebuilt-rule-8-6-1-first-time-seen-driver-loaded]
