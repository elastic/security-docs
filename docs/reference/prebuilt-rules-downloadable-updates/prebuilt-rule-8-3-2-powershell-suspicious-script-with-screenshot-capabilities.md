...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-powershell-suspicious-script-with-screenshot-capabilities.html
---

# PowerShell Suspicious Script with Screenshot Capabilities [prebuilt-rule-8-3-2-powershell-suspicious-script-with-screenshot-capabilities]
...
## Investigation guide [_investigation_guide_2398]
