...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-microsoft-build-engine-started-by-a-script-process.html
---

# Microsoft Build Engine Started by a Script Process [prebuilt-rule-0-14-3-microsoft-build-engine-started-by-a-script-process]
