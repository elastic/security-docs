...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-control-panel-process-with-unusual-arguments.html
---

# Control Panel Process with Unusual Arguments [prebuilt-rule-8-3-3-control-panel-process-with-unusual-arguments]
...
## Investigation guide [_investigation_guide_3056]



## Rule query [_rule_query_3554]
