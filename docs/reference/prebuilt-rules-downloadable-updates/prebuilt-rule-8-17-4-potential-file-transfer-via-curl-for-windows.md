...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-file-transfer-via-curl-for-windows.html
---

# Potential File Transfer via Curl for Windows [prebuilt-rule-8-17-4-potential-file-transfer-via-curl-for-windows]
...
## Investigation guide [_investigation_guide_3944]
