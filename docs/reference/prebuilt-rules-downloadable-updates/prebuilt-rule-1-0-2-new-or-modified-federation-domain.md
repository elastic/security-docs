---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-new-or-modified-federation-domain.html
---

# New or Modified Federation Domain [prebuilt-rule-1-0-2-new-or-modified-federation-domain]
...
## Investigation guide [_investigation_guide_1463]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1694]
