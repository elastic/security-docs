---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-microsoft-365-exchange-safe-link-policy-disabled.html
---

# Microsoft 365 Exchange Safe Link Policy Disabled [prebuilt-rule-1-0-2-microsoft-365-exchange-safe-link-policy-disabled]
...
## Investigation guide [_investigation_guide_1455]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1686]
