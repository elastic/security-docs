...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-powershell-script-with-encryption-decryption-capabilities.html
---

# PowerShell Script with Encryption/Decryption Capabilities [prebuilt-rule-8-6-1-powershell-script-with-encryption-decryption-capabilities]
