...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-suspicious-file-creation-in-etc-for-persistence.html
---

# Suspicious File Creation in /etc for Persistence [prebuilt-rule-8-7-1-suspicious-file-creation-in-etc-for-persistence]
