...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-modification-of-environment-variable-via-launchctl.html
---

# Modification of Environment Variable via Launchctl [prebuilt-rule-8-3-3-modification-of-environment-variable-via-launchctl]
