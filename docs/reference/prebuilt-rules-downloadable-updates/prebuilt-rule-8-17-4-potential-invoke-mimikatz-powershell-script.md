...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-invoke-mimikatz-powershell-script.html
---

# Potential Invoke-Mimikatz PowerShell Script [prebuilt-rule-8-17-4-potential-invoke-mimikatz-powershell-script]
...
## Investigation guide [_investigation_guide_4725]
