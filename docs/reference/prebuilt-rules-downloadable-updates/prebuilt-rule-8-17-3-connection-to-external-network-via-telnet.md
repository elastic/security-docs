---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-connection-to-external-network-via-telnet.html
---

# Connection to External Network via Telnet [prebuilt-rule-8-17-3-connection-to-external-network-via-telnet]
