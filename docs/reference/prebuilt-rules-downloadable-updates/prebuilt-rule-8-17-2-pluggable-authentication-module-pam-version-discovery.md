...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-2-pluggable-authentication-module-pam-version-discovery.html
---

# Pluggable Authentication Module (PAM) Version Discovery [prebuilt-rule-8-17-2-pluggable-authentication-module-pam-version-discovery]
