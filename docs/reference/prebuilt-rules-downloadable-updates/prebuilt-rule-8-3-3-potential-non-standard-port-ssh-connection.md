...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-non-standard-port-ssh-connection.html
---

# Potential Non-Standard Port SSH connection [prebuilt-rule-8-3-3-potential-non-standard-port-ssh-connection]
