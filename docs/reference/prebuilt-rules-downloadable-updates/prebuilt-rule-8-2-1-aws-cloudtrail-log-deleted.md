...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-aws-cloudtrail-log-deleted.html
---

# AWS CloudTrail Log Deleted [prebuilt-rule-8-2-1-aws-cloudtrail-log-deleted]
...
## Investigation guide [_investigation_guide_1834]
