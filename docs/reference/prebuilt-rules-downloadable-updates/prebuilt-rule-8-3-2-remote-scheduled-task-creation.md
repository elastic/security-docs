...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-remote-scheduled-task-creation.html
---

# Remote Scheduled Task Creation [prebuilt-rule-8-3-2-remote-scheduled-task-creation]
...
## Investigation guide [_investigation_guide_2530]
