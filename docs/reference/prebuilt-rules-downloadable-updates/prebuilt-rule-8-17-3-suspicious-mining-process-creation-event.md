...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-suspicious-mining-process-creation-event.html
---

# Suspicious Mining Process Creation Event [prebuilt-rule-8-17-3-suspicious-mining-process-creation-event]
