...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-powershell-mailbox-collection-script.html
---

# PowerShell Mailbox Collection Script [prebuilt-rule-8-6-1-powershell-mailbox-collection-script]
