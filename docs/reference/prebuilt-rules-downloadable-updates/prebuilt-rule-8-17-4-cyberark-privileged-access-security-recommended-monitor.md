...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-cyberark-privileged-access-security-recommended-monitor.html
---

# CyberArk Privileged Access Security Recommended Monitor [prebuilt-rule-8-17-4-cyberark-privileged-access-security-recommended-monitor]
...
## Investigation guide [_investigation_guide_4136]
