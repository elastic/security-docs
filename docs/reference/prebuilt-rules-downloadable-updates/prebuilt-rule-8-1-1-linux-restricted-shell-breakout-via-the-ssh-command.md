...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-linux-restricted-shell-breakout-via-the-ssh-command.html
---

# Linux Restricted Shell Breakout via the SSH command [prebuilt-rule-8-1-1-linux-restricted-shell-breakout-via-the-ssh-command]
