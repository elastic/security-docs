---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-hosts-file-modified.html
---

# Hosts File Modified [prebuilt-rule-8-3-3-hosts-file-modified]
...
## Investigation guide [_investigation_guide_2875]
