...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-softwareupdate-preferences-modification.html
---

# SoftwareUpdate Preferences Modification [prebuilt-rule-8-3-3-softwareupdate-preferences-modification]
