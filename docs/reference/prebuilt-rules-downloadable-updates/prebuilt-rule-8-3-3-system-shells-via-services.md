...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-system-shells-via-services.html
---

# System Shells via Services [prebuilt-rule-8-3-3-system-shells-via-services]
...
## Investigation guide [_investigation_guide_3185]
