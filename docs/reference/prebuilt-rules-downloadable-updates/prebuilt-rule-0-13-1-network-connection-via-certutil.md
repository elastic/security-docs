...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-network-connection-via-certutil.html
---

# Network Connection via Certutil [prebuilt-rule-0-13-1-network-connection-via-certutil]
