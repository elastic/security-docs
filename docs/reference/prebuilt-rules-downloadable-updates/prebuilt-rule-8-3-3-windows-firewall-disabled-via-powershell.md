...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-windows-firewall-disabled-via-powershell.html
---

# Windows Firewall Disabled via PowerShell [prebuilt-rule-8-3-3-windows-firewall-disabled-via-powershell]
...
## Investigation guide [_investigation_guide_3077]
