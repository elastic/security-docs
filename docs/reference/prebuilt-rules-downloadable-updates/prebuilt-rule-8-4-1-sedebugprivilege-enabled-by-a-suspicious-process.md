...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-sedebugprivilege-enabled-by-a-suspicious-process.html
---

# SeDebugPrivilege Enabled by a Suspicious Process [prebuilt-rule-8-4-1-sedebugprivilege-enabled-by-a-suspicious-process]
...
## Investigation guide [_investigation_guide_2579]



## Rule query [_rule_query_2967]
