...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-startup-or-run-key-registry-modification.html
---

# Startup or Run Key Registry Modification [prebuilt-rule-8-1-1-startup-or-run-key-registry-modification]
