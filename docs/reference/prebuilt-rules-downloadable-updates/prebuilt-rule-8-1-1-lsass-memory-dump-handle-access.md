...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-lsass-memory-dump-handle-access.html
---

# LSASS Memory Dump Handle Access [prebuilt-rule-8-1-1-lsass-memory-dump-handle-access]
...
## Investigation guide [_investigation_guide_1728]
