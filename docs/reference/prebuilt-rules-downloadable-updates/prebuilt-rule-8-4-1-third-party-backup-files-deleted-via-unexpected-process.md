...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-third-party-backup-files-deleted-via-unexpected-process.html
---

# Third-party Backup Files Deleted via Unexpected Process [prebuilt-rule-8-4-1-third-party-backup-files-deleted-via-unexpected-process]
...
## Investigation guide [_investigation_guide_2804]
