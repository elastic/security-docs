...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-remotely-started-services-via-rpc.html
---

# Remotely Started Services via RPC [prebuilt-rule-8-4-1-remotely-started-services-via-rpc]
...
## Investigation guide [_investigation_guide_2822]
