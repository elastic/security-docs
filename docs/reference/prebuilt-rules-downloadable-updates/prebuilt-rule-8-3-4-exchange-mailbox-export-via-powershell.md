...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-4-exchange-mailbox-export-via-powershell.html
---

# Exchange Mailbox Export via PowerShell [prebuilt-rule-8-3-4-exchange-mailbox-export-via-powershell]
...
## Investigation guide [_investigation_guide_3223]
