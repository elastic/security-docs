...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-azure-kubernetes-events-deleted.html
---

# Azure Kubernetes Events Deleted [prebuilt-rule-0-14-3-azure-kubernetes-events-deleted]
...
## Investigation guide [_investigation_guide_1332]

## Config

The Azure Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1495]
