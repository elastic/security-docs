...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-windows-script-executing-powershell.html
---

# Windows Script Executing PowerShell [prebuilt-rule-8-4-2-windows-script-executing-powershell]
...
## Investigation guide [_investigation_guide_3487]
