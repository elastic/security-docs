...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-process-activity-via-compiled-html-file.html
---

# Process Activity via Compiled HTML File [prebuilt-rule-8-17-4-process-activity-via-compiled-html-file]
...
## Investigation guide [_investigation_guide_4858]
