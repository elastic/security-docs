...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-privileged-account-brute-force.html
---

# Privileged Account Brute Force [prebuilt-rule-8-4-2-privileged-account-brute-force]
...
## Investigation guide [_investigation_guide_3349]
