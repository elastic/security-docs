...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-linux-restricted-shell-breakout-via-linux-binary-s.html
---

# Linux Restricted Shell Breakout via Linux Binary(s) [prebuilt-rule-8-4-3-linux-restricted-shell-breakout-via-linux-binary-s]
...
## Investigation guide [_investigation_guide_3590]
