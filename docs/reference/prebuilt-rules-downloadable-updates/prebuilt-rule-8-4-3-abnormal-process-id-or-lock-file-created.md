---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-abnormal-process-id-or-lock-file-created.html
---

# Abnormal Process ID or Lock File Created [prebuilt-rule-8-4-3-abnormal-process-id-or-lock-file-created]
...
## Investigation guide [_investigation_guide_3587]
