---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-kubernetes-denied-service-account-request.html
---

# Kubernetes Denied Service Account Request [prebuilt-rule-8-4-2-kubernetes-denied-service-account-request]
...
## Investigation guide [_investigation_guide_3277]



## Rule query [_rule_query_3841]
