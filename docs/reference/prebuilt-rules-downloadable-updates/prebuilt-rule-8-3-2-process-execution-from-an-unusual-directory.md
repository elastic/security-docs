---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-process-execution-from-an-unusual-directory.html
---

# Process Execution from an Unusual Directory [prebuilt-rule-8-3-2-process-execution-from-an-unusual-directory]
...
## Investigation guide [_investigation_guide_2455]



## Rule query [_rule_query_2822]
