...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-powershell-suspicious-discovery-related-windows-api-functions.html
---

# PowerShell Suspicious Discovery Related Windows API Functions [prebuilt-rule-8-3-3-powershell-suspicious-discovery-related-windows-api-functions]
...
## Investigation guide [_investigation_guide_3103]
