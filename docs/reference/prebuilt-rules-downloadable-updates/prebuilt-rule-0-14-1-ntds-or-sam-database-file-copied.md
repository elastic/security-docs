...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-ntds-or-sam-database-file-copied.html
---

# NTDS or SAM Database File Copied [prebuilt-rule-0-14-1-ntds-or-sam-database-file-copied]
