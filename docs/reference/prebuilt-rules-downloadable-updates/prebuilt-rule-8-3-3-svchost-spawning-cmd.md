---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-svchost-spawning-cmd.html
---

# Svchost spawning Cmd [prebuilt-rule-8-3-3-svchost-spawning-cmd]
...
## Investigation guide [_investigation_guide_3112]
