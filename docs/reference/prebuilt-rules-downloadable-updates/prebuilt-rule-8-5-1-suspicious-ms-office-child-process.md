...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-suspicious-ms-office-child-process.html
---

# Suspicious MS Office Child Process [prebuilt-rule-8-5-1-suspicious-ms-office-child-process]
...
## Investigation guide [_investigation_guide_3712]
