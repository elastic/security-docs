---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-aws-saml-activity.html
---

# AWS SAML Activity [prebuilt-rule-1-0-2-aws-saml-activity]
...
## Investigation guide [_investigation_guide_1416]

## Config

The AWS Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1647]
