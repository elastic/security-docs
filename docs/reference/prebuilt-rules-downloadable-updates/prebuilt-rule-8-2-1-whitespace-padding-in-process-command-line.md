...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-whitespace-padding-in-process-command-line.html
---

# Whitespace Padding in Process Command Line [prebuilt-rule-8-2-1-whitespace-padding-in-process-command-line]
...
## Investigation guide [_investigation_guide_2274]
