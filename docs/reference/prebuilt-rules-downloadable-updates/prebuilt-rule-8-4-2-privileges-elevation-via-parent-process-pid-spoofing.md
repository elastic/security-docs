...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-privileges-elevation-via-parent-process-pid-spoofing.html
---

# Privileges Elevation via Parent Process PID Spoofing [prebuilt-rule-8-4-2-privileges-elevation-via-parent-process-pid-spoofing]
