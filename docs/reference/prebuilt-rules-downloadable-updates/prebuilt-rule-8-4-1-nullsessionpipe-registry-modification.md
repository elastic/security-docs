...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-nullsessionpipe-registry-modification.html
---

# NullSessionPipe Registry Modification [prebuilt-rule-8-4-1-nullsessionpipe-registry-modification]
