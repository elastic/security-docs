...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-azure-active-directory-high-risk-sign-in.html
---

# Azure Active Directory High Risk Sign-in [prebuilt-rule-8-3-1-azure-active-directory-high-risk-sign-in]
...
## Investigation guide [_investigation_guide_2282]
