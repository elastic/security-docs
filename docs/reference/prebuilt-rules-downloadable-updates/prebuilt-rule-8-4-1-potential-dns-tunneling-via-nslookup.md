...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-potential-dns-tunneling-via-nslookup.html
---

# Potential DNS Tunneling via NsLookup [prebuilt-rule-8-4-1-potential-dns-tunneling-via-nslookup]
...
## Investigation guide [_investigation_guide_2672]
