---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-persistence-via-folder-action-script.html
---

# Persistence via Folder Action Script [prebuilt-rule-8-3-3-persistence-via-folder-action-script]
