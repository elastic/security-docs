...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-attempt-to-install-kali-linux-via-wsl.html
---

# Attempt to Install Kali Linux via WSL [prebuilt-rule-8-5-1-attempt-to-install-kali-linux-via-wsl]
