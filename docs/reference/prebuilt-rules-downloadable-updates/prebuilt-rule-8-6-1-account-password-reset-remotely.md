...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-account-password-reset-remotely.html
---

# Account Password Reset Remotely [prebuilt-rule-8-6-1-account-password-reset-remotely]
