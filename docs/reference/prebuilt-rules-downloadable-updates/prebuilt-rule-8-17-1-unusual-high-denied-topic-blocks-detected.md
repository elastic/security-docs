...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-1-unusual-high-denied-topic-blocks-detected.html
---

# Unusual High Denied Topic Blocks Detected [prebuilt-rule-8-17-1-unusual-high-denied-topic-blocks-detected]
...
## Investigation guide [_investigation_guide_3889]
