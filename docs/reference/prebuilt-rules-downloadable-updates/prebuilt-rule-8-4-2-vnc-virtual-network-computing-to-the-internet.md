...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-vnc-virtual-network-computing-to-the-internet.html
---

# VNC (Virtual Network Computing) to the Internet [prebuilt-rule-8-4-2-vnc-virtual-network-computing-to-the-internet]
