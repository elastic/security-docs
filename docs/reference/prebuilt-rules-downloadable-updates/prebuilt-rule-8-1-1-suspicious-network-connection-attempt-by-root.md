...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-suspicious-network-connection-attempt-by-root.html
---

# Suspicious Network Connection Attempt by Root [prebuilt-rule-8-1-1-suspicious-network-connection-attempt-by-root]
...
## Investigation guide [_investigation_guide_1682]
