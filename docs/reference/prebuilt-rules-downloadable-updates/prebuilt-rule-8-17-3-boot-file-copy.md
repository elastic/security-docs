---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-boot-file-copy.html
---

# Boot File Copy [prebuilt-rule-8-17-3-boot-file-copy]
