...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-connection-to-internal-network-via-telnet.html
---

# Connection to Internal Network via Telnet [prebuilt-rule-0-13-1-connection-to-internal-network-via-telnet]
