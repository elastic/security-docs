...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-executable-file-creation-by-a-system-critical-process.html
---

# Unusual Executable File Creation by a System Critical Process [prebuilt-rule-8-3-2-unusual-executable-file-creation-by-a-system-critical-process]
...
## Investigation guide [_investigation_guide_2471]
