...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-persistence-via-wmi-event-subscription.html
---

# Persistence via WMI Event Subscription [prebuilt-rule-8-4-2-persistence-via-wmi-event-subscription]
...
## Investigation guide [_investigation_guide_3543]



## Rule query [_rule_query_4233]
