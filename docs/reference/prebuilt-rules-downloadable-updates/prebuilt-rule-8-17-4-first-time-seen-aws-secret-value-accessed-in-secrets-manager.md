...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-first-time-seen-aws-secret-value-accessed-in-secrets-manager.html
---

# First Time Seen AWS Secret Value Accessed in Secrets Manager [prebuilt-rule-8-17-4-first-time-seen-aws-secret-value-accessed-in-secrets-manager]
...
## Investigation guide [_investigation_guide_3983]
