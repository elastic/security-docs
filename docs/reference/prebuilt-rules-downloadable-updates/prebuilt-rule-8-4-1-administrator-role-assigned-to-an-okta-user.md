---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-administrator-role-assigned-to-an-okta-user.html
---

# Administrator Role Assigned to an Okta User [prebuilt-rule-8-4-1-administrator-role-assigned-to-an-okta-user]
...
## Investigation guide [_investigation_guide_2649]



## Rule query [_rule_query_3035]
