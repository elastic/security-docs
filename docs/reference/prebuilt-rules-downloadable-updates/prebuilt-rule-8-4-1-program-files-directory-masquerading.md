...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-program-files-directory-masquerading.html
---

# Program Files Directory Masquerading [prebuilt-rule-8-4-1-program-files-directory-masquerading]
...
## Investigation guide [_investigation_guide_2745]



## Rule query [_rule_query_3139]
