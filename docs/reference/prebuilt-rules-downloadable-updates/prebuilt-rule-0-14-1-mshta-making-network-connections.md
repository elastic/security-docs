---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-mshta-making-network-connections.html
---

# Mshta Making Network Connections [prebuilt-rule-0-14-1-mshta-making-network-connections]
