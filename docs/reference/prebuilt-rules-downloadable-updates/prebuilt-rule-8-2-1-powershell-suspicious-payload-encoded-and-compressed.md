...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-powershell-suspicious-payload-encoded-and-compressed.html
---

# PowerShell Suspicious Payload Encoded and Compressed [prebuilt-rule-8-2-1-powershell-suspicious-payload-encoded-and-compressed]
...
## Investigation guide [_investigation_guide_2131]
