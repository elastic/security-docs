...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-o365-exchange-suspicious-mailbox-right-delegation.html
---

# O365 Exchange Suspicious Mailbox Right Delegation [prebuilt-rule-1-0-2-o365-exchange-suspicious-mailbox-right-delegation]
...
## Investigation guide [_investigation_guide_1459]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1690]
