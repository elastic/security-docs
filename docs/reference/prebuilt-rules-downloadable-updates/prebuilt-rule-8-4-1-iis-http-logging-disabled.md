...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-iis-http-logging-disabled.html
---

# IIS HTTP Logging Disabled [prebuilt-rule-8-4-1-iis-http-logging-disabled]
...
## Investigation guide [_investigation_guide_2741]



## Rule query [_rule_query_3134]
