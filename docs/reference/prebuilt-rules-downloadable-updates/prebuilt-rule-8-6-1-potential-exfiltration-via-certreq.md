---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-potential-exfiltration-via-certreq.html
---

# Potential Exfiltration via Certreq [prebuilt-rule-8-6-1-potential-exfiltration-via-certreq]
