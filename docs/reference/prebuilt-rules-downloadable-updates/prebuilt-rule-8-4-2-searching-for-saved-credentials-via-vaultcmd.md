...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-searching-for-saved-credentials-via-vaultcmd.html
---

# Searching for Saved Credentials via VaultCmd [prebuilt-rule-8-4-2-searching-for-saved-credentials-via-vaultcmd]
...
## Investigation guide [_investigation_guide_3375]



## Rule query [_rule_query_4016]
