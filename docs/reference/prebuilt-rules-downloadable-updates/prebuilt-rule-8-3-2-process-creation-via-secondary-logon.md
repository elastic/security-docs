...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-process-creation-via-secondary-logon.html
---

# Process Creation via Secondary Logon [prebuilt-rule-8-3-2-process-creation-via-secondary-logon]
...
## Investigation guide [_investigation_guide_2351]



## Rule query [_rule_query_2722]
