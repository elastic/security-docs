...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-enumeration-of-users-or-groups-via-built-in-commands.html
---

# Enumeration of Users or Groups via Built-in Commands [prebuilt-rule-8-4-2-enumeration-of-users-or-groups-via-built-in-commands]
...
## Investigation guide [_investigation_guide_3314]



## Rule query [_rule_query_3919]
