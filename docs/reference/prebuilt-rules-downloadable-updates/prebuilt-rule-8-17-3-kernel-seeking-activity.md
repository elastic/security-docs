...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-kernel-seeking-activity.html
---

# Kernel Seeking Activity [prebuilt-rule-8-17-3-kernel-seeking-activity]
