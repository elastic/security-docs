...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-whoami-process-activity.html
---

# Whoami Process Activity [prebuilt-rule-8-3-2-whoami-process-activity]
...
## Investigation guide [_investigation_guide_2489]
