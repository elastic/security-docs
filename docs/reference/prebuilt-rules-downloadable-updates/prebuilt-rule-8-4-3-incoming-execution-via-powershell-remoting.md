---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-incoming-execution-via-powershell-remoting.html
---

# Incoming Execution via PowerShell Remoting [prebuilt-rule-8-4-3-incoming-execution-via-powershell-remoting]
