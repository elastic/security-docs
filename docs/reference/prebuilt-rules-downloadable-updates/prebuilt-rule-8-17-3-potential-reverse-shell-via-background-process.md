...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-potential-reverse-shell-via-background-process.html
---

# Potential Reverse Shell via Background Process [prebuilt-rule-8-17-3-potential-reverse-shell-via-background-process]
