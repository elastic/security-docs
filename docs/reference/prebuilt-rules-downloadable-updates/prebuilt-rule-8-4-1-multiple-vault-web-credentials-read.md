...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-multiple-vault-web-credentials-read.html
---

# Multiple Vault Web Credentials Read [prebuilt-rule-8-4-1-multiple-vault-web-credentials-read]
...
## Investigation guide [_investigation_guide_2702]



## Rule query [_rule_query_3094]
