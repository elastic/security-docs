...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-execution-short-program-name.html
---

# Suspicious Execution - Short Program Name [prebuilt-rule-8-4-2-suspicious-execution-short-program-name]
...
## Investigation guide [_investigation_guide_3433]



## Rule query [_rule_query_4092]
