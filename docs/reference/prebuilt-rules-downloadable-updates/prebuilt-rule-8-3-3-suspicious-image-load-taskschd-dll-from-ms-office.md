...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-suspicious-image-load-taskschd-dll-from-ms-office.html
---

# Suspicious Image Load (taskschd.dll) from MS Office [prebuilt-rule-8-3-3-suspicious-image-load-taskschd-dll-from-ms-office]
...
## Investigation guide [_investigation_guide_3183]



## Rule query [_rule_query_3723]
