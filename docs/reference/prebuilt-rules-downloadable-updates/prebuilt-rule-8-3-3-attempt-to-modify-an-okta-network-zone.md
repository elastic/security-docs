...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-modify-an-okta-network-zone.html
---

# Attempt to Modify an Okta Network Zone [prebuilt-rule-8-3-3-attempt-to-modify-an-okta-network-zone]
...
## Investigation guide [_investigation_guide_2925]



## Rule query [_rule_query_3346]
