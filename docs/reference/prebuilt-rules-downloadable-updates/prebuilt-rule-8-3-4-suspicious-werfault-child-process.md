...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-4-suspicious-werfault-child-process.html
---

# Suspicious WerFault Child Process [prebuilt-rule-8-3-4-suspicious-werfault-child-process]
...
## Investigation guide [_investigation_guide_3225]



## Rule query [_rule_query_3777]
