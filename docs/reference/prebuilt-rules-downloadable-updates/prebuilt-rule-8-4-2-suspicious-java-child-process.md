...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-java-child-process.html
---

# Suspicious JAVA Child Process [prebuilt-rule-8-4-2-suspicious-java-child-process]
...
## Investigation guide [_investigation_guide_3238]
