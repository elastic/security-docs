...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-network-connection-via-certutil.html
---

# Network Connection via Certutil [prebuilt-rule-8-1-1-network-connection-via-certutil]
...
## Investigation guide [_investigation_guide_1711]
