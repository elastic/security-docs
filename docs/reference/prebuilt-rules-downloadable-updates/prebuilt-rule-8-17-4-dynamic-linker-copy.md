---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-dynamic-linker-copy.html
---

# Dynamic Linker Copy [prebuilt-rule-8-17-4-dynamic-linker-copy]
...
## Investigation guide [_investigation_guide_4449]
