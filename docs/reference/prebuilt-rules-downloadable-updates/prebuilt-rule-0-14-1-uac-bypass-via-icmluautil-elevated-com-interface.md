...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-uac-bypass-via-icmluautil-elevated-com-interface.html
---

# UAC Bypass via ICMLuaUtil Elevated COM Interface [prebuilt-rule-0-14-1-uac-bypass-via-icmluautil-elevated-com-interface]
