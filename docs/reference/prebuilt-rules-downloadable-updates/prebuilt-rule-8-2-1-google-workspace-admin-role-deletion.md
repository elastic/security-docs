...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-google-workspace-admin-role-deletion.html
---

# Google Workspace Admin Role Deletion [prebuilt-rule-8-2-1-google-workspace-admin-role-deletion]
...
## Investigation guide [_investigation_guide_1952]
