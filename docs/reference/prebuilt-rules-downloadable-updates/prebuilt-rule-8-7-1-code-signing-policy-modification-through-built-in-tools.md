...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-code-signing-policy-modification-through-built-in-tools.html
---

# Code Signing Policy Modification Through Built-in tools [prebuilt-rule-8-7-1-code-signing-policy-modification-through-built-in-tools]
