...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-dumping-of-keychain-content-via-security-command.html
---

# Dumping of Keychain Content via Security Command [prebuilt-rule-8-4-2-dumping-of-keychain-content-via-security-command]
...
## Investigation guide [_investigation_guide_3308]



## Rule query [_rule_query_3901]
