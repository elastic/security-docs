...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-microsoft-build-engine-started-an-unusual-process.html
---

# Microsoft Build Engine Started an Unusual Process [prebuilt-rule-8-4-2-microsoft-build-engine-started-an-unusual-process]
...
## Investigation guide [_investigation_guide_3409]



## Rule query [_rule_query_4051]
