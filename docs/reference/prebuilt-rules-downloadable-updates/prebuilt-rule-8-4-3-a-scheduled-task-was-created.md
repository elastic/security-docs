...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-a-scheduled-task-was-created.html
---

# A scheduled task was created [prebuilt-rule-8-4-3-a-scheduled-task-was-created]
