---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-attempt-to-modify-an-okta-policy.html
---

# Attempt to Modify an Okta Policy [prebuilt-rule-8-4-1-attempt-to-modify-an-okta-policy]
...
## Investigation guide [_investigation_guide_2637]



## Rule query [_rule_query_3023]
