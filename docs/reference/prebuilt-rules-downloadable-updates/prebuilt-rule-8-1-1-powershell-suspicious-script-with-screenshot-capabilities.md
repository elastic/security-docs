...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-powershell-suspicious-script-with-screenshot-capabilities.html
---

# PowerShell Suspicious Script with Screenshot Capabilities [prebuilt-rule-8-1-1-powershell-suspicious-script-with-screenshot-capabilities]
...
## Investigation guide [_investigation_guide_1709]
