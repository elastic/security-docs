...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-potential-remote-credential-access-via-registry.html
---

# Potential Remote Credential Access via Registry [prebuilt-rule-8-3-2-potential-remote-credential-access-via-registry]
...
## Investigation guide [_investigation_guide_2427]
