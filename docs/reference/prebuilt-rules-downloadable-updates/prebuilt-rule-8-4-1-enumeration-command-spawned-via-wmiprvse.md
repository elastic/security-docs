...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-enumeration-command-spawned-via-wmiprvse.html
---

# Enumeration Command Spawned via WMIPrvSE [prebuilt-rule-8-4-1-enumeration-command-spawned-via-wmiprvse]
...
## Investigation guide [_investigation_guide_2788]



## Rule query [_rule_query_3186]
