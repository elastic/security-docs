---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-netcat-network-activity.html
---

# Netcat Network Activity [prebuilt-rule-8-3-2-netcat-network-activity]
...
## Investigation guide [_investigation_guide_2391]
