...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-reverse-shell-activity-via-terminal.html
---

# Potential Reverse Shell Activity via Terminal [prebuilt-rule-8-3-3-potential-reverse-shell-activity-via-terminal]
...
## Investigation guide [_investigation_guide_2873]
