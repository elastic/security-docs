...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-activity-reported-by-okta-user.html
---

# Suspicious Activity Reported by Okta User [prebuilt-rule-8-2-1-suspicious-activity-reported-by-okta-user]
...
## Investigation guide [_investigation_guide_2018]



## Rule query [_rule_query_2303]
