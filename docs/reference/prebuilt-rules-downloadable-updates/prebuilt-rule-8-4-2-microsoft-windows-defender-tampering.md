...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-microsoft-windows-defender-tampering.html
---

# Microsoft Windows Defender Tampering [prebuilt-rule-8-4-2-microsoft-windows-defender-tampering]
...
## Investigation guide [_investigation_guide_3419]
