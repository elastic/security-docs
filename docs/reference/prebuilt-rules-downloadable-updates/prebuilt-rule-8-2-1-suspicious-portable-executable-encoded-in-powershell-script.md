...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-portable-executable-encoded-in-powershell-script.html
---

# Suspicious Portable Executable Encoded in Powershell Script [prebuilt-rule-8-2-1-suspicious-portable-executable-encoded-in-powershell-script]
...
## Investigation guide [_investigation_guide_2168]
