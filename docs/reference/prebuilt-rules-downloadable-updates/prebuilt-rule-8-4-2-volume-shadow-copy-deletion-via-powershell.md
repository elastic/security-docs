...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-volume-shadow-copy-deletion-via-powershell.html
---

# Volume Shadow Copy Deletion via PowerShell [prebuilt-rule-8-4-2-volume-shadow-copy-deletion-via-powershell]
...
## Investigation guide [_investigation_guide_3484]
