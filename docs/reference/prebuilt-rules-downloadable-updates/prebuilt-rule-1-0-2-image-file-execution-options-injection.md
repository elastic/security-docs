...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-image-file-execution-options-injection.html
---

# Image File Execution Options Injection [prebuilt-rule-1-0-2-image-file-execution-options-injection]
