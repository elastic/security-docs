...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-security-software-discovery-using-wmic.html
---

# Security Software Discovery using WMIC [prebuilt-rule-8-4-1-security-software-discovery-using-wmic]
...
## Investigation guide [_investigation_guide_2780]
