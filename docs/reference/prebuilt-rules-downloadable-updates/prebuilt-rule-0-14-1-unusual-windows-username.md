...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-unusual-windows-username.html
---

# Unusual Windows Username [prebuilt-rule-0-14-1-unusual-windows-username]
...
## Investigation guide [_investigation_guide_1284]
