---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-privilege-escalation-via-windir-environment-variable.html
---

# Privilege Escalation via Windir Environment Variable [prebuilt-rule-8-4-2-privilege-escalation-via-windir-environment-variable]
