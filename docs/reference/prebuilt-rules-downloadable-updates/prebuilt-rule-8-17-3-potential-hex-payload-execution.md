...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-potential-hex-payload-execution.html
---

# Potential Hex Payload Execution [prebuilt-rule-8-17-3-potential-hex-payload-execution]
