---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-attempt-to-install-root-certificate.html
---

# Attempt to Install Root Certificate [prebuilt-rule-8-2-1-attempt-to-install-root-certificate]
