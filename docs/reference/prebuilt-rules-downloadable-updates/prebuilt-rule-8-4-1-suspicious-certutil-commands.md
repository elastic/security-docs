...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-suspicious-certutil-commands.html
---

# Suspicious CertUtil Commands [prebuilt-rule-8-4-1-suspicious-certutil-commands]
...
## Investigation guide [_investigation_guide_2756]



## Rule query [_rule_query_3154]
