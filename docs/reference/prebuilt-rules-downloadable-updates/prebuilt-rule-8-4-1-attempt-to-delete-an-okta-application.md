...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-attempt-to-delete-an-okta-application.html
---

# Attempt to Delete an Okta Application [prebuilt-rule-8-4-1-attempt-to-delete-an-okta-application]
...
## Investigation guide [_investigation_guide_2642]



## Rule query [_rule_query_3028]
