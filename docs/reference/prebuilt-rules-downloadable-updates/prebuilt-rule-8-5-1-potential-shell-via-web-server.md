---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-potential-shell-via-web-server.html
---

# Potential Shell via Web Server [prebuilt-rule-8-5-1-potential-shell-via-web-server]
...
## Investigation guide [_investigation_guide_3671]
