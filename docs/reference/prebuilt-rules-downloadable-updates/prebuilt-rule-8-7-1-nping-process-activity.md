...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-nping-process-activity.html
---

# Nping Process Activity [prebuilt-rule-8-7-1-nping-process-activity]
