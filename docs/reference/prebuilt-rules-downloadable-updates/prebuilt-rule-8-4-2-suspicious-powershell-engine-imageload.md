...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-powershell-engine-imageload.html
---

# Suspicious PowerShell Engine ImageLoad [prebuilt-rule-8-4-2-suspicious-powershell-engine-imageload]
...
## Investigation guide [_investigation_guide_3474]
