---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-enumerating-domain-trusts-via-dsquery-exe.html
---

# Enumerating Domain Trusts via DSQUERY.EXE [prebuilt-rule-8-7-1-enumerating-domain-trusts-via-dsquery-exe]
...
## Investigation guide [_investigation_guide_3811]



## Rule query [_rule_query_4673]
