...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-microsoft-build-engine-using-an-alternate-name.html
---

# Microsoft Build Engine Using an Alternate Name [prebuilt-rule-8-17-4-microsoft-build-engine-using-an-alternate-name]
...
## Investigation guide [_investigation_guide_4762]
