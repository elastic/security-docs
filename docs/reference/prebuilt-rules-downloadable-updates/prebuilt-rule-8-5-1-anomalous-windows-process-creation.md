...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-anomalous-windows-process-creation.html
---

# Anomalous Windows Process Creation [prebuilt-rule-8-5-1-anomalous-windows-process-creation]
...
## Investigation guide [_investigation_guide_3682]
