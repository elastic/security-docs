...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-kubernetes-exposed-service-created-with-type-nodeport.html
---

# Kubernetes Exposed Service Created With Type NodePort [prebuilt-rule-8-4-2-kubernetes-exposed-service-created-with-type-nodeport]
...
## Investigation guide [_investigation_guide_3281]



## Rule query [_rule_query_3845]
