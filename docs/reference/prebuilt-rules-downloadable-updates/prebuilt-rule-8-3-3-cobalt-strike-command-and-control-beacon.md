...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-cobalt-strike-command-and-control-beacon.html
---

# Cobalt Strike Command and Control Beacon [prebuilt-rule-8-3-3-cobalt-strike-command-and-control-beacon]
...
## Investigation guide [_investigation_guide_2981]

## Threat intel

This activity has been observed in FIN7 campaigns.

## Rule query [_rule_query_3470]
