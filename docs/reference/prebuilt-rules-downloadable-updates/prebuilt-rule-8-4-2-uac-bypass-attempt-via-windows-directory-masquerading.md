...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-uac-bypass-attempt-via-windows-directory-masquerading.html
---

# UAC Bypass Attempt via Windows Directory Masquerading [prebuilt-rule-8-4-2-uac-bypass-attempt-via-windows-directory-masquerading]
...
## Investigation guide [_investigation_guide_3566]
