...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-rpc-remote-procedure-call-to-the-internet.html
---

# RPC (Remote Procedure Call) to the Internet [prebuilt-rule-0-14-1-rpc-remote-procedure-call-to-the-internet]
