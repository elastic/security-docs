...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-attempt-to-modify-an-okta-policy-rule.html
---

# Attempt to Modify an Okta Policy Rule [prebuilt-rule-8-4-1-attempt-to-modify-an-okta-policy-rule]
...
## Investigation guide [_investigation_guide_2638]



## Rule query [_rule_query_3024]
