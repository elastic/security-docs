...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-keychain-password-retrieval-via-command-line.html
---

# Keychain Password Retrieval via Command Line [prebuilt-rule-8-4-2-keychain-password-retrieval-via-command-line]
...
## Investigation guide [_investigation_guide_3309]



## Rule query [_rule_query_3903]
