...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-disable-windows-event-and-security-logs-using-built-in-tools.html
---

# Disable Windows Event and Security Logs Using Built-in Tools [prebuilt-rule-8-3-2-disable-windows-event-and-security-logs-using-built-in-tools]
...
## Investigation guide [_investigation_guide_2445]
