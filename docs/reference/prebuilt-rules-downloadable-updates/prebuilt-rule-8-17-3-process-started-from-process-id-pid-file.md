---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-process-started-from-process-id-pid-file.html
---

# Process Started from Process ID (PID) File [prebuilt-rule-8-17-3-process-started-from-process-id-pid-file]
...
## Investigation guide [_investigation_guide_3928]
