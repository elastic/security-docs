...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-windows-defender-disabled-via-registry-modification.html
---

# Windows Defender Disabled via Registry Modification [prebuilt-rule-8-3-1-windows-defender-disabled-via-registry-modification]
...
## Investigation guide [_investigation_guide_2308]
