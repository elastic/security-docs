---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-attempt-to-clear-kernel-ring-buffer.html
---

# Attempt to Clear Kernel Ring Buffer [prebuilt-rule-8-17-3-attempt-to-clear-kernel-ring-buffer]
