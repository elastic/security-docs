...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-exporting-exchange-mailbox-via-powershell.html
---

# Exporting Exchange Mailbox via PowerShell [prebuilt-rule-8-4-1-exporting-exchange-mailbox-via-powershell]
...
## Investigation guide [_investigation_guide_2665]
