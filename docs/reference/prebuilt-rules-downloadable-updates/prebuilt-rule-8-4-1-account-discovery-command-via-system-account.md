---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-account-discovery-command-via-system-account.html
---

# Account Discovery Command via SYSTEM Account [prebuilt-rule-8-4-1-account-discovery-command-via-system-account]
...
## Investigation guide [_investigation_guide_2771]
