---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-image-file-execution-options-injection.html
---

# Image File Execution Options Injection [prebuilt-rule-8-3-1-image-file-execution-options-injection]
