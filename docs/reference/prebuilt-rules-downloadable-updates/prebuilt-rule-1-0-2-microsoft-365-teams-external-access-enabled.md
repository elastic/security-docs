---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-microsoft-365-teams-external-access-enabled.html
---

# Microsoft 365 Teams External Access Enabled [prebuilt-rule-1-0-2-microsoft-365-teams-external-access-enabled]
...
## Investigation guide [_investigation_guide_1461]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1692]
