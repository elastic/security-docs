...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-sensitive-files-compression.html
---

# Sensitive Files Compression [prebuilt-rule-8-6-1-sensitive-files-compression]
