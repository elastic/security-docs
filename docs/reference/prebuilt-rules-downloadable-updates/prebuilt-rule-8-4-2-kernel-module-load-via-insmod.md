...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-kernel-module-load-via-insmod.html
---

# Kernel module load via insmod [prebuilt-rule-8-4-2-kernel-module-load-via-insmod]
