---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-file-creation-time-changed.html
---

# File Creation Time Changed [prebuilt-rule-8-6-1-file-creation-time-changed]
