...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-startup-logon-script-added-to-group-policy-object.html
---

# Startup/Logon Script added to Group Policy Object [prebuilt-rule-8-3-3-startup-logon-script-added-to-group-policy-object]
...
## Investigation guide [_investigation_guide_3198]
