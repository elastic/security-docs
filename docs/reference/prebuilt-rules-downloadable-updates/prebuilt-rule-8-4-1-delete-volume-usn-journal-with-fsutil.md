...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-delete-volume-usn-journal-with-fsutil.html
---

# Delete Volume USN Journal with Fsutil [prebuilt-rule-8-4-1-delete-volume-usn-journal-with-fsutil]
...
## Investigation guide [_investigation_guide_2721]



## Rule query [_rule_query_3113]
