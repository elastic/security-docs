...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-suspicious-net-reflection-via-powershell.html
---

# Suspicious .NET Reflection via PowerShell [prebuilt-rule-8-1-1-suspicious-net-reflection-via-powershell]
...
## Investigation guide [_investigation_guide_1758]
