...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-remote-computer-account-dnshostname-update.html
---

# Remote Computer Account DnsHostName Update [prebuilt-rule-8-3-3-remote-computer-account-dnshostname-update]
