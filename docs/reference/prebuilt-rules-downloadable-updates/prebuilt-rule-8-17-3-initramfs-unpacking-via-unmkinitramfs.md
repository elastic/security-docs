---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-initramfs-unpacking-via-unmkinitramfs.html
---

# Initramfs Unpacking via unmkinitramfs [prebuilt-rule-8-17-3-initramfs-unpacking-via-unmkinitramfs]
