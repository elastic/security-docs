---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-lsass-access-via-malseclogon.html
---

# Suspicious LSASS Access via MalSecLogon [prebuilt-rule-8-2-1-suspicious-lsass-access-via-malseclogon]
...
## Investigation guide [_investigation_guide_2075]



## Rule query [_rule_query_2365]
