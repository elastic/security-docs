---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-program-files-directory-masquerading.html
---

# Program Files Directory Masquerading [prebuilt-rule-0-14-2-program-files-directory-masquerading]
