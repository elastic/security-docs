...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-grub-configuration-generation-through-built-in-utilities.html
---

# GRUB Configuration Generation through Built-in Utilities [prebuilt-rule-8-17-3-grub-configuration-generation-through-built-in-utilities]
