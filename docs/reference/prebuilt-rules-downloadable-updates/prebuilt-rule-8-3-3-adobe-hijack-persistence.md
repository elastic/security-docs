...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-adobe-hijack-persistence.html
---

# Adobe Hijack Persistence [prebuilt-rule-8-3-3-adobe-hijack-persistence]
...
## Investigation guide [_investigation_guide_3163]
