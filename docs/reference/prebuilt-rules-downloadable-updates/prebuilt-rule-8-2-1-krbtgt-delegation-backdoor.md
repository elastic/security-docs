...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-krbtgt-delegation-backdoor.html
---

# KRBTGT Delegation Backdoor [prebuilt-rule-8-2-1-krbtgt-delegation-backdoor]
...
## Investigation guide [_investigation_guide_2211]



## Rule query [_rule_query_2501]
