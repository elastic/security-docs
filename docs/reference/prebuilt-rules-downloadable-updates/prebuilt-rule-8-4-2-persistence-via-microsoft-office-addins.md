...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-persistence-via-microsoft-office-addins.html
---

# Persistence via Microsoft Office AddIns [prebuilt-rule-8-4-2-persistence-via-microsoft-office-addins]
...
## Investigation guide [_investigation_guide_3520]



## Rule query [_rule_query_4200]
