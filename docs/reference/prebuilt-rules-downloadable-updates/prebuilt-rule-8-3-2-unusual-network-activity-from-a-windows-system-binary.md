...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-network-activity-from-a-windows-system-binary.html
---

# Unusual Network Activity from a Windows System Binary [prebuilt-rule-8-3-2-unusual-network-activity-from-a-windows-system-binary]
