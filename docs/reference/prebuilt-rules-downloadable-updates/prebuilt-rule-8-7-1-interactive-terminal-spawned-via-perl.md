---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-interactive-terminal-spawned-via-perl.html
---

# Interactive Terminal Spawned via Perl [prebuilt-rule-8-7-1-interactive-terminal-spawned-via-perl]
