...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-persistence-via-docker-shortcut-modification.html
---

# Persistence via Docker Shortcut Modification [prebuilt-rule-8-4-2-persistence-via-docker-shortcut-modification]
