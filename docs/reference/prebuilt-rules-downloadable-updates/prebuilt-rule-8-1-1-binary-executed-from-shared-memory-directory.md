...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-binary-executed-from-shared-memory-directory.html
---

# Binary Executed from Shared Memory Directory [prebuilt-rule-8-1-1-binary-executed-from-shared-memory-directory]
