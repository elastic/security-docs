...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-windows-service-installed-via-an-unusual-client.html
---

# Windows Service Installed via an Unusual Client [prebuilt-rule-1-0-2-windows-service-installed-via-an-unusual-client]
...
## Investigation guide [_investigation_guide_1376]
