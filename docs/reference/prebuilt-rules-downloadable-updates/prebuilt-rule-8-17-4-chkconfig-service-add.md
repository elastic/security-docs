...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-chkconfig-service-add.html
---

# Chkconfig Service Add [prebuilt-rule-8-17-4-chkconfig-service-add]
...
## Investigation guide [_investigation_guide_4440]
