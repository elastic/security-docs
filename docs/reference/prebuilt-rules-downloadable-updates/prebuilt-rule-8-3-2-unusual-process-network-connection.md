...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-process-network-connection.html
---

# Unusual Process Network Connection [prebuilt-rule-8-3-2-unusual-process-network-connection]
...
## Investigation guide [_investigation_guide_2474]
