...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-access-to-a-sensitive-ldap-attribute.html
---

# Access to a Sensitive LDAP Attribute [prebuilt-rule-8-7-1-access-to-a-sensitive-ldap-attribute]
...
## Investigation guide [_investigation_guide_3847]
