---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-13-1-unusual-network-connection-via-rundll32.html
---

# Unusual Network Connection via RunDLL32 [prebuilt-rule-0-13-1-unusual-network-connection-via-rundll32]
