...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-persistence-via-login-hook.html
---

# Potential Persistence via Login Hook [prebuilt-rule-8-17-4-potential-persistence-via-login-hook]
...
## Investigation guide [_investigation_guide_4595]
