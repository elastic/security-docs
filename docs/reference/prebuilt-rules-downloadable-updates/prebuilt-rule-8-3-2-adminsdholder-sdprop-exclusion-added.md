...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-adminsdholder-sdprop-exclusion-added.html
---

# AdminSDHolder SDProp Exclusion Added [prebuilt-rule-8-3-2-adminsdholder-sdprop-exclusion-added]
...
## Investigation guide [_investigation_guide_2539]
