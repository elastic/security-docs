---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-2-virtual-machine-fingerprinting-via-grep.html
---

# Virtual Machine Fingerprinting via Grep [prebuilt-rule-0-14-2-virtual-machine-fingerprinting-via-grep]
