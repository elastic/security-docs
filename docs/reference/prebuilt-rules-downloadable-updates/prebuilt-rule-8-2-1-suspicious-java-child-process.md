...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-java-child-process.html
---

# Suspicious JAVA Child Process [prebuilt-rule-8-2-1-suspicious-java-child-process]
...
## Investigation guide [_investigation_guide_1826]



## Rule query [_rule_query_2116]
