...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-group-policy-abuse-for-privilege-addition.html
---

# Group Policy Abuse for Privilege Addition [prebuilt-rule-8-4-3-group-policy-abuse-for-privilege-addition]
...
## Investigation guide [_investigation_guide_3647]
