...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-potential-lateral-tool-transfer-via-smb-share.html
---

# Potential Lateral Tool Transfer via SMB Share [prebuilt-rule-8-3-2-potential-lateral-tool-transfer-via-smb-share]
...
## Investigation guide [_investigation_guide_2523]
