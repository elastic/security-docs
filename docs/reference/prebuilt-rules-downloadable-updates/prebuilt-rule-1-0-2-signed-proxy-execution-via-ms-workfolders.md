...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-signed-proxy-execution-via-ms-workfolders.html
---

# Signed Proxy Execution via MS WorkFolders [prebuilt-rule-1-0-2-signed-proxy-execution-via-ms-workfolders]
...
## Investigation guide [_investigation_guide_1372]
