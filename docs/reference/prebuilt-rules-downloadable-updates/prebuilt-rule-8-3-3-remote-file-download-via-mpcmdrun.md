...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-remote-file-download-via-mpcmdrun.html
---

# Remote File Download via MpCmdRun [prebuilt-rule-8-3-3-remote-file-download-via-mpcmdrun]
...
## Investigation guide [_investigation_guide_2999]
