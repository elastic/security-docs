...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-user-added-to-privileged-group-in-active-directory.html
---

# User Added to Privileged Group in Active Directory [prebuilt-rule-8-3-2-user-added-to-privileged-group-in-active-directory]
...
## Investigation guide [_investigation_guide_2545]
