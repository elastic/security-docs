...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-windows-network-enumeration.html
---

# Windows Network Enumeration [prebuilt-rule-8-3-3-windows-network-enumeration]
...
## Investigation guide [_investigation_guide_3100]
