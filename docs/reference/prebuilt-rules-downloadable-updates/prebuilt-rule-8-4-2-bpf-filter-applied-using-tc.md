---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-bpf-filter-applied-using-tc.html
---

# BPF filter applied using TC [prebuilt-rule-8-4-2-bpf-filter-applied-using-tc]
