---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-deactivate-an-okta-policy.html
---

# Attempt to Deactivate an Okta Policy [prebuilt-rule-8-3-3-attempt-to-deactivate-an-okta-policy]
...
## Investigation guide [_investigation_guide_2921]



## Rule query [_rule_query_3342]
