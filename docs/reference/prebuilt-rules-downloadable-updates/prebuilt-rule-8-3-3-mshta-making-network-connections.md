...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-mshta-making-network-connections.html
---

# Mshta Making Network Connections [prebuilt-rule-8-3-3-mshta-making-network-connections]
