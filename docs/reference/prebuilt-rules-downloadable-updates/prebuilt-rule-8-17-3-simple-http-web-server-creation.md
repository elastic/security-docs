...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-simple-http-web-server-creation.html
---

# Simple HTTP Web Server Creation [prebuilt-rule-8-17-3-simple-http-web-server-creation]
