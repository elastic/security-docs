---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-unusual-windows-path-activity.html
---

# Unusual Windows Path Activity [prebuilt-rule-8-3-1-unusual-windows-path-activity]
