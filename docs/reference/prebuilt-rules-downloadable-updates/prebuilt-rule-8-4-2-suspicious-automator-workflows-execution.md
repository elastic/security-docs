...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-automator-workflows-execution.html
---

# Suspicious Automator Workflows Execution [prebuilt-rule-8-4-2-suspicious-automator-workflows-execution]
