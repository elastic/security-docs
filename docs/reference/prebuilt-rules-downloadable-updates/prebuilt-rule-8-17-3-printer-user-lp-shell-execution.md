...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-printer-user-lp-shell-execution.html
---

# Printer User (lp) Shell Execution [prebuilt-rule-8-17-3-printer-user-lp-shell-execution]
...
## Investigation guide [_investigation_guide_3924]
