...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-ssh-authorized-keys-file-modification.html
---

# SSH Authorized Keys File Modification [prebuilt-rule-8-3-1-ssh-authorized-keys-file-modification]
