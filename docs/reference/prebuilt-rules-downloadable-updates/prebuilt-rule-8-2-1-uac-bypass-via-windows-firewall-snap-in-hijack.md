...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-uac-bypass-via-windows-firewall-snap-in-hijack.html
---

# UAC Bypass via Windows Firewall Snap-In Hijack [prebuilt-rule-8-2-1-uac-bypass-via-windows-firewall-snap-in-hijack]
...
## Investigation guide [_investigation_guide_2249]
