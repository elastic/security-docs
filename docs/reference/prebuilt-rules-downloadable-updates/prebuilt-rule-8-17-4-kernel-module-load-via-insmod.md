...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-kernel-module-load-via-insmod.html
---

# Kernel Module Load via insmod [prebuilt-rule-8-17-4-kernel-module-load-via-insmod]
...
## Investigation guide [_investigation_guide_4459]
