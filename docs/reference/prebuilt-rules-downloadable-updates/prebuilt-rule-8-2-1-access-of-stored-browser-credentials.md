...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-access-of-stored-browser-credentials.html
---

# Access of Stored Browser Credentials [prebuilt-rule-8-2-1-access-of-stored-browser-credentials]
...
## Investigation guide [_investigation_guide_2035]



## Rule query [_rule_query_2325]
