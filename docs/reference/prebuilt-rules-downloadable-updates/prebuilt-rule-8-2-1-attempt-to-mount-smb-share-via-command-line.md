---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-attempt-to-mount-smb-share-via-command-line.html
---

# Attempt to Mount SMB Share via Command Line [prebuilt-rule-8-2-1-attempt-to-mount-smb-share-via-command-line]
...
## Investigation guide [_investigation_guide_2044]



## Rule query [_rule_query_2334]
