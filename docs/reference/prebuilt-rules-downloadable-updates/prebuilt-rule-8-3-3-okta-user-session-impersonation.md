---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-okta-user-session-impersonation.html
---

# Okta User Session Impersonation [prebuilt-rule-8-3-3-okta-user-session-impersonation]
...
## Investigation guide [_investigation_guide_2918]



## Rule query [_rule_query_3339]
