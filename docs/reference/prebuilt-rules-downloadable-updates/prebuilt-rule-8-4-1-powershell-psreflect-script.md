...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-powershell-psreflect-script.html
---

# PowerShell PSReflect Script [prebuilt-rule-8-4-1-powershell-psreflect-script]
...
## Investigation guide [_investigation_guide_2793]
