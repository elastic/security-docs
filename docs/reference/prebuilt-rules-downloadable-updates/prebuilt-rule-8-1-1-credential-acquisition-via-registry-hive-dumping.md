...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-credential-acquisition-via-registry-hive-dumping.html
---

# Credential Acquisition via Registry Hive Dumping [prebuilt-rule-8-1-1-credential-acquisition-via-registry-hive-dumping]
...
## Investigation guide [_investigation_guide_1725]
