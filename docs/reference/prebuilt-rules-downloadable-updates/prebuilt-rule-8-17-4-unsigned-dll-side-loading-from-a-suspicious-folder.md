...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-unsigned-dll-side-loading-from-a-suspicious-folder.html
---

# Unsigned DLL Side-Loading from a Suspicious Folder [prebuilt-rule-8-17-4-unsigned-dll-side-loading-from-a-suspicious-folder]
...
## Investigation guide [_investigation_guide_4811]
