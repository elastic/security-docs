...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-powershell-script-block-logging-disabled.html
---

# PowerShell Script Block Logging Disabled [prebuilt-rule-8-3-3-powershell-script-block-logging-disabled]
...
## Investigation guide [_investigation_guide_3048]
