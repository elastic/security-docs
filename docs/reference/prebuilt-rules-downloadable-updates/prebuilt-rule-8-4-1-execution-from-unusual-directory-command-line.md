...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-execution-from-unusual-directory-command-line.html
---

# Execution from Unusual Directory - Command Line [prebuilt-rule-8-4-1-execution-from-unusual-directory-command-line]
...
## Investigation guide [_investigation_guide_2789]
