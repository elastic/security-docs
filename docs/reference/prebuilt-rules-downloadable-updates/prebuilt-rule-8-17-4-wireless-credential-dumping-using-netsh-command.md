...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-wireless-credential-dumping-using-netsh-command.html
---

# Wireless Credential Dumping using Netsh Command [prebuilt-rule-8-17-4-wireless-credential-dumping-using-netsh-command]
...
## Investigation guide [_investigation_guide_4746]
