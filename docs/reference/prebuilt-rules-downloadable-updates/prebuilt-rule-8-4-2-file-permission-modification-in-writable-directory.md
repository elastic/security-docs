...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-file-permission-modification-in-writable-directory.html
---

# File Permission Modification in Writable Directory [prebuilt-rule-8-4-2-file-permission-modification-in-writable-directory]
