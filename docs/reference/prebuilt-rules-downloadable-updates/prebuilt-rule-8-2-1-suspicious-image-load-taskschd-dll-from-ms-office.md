...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-image-load-taskschd-dll-from-ms-office.html
---

# Suspicious Image Load (taskschd.dll) from MS Office [prebuilt-rule-8-2-1-suspicious-image-load-taskschd-dll-from-ms-office]
...
## Investigation guide [_investigation_guide_2218]



## Rule query [_rule_query_2508]
