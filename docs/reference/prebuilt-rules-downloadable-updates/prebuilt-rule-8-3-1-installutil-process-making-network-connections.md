...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-installutil-process-making-network-connections.html
---

# InstallUtil Process Making Network Connections [prebuilt-rule-8-3-1-installutil-process-making-network-connections]
