...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-aws-ec2-full-network-packet-capture-detected.html
---

# AWS EC2 Full Network Packet Capture Detected [prebuilt-rule-8-2-1-aws-ec2-full-network-packet-capture-detected]
...
## Investigation guide [_investigation_guide_1847]



## Rule query [_rule_query_2137]
