...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-setcap-setuid-setgid-capability-set.html
---

# Setcap setuid/setgid Capability Set [prebuilt-rule-8-17-3-setcap-setuid-setgid-capability-set]
...
## Investigation guide [_investigation_guide_3939]
