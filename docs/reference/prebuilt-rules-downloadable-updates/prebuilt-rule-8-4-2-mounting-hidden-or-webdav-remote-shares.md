...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-mounting-hidden-or-webdav-remote-shares.html
---

# Mounting Hidden or WebDav Remote Shares [prebuilt-rule-8-4-2-mounting-hidden-or-webdav-remote-shares]
...
## Investigation guide [_investigation_guide_3502]



## Rule query [_rule_query_4175]
