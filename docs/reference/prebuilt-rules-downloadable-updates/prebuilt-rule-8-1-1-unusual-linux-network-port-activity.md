---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-unusual-linux-network-port-activity.html
---

# Unusual Linux Network Port Activity [prebuilt-rule-8-1-1-unusual-linux-network-port-activity]
