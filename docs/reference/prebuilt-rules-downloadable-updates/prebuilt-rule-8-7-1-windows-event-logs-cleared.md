...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-windows-event-logs-cleared.html
---

# Windows Event Logs Cleared [prebuilt-rule-8-7-1-windows-event-logs-cleared]
...
## Investigation guide [_investigation_guide_3856]
