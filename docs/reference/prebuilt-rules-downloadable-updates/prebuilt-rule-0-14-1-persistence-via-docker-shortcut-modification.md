...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-persistence-via-docker-shortcut-modification.html
---

# Persistence via Docker Shortcut Modification [prebuilt-rule-0-14-1-persistence-via-docker-shortcut-modification]
