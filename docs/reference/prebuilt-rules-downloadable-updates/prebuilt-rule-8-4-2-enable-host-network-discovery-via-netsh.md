---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-enable-host-network-discovery-via-netsh.html
---

# Enable Host Network Discovery via Netsh [prebuilt-rule-8-4-2-enable-host-network-discovery-via-netsh]
...
## Investigation guide [_investigation_guide_3402]
