...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-account-configured-with-never-expiring-password.html
---

# Account Configured with Never-Expiring Password [prebuilt-rule-8-7-1-account-configured-with-never-expiring-password]
...
## Investigation guide [_investigation_guide_3874]
