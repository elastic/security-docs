...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-solarwinds-process-disabling-services-via-registry.html
---

# SolarWinds Process Disabling Services via Registry [prebuilt-rule-8-4-1-solarwinds-process-disabling-services-via-registry]
...
## Investigation guide [_investigation_guide_2755]



## Rule query [_rule_query_3153]
