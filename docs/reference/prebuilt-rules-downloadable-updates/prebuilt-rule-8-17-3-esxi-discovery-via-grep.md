...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-esxi-discovery-via-grep.html
---

# ESXI Discovery via Grep [prebuilt-rule-8-17-3-esxi-discovery-via-grep]
