...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-microsoft-365-exchange-management-group-role-assignment.html
---

# Microsoft 365 Exchange Management Group Role Assignment [prebuilt-rule-1-0-2-microsoft-365-exchange-management-group-role-assignment]
...
## Investigation guide [_investigation_guide_1460]

## Config

The Office 365 Logs Fleet integration, Filebeat module, or similarly structured data is required to be compatible with this rule.

## Rule query [_rule_query_1691]
