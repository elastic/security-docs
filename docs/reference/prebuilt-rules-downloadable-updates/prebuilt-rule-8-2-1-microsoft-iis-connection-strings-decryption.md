...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-microsoft-iis-connection-strings-decryption.html
---

# Microsoft IIS Connection Strings Decryption [prebuilt-rule-8-2-1-microsoft-iis-connection-strings-decryption]
...
## Investigation guide [_investigation_guide_2073]



## Rule query [_rule_query_2363]
