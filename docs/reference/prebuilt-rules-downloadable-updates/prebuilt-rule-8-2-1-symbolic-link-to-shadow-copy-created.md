...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-symbolic-link-to-shadow-copy-created.html
---

# Symbolic Link to Shadow Copy Created [prebuilt-rule-8-2-1-symbolic-link-to-shadow-copy-created]
...
## Investigation guide [_investigation_guide_2093]
