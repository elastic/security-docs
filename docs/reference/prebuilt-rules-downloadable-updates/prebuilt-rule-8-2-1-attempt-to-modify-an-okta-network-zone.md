...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-attempt-to-modify-an-okta-network-zone.html
---

# Attempt to Modify an Okta Network Zone [prebuilt-rule-8-2-1-attempt-to-modify-an-okta-network-zone]
...
## Investigation guide [_investigation_guide_2008]



## Rule query [_rule_query_2293]
