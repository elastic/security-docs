...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-suspicious-print-spooler-spl-file-created.html
---

# Suspicious Print Spooler SPL File Created [prebuilt-rule-8-17-4-suspicious-print-spooler-spl-file-created]
...
## Investigation guide [_investigation_guide_4972]
