...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-6-1-potential-ssh-password-guessing.html
---

# Potential SSH Password Guessing [prebuilt-rule-8-6-1-potential-ssh-password-guessing]
...
## Investigation guide [_investigation_guide_3736]
