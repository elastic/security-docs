...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-abnormal-process-id-or-lock-file-created.html
---

# Abnormal Process ID or Lock File Created [prebuilt-rule-8-7-1-abnormal-process-id-or-lock-file-created]
...
## Investigation guide [_investigation_guide_3822]
