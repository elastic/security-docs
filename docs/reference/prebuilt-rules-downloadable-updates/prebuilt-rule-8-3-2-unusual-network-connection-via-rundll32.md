...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-network-connection-via-rundll32.html
---

# Unusual Network Connection via RunDLL32 [prebuilt-rule-8-3-2-unusual-network-connection-via-rundll32]
...
## Investigation guide [_investigation_guide_2473]
