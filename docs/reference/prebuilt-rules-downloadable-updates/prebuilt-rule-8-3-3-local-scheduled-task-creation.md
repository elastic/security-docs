---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-local-scheduled-task-creation.html
---

# Local Scheduled Task Creation [prebuilt-rule-8-3-3-local-scheduled-task-creation]
