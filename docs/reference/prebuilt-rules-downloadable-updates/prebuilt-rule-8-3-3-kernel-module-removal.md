---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-kernel-module-removal.html
---

# Kernel Module Removal [prebuilt-rule-8-3-3-kernel-module-removal]
