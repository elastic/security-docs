...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-potential-ssh-brute-force-detected-on-privileged-account.html
---

# Potential SSH Brute Force Detected on Privileged Account [prebuilt-rule-8-4-3-potential-ssh-brute-force-detected-on-privileged-account]
...
## Investigation guide [_investigation_guide_3582]
