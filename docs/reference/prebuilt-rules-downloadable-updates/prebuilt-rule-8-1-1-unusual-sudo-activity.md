...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-unusual-sudo-activity.html
---

# Unusual Sudo Activity [prebuilt-rule-8-1-1-unusual-sudo-activity]
