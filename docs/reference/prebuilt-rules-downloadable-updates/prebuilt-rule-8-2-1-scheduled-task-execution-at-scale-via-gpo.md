...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-scheduled-task-execution-at-scale-via-gpo.html
---

# Scheduled Task Execution at Scale via GPO [prebuilt-rule-8-2-1-scheduled-task-execution-at-scale-via-gpo]
...
## Investigation guide [_investigation_guide_2234]
