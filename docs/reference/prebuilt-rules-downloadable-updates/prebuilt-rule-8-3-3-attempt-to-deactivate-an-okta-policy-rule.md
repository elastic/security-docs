...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-attempt-to-deactivate-an-okta-policy-rule.html
---

# Attempt to Deactivate an Okta Policy Rule [prebuilt-rule-8-3-3-attempt-to-deactivate-an-okta-policy-rule]
...
## Investigation guide [_investigation_guide_2922]



## Rule query [_rule_query_3343]
