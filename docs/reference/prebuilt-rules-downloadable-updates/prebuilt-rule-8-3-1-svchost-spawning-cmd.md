...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-svchost-spawning-cmd.html
---

# Svchost spawning Cmd [prebuilt-rule-8-3-1-svchost-spawning-cmd]
...
## Investigation guide [_investigation_guide_2316]
