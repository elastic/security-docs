---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-1-suspicious-powershell-script.html
---

# Suspicious Powershell Script [prebuilt-rule-8-3-1-suspicious-powershell-script]
