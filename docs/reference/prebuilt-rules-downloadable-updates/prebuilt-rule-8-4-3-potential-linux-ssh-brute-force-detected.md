...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-potential-linux-ssh-brute-force-detected.html
---

# Potential Linux SSH Brute Force Detected [prebuilt-rule-8-4-3-potential-linux-ssh-brute-force-detected]
...
## Investigation guide [_investigation_guide_3581]
