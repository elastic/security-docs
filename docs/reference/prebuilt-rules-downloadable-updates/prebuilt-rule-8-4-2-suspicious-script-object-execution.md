...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-script-object-execution.html
---

# Suspicious Script Object Execution [prebuilt-rule-8-4-2-suspicious-script-object-execution]
