...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-persistence-via-kde-autostart-script-or-desktop-file-modification.html
---

# Persistence via KDE AutoStart Script or Desktop File Modification [prebuilt-rule-8-5-1-persistence-via-kde-autostart-script-or-desktop-file-modification]
...
## Investigation guide [_investigation_guide_3670]



## Rule query [_rule_query_4459]
