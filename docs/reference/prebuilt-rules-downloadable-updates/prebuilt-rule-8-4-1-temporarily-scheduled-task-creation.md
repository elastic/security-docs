...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-temporarily-scheduled-task-creation.html
---

# Temporarily Scheduled Task Creation [prebuilt-rule-8-4-1-temporarily-scheduled-task-creation]
