...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-5-1-suspicious-lsass-process-access.html
---

# Suspicious Lsass Process Access [prebuilt-rule-8-5-1-suspicious-lsass-process-access]
...
## Investigation guide [_investigation_guide_3652]

## Setup

## Rule query [_rule_query_4404]
