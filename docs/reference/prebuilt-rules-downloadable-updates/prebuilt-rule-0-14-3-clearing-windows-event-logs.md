...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-clearing-windows-event-logs.html
---

# Clearing Windows Event Logs [prebuilt-rule-0-14-3-clearing-windows-event-logs]
