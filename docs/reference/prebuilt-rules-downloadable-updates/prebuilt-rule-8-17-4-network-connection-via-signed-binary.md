---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-network-connection-via-signed-binary.html
---

# Network Connection via Signed Binary [prebuilt-rule-8-17-4-network-connection-via-signed-binary]
...
## Investigation guide [_investigation_guide_4779]
