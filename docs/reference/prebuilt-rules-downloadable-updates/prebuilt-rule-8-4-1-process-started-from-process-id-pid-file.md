...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-process-started-from-process-id-pid-file.html
---

# Process Started from Process ID (PID) File [prebuilt-rule-8-4-1-process-started-from-process-id-pid-file]
...
## Investigation guide [_investigation_guide_2657]
