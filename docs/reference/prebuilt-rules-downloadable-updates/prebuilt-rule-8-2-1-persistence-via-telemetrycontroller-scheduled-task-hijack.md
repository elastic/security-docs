...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-persistence-via-telemetrycontroller-scheduled-task-hijack.html
---

# Persistence via TelemetryController Scheduled Task Hijack [prebuilt-rule-8-2-1-persistence-via-telemetrycontroller-scheduled-task-hijack]
...
## Investigation guide [_investigation_guide_2227]



## Rule query [_rule_query_2517]
