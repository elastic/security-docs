---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-timestomping-using-touch-command.html
---

# Timestomping using Touch Command [prebuilt-rule-8-3-3-timestomping-using-touch-command]
...
## Investigation guide [_investigation_guide_2870]



## Rule query [_rule_query_3286]
