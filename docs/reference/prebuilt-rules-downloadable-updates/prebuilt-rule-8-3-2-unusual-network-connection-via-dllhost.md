...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-unusual-network-connection-via-dllhost.html
---

# Unusual Network Connection via DllHost [prebuilt-rule-8-3-2-unusual-network-connection-via-dllhost]
