...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-attempt-to-mount-smb-share-via-command-line.html
---

# Attempt to Mount SMB Share via Command Line [prebuilt-rule-8-4-2-attempt-to-mount-smb-share-via-command-line]
...
## Investigation guide [_investigation_guide_3315]



## Rule query [_rule_query_3928]
