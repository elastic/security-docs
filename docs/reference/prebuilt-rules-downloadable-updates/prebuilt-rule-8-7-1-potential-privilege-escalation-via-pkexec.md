...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-potential-privilege-escalation-via-pkexec.html
---

# Potential Privilege Escalation via PKEXEC [prebuilt-rule-8-7-1-potential-privilege-escalation-via-pkexec]
