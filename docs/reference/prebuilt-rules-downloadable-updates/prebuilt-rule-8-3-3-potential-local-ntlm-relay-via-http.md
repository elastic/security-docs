...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-potential-local-ntlm-relay-via-http.html
---

# Potential Local NTLM Relay via HTTP [prebuilt-rule-8-3-3-potential-local-ntlm-relay-via-http]
