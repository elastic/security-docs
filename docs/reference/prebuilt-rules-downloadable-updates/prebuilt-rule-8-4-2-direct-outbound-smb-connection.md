...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-direct-outbound-smb-connection.html
---

# Direct Outbound SMB Connection [prebuilt-rule-8-4-2-direct-outbound-smb-connection]
...
## Investigation guide [_investigation_guide_3496]
