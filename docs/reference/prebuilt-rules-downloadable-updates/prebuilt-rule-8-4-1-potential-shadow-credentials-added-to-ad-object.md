...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-potential-shadow-credentials-added-to-ad-object.html
---

# Potential Shadow Credentials added to AD Object [prebuilt-rule-8-4-1-potential-shadow-credentials-added-to-ad-object]
...
## Investigation guide [_investigation_guide_2705]



## Rule query [_rule_query_3097]
