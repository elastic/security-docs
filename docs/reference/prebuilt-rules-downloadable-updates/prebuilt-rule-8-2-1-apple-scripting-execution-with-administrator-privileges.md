...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-apple-scripting-execution-with-administrator-privileges.html
---

# Apple Scripting Execution with Administrator Privileges [prebuilt-rule-8-2-1-apple-scripting-execution-with-administrator-privileges]
...
## Investigation guide [_investigation_guide_2053]



## Rule query [_rule_query_2343]
