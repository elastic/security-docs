---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-7-1-execution-via-windows-subsystem-for-linux.html
---

# Execution via Windows Subsystem for Linux [prebuilt-rule-8-7-1-execution-via-windows-subsystem-for-linux]
