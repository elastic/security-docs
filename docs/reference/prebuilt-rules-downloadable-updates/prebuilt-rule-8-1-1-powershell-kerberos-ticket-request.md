...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-1-1-powershell-kerberos-ticket-request.html
---

# PowerShell Kerberos Ticket Request [prebuilt-rule-8-1-1-powershell-kerberos-ticket-request]
...
## Investigation guide [_investigation_guide_1734]
