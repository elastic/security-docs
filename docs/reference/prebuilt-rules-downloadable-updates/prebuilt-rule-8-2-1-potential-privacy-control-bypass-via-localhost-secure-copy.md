---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-potential-privacy-control-bypass-via-localhost-secure-copy.html
---

# Potential Privacy Control Bypass via Localhost Secure Copy [prebuilt-rule-8-2-1-potential-privacy-control-bypass-via-localhost-secure-copy]
...
## Investigation guide [_investigation_guide_2042]



## Rule query [_rule_query_2332]
