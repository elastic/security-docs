...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-3-potential-linux-backdoor-user-account-creation.html
---

# Potential Linux Backdoor User Account Creation [prebuilt-rule-8-17-3-potential-linux-backdoor-user-account-creation]
...
## Investigation guide [_investigation_guide_3935]
