...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-3-user-account-exposed-to-kerberoasting.html
---

# User account exposed to Kerberoasting [prebuilt-rule-8-4-3-user-account-exposed-to-kerberoasting]
...
## Investigation guide [_investigation_guide_3618]
