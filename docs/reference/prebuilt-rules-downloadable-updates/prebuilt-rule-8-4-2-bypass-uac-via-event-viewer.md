...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-bypass-uac-via-event-viewer.html
---

# Bypass UAC via Event Viewer [prebuilt-rule-8-4-2-bypass-uac-via-event-viewer]
...
## Investigation guide [_investigation_guide_3565]
