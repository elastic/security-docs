...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-suspicious-imagepath-service-creation.html
---

# Suspicious ImagePath Service Creation [prebuilt-rule-8-4-2-suspicious-imagepath-service-creation]
