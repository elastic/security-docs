...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-suspicious-wmic-xsl-script-execution.html
---

# Suspicious WMIC XSL Script Execution [prebuilt-rule-8-2-1-suspicious-wmic-xsl-script-execution]
