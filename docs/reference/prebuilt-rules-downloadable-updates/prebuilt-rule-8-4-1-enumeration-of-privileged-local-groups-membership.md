...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-enumeration-of-privileged-local-groups-membership.html
---

# Enumeration of Privileged Local Groups Membership [prebuilt-rule-8-4-1-enumeration-of-privileged-local-groups-membership]
...
## Investigation guide [_investigation_guide_2778]
