...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-file-transfer-or-listener-established-via-netcat.html
---

# File Transfer or Listener Established via Netcat [prebuilt-rule-8-4-2-file-transfer-or-listener-established-via-netcat]
...
## Investigation guide [_investigation_guide_3300]
