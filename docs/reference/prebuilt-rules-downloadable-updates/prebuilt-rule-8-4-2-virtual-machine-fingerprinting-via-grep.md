...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-virtual-machine-fingerprinting-via-grep.html
---

# Virtual Machine Fingerprinting via Grep [prebuilt-rule-8-4-2-virtual-machine-fingerprinting-via-grep]
...
## Investigation guide [_investigation_guide_3236]



## Rule query [_rule_query_3794]
