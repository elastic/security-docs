...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-2-ntds-or-sam-database-file-copied.html
---

# NTDS or SAM Database File Copied [prebuilt-rule-8-3-2-ntds-or-sam-database-file-copied]
...
## Investigation guide [_investigation_guide_2412]



## Rule query [_rule_query_2778]
