...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-1-microsoft-build-engine-started-by-a-system-process.html
---

# Microsoft Build Engine Started by a System Process [prebuilt-rule-8-4-1-microsoft-build-engine-started-by-a-system-process]
...
## Investigation guide [_investigation_guide_2734]



## Rule query [_rule_query_3126]
