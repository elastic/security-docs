...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-1-uac-bypass-via-diskcleanup-scheduled-task-hijack.html
---

# UAC Bypass via DiskCleanup Scheduled Task Hijack [prebuilt-rule-0-14-1-uac-bypass-via-diskcleanup-scheduled-task-hijack]
