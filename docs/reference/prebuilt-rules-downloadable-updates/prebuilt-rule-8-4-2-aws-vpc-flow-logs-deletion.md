...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-aws-vpc-flow-logs-deletion.html
---

# AWS VPC Flow Logs Deletion [prebuilt-rule-8-4-2-aws-vpc-flow-logs-deletion]
...
## Investigation guide [_investigation_guide_3250]
