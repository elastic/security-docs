...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-startup-persistence-by-a-suspicious-process.html
---

# Startup Persistence by a Suspicious Process [prebuilt-rule-8-4-2-startup-persistence-by-a-suspicious-process]
...
## Investigation guide [_investigation_guide_3528]
