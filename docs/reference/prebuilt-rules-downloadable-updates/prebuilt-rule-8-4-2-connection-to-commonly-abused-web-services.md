...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-connection-to-commonly-abused-web-services.html
---

# Connection to Commonly Abused Web Services [prebuilt-rule-8-4-2-connection-to-commonly-abused-web-services]
...
## Investigation guide [_investigation_guide_3338]
