...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-1-0-2-potential-lsa-authentication-package-abuse.html
---

# Potential LSA Authentication Package Abuse [prebuilt-rule-1-0-2-potential-lsa-authentication-package-abuse]
