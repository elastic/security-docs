...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-security-software-discovery-via-grep.html
---

# Security Software Discovery via Grep [prebuilt-rule-8-3-3-security-software-discovery-via-grep]
...
## Investigation guide [_investigation_guide_2871]
