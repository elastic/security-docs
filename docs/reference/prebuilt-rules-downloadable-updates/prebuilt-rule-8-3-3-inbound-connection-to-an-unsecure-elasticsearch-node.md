---
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-3-3-inbound-connection-to-an-unsecure-elasticsearch-node.html
---

# Inbound Connection to an Unsecure Elasticsearch Node [prebuilt-rule-8-3-3-inbound-connection-to-an-unsecure-elasticsearch-node]
...
## Investigation guide [_investigation_guide_2986]



## Rule query [_rule_query_3478]
