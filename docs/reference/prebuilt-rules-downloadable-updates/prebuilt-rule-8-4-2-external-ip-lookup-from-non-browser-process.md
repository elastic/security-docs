...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-4-2-external-ip-lookup-from-non-browser-process.html
---

# External IP Lookup from Non-Browser Process [prebuilt-rule-8-4-2-external-ip-lookup-from-non-browser-process]
...
## Investigation guide [_investigation_guide_3452]
