...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-0-14-3-suspicious-zoom-child-process.html
---

# Suspicious Zoom Child Process [prebuilt-rule-0-14-3-suspicious-zoom-child-process]
