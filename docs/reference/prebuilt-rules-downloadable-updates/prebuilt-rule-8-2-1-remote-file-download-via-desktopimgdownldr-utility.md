...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-2-1-remote-file-download-via-desktopimgdownldr-utility.html
---

# Remote File Download via Desktopimgdownldr Utility [prebuilt-rule-8-2-1-remote-file-download-via-desktopimgdownldr-utility]
...
## Investigation guide [_investigation_guide_2063]
