...
applies_to:
  ...
  serverless:
    security: all
mapped_pages:
  - https://www.elastic.co/guide/en/security/current/prebuilt-rule-8-17-4-potential-persistence-via-file-modification.html
---

# Potential Persistence via File Modification [prebuilt-rule-8-17-4-potential-persistence-via-file-modification]
...
## Investigation guide [_investigation_guide_4157]
