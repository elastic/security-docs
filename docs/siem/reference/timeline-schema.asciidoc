...
. <<timeline-object-dropzone, Dropzone object>>: Each statement is contained in
...
|<<dataProvider-obj, dataProviders[]>> |Object that represents each individual
dropzone query statement.
