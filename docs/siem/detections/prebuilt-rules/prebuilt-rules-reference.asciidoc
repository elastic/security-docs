...
|<<elastic-endpoint-prebuilt-rule, Elastic Endpoint Security>> |Generates a detection alert each time an Elastic Endpoint alert is received. Enabling this rule allows you to immediately begin investigating your Elastic Endpoint alerts. |[Elastic] [Endpoint]  |7.9.0 |1
