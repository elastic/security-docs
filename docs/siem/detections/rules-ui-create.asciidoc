...
.. _Elastic endpoint exceptions_ (optional): Use exceptions added to the
Elastic Endpoint rule to prevent alerts
(see <<endpoint-rule-exceptions, Elastic Endpoint rule exceptions>>).
+
NOTE: If you select this option, all future exceptions added to the Elastic
Endpoint rule will also affect this rule.
