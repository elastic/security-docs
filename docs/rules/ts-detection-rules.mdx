...
<DocImage size="l" flatImage alt="Warning for fields with type conflicts" url="../images/ts-detection-rules/-troubleshooting-warning-type-conflicts.png" /> 
...
<DocImage size="l" flatImage alt="Warning for unmapped fields" url="../images/ts-detection-rules/-troubleshooting-warning-unmapped-fields.png" /> 
