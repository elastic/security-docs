---
id: serverlessSecurityBuildingBlockRule
...
* Rules that execute on the alert indices (`.alerts-security.alerts-<space>`).
...
By default, building block alerts are excluded from the Overview dashboard and Alerts page.
