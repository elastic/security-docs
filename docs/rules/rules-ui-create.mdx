...
To create or edit ((ml)) rules, you need an [appropriate license](https://www.elastic.co/subscriptions) and user role. Additionally, the selected ((ml)) job must be running for the rule to function correctly.
</DocCallOut>
