...
<DocImage size="xl" url="../images/interactive-investigation-guides/-detections-ig-alert-flyout.png" alt="Alert details flyout with interactive investigation guide" />
...
<DocImage size="xl" url="../images/interactive-investigation-guides/-detections-ig-timeline-template-fields.png" alt="Timeline template" />
