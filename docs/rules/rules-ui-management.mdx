...
* Edit a single rule: Select the **All actions** menu (*...*) on a rule, then select **Edit rule settings**. The **Edit rule settings** view opens, where you can modify the <DocLink id="serverlessSecurityRulesUiCreate">rule's settings</DocLink>.
