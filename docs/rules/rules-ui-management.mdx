...
- **Value lists**: Any value lists used for rule exceptions are _not_ included in rule exports or imports. Use the <DocLink id="serverlessSecurityValueListsExceptions" section="manage-value-lists">Import value lists</DocLink> UI (*Manage* -> **Rules** -> **Import value lists**) to export and import value lists separately.
