---
id: serverlessSecurityUnusualCountryForAnAwsCommand
slug: /serverless/security/unusual-country-for-an-aws-command
title: Unusual Country For an AWS Command
description: Description to be written
tags: []
---

<div id="unusual-country-for-an-aws-command"></div>
...
**Searches indices from**: now-2h ([Date Math format](((ref))/common-options.html#date-math), see also <DocLink id="serverlessSecurityRulesUiCreate" section="set-the-rules-schedule">`Additional look-back time`</DocLink>)
