---
id: serverlessSecurityAzureActiveDirectoryHighRiskUserSignInHeuristic
slug: /serverless/security/azure-active-directory-high-risk-user-sign-in-heuristic
title: Azure Active Directory High Risk User Sign-in Heuristic
description: Description to be written
tags: []
---

<div id="azure-active-directory-high-risk-user-sign-in-heuristic"></div>
