---
id: serverlessSecurityUserAccountExposedToKerberoasting
slug: /serverless/security/user-account-exposed-to-kerberoasting
title: User account exposed to Kerberoasting
description: Description to be written
tags: []
---

<div id="user-account-exposed-to-kerberoasting"></div>
