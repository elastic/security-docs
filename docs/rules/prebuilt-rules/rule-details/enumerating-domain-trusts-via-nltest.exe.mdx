---
id: serverlessSecurityEnumeratingDomainTrustsViaNltest.exe
slug: /serverless/security/enumerating-domain-trusts-via-nltest.exe
title: Enumerating Domain Trusts via NLTEST.EXE
description: Description to be written
tags: []
---

<div id="enumerating-domain-trusts-via-nltest.exe"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityEnumeratingDomainTrustsViaNltest.exe" section="rule-version-history">version history</DocLink>)
...
<div id="enumerating-domain-trusts-via-nltest.exe-history"></div>
