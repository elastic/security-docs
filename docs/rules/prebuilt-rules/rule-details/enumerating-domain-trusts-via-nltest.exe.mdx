---
id: enSecurityEnumeratingDomainTrustsViaNltest.exe
...
**Version**: 102 (<DocLink id="enSecurityEnumeratingDomainTrustsViaNltest.exe" section="rule-version-history">version history</DocLink>)
