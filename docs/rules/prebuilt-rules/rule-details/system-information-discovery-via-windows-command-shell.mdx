...
slug: /serverless/security/system-information-discovery-via-windows-command-shell
title: System Information Discovery via Windows Command Shell
description: Description to be written
tags: []
---

<div id="system-information-discovery-via-windows-command-shell"></div>
