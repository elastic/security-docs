---
id: serverlessSecurityExecutionFromUnusualDirectoryCommandLine
slug: /serverless/security/execution-from-unusual-directory-command-line
title: Execution from Unusual Directory - Command Line
description: Description to be written
tags: []
---

<div id="execution-from-unusual-directory-command-line"></div>
