...
slug: /serverless/security/attempt-to-deactivate-an-okta-application
title: Attempt to Deactivate an Okta Application
description: Description to be written
tags: []
---

<div id="attempt-to-deactivate-an-okta-application"></div>
