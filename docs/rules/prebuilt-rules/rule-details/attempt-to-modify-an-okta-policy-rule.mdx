---
id: serverlessSecurityAttemptToModifyAnOktaPolicyRule
slug: /serverless/security/attempt-to-modify-an-okta-policy-rule
title: Attempt to Modify an Okta Policy Rule
description: Description to be written
tags: []
---

<div id="attempt-to-modify-an-okta-policy-rule"></div>
