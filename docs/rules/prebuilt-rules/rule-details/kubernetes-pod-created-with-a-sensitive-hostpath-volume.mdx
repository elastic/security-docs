---
id: serverlessSecurityKubernetesPodCreatedWithASensitiveHostpathVolume
slug: /serverless/security/kubernetes-pod-created-with-a-sensitive-hostpath-volume
title: Kubernetes Pod created with a Sensitive hostPath Volume
description: Description to be written
tags: []
---

<div id="kubernetes-pod-created-with-a-sensitive-hostpath-volume"></div>
