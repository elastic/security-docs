---
id: serverlessSecurityAwsRootLoginWithoutMfa
slug: /serverless/security/aws-root-login-without-mfa
title: AWS Root Login Without MFA
description: Description to be written
tags: []
---

<div id="aws-root-login-without-mfa"></div>
