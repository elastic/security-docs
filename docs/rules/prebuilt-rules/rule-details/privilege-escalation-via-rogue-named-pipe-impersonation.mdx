---
id: serverlessSecurityPrivilegeEscalationViaRogueNamedPipeImpersonation
slug: /serverless/security/privilege-escalation-via-rogue-named-pipe-impersonation
title: Privilege Escalation via Rogue Named Pipe Impersonation
description: Description to be written
tags: []
---

<div id="privilege-escalation-via-rogue-named-pipe-impersonation"></div>
