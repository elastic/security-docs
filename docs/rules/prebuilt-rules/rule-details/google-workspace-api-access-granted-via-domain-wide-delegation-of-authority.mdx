...
slug: /serverless/security/google-workspace-api-access-granted-via-domain-wide-delegation-of-authority
title: Google Workspace API Access Granted via Domain-Wide Delegation of Authority
description: Description to be written
tags: []
---

<div id="google-workspace-api-access-granted-via-domain-wide-delegation-of-authority"></div>
