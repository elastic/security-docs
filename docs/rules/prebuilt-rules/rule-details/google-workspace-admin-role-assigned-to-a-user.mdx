---
id: serverlessSecurityGoogleWorkspaceAdminRoleAssignedToAUser
slug: /serverless/security/google-workspace-admin-role-assigned-to-a-user
title: Google Workspace Admin Role Assigned to a User
description: Description to be written
tags: []
---

<div id="google-workspace-admin-role-assigned-to-a-user"></div>
