---
id: enSecurityUnusualLinuxSystemOwnerOrUserDiscoveryActivity
...
**Version**: 100 (<DocLink id="enSecurityUnusualLinuxSystemOwnerOrUserDiscoveryActivity" section="rule-version-history">version history</DocLink>)
