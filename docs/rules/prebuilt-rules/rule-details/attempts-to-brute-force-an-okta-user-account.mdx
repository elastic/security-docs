...
slug: /serverless/security/attempts-to-brute-force-an-okta-user-account
title: Attempts to Brute Force an Okta User Account
description: Description to be written
tags: []
---

<div id="attempts-to-brute-force-an-okta-user-account"></div>
...
**Searches indices from**: now-180m ([Date Math format](((ref))/common-options.html#date-math), see also <DocLink id="serverlessSecurityRulesUiCreate" section="set-the-rules-schedule">`Additional look-back time`</DocLink>)
