---
id: serverlessSecurityDisableWindowsFirewallRulesViaNetsh
slug: /serverless/security/disable-windows-firewall-rules-via-netsh
title: Disable Windows Firewall Rules via Netsh
description: Description to be written
tags: []
---

<div id="disable-windows-firewall-rules-via-netsh"></div>
