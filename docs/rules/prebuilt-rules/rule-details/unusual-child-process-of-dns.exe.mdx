---
id: enSecurityUnusualChildProcessOfDns.exe
...
**Version**: 102 (<DocLink id="enSecurityUnusualChildProcessOfDns.exe" section="rule-version-history">version history</DocLink>)
