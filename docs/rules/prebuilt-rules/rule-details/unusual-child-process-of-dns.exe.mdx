---
id: serverlessSecurityUnusualChildProcessOfDns.exe
slug: /serverless/security/unusual-child-process-of-dns.exe
title: Unusual Child Process of dns.exe
description: Description to be written
tags: []
---

<div id="unusual-child-process-of-dns.exe"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityUnusualChildProcessOfDns.exe" section="rule-version-history">version history</DocLink>)
...
<div id="unusual-child-process-of-dns.exe-history"></div>
