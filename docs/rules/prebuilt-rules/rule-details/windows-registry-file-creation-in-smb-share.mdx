...
slug: /serverless/security/windows-registry-file-creation-in-smb-share
title: Windows Registry File Creation in SMB Share
description: Description to be written
tags: []
---

<div id="windows-registry-file-creation-in-smb-share"></div>
