---
id: serverlessSecurityPotentialReverseShellViaSuspiciousBinary
slug: /serverless/security/potential-reverse-shell-via-suspicious-binary
title: Potential Reverse Shell via Suspicious Binary
description: Description to be written
tags: []
---

<div id="potential-reverse-shell-via-suspicious-binary"></div>
