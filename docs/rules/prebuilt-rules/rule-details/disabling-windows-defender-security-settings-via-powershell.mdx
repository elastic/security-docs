---
id: serverlessSecurityDisablingWindowsDefenderSecuritySettingsViaPowershell
slug: /serverless/security/disabling-windows-defender-security-settings-via-powershell
title: Disabling Windows Defender Security Settings via PowerShell
description: Description to be written
tags: []
---

<div id="disabling-windows-defender-security-settings-via-powershell"></div>
