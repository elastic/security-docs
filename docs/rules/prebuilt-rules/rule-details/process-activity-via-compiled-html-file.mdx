---
id: serverlessSecurityProcessActivityViaCompiledHtmlFile
slug: /serverless/security/process-activity-via-compiled-html-file
title: Process Activity via Compiled HTML File
description: Description to be written
tags: []
---

<div id="process-activity-via-compiled-html-file"></div>
