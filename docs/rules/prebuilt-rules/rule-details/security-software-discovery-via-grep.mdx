---
id: serverlessSecuritySecuritySoftwareDiscoveryViaGrep
slug: /serverless/security/security-software-discovery-via-grep
title: Security Software Discovery via Grep
description: Description to be written
tags: []
---

<div id="security-software-discovery-via-grep"></div>
