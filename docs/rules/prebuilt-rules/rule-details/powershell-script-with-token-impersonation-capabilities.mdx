---
id: serverlessSecurityPowershellScriptWithTokenImpersonationCapabilities
slug: /serverless/security/powershell-script-with-token-impersonation-capabilities
title: PowerShell Script with Token Impersonation Capabilities
description: Description to be written
tags: []
---

<div id="powershell-script-with-token-impersonation-capabilities"></div>
