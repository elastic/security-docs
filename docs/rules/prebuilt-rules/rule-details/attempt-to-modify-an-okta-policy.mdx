---
id: serverlessSecurityAttemptToModifyAnOktaPolicy
slug: /serverless/security/attempt-to-modify-an-okta-policy
title: Attempt to Modify an Okta Policy
description: Description to be written
tags: []
---

<div id="attempt-to-modify-an-okta-policy"></div>
