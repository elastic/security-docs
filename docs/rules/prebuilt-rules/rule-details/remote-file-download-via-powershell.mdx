---
id: serverlessSecurityRemoteFileDownloadViaPowershell
slug: /serverless/security/remote-file-download-via-powershell
title: Remote File Download via PowerShell
description: Description to be written
tags: []
---

<div id="remote-file-download-via-powershell"></div>
