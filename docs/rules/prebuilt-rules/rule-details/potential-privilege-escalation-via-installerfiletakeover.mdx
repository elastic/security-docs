---
id: serverlessSecurityPotentialPrivilegeEscalationViaInstallerfiletakeover
slug: /serverless/security/potential-privilege-escalation-via-installerfiletakeover
title: Potential Privilege Escalation via InstallerFileTakeOver
description: Description to be written
tags: []
---

<div id="potential-privilege-escalation-via-installerfiletakeover"></div>
