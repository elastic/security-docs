---
id: serverlessSecurityPersistenceViaWmiStandardRegistryProvider
slug: /serverless/security/persistence-via-wmi-standard-registry-provider
title: Persistence via WMI Standard Registry Provider
description: Description to be written
tags: []
---

<div id="persistence-via-wmi-standard-registry-provider"></div>
