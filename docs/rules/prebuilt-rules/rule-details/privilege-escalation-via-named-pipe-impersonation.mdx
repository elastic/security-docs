---
id: serverlessSecurityPrivilegeEscalationViaNamedPipeImpersonation
slug: /serverless/security/privilege-escalation-via-named-pipe-impersonation
title: Privilege Escalation via Named Pipe Impersonation
description: Description to be written
tags: []
---

<div id="privilege-escalation-via-named-pipe-impersonation"></div>
