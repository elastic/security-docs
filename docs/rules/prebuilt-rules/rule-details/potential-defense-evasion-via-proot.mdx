---
id: serverlessSecurityPotentialDefenseEvasionViaProot
slug: /serverless/security/potential-defense-evasion-via-proot
title: Potential Defense Evasion via PRoot
description: Description to be written
tags: []
---

<div id="potential-defense-evasion-via-proot"></div>
