---
id: serverlessSecurityUnusualParentProcessForCmd.exe
slug: /serverless/security/unusual-parent-process-for-cmd.exe
...
**Version**: 102 (<DocLink id="serverlessSecurityUnusualParentProcessForCmd.exe" section="rule-version-history">version history</DocLink>)
...
<div id="unusual-parent-process-for-cmd.exe-history"></div>
