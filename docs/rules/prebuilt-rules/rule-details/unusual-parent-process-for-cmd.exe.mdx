---
id: enSecurityUnusualParentProcessForCmd.exe
...
**Version**: 102 (<DocLink id="enSecurityUnusualParentProcessForCmd.exe" section="rule-version-history">version history</DocLink>)
