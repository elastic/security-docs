---
id: enSecurityAwsAccessSecretInSecretsManager
...
**Version**: 103 (<DocLink id="enSecurityAwsAccessSecretInSecretsManager" section="rule-version-history">version history</DocLink>)
