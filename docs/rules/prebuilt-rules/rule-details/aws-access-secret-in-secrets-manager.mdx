---
id: serverlessSecurityAwsAccessSecretInSecretsManager
slug: /serverless/security/aws-access-secret-in-secrets-manager
title: AWS Access Secret in Secrets Manager
description: Description to be written
tags: []
---

<div id="aws-access-secret-in-secrets-manager"></div>
...
**Version**: 103 (<DocLink id="serverlessSecurityAwsAccessSecretInSecretsManager" section="rule-version-history">version history</DocLink>)
...
<div id="aws-access-secret-in-secrets-manager-history"></div>
