---
id: serverlessSecurityAzureActiveDirectoryHighRiskSignIn
slug: /serverless/security/azure-active-directory-high-risk-sign-in
title: Azure Active Directory High Risk Sign-in
description: Description to be written
tags: []
---

<div id="azure-active-directory-high-risk-sign-in"></div>
