---
id: serverlessSecurityExecutionViaMssqlXpCmdshellStoredProcedure
slug: /serverless/security/execution-via-mssql-xp-cmdshell-stored-procedure
title: Execution via MSSQL xp_cmdshell Stored Procedure
description: Description to be written
tags: []
---

<div id="execution-via-mssql-xp-cmdshell-stored-procedure"></div>
