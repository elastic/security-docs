---
id: serverlessSecurityAttemptToDeactivateAnOktaPolicy
slug: /serverless/security/attempt-to-deactivate-an-okta-policy
title: Attempt to Deactivate an Okta Policy
description: Description to be written
tags: []
---

<div id="attempt-to-deactivate-an-okta-policy"></div>
