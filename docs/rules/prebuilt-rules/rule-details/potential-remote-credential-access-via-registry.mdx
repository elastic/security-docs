---
id: serverlessSecurityPotentialRemoteCredentialAccessViaRegistry
slug: /serverless/security/potential-remote-credential-access-via-registry
title: Potential Remote Credential Access via Registry
description: Description to be written
tags: []
---

<div id="potential-remote-credential-access-via-registry"></div>
