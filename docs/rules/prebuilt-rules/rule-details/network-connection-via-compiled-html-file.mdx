---
id: serverlessSecurityNetworkConnectionViaCompiledHtmlFile
slug: /serverless/security/network-connection-via-compiled-html-file
title: Network Connection via Compiled HTML File
description: Description to be written
tags: []
---

<div id="network-connection-via-compiled-html-file"></div>
