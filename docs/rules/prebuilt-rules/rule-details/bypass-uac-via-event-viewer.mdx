---
id: serverlessSecurityBypassUacViaEventViewer
slug: /serverless/security/bypass-uac-via-event-viewer
title: Bypass UAC via Event Viewer
description: Description to be written
tags: []
---

<div id="bypass-uac-via-event-viewer"></div>
