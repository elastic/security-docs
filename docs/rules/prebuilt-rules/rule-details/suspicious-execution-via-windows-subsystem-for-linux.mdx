---
id: serverlessSecuritySuspiciousExecutionViaWindowsSubsystemForLinux
slug: /serverless/security/suspicious-execution-via-windows-subsystem-for-linux
title: Suspicious Execution via Windows Subsystem for Linux
description: Description to be written
tags: []
---

<div id="suspicious-execution-via-windows-subsystem-for-linux"></div>
