---
id: serverlessSecurityReverseShellCreatedViaNamedPipe
slug: /serverless/security/reverse-shell-created-via-named-pipe
title: Reverse Shell Created via Named Pipe
description: Description to be written
tags: []
---

<div id="reverse-shell-created-via-named-pipe"></div>
