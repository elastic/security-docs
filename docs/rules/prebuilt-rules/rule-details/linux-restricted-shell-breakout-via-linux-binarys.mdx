---
id: enSecurityLinuxRestrictedShellBreakoutViaLinuxBinarys
...
**Version**: 100 (<DocLink id="enSecurityLinuxRestrictedShellBreakoutViaLinuxBinarys" section="rule-version-history">version history</DocLink>)
