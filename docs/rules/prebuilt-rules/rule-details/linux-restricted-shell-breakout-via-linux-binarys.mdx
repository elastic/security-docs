---
id: serverlessSecurityLinuxRestrictedShellBreakoutViaLinuxBinarys
slug: /serverless/security/linux-restricted-shell-breakout-via-linux-binarys
title: Linux Restricted Shell Breakout via  Linux Binary(s)
description: Description to be written
tags: []
---

<div id="linux-restricted-shell-breakout-via-linux-binarys"></div>
...
**Version**: 100 (<DocLink id="serverlessSecurityLinuxRestrictedShellBreakoutViaLinuxBinarys" section="rule-version-history">version history</DocLink>)
...
<div id="linux-restricted-shell-breakout-via-linux-binarys-history"></div>
