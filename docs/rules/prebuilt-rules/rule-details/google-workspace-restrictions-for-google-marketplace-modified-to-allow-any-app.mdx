...
slug: /serverless/security/google-workspace-restrictions-for-google-marketplace-modified-to-allow-any-app
title: Google Workspace Restrictions for Google Marketplace Modified to Allow Any App
description: Description to be written
tags: []
---

<div id="google-workspace-restrictions-for-google-marketplace-modified-to-allow-any-app"></div>
