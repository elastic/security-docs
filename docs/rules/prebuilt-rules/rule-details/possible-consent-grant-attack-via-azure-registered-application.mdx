...
slug: /serverless/security/possible-consent-grant-attack-via-azure-registered-application
title: Possible Consent Grant Attack via Azure-Registered Application
description: Description to be written
tags: []
---

<div id="possible-consent-grant-attack-via-azure-registered-application"></div>
