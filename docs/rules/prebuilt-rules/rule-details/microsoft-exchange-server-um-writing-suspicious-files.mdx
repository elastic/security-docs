---
id: serverlessSecurityMicrosoftExchangeServerUmWritingSuspiciousFiles
slug: /serverless/security/microsoft-exchange-server-um-writing-suspicious-files
title: Microsoft Exchange Server UM Writing Suspicious Files
description: Description to be written
tags: []
---

<div id="microsoft-exchange-server-um-writing-suspicious-files"></div>
