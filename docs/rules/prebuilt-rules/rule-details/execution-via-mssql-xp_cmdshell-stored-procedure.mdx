---
id: serverlessSecurityExecutionViaMssqlXp_cmdshellStoredProcedure
slug: /serverless/security/execution-via-mssql-xp_cmdshell-stored-procedure
title: Execution via MSSQL xp_cmdshell Stored Procedure
description: Description to be written
tags: []
---

<div id="execution-via-mssql-xp_cmdshell-stored-procedure"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityExecutionViaMssqlXp_cmdshellStoredProcedure" section="rule-version-history">version history</DocLink>)
...
<div id="execution-via-mssql-xp_cmdshell-stored-procedure-history"></div>
