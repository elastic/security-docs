---
id: enSecurityExecutionViaMssqlXp_cmdshellStoredProcedure
...
**Version**: 102 (<DocLink id="enSecurityExecutionViaMssqlXp_cmdshellStoredProcedure" section="rule-version-history">version history</DocLink>)
