---
id: serverlessSecuritySignedProxyExecutionViaMsWorkFolders
slug: /serverless/security/signed-proxy-execution-via-ms-work-folders
title: Signed Proxy Execution via MS Work Folders
description: Description to be written
tags: []
---

<div id="signed-proxy-execution-via-ms-work-folders"></div>
