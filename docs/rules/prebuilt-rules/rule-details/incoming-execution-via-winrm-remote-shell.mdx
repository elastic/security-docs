---
id: serverlessSecurityIncomingExecutionViaWinrmRemoteShell
slug: /serverless/security/incoming-execution-via-winrm-remote-shell
title: Incoming Execution via WinRM Remote Shell
description: Description to be written
tags: []
---

<div id="incoming-execution-via-winrm-remote-shell"></div>
