---
id: enSecurityExecutionOfFileWrittenOrModifiedByPdfReader
...
**Searches indices from**: now-120m ([Date Math format](((ref))/common-options.html#date-math), see also <DocLink id="enSecurityRulesUiCreate" section="set-the-rules-schedule">`Additional look-back time`</DocLink>)
