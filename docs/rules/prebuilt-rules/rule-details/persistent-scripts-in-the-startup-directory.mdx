...
slug: /serverless/security/persistent-scripts-in-the-startup-directory
title: Persistent Scripts in the Startup Directory
description: Description to be written
tags: []
---

<div id="persistent-scripts-in-the-startup-directory"></div>
