---
id: enSecurityGoogleWorkspaceUserGroupAccessModifiedToAllowExternalAccess
...
**Version**: 2 (<DocLink id="enSecurityGoogleWorkspaceUserGroupAccessModifiedToAllowExternalAccess" section="rule-version-history">version history</DocLink>)
