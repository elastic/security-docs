---
id: serverlessSecurityGoogleWorkspaceUserGroupAccessModifiedToAllowExternalAccess
slug: /serverless/security/google-workspace-user-group-access-modified-to-allow-external-access
title: Google Workspace User Group Access Modified to Allow External Access
description: Description to be written
tags: []
---

<div id="google-workspace-user-group-access-modified-to-allow-external-access"></div>
...
**Searches indices from**: now-130m ([Date Math format](((ref))/common-options.html#date-math), see also <DocLink id="serverlessSecurityRulesUiCreate" section="set-the-rules-schedule">`Additional look-back time`</DocLink>)
...
**Version**: 2 (<DocLink id="serverlessSecurityGoogleWorkspaceUserGroupAccessModifiedToAllowExternalAccess" section="rule-version-history">version history</DocLink>)
...
<div id="google-workspace-user-group-access-modified-to-allow-external-access-history"></div>
