---
id: serverlessSecurityAwsCloudtrailLogDeleted
slug: /serverless/security/aws-cloudtrail-log-deleted
title: AWS CloudTrail Log Deleted
description: Description to be written
tags: []
---

<div id="aws-cloudtrail-log-deleted"></div>
