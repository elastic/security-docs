---
id: serverlessSecurityUnusualFileModificationByDns.exe
slug: /serverless/security/unusual-file-modification-by-dns.exe
title: Unusual File Modification by dns.exe
description: Description to be written
tags: []
---

<div id="unusual-file-modification-by-dns.exe"></div>
...
**Version**: 101 (<DocLink id="serverlessSecurityUnusualFileModificationByDns.exe" section="rule-version-history">version history</DocLink>)
...
<div id="unusual-file-modification-by-dns.exe-history"></div>
