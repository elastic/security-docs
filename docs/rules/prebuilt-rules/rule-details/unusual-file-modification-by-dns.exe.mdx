---
id: enSecurityUnusualFileModificationByDns.exe
...
**Version**: 101 (<DocLink id="enSecurityUnusualFileModificationByDns.exe" section="rule-version-history">version history</DocLink>)
