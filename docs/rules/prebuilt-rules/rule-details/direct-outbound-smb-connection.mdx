---
id: serverlessSecurityDirectOutboundSmbConnection
slug: /serverless/security/direct-outbound-smb-connection
title: Direct Outbound SMB Connection
description: Description to be written
tags: []
---

<div id="direct-outbound-smb-connection"></div>
