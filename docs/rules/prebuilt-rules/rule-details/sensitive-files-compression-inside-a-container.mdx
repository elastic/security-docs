...
slug: /serverless/security/sensitive-files-compression-inside-a-container
title: Sensitive Files Compression Inside A Container
description: Description to be written
tags: []
---

<div id="sensitive-files-compression-inside-a-container"></div>
