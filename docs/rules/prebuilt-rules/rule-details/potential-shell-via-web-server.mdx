---
id: enSecurityPotentialShellViaWebServer
...
**Version**: 102 (<DocLink id="enSecurityPotentialShellViaWebServer" section="rule-version-history">version history</DocLink>)
