---
id: serverlessSecurityPotentialShellViaWebServer
slug: /serverless/security/potential-shell-via-web-server
title: Potential Shell via Web Server
description: Description to be written
tags: []
---

<div id="potential-shell-via-web-server"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityPotentialShellViaWebServer" section="rule-version-history">version history</DocLink>)
...
<div id="potential-shell-via-web-server-history"></div>
