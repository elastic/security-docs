---
id: serverlessSecurityThreatIntelIndicatorMatch
slug: /serverless/security/threat-intel-indicator-match
title: Threat Intel Indicator Match
description: Description to be written
tags: []
---

<div id="threat-intel-indicator-match"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityThreatIntelIndicatorMatch" section="rule-version-history">version history</DocLink>)
...
<div id="threat-intel-indicator-match-history"></div>
