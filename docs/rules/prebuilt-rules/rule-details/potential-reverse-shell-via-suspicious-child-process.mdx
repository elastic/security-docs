---
id: serverlessSecurityPotentialReverseShellViaSuspiciousChildProcess
slug: /serverless/security/potential-reverse-shell-via-suspicious-child-process
title: Potential Reverse Shell via Suspicious Child Process
description: Description to be written
tags: []
---

<div id="potential-reverse-shell-via-suspicious-child-process"></div>
