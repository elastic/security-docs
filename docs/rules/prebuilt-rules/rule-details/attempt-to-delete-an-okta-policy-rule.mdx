---
id: serverlessSecurityAttemptToDeleteAnOktaPolicyRule
slug: /serverless/security/attempt-to-delete-an-okta-policy-rule
title: Attempt to Delete an Okta Policy Rule
description: Description to be written
tags: []
---

<div id="attempt-to-delete-an-okta-policy-rule"></div>
