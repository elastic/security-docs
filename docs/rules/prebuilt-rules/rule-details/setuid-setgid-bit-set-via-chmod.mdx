---
id: serverlessSecuritySetuidSetgidBitSetViaChmod
slug: /serverless/security/setuid-setgid-bit-set-via-chmod
title: Setuid / Setgid Bit Set via chmod
description: Description to be written
tags: []
---

<div id="setuid-setgid-bit-set-via-chmod"></div>
