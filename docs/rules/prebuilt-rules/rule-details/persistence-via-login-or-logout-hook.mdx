---
id: serverlessSecurityPersistenceViaLoginOrLogoutHook
slug: /serverless/security/persistence-via-login-or-logout-hook
title: Persistence via Login or Logout Hook
description: Description to be written
tags: []
---

<div id="persistence-via-login-or-logout-hook"></div>
