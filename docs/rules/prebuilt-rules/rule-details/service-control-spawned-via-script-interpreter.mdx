---
id: serverlessSecurityServiceControlSpawnedViaScriptInterpreter
slug: /serverless/security/service-control-spawned-via-script-interpreter
title: Service Control Spawned via Script Interpreter
description: Description to be written
tags: []
---

<div id="service-control-spawned-via-script-interpreter"></div>
