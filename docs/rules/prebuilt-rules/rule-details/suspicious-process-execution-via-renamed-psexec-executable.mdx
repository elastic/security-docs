...
slug: /serverless/security/suspicious-process-execution-via-renamed-psexec-executable
title: Suspicious Process Execution via Renamed PsExec Executable
description: Description to be written
tags: []
---

<div id="suspicious-process-execution-via-renamed-psexec-executable"></div>
