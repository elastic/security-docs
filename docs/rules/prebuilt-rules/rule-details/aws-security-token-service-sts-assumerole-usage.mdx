---
id: serverlessSecurityAwsSecurityTokenServiceStsAssumeroleUsage
slug: /serverless/security/aws-security-token-service-sts-assumerole-usage
title: AWS Security Token Service (STS) AssumeRole Usage
description: Description to be written
tags: []
---

<div id="aws-security-token-service-sts-assumerole-usage"></div>
