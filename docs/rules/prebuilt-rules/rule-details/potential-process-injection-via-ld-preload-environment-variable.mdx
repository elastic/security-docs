---
id: serverlessSecurityPotentialProcessInjectionViaLdPreloadEnvironmentVariable
slug: /serverless/security/potential-process-injection-via-ld-preload-environment-variable
title: Potential Process Injection via LD_PRELOAD Environment Variable
description: Description to be written
tags: []
---

<div id="potential-process-injection-via-ld-preload-environment-variable"></div>
