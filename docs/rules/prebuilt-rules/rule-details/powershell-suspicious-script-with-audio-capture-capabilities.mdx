...
slug: /serverless/security/powershell-suspicious-script-with-audio-capture-capabilities
title: PowerShell Suspicious Script with Audio Capture Capabilities
description: Description to be written
tags: []
---

<div id="powershell-suspicious-script-with-audio-capture-capabilities"></div>
