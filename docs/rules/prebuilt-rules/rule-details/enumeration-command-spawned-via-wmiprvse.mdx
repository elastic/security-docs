---
id: serverlessSecurityEnumerationCommandSpawnedViaWmiprvse
slug: /serverless/security/enumeration-command-spawned-via-wmiprvse
title: Enumeration Command Spawned via WMIPrvSE
description: Description to be written
tags: []
---

<div id="enumeration-command-spawned-via-wmiprvse"></div>
