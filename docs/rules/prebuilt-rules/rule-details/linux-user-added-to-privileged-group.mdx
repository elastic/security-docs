---
id: serverlessSecurityLinuxUserAddedToPrivilegedGroup
slug: /serverless/security/linux-user-added-to-privileged-group
title: Linux User Added to Privileged Group
description: Description to be written
tags: []
---

<div id="linux-user-added-to-privileged-group"></div>
