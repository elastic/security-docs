---
id: serverlessSecurityMacosInstallerPackageSpawnsNetworkEvent
slug: /serverless/security/macos-installer-package-spawns-network-event
title: MacOS Installer Package Spawns Network Event
description: Description to be written
tags: []
---

<div id="macos-installer-package-spawns-network-event"></div>
