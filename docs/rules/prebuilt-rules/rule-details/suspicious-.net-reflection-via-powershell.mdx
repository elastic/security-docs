---
id: enSecuritySuspicious.netReflectionViaPowershell
...
**Version**: 102 (<DocLink id="enSecuritySuspicious.netReflectionViaPowershell" section="rule-version-history">version history</DocLink>)
