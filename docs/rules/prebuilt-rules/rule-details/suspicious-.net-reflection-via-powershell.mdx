---
id: serverlessSecuritySuspicious.netReflectionViaPowershell
slug: /serverless/security/suspicious-.net-reflection-via-powershell
title: Suspicious .NET Reflection via PowerShell
description: Description to be written
tags: []
---

<div id="suspicious-.net-reflection-via-powershell"></div>
...
**Version**: 102 (<DocLink id="serverlessSecuritySuspicious.netReflectionViaPowershell" section="rule-version-history">version history</DocLink>)
...
<div id="suspicious-.net-reflection-via-powershell-history"></div>
