---
id: enSecurityOktaUserSessionImpersonation
slug: /en/security/okta-user-session-impersonation
title: Okta User Session Impersonation
description: Description to be written
tags: []
---

<div id="okta-user-session-impersonation"></div>
