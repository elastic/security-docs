---
id: serverlessSecurityExchangeMailboxExportViaPowershell
slug: /serverless/security/exchange-mailbox-export-via-powershell
title: Exchange Mailbox Export via PowerShell
description: Description to be written
tags: []
---

<div id="exchange-mailbox-export-via-powershell"></div>
