---
id: serverlessSecurityExecutionViaElectronChildProcessNode.jsModule
slug: /serverless/security/execution-via-electron-child-process-node.js-module
title: Execution via Electron Child Process Node.js Module
description: Description to be written
tags: []
---

<div id="execution-via-electron-child-process-node.js-module"></div>
...
**Version**: 100 (<DocLink id="serverlessSecurityExecutionViaElectronChildProcessNode.jsModule" section="rule-version-history">version history</DocLink>)
...
<div id="execution-via-electron-child-process-node.js-module-history"></div>
