---
id: serverlessSecurityDisableWindowsEventAndSecurityLogsUsingBuiltInTools
slug: /serverless/security/disable-windows-event-and-security-logs-using-built-in-tools
title: Disable Windows Event and Security Logs Using Built-in Tools
description: Description to be written
tags: []
---

<div id="disable-windows-event-and-security-logs-using-built-in-tools"></div>
