---
id: serverlessSecurityAttemptToDeleteAnOktaPolicy
slug: /serverless/security/attempt-to-delete-an-okta-policy
title: Attempt to Delete an Okta Policy
description: Description to be written
tags: []
---

<div id="attempt-to-delete-an-okta-policy"></div>
