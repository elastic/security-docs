---
id: serverlessSecurityUnusualCityForAnAwsCommand
slug: /serverless/security/unusual-city-for-an-aws-command
title: Unusual City For an AWS Command
description: Description to be written
tags: []
---

<div id="unusual-city-for-an-aws-command"></div>
