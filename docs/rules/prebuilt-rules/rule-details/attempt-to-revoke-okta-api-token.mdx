---
id: serverlessSecurityAttemptToRevokeOktaApiToken
slug: /serverless/security/attempt-to-revoke-okta-api-token
title: Attempt to Revoke Okta API Token
description: Description to be written
tags: []
---

<div id="attempt-to-revoke-okta-api-token"></div>
