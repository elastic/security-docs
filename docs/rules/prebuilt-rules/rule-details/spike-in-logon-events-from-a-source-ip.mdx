---
id: serverlessSecuritySpikeInLogonEventsFromASourceIp
slug: /serverless/security/spike-in-logon-events-from-a-source-ip
...
**Version**: 100 (<DocLink id="serverlessSecuritySpikeInLogonEventsFromASourceIp" section="rule-version-history">version history</DocLink>)
