---
id: serverlessSecurityAwsManagementConsoleRootLogin
slug: /serverless/security/aws-management-console-root-login
title: AWS Management Console Root Login
description: Description to be written
tags: []
---

<div id="aws-management-console-root-login"></div>
