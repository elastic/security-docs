---
id: serverlessSecurityAwsIamAssumeRolePolicyUpdate
slug: /serverless/security/aws-iam-assume-role-policy-update
title: AWS IAM Assume Role Policy Update
description: Description to be written
tags: []
---

<div id="aws-iam-assume-role-policy-update"></div>
