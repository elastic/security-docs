---
id: serverlessSecuritySuspiciousNetworkActivityToTheInternetByPreviouslyUnknownExecutable
slug: /serverless/security/suspicious-network-activity-to-the-internet-by-previously-unknown-executable
title: Suspicious Network Activity to the Internet by Previously Unknown Executable
description: Description to be written
tags: []
---

<div id="suspicious-network-activity-to-the-internet-by-previously-unknown-executable"></div>
...
**Searches indices from**: now-59m ([Date Math format](((ref))/common-options.html#date-math), see also <DocLink id="serverlessSecurityRulesUiCreate" section="set-the-rules-schedule">`Additional look-back time`</DocLink>)
