---
id: serverlessSecurityGoogleWorkspaceDriveEncryptionKeySAccessedFromAnonymousUser
slug: /serverless/security/google-workspace-drive-encryption-key-s-accessed-from-anonymous-user
