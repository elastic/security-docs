---
id: serverlessSecurityAccountDiscoveryCommandViaSystemAccount
slug: /serverless/security/account-discovery-command-via-system-account
title: Account Discovery Command via SYSTEM Account
description: Description to be written
tags: []
---

<div id="account-discovery-command-via-system-account"></div>
