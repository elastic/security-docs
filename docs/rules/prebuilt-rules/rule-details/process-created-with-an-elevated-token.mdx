---
id: serverlessSecurityProcessCreatedWithAnElevatedToken
slug: /serverless/security/process-created-with-an-elevated-token
title: Process Created with an Elevated Token
description: Description to be written
tags: []
---

<div id="process-created-with-an-elevated-token"></div>
