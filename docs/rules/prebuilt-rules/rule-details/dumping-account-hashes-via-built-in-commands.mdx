---
id: serverlessSecurityDumpingAccountHashesViaBuiltInCommands
slug: /serverless/security/dumping-account-hashes-via-built-in-commands
title: Dumping Account Hashes via Built-In Commands
description: Description to be written
tags: []
---

<div id="dumping-account-hashes-via-built-in-commands"></div>
