...
slug: /serverless/security/sensitive-privilege-seenabledelegationprivilege-assigned-to-a-user
title: Sensitive Privilege SeEnableDelegationPrivilege assigned to a User
description: Description to be written
tags: []
---

<div id="sensitive-privilege-seenabledelegationprivilege-assigned-to-a-user"></div>
