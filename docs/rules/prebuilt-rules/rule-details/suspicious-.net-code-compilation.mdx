---
id: serverlessSecuritySuspicious.netCodeCompilation
slug: /serverless/security/suspicious-.net-code-compilation
...
**Version**: 102 (<DocLink id="serverlessSecuritySuspicious.netCodeCompilation" section="rule-version-history">version history</DocLink>)
...
<div id="suspicious-.net-code-compilation-history"></div>
