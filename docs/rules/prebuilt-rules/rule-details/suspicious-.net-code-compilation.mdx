---
id: enSecuritySuspicious.netCodeCompilation
...
**Version**: 102 (<DocLink id="enSecuritySuspicious.netCodeCompilation" section="rule-version-history">version history</DocLink>)
