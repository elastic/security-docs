---
id: serverlessSecurityVolumeShadowCopyDeletionViaWmic
slug: /serverless/security/volume-shadow-copy-deletion-via-wmic
title: Volume Shadow Copy Deletion via WMIC
description: Description to be written
tags: []
---

<div id="volume-shadow-copy-deletion-via-wmic"></div>
