---
id: enSecurityThreatDetectedByOktaThreatinsight
...
**Version**: 102 (<DocLink id="enSecurityThreatDetectedByOktaThreatinsight" section="rule-version-history">version history</DocLink>)
