...
slug: /serverless/security/potential-shadow-file-read-via-command-line-utilities
title: Potential Shadow File Read via Command Line Utilities
description: Description to be written
tags: []
---

<div id="potential-shadow-file-read-via-command-line-utilities"></div>
