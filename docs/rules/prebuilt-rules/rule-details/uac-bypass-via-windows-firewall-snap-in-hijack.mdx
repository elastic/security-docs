---
id: serverlessSecurityUacBypassViaWindowsFirewallSnapInHijack
slug: /serverless/security/uac-bypass-via-windows-firewall-snap-in-hijack
title: UAC Bypass via Windows Firewall Snap-In Hijack
description: Description to be written
tags: []
---

<div id="uac-bypass-via-windows-firewall-snap-in-hijack"></div>
