---
id: serverlessSecurityRemoteFileDownloadViaScriptInterpreter
slug: /serverless/security/remote-file-download-via-script-interpreter
title: Remote File Download via Script Interpreter
description: Description to be written
tags: []
---

<div id="remote-file-download-via-script-interpreter"></div>
