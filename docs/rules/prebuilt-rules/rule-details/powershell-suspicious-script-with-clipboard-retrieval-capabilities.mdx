...
slug: /serverless/security/powershell-suspicious-script-with-clipboard-retrieval-capabilities
title: PowerShell Suspicious Script with Clipboard Retrieval Capabilities
description: Description to be written
tags: []
---

<div id="powershell-suspicious-script-with-clipboard-retrieval-capabilities"></div>
