---
id: serverlessSecurityThreatIntelFilebeatModuleV8.xIndicatorMatch
slug: /serverless/security/threat-intel-filebeat-module-v8.x-indicator-match
title: Threat Intel Filebeat Module (v8.x) Indicator Match
description: Description to be written
tags: []
---

<div id="threat-intel-filebeat-module-v8.x-indicator-match"></div>
...
**Version**: 102 (<DocLink id="serverlessSecurityThreatIntelFilebeatModuleV8.xIndicatorMatch" section="rule-version-history">version history</DocLink>)
...
<div id="threat-intel-filebeat-module-v8.x-indicator-match-history"></div>
