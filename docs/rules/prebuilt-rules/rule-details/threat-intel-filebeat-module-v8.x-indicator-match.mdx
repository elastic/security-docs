---
id: enSecurityThreatIntelFilebeatModuleV8.xIndicatorMatch
...
**Version**: 102 (<DocLink id="enSecurityThreatIntelFilebeatModuleV8.xIndicatorMatch" section="rule-version-history">version history</DocLink>)
