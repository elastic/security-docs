---
id: serverlessSecurityAttemptToDeactivateAnOktaPolicyRule
slug: /serverless/security/attempt-to-deactivate-an-okta-policy-rule
title: Attempt to Deactivate an Okta Policy Rule
description: Description to be written
tags: []
---

<div id="attempt-to-deactivate-an-okta-policy-rule"></div>
