---
id: serverlessSecurityPersistenceViaBitsJobNotifyCmdline
slug: /serverless/security/persistence-via-bits-job-notify-cmdline
title: Persistence via BITS Job Notify Cmdline
description: Description to be written
tags: []
---

<div id="persistence-via-bits-job-notify-cmdline"></div>
