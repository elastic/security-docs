---
id: serverlessSecurityProcessExecutionFromAnUnusualDirectory
slug: /serverless/security/process-execution-from-an-unusual-directory
title: Process Execution from an Unusual Directory
description: Description to be written
tags: []
---

<div id="process-execution-from-an-unusual-directory"></div>
