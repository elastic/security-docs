...
slug: /serverless/security/security-software-discovery-using-wmic
title: Security Software Discovery using WMIC
description: Description to be written
tags: []
---

<div id="security-software-discovery-using-wmic"></div>
