---
id: enSecuritySuspiciousImageLoadTaskschd.dllFromMsOffice
...
**Version**: 100 (<DocLink id="enSecuritySuspiciousImageLoadTaskschd.dllFromMsOffice" section="rule-version-history">version history</DocLink>)
