---
id: serverlessSecuritySuspiciousImageLoadTaskschd.dllFromMsOffice
slug: /serverless/security/suspicious-image-load-taskschd.dll-from-ms-office
title: Suspicious Image Load (taskschd.dll) from MS Office
description: Description to be written
tags: []
---

<div id="suspicious-image-load-taskschd.dll-from-ms-office"></div>
...
**Version**: 100 (<DocLink id="serverlessSecuritySuspiciousImageLoadTaskschd.dllFromMsOffice" section="rule-version-history">version history</DocLink>)
...
<div id="suspicious-image-load-taskschd.dll-from-ms-office-history"></div>
