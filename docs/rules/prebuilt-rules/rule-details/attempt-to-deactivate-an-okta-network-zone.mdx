---
id: serverlessSecurityAttemptToDeactivateAnOktaNetworkZone
slug: /serverless/security/attempt-to-deactivate-an-okta-network-zone
title: Attempt to Deactivate an Okta Network Zone
description: Description to be written
tags: []
---

<div id="attempt-to-deactivate-an-okta-network-zone"></div>
