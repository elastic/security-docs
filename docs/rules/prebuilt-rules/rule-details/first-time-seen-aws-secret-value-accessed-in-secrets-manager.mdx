---
id: serverlessSecurityFirstTimeSeenAwsSecretValueAccessedInSecretsManager
slug: /serverless/security/first-time-seen-aws-secret-value-accessed-in-secrets-manager
title: First Time Seen AWS Secret Value Accessed in Secrets Manager
description: Description to be written
tags: []
---

<div id="first-time-seen-aws-secret-value-accessed-in-secrets-manager"></div>
