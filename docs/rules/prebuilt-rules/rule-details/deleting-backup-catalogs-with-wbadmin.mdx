...
slug: /serverless/security/deleting-backup-catalogs-with-wbadmin
title: Deleting Backup Catalogs with Wbadmin
description: Description to be written
tags: []
---

<div id="deleting-backup-catalogs-with-wbadmin"></div>
