...
1. Go to **Rules** -> **Detection rules (SIEM)**, then select the **Rule Updates** tab.
    ...
    <DocCallOut title="Tip">
    To examine the details of a rule's latest version before you update it, select the rule name. This opens the rule details flyout.
    </DocCallOut>
...
<DocCallOut title="Tip">
You can hide the **integrations** badge in the rules tables. Go to **Project settings** -> **Stack Management** -> **Advanced Settings**, then turn off `securitySolution:showRelatedIntegrations`.
</DocCallOut>
