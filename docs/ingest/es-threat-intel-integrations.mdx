---
id: serverlessSecurityEsThreatIntelIntegrations
...
You can connect to threat intelligence sources using an <DocLink id="serverlessSecurityEsThreatIntelIntegrations" section="add-an-((agent))-integration">((agent)) integration</DocLink>, the <DocLink id="serverlessSecurityEsThreatIntelIntegrations" section="add-a-((filebeat))-threat-intel-module-integration">Threat Intel module</DocLink>, or a <DocLink id="serverlessSecurityEsThreatIntelIntegrations" section="add-a-custom-integration">custom integration</DocLink>.
