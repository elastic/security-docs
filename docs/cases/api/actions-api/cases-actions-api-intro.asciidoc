...
|`incidentTypes` |String |IBM Resilient incident types. |No. Valid only for IBM Resilient connectors.
...
|`name` |String |IBM Resilient organization incident name. |Yes. Valid only for IBM Resilient connectors.
...
|`severityCode` |String |IBM Resilient incident severity code. |No. Valid only for IBM Resilient connectors.
