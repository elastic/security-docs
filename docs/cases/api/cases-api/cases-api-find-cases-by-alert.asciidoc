...
Uses an alert ID (`alert_id`) to retrieve the case IDs of cases the alert is attached to.
...
Returns case IDs with the alert `293f1bc0-74f6-11ea-b83a-553aecdb28b6` attached to them:
...
A JSON array containing retrieved case IDs and titles.
