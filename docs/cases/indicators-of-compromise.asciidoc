...
* You must have the `Blocklist` <<endpoint-management-req,feature privilege>> to access this feature.
--
...
. In the **Conditions** section, verify that indicator details are correct.
