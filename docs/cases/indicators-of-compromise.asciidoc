...
* *Indicator name*: The name of the indicator. Clicking on the linked name opens the Indicator details flyout, which contains additional indicator metadata in JSON format.
