...
Add indicators to blocklists to prevent selected applications from running on your hosts. You can add indicators of the `file` indicator type and that have hash values for the MD5, SHA-1, or SHA-256 fields.
