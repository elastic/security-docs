...
After you add indicators to the Indicators page, you can <<examine-indicator-details, examine>>, search, filter, and take action on indicator data. Indicators also appear in the Trend view, which shows the total accumulative values in the legend.
...
Attaching indicators to cases provides more context and actionability to your investigations. In doing this, you can easily share or escalate threat intelligence to other teams or workflows.
