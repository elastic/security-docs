...
. Enter your required settings. For connector configuration details, refer to {kibana-ref}/servicenow-action-type.html[{sn-itsm} connector], {kibana-ref}/servicenow-sir-action-type.html[{sn-sir} connector], {kibana-ref}/jira-action-type.html[{jira} connector], {kibana-ref}/resilient-action-type.html[{ibm-r} connector], {kibana-ref}/swimlane-action-type.html[{swimlane} connector], or
