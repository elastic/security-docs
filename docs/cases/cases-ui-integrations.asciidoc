...
| *Use OAuth authentication* | ({sn} only) Turn on the toggle to authenticate a connection between Elastic and {sn}. Refer to the {sn} {kibana-ref}/action-types.html[Connector] topics for more information.
