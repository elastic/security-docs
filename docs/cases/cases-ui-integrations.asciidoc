...
+
IMPORTANT: Before creating a new {sn} ITSM or SecOps connector, you must install the Elastic application on your ServiceNow instance and complete additional configuration steps. If you do not do this, an error message displays and you cannot save the new connector. Refer to ServiceNow SecOps and ServiceNow ITSM for more information. 
