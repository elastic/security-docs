...
To add a Lens visualization to your case within a comment:

. Click the *Visualization* button. The Add Visualization modal appears.  
. Select an existing visualization from your Visualize Library or create a new visualization.
. To save the visualization to your Visualize Library, click the *Save to library* button (optional).
...
. Click *Preview* to check how the visualization appears in the case comment.
. Click *Add Comment* to add the visualization to your case.  

NOTE: Once a visualization has been added to a case, it cannot be modified or deleted. However, you can further interact with the visualization by clicking the *Open Visualization* option in the comment menu.
  
[role="screenshot"]
