...
* Review a <<cases-summary, summary>> of the case
* Add a new comment
...
* **Case created**: Shows the date and time the case was created.
* **Open duration**: Shows how much time has passed since the case was created.
* **In progress duration**: Shows how long the case has been in the In progress status.
