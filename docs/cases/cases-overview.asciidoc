...
* Get a <<cases-summary, summary>> of the case
* Add a new comment
...
[float]
[[cases-summary]]
== Understand the case summary

You can find metrics about the case, that summarize alert information and response times, at the top of every case:
