...
NOTE: To update cases, you role requires certain Kibana space privileges.  Specifically, your role needs *All* sub-feature privileges for the *Case* feature and *All* privileges for the *Action and Connectors* feature. See <<case-permissions>> for more information.
