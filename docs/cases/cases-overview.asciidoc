...
Click on an existing case to open it and to access the case summary. The case summary, located under the case title, consists of metrics that summarize alert information and response times. The metrics update when you attach additional unique alerts to the case, add more connectors, or modify the case's status:
