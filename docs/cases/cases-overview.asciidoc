...
Click on an existing case to open it and to access the case summary. The case summary, which is located under the case title, consists of metrics that summarize alert information and response times. The metrics are updated any time you modify the case:
