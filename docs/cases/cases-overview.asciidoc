...
. Go to the *Cases* page and click *Create new case*. When creating a case for the first time, the *Create new case* button will be in the empty Cases table or above it.
+
[role="screenshot"]
