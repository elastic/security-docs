...
To explore the alerts attached to a case, click the *Alerts* tab. In the table, which is in technical preview, alerts are organized by timestamp and in descending order. You can customize the table's view and sort alerts. To view alert details, click the *View details* button.
