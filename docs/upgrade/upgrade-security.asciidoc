...
This section provides the necessary steps you need to take before upgrading to 8.x. It also contains new requirements and other pertinent info that affect various features in the {security-app}.  
