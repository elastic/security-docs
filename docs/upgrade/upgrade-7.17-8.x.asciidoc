...
. We recommend you {api-kibana}/operation/operation-exportrules[export all your custom detection rules] in case there are issues with the detection engine after the upgrade.
