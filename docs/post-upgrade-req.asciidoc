...
NOTE: If you have upgraded from < 7.9.0 to >= 7.11.0, there is now a <<signals-migration, Migration API>> that can be used instead of the manual process described below.
