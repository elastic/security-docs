...
.. Go to the *Shared exception lists* page. Find **Detection rules (SIEM)** in the main menu or look for “Detection rules (SIEM)” using the <<kibana-navigation-search,global search field>>, then go to *Shared exception lists*.
