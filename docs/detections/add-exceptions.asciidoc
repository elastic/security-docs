...
+ 
NOTE: The speed at which the exception is applied to {elastic-endpoint} depends on the size of your deployment. It may take longer for exceptions to be applied to hosts within larger deployments.
