...
Selecting a field with conflicts can cause unusual exception behavior, such as unexpected alerts from the specified indices. To avoid this, ensure you are defining field values correctly when configuring exception conditions. 
