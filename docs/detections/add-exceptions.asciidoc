...
Field with conflicts are marked with a warning icon (image:images/field-warning-icon.png[Field conflict warning icon,15,15]). You can learn more about the conflict by hovering over the field. After you select the field, conflict details are moved beneath the **Field** field.
...
[float]
[[example-type-conflicts-unmapped]]
