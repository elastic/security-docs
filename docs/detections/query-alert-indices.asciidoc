...
Once you update to 8.0.0 or later, you should query the following index alias, which will include both legacy (before 8.0.0) and new alerts:
...
[discrete]
=== For alerts from versions before 8.0.0:
