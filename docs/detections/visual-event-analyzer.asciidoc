...
In the example screenshot below, five alerts were generated against the analyzed event (`lsass.exe`). The left pane displays the associated alerts and basic information about each one.
