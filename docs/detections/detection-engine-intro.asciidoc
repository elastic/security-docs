...
To learn more about how your rules and alerts are affected by using the {ref}/logs-data-stream.html[LogsDB index mode], refer to <<detections-logsdb-index-mode-impact>>. 