...
Learn more about an alert and what generated it by opening the alert's details. Click the *View details* button from the Alerts table to inspect an alert. 
...
The expandable flyout provides you with a central location to assess all possible information about a given alert so you can launch an investigation, open a case, or make a response. 

The right panel of the expandable flyout appears with several options to view alert data. The expandable flyout has three main components: the right panel, the preview panel, and the left panel.
...
Provides an overview of the alert and allows you to view the alert document in the table or JSON format. 
...
Shows an expanded version of the rule summary and alert reason.

[discrete]
[[left-panel]]
=== Left panel 

Contains three main tabs (**Insights**, **Investigation**, and **Response**) and multiple sub-tabs. Each tab displays more information about sections in the right panel. For example, if you wanted to learn more about hosts or users that you're monitoring, you can find more information on them in the *Entities* tab (**Insights** -> **Entities**).
