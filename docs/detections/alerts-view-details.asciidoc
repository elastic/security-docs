...
The About section within the **Overview** tab provides a brief description of the rule that's related to the alert and an explanation of what generated the alert. 
...
The Investigation section within the **Overview** tab offers quick ways to begin investigating the alert. 
...
The Visualizations section within the **Overview** tab offers a glimpse of the processes that led up to the alert and occurred after it. 
...
The Insights section within the **Overview** tab offers different perspectives from which you can assess the alert. 
...
The **Response** section within the **Overview** tab shows <<rules-ui-create,response actions>> that were added to the rule associated with the alert. Click **Response** to display the response action's results in the left panel.
