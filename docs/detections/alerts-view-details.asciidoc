...
* Click the history icon (image:images/history-icon.png[History icon,15,15]) to display a list of previously visited places. The list will show any rules, alerts, events, users, or hosts who's details you viewed. Click their entry to quickly access their details flyout.
