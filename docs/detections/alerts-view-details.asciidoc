...
* *Event renderer*: Surfaces important alert details to provide useful context for understanding the alert. Alert details are assembled into a human-readable format and alert fields are interactive.
+
