...
The alert details flyout has a right panel, a preview panel, and a left panel. 
...
[role="screenshot"]
image::images/expandable-flyout-right-panel.png[Right panel of the alert details flyout, 50%]
...
[role="screenshot"]
image::images/expandable-flyout-preview-panel.png[Preview panel of the alert details flyout, 50%]
...
[role="screenshot"]
image::images/expandable-flyout-left-panel.png[Left panel of the alert details flyout, 80%]
