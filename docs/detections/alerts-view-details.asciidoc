...
* *Response Results*: Results from <<add-osquery-response-action,Osquery queries>> attached to rules and <<rules-add-endpoint-response-action,endpoint response actions>>.
