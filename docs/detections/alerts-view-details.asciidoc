...
Available threat indicator match data is placed under the **Threat Match Detected** subsection of the Enriched data section.

[role="screenshot"]
image::images/matched-indicator-sub-sec.png[Threat Match Detected subsection with matched file hash, 600]

All other available threat intelligence data appears under the **Enriched with Threat Intelligence** subsection.
