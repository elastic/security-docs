...
.. Go to *Detect* -> *Alerts*.
.. Scroll down to the Alerts table, and from an alert for which you want to create an exception, click the *More Actions* button (*...*), then select *Add rule exception*.
