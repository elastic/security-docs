...
From the *Rule exceptions* or *Endpoint exceptions* tab, navigate to an exception list item and click *Affects X rules* to display the rules affected by the exception.
