...
NOTE: To restore the default settings for optional fields, omit the fields from the your request.  
...
exception item. |Yes
|`expire_time` |String |An expiration date in ISO format |No, defaults to undefined.
