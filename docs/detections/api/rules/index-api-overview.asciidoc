...
NOTE: It is highly recommended to update this ILM policy to include an {ref}/ilm-delete.html[{ilm-init} delete action], based on your internal security compliance policy, if you don't want the signal indices to stay forever on your deployment's hot tiers
