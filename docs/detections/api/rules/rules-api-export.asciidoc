...
Exports rules to an `.ndjson` file. These configuration items are included in the `.ndjson` file when you export detection rules:

* Actions
* Exception lists

Please note that you cannot export prebuilt rules, but they are available at https://github.com/elastic/detection-rules/tree/main/rules/.
