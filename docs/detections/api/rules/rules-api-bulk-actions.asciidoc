...
- `attributes.summary.succeeded`: number of successful outcomes (number of rules that were enabled or deleted or updated - depending on the type of action)
- `attributes.summary.failed`: number of failed outcomes
- `attributes.summary.skipped`: number of rules that were skipped due to various reasons (see below)
