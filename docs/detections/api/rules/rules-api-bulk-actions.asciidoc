...
Response payload returns 2 failed rules and 1 successful. In `attributes.errors` section of response, can be found error messages with list of failed rules(id and name).
