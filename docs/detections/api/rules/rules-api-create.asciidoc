...
+
NOTE: The {esql} rule type is available by default. Turn this option off by toggling the {kibana-ref}/advanced-options.html#kibana-general-settings[`enableESQL`] advanced setting off.
