...
===== Optional alert suppression fields for query, indicator match, threshold rule, event correlation, and new terms rules

preview::[]

====== Query rule, indicator match, event correlation, and new terms rule
