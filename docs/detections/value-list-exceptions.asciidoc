...
** **Edit a value**: In the Value column, go to the value you want to edit and click the **Edit** button (image:images/rules-table-error-icon.png[Edit button from Manage value lists window,15,15]). When you're done editing, click the **Save** button (image:images/rules-table-error-icon.png[Save button from Manage value lists window,15,15]) to save your changes. Click the **Cancel** button (image:images/rules-table-error-icon.png[Cancel button from Manage value lists window,15,15]) to revert your changes. 
** **Remove a value**: Click the **Remove value list** button (image:images/rules-table-error-icon.png[Remove value list button from Manage value lists window,15,15]) to delete a value from the list.
...
.. Click the **Export value list** button (image:images/rules-table-error-icon.png[Export button from Manage value lists window,15,15]) to export the value list. 
.. Click the **Remove value list** button (image:images/rules-table-error-icon.png[Remove button from Manage value lists window,15,15]) to delete the value list.
+
[role="screenshot"]
