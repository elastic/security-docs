...
. Go to the *Rules* page. To access it, find **Detection rules (SIEM)** in the main menu or look for “Detection rules (SIEM)” using the <<kibana-navigation-search,global search field>>. 
...
//Revisit the nav instructions in this list item.
+
...
//Revisit the nav instructions in the tip above.
...
//Revisit the nav instructions in the list item above.
