...
** *Custom highlighted fields*: Add custom highlighted fields on all selected rules. To overwrite a rule's current set of custom highlighted fields, select the **Overwrite all selected rules' custom highlighted fields** option, then click **Save**. 
