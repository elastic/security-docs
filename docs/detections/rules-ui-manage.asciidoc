...
+
NOTE: Rule actions that you add during a {ref}/maintenance-windows.html[maintenance window] won't run. They'll resume running after the maintenance window ends.
