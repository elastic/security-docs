...
+
NOTE: The action frequency you select is applied to all actions (both new and existing) on all selected rules. If you don't want to change the frequency of existing actions, update the rules separately.
