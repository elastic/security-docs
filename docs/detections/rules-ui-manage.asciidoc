...
+
TIP: Go to the Actions tab to <<snooze-rules-ui,snooze>> a rule's notifications.  
...
You can duplicate, enable, disable, snooze, and delete rules:
...
* To <<snooze-rules-ui,snooze>> a rule, click the bell icon.
