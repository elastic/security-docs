...
Instead of turning off rules to stop alert notifications, snooze rule actions for a defined period of time. When you snooze rule actions, the rule continues to run on its defined schedule but alerts won't trigger any actions and notifications won't be sent. 

You can snooze notifications for a specified period of time, indefinitely, or schedule single or recurring downtimes. When rule notifications are snoozed, you can cancel or change the duration of the snoozed state.
