...
The rule runs over the time range that you selected. Note that all <<rule-notifications,alert actions>> for the rule are activated, except for custom **Summary of alerts** actions. 
