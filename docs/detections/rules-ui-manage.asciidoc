...
Manually run enabled rules for a specified period of time to force test them, provide additional rule coverage, or fill <<gaps-table,gaps in rule coverage>>.
