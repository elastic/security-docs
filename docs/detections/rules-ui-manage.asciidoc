...
The rules list retains your sorting and filtering settings when you navigate away and return to the page. Select *Clear filters* above the table to revert to the default view.
