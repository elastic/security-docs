...
You can export detection rules to an `.ndjson` file, which you can then import into another {elastic-sec} environment. These items are included when you export and import detection rules configured with them:
