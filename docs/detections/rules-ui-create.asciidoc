...
[sidebar]
--
* To create detection rules, you must have access to data views, which requires the <<kibana-role-management, {kib} privilege>>
`Data View Management`.

* You will also require permissions to enable and view detections, manage rules, manage alerts, and preview rules. These permissions depend on the user role. Refer to <<detections-permissions-section>> for more information.
--
