...
TIP: To improve the visibility of these fields while investigating alerts that the {esql} rule generates, add them to the rule's  <<rule-ui-advanced-params,custom highlighted fields>>. 
