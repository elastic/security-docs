...
The following variables can be passed if the rule’s action frequency is a summary of alerts or per alert: 
...
The following variables can only be passed if the rule’s action frequency is per alert: 
