...
Email, {ibm-r}, {jira}, Microsoft Teams, PagerDuty, Slack, {sn} (ITSM, SecOps, and ITOM), Slack, {swimlane}, and Webhook, and can be configured when you create or edit a rule.
