...
You can use http://mustache.github.io/[mustache syntax] to add the following placeholders to <<rule-notifications, rule action>> fields. Any plural name (ending with the letter `s`) represents an array of values.
