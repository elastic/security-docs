...
** *Summary of alerts*: Select this option if want to reduce the number of notifications you receive without affecting their timeliness. Alert notifications that summarize the new, ongoing, and recovered alerts will be sent at your preferred time intervals. 
+
