...
+
IMPORTANT: When checking multiple fields, results are limited to no more than 100 unique combinations; any additional combinations will not be detected. If you expect your data to produce more than 100 unique new terms combinations, consider checking other fields to narrow down the search.
