...
+
NOTE: The preview excludes the effects of rule exceptions and timestamp overrides. Alerts with multiple `event.category` values are counted more than once.
+
[role="screenshot"]
