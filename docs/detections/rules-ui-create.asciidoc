...
You can preview custom query, threshold, machine learning, event correlation, or indicator match rules to learn how noisy a rule will be before submitting it. If necessary, you can then adjust the rule's query.
