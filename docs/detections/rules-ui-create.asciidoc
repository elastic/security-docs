...
At any step, you can <<preview-rules,preview the rule>> beforehand to see what kind of results you can expect.
...
* Use the time picker to define the preview's time range.
+
