...
+
TIP: Click the **ES|QL reference** button (image:images/esq-ref-button.png[Click the ES|QL reference button,20,20]) to the right of the query bar to open an ES|QL syntax reference guide.
+
