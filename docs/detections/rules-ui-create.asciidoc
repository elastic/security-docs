...
+
IMPORTANT: If your threat indicator data is at a different location, update this setting with the appropriate field prefix to ensure alert enrichment can still be performed.
