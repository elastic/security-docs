...
+
** **Aggregating query**: Uses {ref}/esql-agg-functions.html[STATS...BY] functions to aggregate data. Results from each query row are not saved to an alert document within Elasticsearch. 
+
