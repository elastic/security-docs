...
.. *Custom highlighted fields* (optional): Specify additional fields to display in the [investigation-section,Highlighted fields] section of the alert details flyout.
