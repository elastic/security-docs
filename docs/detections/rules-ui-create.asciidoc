...
[IMPORTANT]
==============
After you activate a rule, you can periodically check if the rule is running as expected
in the <<alerts-ui-monitor, Monitoring tab>> on the Rules page. If you see
...
You can preview any rule to learn how noisy it will be before submitting it. If necessary, you can then adjust the rule's query.
