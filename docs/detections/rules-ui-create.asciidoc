...
NOTE: The {esql} rule type option is available by default. To hide and turn the option off, toggle the {kibana-ref}/advanced-options.html#kibana-general-settings[`enableESQL`] advanced setting off.
