...
* To resize the preview, hover between the rule settings and preview areas, then click and drag the border. You can also click the border, then the collapse icon (image:images/collapse-right-icon.png[Collapse icon,16,17]) to collapse and expand the preview.
