...
- If your query contains non-ECS fields, you won't be able to search or filter for the new fields unless you <<runtime-fields,create runtime fields>> for them. 
- Custom highlighted fields are not supported for newly created fields. 
