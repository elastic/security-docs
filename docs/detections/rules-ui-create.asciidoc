...
.. *Custom highlighted fields* (optional): Add one or more alert fields to the Highlighted field section in the alert details flyout.
//link to about section within the new flyout docs
