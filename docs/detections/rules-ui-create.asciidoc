...
If the rule’s action frequency is a summary of alerts, it passes the variables that summarize alerts. Refer to {kibana-ref}/rule-action-variables.html#alert-summary-action-variables[Action frequency: Summary of alerts] more information about summary of alert variables. 
