...
The Endpoint response action allows you to automatically run response actions on an endpoint when the rule's conditions are met. Refer to <<isolate-a-host>> to learn more.
