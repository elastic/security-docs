...
.. * Indicator prefix override* (optional): Specify the document prefix containing your indicator fields. This field is used to enrich indicator match alerts with threat intelligence.
