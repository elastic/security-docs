...
*Triage and analysis**Investigating AWS CloudWatch Alarm Deletion*Amazon CloudWatch is a monitoring and observability service that collects monitoring and operational data in the form of
...
tracks and evade security defenses.*Possible investigation steps*- Identify the user account that performed the action and whether it should perform this kind of action.
