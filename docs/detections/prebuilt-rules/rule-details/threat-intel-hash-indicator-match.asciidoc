...
This rule needs threat intelligence indicators to work. Threat intelligence indicators can be collected using an {security-guide}/security/current/es-threat-intel-integrations.html#agent-ti-integration[Elastic Agent integration], the {security-guide}/security/current/es-threat-intel-integrations.html#ti-mod-integration[Threat Intel module], or a {security-guide}/security/current/es-threat-intel-integrations.html#custom-ti-integration[custom integration].

More information can be found {security-guide}/security/current/es-threat-intel-integrations.html[here].
----------------------------------
