...
This rule needs threat intelligence indicators to work. Threat intelligence indicators can be collected using an <<agent-ti-integration,Elastic Agent integration>>, the <<ti-mod-integration,Threat Intel module>>, or a <<custom-ti-integration,custom integration>>.

More information can be found in <<es-threat-intel-integrations>>.
----------------------------------
