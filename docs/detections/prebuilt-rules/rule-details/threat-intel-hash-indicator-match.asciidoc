...
This rule needs threat intelligence indicators to work. Threat intelligence indicators can be collected using an [Elastic Agent integration]({security-guide}/es-threat-intel-integrations.html#agent-ti-integration), the [Threat Intel module]({security-guide}/es-threat-intel-integrations.html#ti-mod-integration), or a [custom integration]({security-guide}/es-threat-intel-integrations.html#custom-ti-integration).

More information can be found [here]({security-guide}/es-threat-intel-integrations.html).
----------------------------------
