...
For more information about using MFA in AWS, access the https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_mfa.html.
...
- Follow security best practices https://aws.amazon.com/premiumsupport/knowledge-center/security-best-practices/ by AWS.
