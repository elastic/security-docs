...
*Version*: 4 (<<unusual-process-for-a-linux-host-history, version history>>)
...
Alerts from this rule indicate the presence of a Linux process that is rare and unusual for the host it ran on. Here are some possible avenues of investigation:
