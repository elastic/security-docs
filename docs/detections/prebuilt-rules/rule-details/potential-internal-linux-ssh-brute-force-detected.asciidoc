...
*Triage and analysis**Investigating Potential Internal Linux SSH Brute Force Detected*The rule identifies consecutive internal SSH login failures targeting a user account from the same source IP address to the same target host indicating brute force login attempts.*Possible investigation steps*- Investigate the login failure user name(s).
...
- Infrastructure or availability issue.*Related Rules*- Potential External Linux SSH Brute Force Detected - fa210b61-b627-4e5e-86f4-17e8270656ab
