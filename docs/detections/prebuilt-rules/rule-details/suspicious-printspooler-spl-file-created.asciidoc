...
[source,markdown]
----------------------------------
## Threat intel Refer to CVEs, CVE-2020-1048 and CVE-2020-1337 for
further information on the vulnerability and exploit. Verify that the
relevant system is patched.
----------------------------------
