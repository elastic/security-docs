...
*Triage and analysis**Investigating Setcap setuid/setgid Capability Set*Setuid (Set User ID) and setgid (Set Group ID) are Unix-like OS features that enable processes to run with elevated privileges, based on the file owner or group.
