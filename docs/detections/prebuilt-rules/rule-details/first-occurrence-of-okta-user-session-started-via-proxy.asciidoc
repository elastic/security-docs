...
- Evaluate the actions that happened just before and after this event in the `okta.event_type` field to help understand the full context of the activity.*False positive analysis:*- A user may have legitimately started a session via a proxy for security or privacy reasons.*Response and remediation:*- Review the profile of the user involved in this action to determine if proxy usage may be expected.
