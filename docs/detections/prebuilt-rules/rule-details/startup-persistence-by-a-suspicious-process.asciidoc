...
*Triage and analysis**Investigating Startup Persistence by a Suspicious Process*The Windows Startup folder is a special folder in Windows. Programs added to this folder are executed during account logon, without user interaction, providing an excellent way for attackers to maintain persistence.
