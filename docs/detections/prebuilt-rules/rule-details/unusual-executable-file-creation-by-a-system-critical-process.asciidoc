...
*Triage and analysis**Investigating Unusual Executable File Creation by a System Critical Process*Windows internal/system processes have some characteristics that can be used to spot suspicious activities. One of these characteristics is file operations.
