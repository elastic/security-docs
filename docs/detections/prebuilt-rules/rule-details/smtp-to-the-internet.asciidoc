...
*Version*: 7 (<<smtp-to-the-internet-history, version history>>)
...
and source.ip:( 10.0.0.0/8 or 172.16.0.0/12 or 192.168.0.0/16 ) and
not destination.ip:( 10.0.0.0/8 or 127.0.0.0/8 or 169.254.0.0/16 or
