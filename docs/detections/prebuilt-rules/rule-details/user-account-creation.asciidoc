...
*Triage and analysis**Investigating User Account Creation*Attackers may create new accounts (both local and domain) to maintain access to victim systems.
...
- Windows User Account Creation - 38e17753-f581-4644-84da-0d60a8318694*Response and remediation*- Initiate the incident response process based on the outcome of the triage.
