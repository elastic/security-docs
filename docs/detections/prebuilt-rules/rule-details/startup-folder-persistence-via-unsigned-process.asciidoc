...
*Version*: 102 (<<startup-folder-persistence-via-unsigned-process-history, version history>>)
...
where event.type == "start" and process.code_signature.trusted ==
false and /* suspicious paths can be added here */
