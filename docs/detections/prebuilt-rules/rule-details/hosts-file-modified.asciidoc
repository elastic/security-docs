...
[source,markdown]
----------------------------------
## Config For Windows systems using Auditbeat, this rule requires
adding 'C:/Windows/System32/drivers/etc' as an additional path in the
'file_integrity' module of auditbeat.yml.
----------------------------------
