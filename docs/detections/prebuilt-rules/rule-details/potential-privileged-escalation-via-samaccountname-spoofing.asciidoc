...
*Version*: 100 (<<potential-privileged-escalation-via-samaccountname-spoofing-history, version history>>)
...
[[potential-privileged-escalation-via-samaccountname-spoofing-history]]
