...
*Version*: 101 (<<process-activity-via-compiled-html-file-history, version history>>)
...
"hh.exe" and process.name : ("mshta.exe", "cmd.exe",
"powershell.exe", "pwsh.exe", "powershell_ise.exe", "cscript.exe",
"wscript.exe")
----------------------------------
