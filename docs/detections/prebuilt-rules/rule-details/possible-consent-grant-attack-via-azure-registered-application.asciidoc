...
- Export and examine the https://docs.microsoft.com/en-us/defender-cloud-apps/manage-app-permissionsoauth-app-auditing[Oauth app auditing] to identify users affected.
...
- https://docs.microsoft.com/en-us/defender-cloud-apps/manage-app-permissionssend-feedback[Report] the application as malicious to Microsoft.
