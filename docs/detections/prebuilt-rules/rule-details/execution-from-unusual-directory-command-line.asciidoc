...
*Triage and analysis**Investigating Execution from Unusual Directory - Command Line*This rule looks for the execution of scripts from unusual directories. Attackers can use system or application paths to hide malware and make the execution less suspicious.
