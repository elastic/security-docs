...
*Triage and analysis**Investigating Suspicious Process Spawned from MOTD Detected*The message-of-the-day (MOTD) is used to display a customizable system-wide message or information to users upon login in Linux.
