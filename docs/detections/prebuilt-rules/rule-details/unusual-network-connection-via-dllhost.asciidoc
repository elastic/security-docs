...
*Version*: 101 (<<unusual-network-connection-via-dllhost-history, version history>>)
...
where event.type == "start" and process.name : "dllhost.exe" and
process.args_count == 1] [network where process.name : "dllhost.exe"
...
[[unusual-network-connection-via-dllhost-history]]
...
"203.0.113.0/24", "240.0.0.0/4", "::1", "FE80::/10", "FF00::/8")]
----------------------------------
