...
*Version*: 101 (<<high-number-of-process-terminations-history, version history>>)
...
[source,js]
----------------------------------
event.category:process and event.type:start and process.name:"pkill"
and process.args:"-f"
----------------------------------
...
[[high-number-of-process-terminations-history]]
