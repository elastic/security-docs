...
*Version*: 102 (<<uac-bypass-via-windows-firewall-snap-in-hijack-history, version history>>)
...
"mmc.exe" and /* process.Ext.token.integrity_level_name == "high" can
be added in future for tuning */ /* args of the Windows Firewall
SnapIn */ process.parent.args == "WF.msc" and process.name !=
"WerFault.exe"
----------------------------------
