...
[source,markdown]
----------------------------------
## Config This rule requires the addition of port `9200` and
`send_all_headers` to the `HTTP` protocol configuration in
`packetbeat.yml`. See the References section for additional
