...
*Version*: 102 (<<remote-file-download-via-desktopimgdownldr-utility-history, version history>>)
...
"desktopimgdownldr.exe" or process.pe.original_file_name ==
"desktopimgdownldr.exe") and process.args : "/lockscreenurl:http*"
----------------------------------
