...
For more information about using MFA in Azure AD, access the https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-mfa-howitworkshow-to-enable-and-use-azure-ad-multi-factor-authentication[official documentation]
