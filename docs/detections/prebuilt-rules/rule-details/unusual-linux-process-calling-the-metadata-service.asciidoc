...
*Machine learning job*: linux_rare_metadata_process, v2_linux_rare_metadata_process
...
*Version*: 3 (<<unusual-linux-process-calling-the-metadata-service-history, version history>>)
