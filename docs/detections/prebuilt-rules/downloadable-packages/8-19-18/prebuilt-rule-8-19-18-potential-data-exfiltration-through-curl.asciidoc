[[prebuilt-rule-8-19-18-potential-data-exfiltration-through-curl]]
...
[source, js]
----------------------------------
process where host.os.type == "linux" and event.type == "start" and event.action in ("exec", "ProcessRollup2", "start") and
