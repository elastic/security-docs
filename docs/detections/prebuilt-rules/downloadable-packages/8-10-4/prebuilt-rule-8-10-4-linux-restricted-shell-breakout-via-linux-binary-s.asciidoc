[[prebuilt-rule-8-10-4-linux-restricted-shell-breakout-via-linux-binary-s]]
...
the usage of Session View for Analysis refer to the {security-guide}/security/current/session-view.html[helper guide].
----------------------------------
