[[prebuilt-rule-8-10-10-remote-file-download-via-desktopimgdownldr-utility]]
...
> This investigation guide uses the {security-guide}/security/master/interactive-investigation-guides.html[Investigate Markdown Plugin] introduced in Elastic Stack version 8.8.0. Older Elastic Stack versions will display unrendered Markdown in this guide.
