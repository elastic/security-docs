[[prebuilt-rule-8-19-20-aws-iam-saml-provider-created]]
...
- **https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_saml.html[AWS IAM SAML Providers Documentation]**
