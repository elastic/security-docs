[[prebuilt-rule-8-19-20-genai-process-performing-encoding-chunking-prior-to-network-activity]]
...
** ID: T1560.002
** Reference URL: https://attack.mitre.org/techniques/T1560/002/
* Tactic:
** Name: Exfiltration
** ID: TA0010
...
** ID: T1030
** Reference URL: https://attack.mitre.org/techniques/T1030/
