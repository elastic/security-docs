[[prebuilt-rule-8-19-13-deprecated-potential-successful-linux-ftp-brute-force-attack-detected]]
...
*Investigating Deprecated - Potential Successful Linux FTP Brute Force Attack Detected*
