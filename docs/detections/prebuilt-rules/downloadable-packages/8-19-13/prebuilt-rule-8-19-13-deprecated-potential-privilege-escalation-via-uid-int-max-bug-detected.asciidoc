[[prebuilt-rule-8-19-13-deprecated-potential-privilege-escalation-via-uid-int-max-bug-detected]]
...
*Investigating Deprecated - Potential Privilege Escalation via UID INT_MAX Bug Detected*
