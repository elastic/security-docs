[[prebuilt-rule-8-19-13-deprecated-potential-successful-linux-rdp-brute-force-attack-detected]]
...
*Investigating Deprecated - Potential Successful Linux RDP Brute Force Attack Detected*
