[[prebuilt-rule-8-19-13-machine-learning-detected-a-suspicious-windows-event-with-a-low-malicious-probability-score]]
...
not process.executable : ("C:\\Program Files\\*.exe", "C:\\Program Files (x86)\\*.exe")
