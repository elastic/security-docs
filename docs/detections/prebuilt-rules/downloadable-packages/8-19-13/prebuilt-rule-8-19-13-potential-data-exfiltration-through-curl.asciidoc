[[prebuilt-rule-8-19-13-potential-data-exfiltration-through-curl]]
...
?process.parent.executable != null and (process.args in ("-F", "-T", "-d") or process.args like ("--data*", "--form*")) and 
