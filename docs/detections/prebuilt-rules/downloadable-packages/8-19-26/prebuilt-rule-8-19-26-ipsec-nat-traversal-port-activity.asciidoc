[[prebuilt-rule-8-19-26-ipsec-nat-traversal-port-activity]]
...
[source, js]
----------------------------------
(data_stream.dataset: network_traffic.flow or (event.category: (network or network_traffic))) and network.transport:udp and destination.port:4500
