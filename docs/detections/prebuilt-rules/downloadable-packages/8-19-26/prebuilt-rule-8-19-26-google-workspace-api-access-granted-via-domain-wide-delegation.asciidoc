[[prebuilt-rule-8-19-26-google-workspace-api-access-granted-via-domain-wide-delegation]]
...
- Review DWD configuration in the Google Admin console:
  - Sign in to https://admin.google.com[admin.google.com] with an authorized administrator account.
