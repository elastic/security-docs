[[prebuilt-rule-8-19-33-network-activity-to-a-suspicious-top-level-domain]]
...
not process.executable : (
    ...
    "?:\\ProgramData\\Microsoft\\Windows Defender Advanced Threat Protection\\Platform\\Versions\\*\\*.exe",
    "\\Device\\HarddiskVolume*\\ProgramData\\Microsoft\\Windows Defender Advanced Threat Protection\\Platform\\Versions\\*\\*.exe"
)
