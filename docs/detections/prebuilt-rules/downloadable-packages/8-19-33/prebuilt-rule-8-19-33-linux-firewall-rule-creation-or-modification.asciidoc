[[prebuilt-rule-8-19-33-linux-firewall-rule-creation-or-modification]]
...
- https://www.elastic.co/docs/reference/integrations/auditd_manager[Auditd Manager]
- https://www.elastic.co/guide/en/beats/auditbeat/current/auditbeat-installation-configuration.html[Auditbeat]
