[[prebuilt-rule-8-19-33-unusual-network-connection-to-suspicious-web-service]]
...
not (process.code_signature.subject_name:(*Mozilla* or *Google* or *Brave* or *Opera* or "Software Signing" or "macOS Software Signing" or *Zscaler* or *Browser*) and process.code_signature.trusted:true)  and 
...
** ID: T1567.004
** Reference URL: https://attack.mitre.org/techniques/T1567/004/
