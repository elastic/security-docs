[[prebuilt-rule-8-18-11-aws-iam-administratoraccess-policy-attached-to-role]]
...
this policy to a compromised role for privilege escalation or as a means of persistence. This rule uses https://www.elastic.co/guide/en/security/current/rules-ui-create.html#create-esql-rule[ESQL]
