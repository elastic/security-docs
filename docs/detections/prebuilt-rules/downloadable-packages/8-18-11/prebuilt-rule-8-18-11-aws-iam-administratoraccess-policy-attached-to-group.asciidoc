[[prebuilt-rule-8-18-11-aws-iam-administratoraccess-policy-attached-to-group]]
...
this policy to the current user's groups for privilege escalation or as a means of persistence. This rule uses https://www.elastic.co/guide/en/security/current/rules-ui-create.html#create-esql-rule[ESQL]
