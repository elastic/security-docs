[[prebuilt-rule-8-19-32-smtp-to-the-internet-on-port-26-tcp]]
...
[source, js]
----------------------------------
(data_stream.dataset: (fortinet_fortigate.log or network_traffic.flow or zeek.smtp) or event.category:(network or network_traffic)) and
