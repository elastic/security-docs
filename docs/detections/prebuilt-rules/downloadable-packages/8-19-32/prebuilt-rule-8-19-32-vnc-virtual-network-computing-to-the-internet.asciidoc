[[prebuilt-rule-8-19-32-vnc-virtual-network-computing-to-the-internet]]
...
[source, js]
----------------------------------
(data_stream.dataset:(fortinet_fortigate.log or network_traffic.flow) or event.category:(network or network_traffic)) and
...
** Name: VNC
** ID: T1021.005
** Reference URL: https://attack.mitre.org/techniques/T1021/005/
