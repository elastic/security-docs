[[prebuilt-rule-8-19-32-elastic-defend-alert-followed-by-telemetry-loss]]
...
*Searches indices from*: now-14m ({ref}/common-options.html#date-math[Date Math format], see also <<rule-schedule, `Additional look-back time`>>)
