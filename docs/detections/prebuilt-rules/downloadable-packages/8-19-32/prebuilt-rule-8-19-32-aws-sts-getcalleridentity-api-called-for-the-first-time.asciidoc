[[prebuilt-rule-8-19-32-aws-sts-getcalleridentity-api-called-for-the-first-time]]
...
data_stream.dataset: "aws.cloudtrail"
    ...
    and not user_agent.original: (*Terraform* or *terraform* or *Pulumi* or *eksctl*)
