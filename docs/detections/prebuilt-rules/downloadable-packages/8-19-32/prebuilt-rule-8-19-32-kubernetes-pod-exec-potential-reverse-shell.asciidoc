[[prebuilt-rule-8-19-32-kubernetes-pod-exec-potential-reverse-shell]]
...
matches high-signal shell and socket idioms often used to obtain a fallback shell from inside a container.
