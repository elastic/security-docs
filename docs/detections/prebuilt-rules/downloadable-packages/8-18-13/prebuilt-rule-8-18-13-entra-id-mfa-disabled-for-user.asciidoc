[[prebuilt-rule-8-18-13-entra-id-mfa-disabled-for-user]]
...
For more information about using MFA in Microsoft Entra ID, access the https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-mfa-howitworks#how-to-enable-and-use-azure-ad-multi-factor-authentication[official documentation].
