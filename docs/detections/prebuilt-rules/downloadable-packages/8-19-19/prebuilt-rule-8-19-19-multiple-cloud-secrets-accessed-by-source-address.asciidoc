[[prebuilt-rule-8-19-19-multiple-cloud-secrets-accessed-by-source-address]]
...
- GCP Audit: https://docs.cloud.google.com/logging/docs/audit/configure-data-access[Enable DATA_READ for the Secret Manager API service]
- Azure: https://learn.microsoft.com/en-us/azure/key-vault/general/howto-logging?tabs=azure-cli[Enable Diagnostic Logging for the Key Vault Service]
