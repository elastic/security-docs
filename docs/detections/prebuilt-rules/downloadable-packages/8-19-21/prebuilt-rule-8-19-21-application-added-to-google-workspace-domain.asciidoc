[[prebuilt-rule-8-19-21-application-added-to-google-workspace-domain]]
...
[source, js]
----------------------------------
data_stream.dataset:google_workspace.admin and event.provider:admin and event.category:iam and event.action:ADD_APPLICATION
