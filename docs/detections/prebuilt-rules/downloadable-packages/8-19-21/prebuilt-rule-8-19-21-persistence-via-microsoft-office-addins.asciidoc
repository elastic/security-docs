[[prebuilt-rule-8-19-21-persistence-via-microsoft-office-addins]]
...
- Conduct a full antivirus and antimalware scan on the affected system using tools like Microsoft Defender XDR to ensure no other malicious files are present.
