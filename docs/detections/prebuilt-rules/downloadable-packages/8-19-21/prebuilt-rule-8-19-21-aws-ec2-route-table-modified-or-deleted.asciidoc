[[prebuilt-rule-8-19-21-aws-ec2-route-table-modified-or-deleted]]
...
- **Revoke Unauthorized Permissions**: If unauthorized, remove permissions for related actions from the user or role. You can use the managed https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSDenyAll.html[AWSDenyAll] policy.
