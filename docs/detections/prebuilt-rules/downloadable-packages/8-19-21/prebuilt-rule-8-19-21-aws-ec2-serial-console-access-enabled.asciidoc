[[prebuilt-rule-8-19-21-aws-ec2-serial-console-access-enabled]]
...
- **https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-serial-console.html[AWS Documentation: EC2 Serial Console]**
