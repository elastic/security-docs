[[prebuilt-rule-8-19-21-aws-management-console-root-login]]
...
- **https://github.com/aws-samples/aws-incident-response-playbooks/tree/c151b0dc091755fffd4d662a8f29e2f6794da52c/playbooks[AWS IR Playbooks]:** See “Account Compromise” and “Credential Compromise” playbooks for containment and recovery procedures.  
- **https://github.com/aws-samples/aws-customer-playbook-framework/tree/a8c7b313636b406a375952ac00b2d68e89a991f2/docs[AWS Customer Playbook Framework]:** Reference “Account Access Investigation” for evidence handling and credential rotation steps.  
- **AWS Documentation:** https://docs.aws.amazon.com/general/latest/gr/root-vs-iam.html#aws_tasks-that-require-root[Tasks that require the root user].  
