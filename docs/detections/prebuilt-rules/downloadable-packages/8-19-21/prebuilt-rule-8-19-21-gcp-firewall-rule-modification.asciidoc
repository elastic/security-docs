[[prebuilt-rule-8-19-21-gcp-firewall-rule-modification]]
...
[source, js]
----------------------------------
data_stream.dataset:gcp.audit and event.action:(*.compute.firewalls.patch or google.appengine.*.Firewall.Update*Rule)
