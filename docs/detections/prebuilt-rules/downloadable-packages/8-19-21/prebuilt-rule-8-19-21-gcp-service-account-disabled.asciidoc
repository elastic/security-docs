[[prebuilt-rule-8-19-21-gcp-service-account-disabled]]
...
[source, js]
----------------------------------
data_stream.dataset:gcp.audit and event.action:google.iam.admin.v*.DisableServiceAccount and event.outcome:success
