[[prebuilt-rule-8-19-21-google-workspace-password-policy-modified]]
...
[source, js]
----------------------------------
data_stream.dataset:google_workspace.admin and event.provider:admin and event.category:iam and
