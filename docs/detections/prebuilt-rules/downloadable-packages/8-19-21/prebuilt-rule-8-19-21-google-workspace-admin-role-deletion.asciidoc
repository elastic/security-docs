[[prebuilt-rule-8-19-21-google-workspace-admin-role-deletion]]
...
[source, js]
----------------------------------
data_stream.dataset:google_workspace.admin and event.provider:admin and event.category:iam and event.action:DELETE_ROLE
