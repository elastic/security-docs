[[prebuilt-rule-8-19-21-google-workspace-custom-admin-role-created]]
...
[source, js]
----------------------------------
data_stream.dataset:google_workspace.admin and event.provider:admin and event.category:iam and event.action:CREATE_ROLE
