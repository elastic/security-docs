[[prebuilt-rule-8-19-21-attempt-to-install-kali-linux-via-wsl]]
...
- Review and update endpoint protection configurations to enhance detection and prevention capabilities against similar threats, leveraging data sources like Microsoft Defender XDR and Sysmon.
