[[prebuilt-rule-8-19-21-gcp-service-account-deletion]]
...
[source, js]
----------------------------------
data_stream.dataset:gcp.audit and event.action:google.iam.admin.v*.DeleteServiceAccount and event.outcome:success
