[[prebuilt-rule-8-19-21-gcp-iam-service-account-key-deletion]]
...
[source, js]
----------------------------------
data_stream.dataset:gcp.audit and event.action:google.iam.admin.v*.DeleteServiceAccountKey and event.outcome:success
