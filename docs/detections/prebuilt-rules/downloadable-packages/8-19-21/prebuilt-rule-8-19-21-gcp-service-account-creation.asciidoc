[[prebuilt-rule-8-19-21-gcp-service-account-creation]]
...
[source, js]
----------------------------------
data_stream.dataset:gcp.audit and event.action:google.iam.admin.v*.CreateServiceAccount and event.outcome:success
