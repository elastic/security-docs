[[prebuilt-rule-8-19-21-potential-persistence-via-file-modification]]
...
[source, js]
----------------------------------
file where host.os.type == "linux" and data_stream.dataset == "fim.event" and event.action == "updated" and
file.path : (
  // cron, anacron & at
...
** Name: Udev Rules
** ID: T1546.017
** Reference URL: https://attack.mitre.org/techniques/T1546/017/
* Technique:
