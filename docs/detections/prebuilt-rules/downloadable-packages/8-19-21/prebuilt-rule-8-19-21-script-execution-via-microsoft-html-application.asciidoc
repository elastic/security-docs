[[prebuilt-rule-8-19-21-script-execution-via-microsoft-html-application]]
...
- Correlate the event with other security logs and alerts from data sources like Sysmon, SentinelOne, or Microsoft Defender XDR to gather additional context and determine if this activity is part of a broader attack pattern.
