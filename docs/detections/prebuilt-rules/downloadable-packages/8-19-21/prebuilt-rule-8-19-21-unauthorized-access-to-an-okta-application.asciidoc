[[prebuilt-rule-8-19-21-unauthorized-access-to-an-okta-application]]
...
[source, js]
----------------------------------
data_stream.dataset:okta.system and event.action:app.generic.unauth_app_access_attempt
