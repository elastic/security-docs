[[prebuilt-rule-8-19-21-google-workspace-custom-gmail-route-created-or-modified]]
...
[source, js]
----------------------------------
data_stream.dataset:"google_workspace.admin" and event.action:("CREATE_GMAIL_SETTING" or "CHANGE_GMAIL_SETTING")
