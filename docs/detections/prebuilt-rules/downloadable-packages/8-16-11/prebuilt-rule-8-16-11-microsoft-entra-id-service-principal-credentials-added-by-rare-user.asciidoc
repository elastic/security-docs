[[prebuilt-rule-8-16-11-microsoft-entra-id-service-principal-credentials-added-by-rare-user]]
...
- https://cloud.google.com/blog/topics/threat-intelligence/remediation-and-hardening-strategies-for-microsoft-365-to-defend-against-unc2452[Hardening Microsoft 365 and Azure AD – Google Threat Intelligence]
- https://dirkjanm.io/azure-ad-privilege-escalation-application-admin/[Azure AD Privilege Escalation – Dirkjan Mollema]
- https://learn.microsoft.com/en-us/entra/fundamentals/security-best-practices[Microsoft Entra Best Practices]
