[[prebuilt-rule-8-16-10-process-injection-prevented-elastic-endgame]]
...
*Searches indices from*: now-1m ({ref}/common-options.html#date-math[Date Math format], see also <<rule-schedule, `Additional look-back time`>>)
