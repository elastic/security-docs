[[prebuilt-rule-8-19-23-smtp-on-port-26-tcp]]
=== SMTP on Port 26/TCP
...
[source, js]
----------------------------------
(data_stream.dataset: (network_traffic.flow or zeek.smtp) or event.category:(network or network_traffic)) and network.transport:tcp and destination.port:26
...
** Name: Mail Protocols
** ID: T1071.003
** Reference URL: https://attack.mitre.org/techniques/T1071/003/
* Technique:
