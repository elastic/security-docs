[[prebuilt-rule-8-19-23-persistence-via-microsoft-outlook-vba]]
...
- Correlate the findings with other data sources such as Sysmon, Microsoft Defender XDR, or SentinelOne to gather additional context or related events.
...
- Conduct a full antivirus and antimalware scan on the affected endpoint using tools like Microsoft Defender XDR to identify and remove any additional threats.
...
** ID: T1137.001
** Reference URL: https://attack.mitre.org/techniques/T1137/001/
