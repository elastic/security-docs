[[prebuilt-rule-8-19-23-sedebugprivilege-enabled-by-a-suspicious-process]]
...
Audit Token Right Adjusted Events must be enabled to generate the events used by this rule.
Setup instructions: https://ela.st/audit-token-right-adjusted-events
