[[prebuilt-rule-8-19-23-command-execution-via-solarwinds-process]]
...
- Correlate the event with other security logs and alerts from data sources like Microsoft Defender XDR or Sysmon to gather additional context and identify potential patterns of malicious behavior.
