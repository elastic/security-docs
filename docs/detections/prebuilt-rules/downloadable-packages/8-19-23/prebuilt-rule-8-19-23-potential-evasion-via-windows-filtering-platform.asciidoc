[[prebuilt-rule-8-19-23-potential-evasion-via-windows-filtering-platform]]
...
- https://ela.st/audit-filtering-platform-connection[Audit Filtering Platform Connection]
- https://ela.st/audit-filtering-platform-packet-drop[Audit Filtering Platform Packet Drop]
