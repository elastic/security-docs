[[prebuilt-rule-8-19-23-windows-sandbox-with-sensitive-configuration]]
...
- Correlate the sandbox activity with other security alerts or logs from data sources like Elastic Endgame, Sysmon, or Microsoft Defender XDR to gather additional context and identify any related suspicious activities.
