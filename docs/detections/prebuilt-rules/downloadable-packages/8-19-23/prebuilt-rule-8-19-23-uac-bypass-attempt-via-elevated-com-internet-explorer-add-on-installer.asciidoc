[[prebuilt-rule-8-19-23-uac-bypass-attempt-via-elevated-com-internet-explorer-add-on-installer]]
...
- Correlate this event with other security alerts or logs from data sources like Elastic Endgame, Elastic Defend, Sysmon, Microsoft Defender XDR, or SentinelOne to identify any related malicious activity.
