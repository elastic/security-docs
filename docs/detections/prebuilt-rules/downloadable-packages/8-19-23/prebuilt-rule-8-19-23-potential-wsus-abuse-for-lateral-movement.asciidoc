[[prebuilt-rule-8-19-23-potential-wsus-abuse-for-lateral-movement]]
...
- Correlate the alert with other security logs and alerts from data sources like Elastic Endgame, Sysmon, or Microsoft Defender XDR to gather additional context and confirm the legitimacy of the activity.
