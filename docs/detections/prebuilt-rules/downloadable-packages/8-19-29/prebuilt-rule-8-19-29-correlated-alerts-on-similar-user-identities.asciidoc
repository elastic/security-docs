[[prebuilt-rule-8-19-29-correlated-alerts-on-similar-user-identities]]
...
following the https://www.elastic.co/docs/explore-analyze/ai-features/llm-guides/llm-connectors[LLM connector documentation]
