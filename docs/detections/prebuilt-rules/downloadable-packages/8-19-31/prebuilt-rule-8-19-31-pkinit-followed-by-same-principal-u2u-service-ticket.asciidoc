[[prebuilt-rule-8-19-31-pkinit-followed-by-same-principal-u2u-service-ticket]]
...
- https://ela.st/audit-kerberos-authentication-service[Audit Kerberos Authentication Service]
- https://ela.st/audit-kerberos-service-ticket-operations[Audit Kerberos Service Ticket Operations]
