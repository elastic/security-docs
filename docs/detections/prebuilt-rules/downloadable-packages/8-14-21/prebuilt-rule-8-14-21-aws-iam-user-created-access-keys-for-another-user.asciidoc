[[prebuilt-rule-8-14-21-aws-iam-user-created-access-keys-for-another-user]]
...
set of credentials for another user for privilege escalation or as a means of persistence. This rule uses https://www.elastic.co/guide/en/security/current/rules-ui-create.html#create-esql-rule[ES|QL]
