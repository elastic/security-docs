[[prebuilt-rule-8-14-21-aws-sts-getcalleridentity-api-called-for-the-first-time]]
...
This rule looks for use of the `GetCallerIdentity` operation. This is a https://www.elastic.co/guide/en/security/current/rules-ui-create.html#create-new-terms-rule[New Terms] rule indicating this is the first time a specific user identity has called this operation within the last 15 days.
