[[prebuilt-rule-8-7-10-threat-intel-windows-registry-indicator-match]]
...
This rule needs threat intelligence indicators to work. Threat intelligence indicators can be collected using the https://www.elastic.co/guide/en/security/current/es-threat-intel-integrations.html[Threat Intel integration].
