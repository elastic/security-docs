[[prebuilt-rule-8-19-27-ipsec-nat-traversal-port-activity]]
...
[source, js]
----------------------------------
(data_stream.dataset: (network_traffic.flow or zeek.connection) or (event.category: (network or network_traffic))) and
