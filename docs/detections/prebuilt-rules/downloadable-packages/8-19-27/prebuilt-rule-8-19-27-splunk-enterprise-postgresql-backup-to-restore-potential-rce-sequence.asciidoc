[[prebuilt-rule-8-19-27-splunk-enterprise-postgresql-backup-to-restore-potential-rce-sequence]]
...
*Searches indices from*: now-19m ({ref}/common-options.html#date-math[Date Math format], see also <<rule-schedule, `Additional look-back time`>>)
