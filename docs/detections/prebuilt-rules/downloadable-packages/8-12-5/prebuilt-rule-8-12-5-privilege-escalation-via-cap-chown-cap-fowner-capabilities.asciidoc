[[prebuilt-rule-8-12-5-privilege-escalation-via-cap-chown-cap-fowner-capabilities]]
...
This rule requires data coming in from Auditd Manager.*Auditd Manager Integration Setup*The Auditd Manager Integration receives audit events from the Linux Audit Framework which is a part of the Linux kernel.
