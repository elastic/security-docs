[[prebuilt-rule-8-12-5-potential-linux-tunneling-and-or-port-forwarding]]
...
*Triage and analysis**Investigating Potential Linux Tunneling and/or Port Forwarding*Attackers can leverage many utilities to clandestinely tunnel network communications and evade security measures, potentially gaining unauthorized access to sensitive systems.
...
- ProxyChains Activity - 4b868f1f-15ff-4ba3-8c11-d5a7a6356d37*False positive analysis*- If this activity is related to new benign software installation activity, consider adding exceptions — preferably with a combination of user and command line conditions.
