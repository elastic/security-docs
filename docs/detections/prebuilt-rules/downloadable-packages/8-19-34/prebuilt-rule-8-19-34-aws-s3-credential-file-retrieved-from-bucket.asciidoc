[[prebuilt-rule-8-19-34-aws-s3-credential-file-retrieved-from-bucket]]
...
data_stream.dataset: "aws.cloudtrail" and
    ...
    not aws.cloudtrail.user_identity.type: "AWSService" and
    not user.name: (AWSAccelerator-*) and
    not aws.cloudtrail.additional_eventdata: *bytesTransferredOut=0*
