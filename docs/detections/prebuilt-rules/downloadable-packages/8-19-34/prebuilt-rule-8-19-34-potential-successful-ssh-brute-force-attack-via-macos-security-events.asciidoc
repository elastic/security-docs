[[prebuilt-rule-8-19-34-potential-successful-ssh-brute-force-attack-via-macos-security-events]]
...
Integration setup instructions: https://www.elastic.co/docs/reference/security/prebuilt-rules/integration/macos/macos_security_events[macOS Security Events]
SSH authentication logging setup instructions: https://www.elastic.co/docs/reference/security/prebuilt-rules/integration/macos/macos_security_events_ssh_authentication[macOS Security Events: SSH Authentication]
