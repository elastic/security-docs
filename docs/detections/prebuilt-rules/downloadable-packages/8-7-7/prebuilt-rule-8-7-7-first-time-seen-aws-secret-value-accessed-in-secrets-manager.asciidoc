[[prebuilt-rule-8-7-7-first-time-seen-aws-secret-value-accessed-in-secrets-manager]]
...
This rule looks for the retrieval of credentials using `GetSecretValue` action in Secrets Manager programmatically. This is a {security-guide}/{security-guide}/rules-ui-create.html#create-new-terms-rule[new terms][new terms] rule indicating this is the first time a specific user identity has successfuly retrieved a secret value from Secrets Manager.
