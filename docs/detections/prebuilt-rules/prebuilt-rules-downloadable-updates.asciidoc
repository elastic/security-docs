...
This release includes new rules for MacOS, Linux and cloud services.
Also, included are investigation guides for Windows rules and new rules for credential theft and Active Directory (AD).
New threat-centric rules to help detect https://www.elastic.co/blog/detecting-and-responding-to-dirty-pipe-with-elastic[CVE-2022-0847 (Dirty Pipe)]
