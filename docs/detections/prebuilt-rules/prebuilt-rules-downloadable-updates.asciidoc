...
This release includes rules covering windows endpoints as well as several third-party integrations, including several
rules which were contributed by the community.
