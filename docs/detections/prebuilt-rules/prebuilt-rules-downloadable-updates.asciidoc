...
This release includes new rules for for MacOS regarding initial access and persistence coverage.
New rules to detect shell evasion in Linux have also been added.
Also, included are expanded detailed investigation guides coverage for Windows rules as well as new rules for credential theft and Active Directory (AD).
Additionally, it includes new rules to help detect the emerging threat https://www.elastic.co/blog/detecting-and-responding-to-dirty-pipe-with-elastic[CVE-2022-0847 (Dirty Pipe)]
