...
|<<prebuilt-rule-7-16-4-prebuilt-rules-7-16-4-summary, 7.16.4>> | 22 Aug 2022 | 434 | 69 |
This release includes new rules for Windows, MacOS, Linux, GCP and Kubernetes, as well as considerable tuning efforts.
Also included are expanded investigation guides for Windows, Azure and AWS rules.
