...
This release includes new rules for Windows, MacOS, Linux, Kubernetes and GCP, as well as considerable tuning efforts.
Also included are expanded investigation guides for Windows rules and new investigation guides for Azure and AWS.
