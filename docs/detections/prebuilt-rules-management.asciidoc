...
** Edit the final update: Correct or change the value that will be applied to the field when you update the rule. To do this, go to the *Final update* section, then edit and save your changes.
...
TIP: You can still change the final field value, if needed. To do this, edit the value in the *Final update* section, then save your changes.
...
+
. Go to the *Final update* section and enter the appropriate final value.
