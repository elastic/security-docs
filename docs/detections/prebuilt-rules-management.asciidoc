...
IMPORTANT: The following steps are only applicable if you have an https://www.elastic.co/subscriptions/cloud[Platinum] subscription or lower. If you have an Enterprise subscription, follow the guidelines in <<prebuilt-rules-update-modified-unmodified>> instead. 
...
. Do one of the following to update prebuilt rules on the *Rules Updates* tab:
