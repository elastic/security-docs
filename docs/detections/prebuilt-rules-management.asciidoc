...
+
TIP: To view the details of a rule before you install it, select the rule name. This opens the rule details flyout.
...
+
TIP: To view the details of a rule's latest version before you update it, select the rule name. This opens the rule details flyout.
+
[role="screenshot"]
