[[runtime-fields]]
== Add runtime fields in {elastic-sec}
...
You can add a runtime field to your detection alerts or events from any page that lists alerts or events in a data grid table, such as the *Alerts*, *Timelines*, *Hosts*, and *Users* pages. The new field becomes available to all {elastic-sec} alerts and events.
