...
The **Only rules with unfilled gaps** filter on the right of the panel lets you only display rules with unfilled gaps. Note that the filter excludes rules with gaps that are being filled. 
