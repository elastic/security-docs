...
Go to the **Execution results** tab to access the rule’s execution log, monitor gaps in the rule’s execution schedule, and get details about manual rule runs. 
...
The Gaps table provides you with a detailed view of gaps in a rule’s execution schedule. Use this information to assess gaps and then fill them. To access the Gaps table, click the rule’s name to open its details, go to the **Execution results** tab, then scroll down until you get to the table.
