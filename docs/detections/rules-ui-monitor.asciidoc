...
Therefore, if you have upgraded the cluster to 7.11 or 7.12 and are using
multiple versions of {beats} and {agent}, to ensure continued rule coverage you 
must create new rules that use the new {ml} jobs and enable them to run
