...
You can also search for a tactic or technique name, technique number, or rule name in the search bar. Only rules matching the search term will be considered for rules coverage.
