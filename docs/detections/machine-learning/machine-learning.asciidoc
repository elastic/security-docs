...
Machine learning jobs can also be installed via https://docs.elastic.co/integrations[Elastic integrations]. We currently have the following Advanced Analytics integrations for Security:
