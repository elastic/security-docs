...
. When configuring the rule type (the *Define rule* step for a new rule, or the *Definition* tab for an existing rule), configure how you want to group events for alert suppression:
+
--
