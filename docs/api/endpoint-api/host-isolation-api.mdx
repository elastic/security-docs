---
id: serverlessSecurityHostIsolationApi
# slug: /serverless/security/host-isolation-api
...
<div id="host-isolation-api"></div>

Isolates a host running ((elastic-defend)) from the network.

`Isolated` is a persistent status until the endpoint is given a release command. You must have the **Host Isolation** <DocLink id="serverlessSecurityEndpointManagementReq">privilege</DocLink> and at least a Platinum license to perform this action.
