---
id: serverlessSecurityListEndpointsApi
# slug: /serverless/security/list-endpoints-api
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>The zero-based page of results to retrieve.</DocCell>
    <DocCell>
      0
  ...
  <DocRow>
    <DocCell>`kuery`</DocCell>
    <DocCell>string</DocCell>
    <DocCell>A KQL string.</DocCell>
    <DocCell>
