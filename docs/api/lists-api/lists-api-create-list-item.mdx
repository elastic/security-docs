---
id: serverlessSecurityListsApiCreateListItem
# slug: /serverless/security/lists-api-create-list-item
...
<div id="lists-api-create-list-item"></div>
...
|---|---|---|---|
| `id` | String | Unique identifier of the list item. | No, automatically created when it is not provided. |
| `list_id` | String | ID of the associated <DocLink id="serverlessSecurityListsApiCreateContainer">list container</DocLink>. | Yes |
...
<DocLink id="serverlessSecurityListsApiUpdateItem">updating a list item</DocLink>.
