---
id: enSecurityExceptionsApiOverview
slug: /en/security/exceptions-api-overview
title: Exceptions API
description: Description to be written
tags: []
---

<div id="exceptions-api-overview"></div>
...
For detection rules, you can also use <DocLink id="enSecurityListsApiOverview">lists</DocLink> to define
...
<DocLink id="enSecurityListsApiCreateContainer">list container</DocLink> with a rule. To use list
exceptions, create an exception item that references the relevant list
container (see this <DocLink id="enSecurityExceptionsApiCreateExceptionItem" section="list-item-example">example request</DocLink>).
</DocCallOut>
...
![](../images/exceptions-api-overview/-detections-api-exceptions-exceptions-logic.png)

<DocCallOut title="Important" color="warning">
Before you can create exceptions, you must create `.lists` and
`.items` indices for the ((kib)) space (see <DocLink id="enSecurityListsIndexApiOverview">Lists index endpoint</DocLink>).
</DocCallOut>
