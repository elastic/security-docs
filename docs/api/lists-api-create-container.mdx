---
id: enSecurityListsApiCreateContainer
...
A list container groups common <DocLink id="enSecurityListsApiCreateListItem">list items</DocLink> that
...
<DocLink id="enSecurityListsApiGetItem">Get list item</DocLink>.
</DocCallOut>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      * `{{{gte}}},{{{lte}}}` - Date range values.
      ...
      <DocLink id="enSecurityListsApiCreateContainer" section="serializer">`serializer`</DocLink>.
...
<DocLink id="enSecurityListsApiUpdateContainer">updating a list container</DocLink>.
