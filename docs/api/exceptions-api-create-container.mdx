---
id: enSecurityExceptionsApiCreateContainer
slug: /en/security/exceptions-api-create-container
...
An exception container groups <DocLink id="enSecurityExceptionsApiCreateExceptionItem">exception items</DocLink>
...
You can assign detection rules with multiple exception containers. For more information, see <DocLink id="enSecurityRulesApiCreate">Create rule</DocLink> and <DocLink id="enSecurityRulesApiUpdate">Update rule</DocLink>.
