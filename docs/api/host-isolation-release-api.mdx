---
id: enSecurityHostIsolationReleaseApi
...
You must have the **Host Isolation** <DocLink id="enSecurityEndpointManagementReq">privilege</DocLink> to perform this action. It is available to all license levels.
