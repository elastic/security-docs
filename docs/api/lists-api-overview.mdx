---
id: enSecurityListsApiOverview
slug: /en/security/lists-api-overview
title: Lists API
...
Lists can be used with detection rule <DocLink id="enSecurityExceptionsApiOverview">exceptions</DocLink>
...
<DocLink id="enSecurityExceptionsApiOverview">Exceptions API</DocLink> to create an
<DocLink id="enSecurityExceptionsApiCreateExceptionItem">exception item</DocLink> that references the
...
Use an <DocLink id="enSecurityExceptionsApiCreateExceptionItem">exception item</DocLink> to define the
operator and associate it with an <DocLink id="enSecurityExceptionsApiCreateContainer">exception container</DocLink>.
...
indices for the ((kib)) space (see <DocLink id="enSecurityListsIndexApiOverview">Lists index endpoint</DocLink>).
</DocCallOut>
...
See <DocLink id="enSecurityDetectionsPermissionsSection">Detections prerequisites and requirements</DocLink> for a complete list of requirements.
