---
id: enSecurityBulkActionsRulesApi
slug: /en/security/bulk-actions-rules-api
...
This API has been deprecated since version 8.2, and is scheduled for end of life in Q4 2023. Please use the <DocLink id="enSecurityBulkActionsRulesApi" section="bulk-action">bulk action API</DocLink> instead.
</DocCallOut>
...
<DocLink id="enSecurityRulesApiCreate">required fields</DocLink>.
...
* The <DocLink id="enSecurityRulesApiUpdate">fields</DocLink> you want to modify.
...
some fields are required (see <DocLink id="enSecurityRulesApiUpdate">Update rule</DocLink> for a list of required
fields).
...
|---|---|---|---|
| `dry_run` | Boolean | Enables <DocLink id="enSecurityBulkActionsRulesApi" section="dry-run-mode">dry run mode</DocLink> for the request call. | No |
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      <DocLink id="enSecurityBulkActionsRulesApi" section="bulkeditaction-object">BulkEditAction[]</DocLink>
  ...
  <DocRow>
    ...
    <DocCell>
      <DocLink id="enSecurityBulkActionsRulesApi" section="bulkduplicateaction-object">BulkDuplicateAction[]</DocLink>
...
<DocLink id="enSecurityBulkActionsRulesApi" section="bulkeditaction-object">Actions</DocLink> are shown in order of oldest to newest in the `edit` array payload's property.
