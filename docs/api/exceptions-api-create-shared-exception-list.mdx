---
id: enSecurityExceptionsApiCreateSharedExceptionList
...
For more information, refer to <DocLink id="enSecurityRulesApiCreate">Create rule</DocLink> and <DocLink id="enSecurityRulesApiUpdate">Update rule</DocLink>.
