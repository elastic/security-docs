...
![Expandable flyout, 90%](../images/view-alert-details/-detections-open-alert-details-flyout.gif)
...
To use the simplified alert details flyout design from ((elastic-sec)) 8.9 and earlier, turn off the <DocLink id="serverlessSecurityAdvancedSettings" section="display-the-expandable-flyout">`securitySolution:enableExpandableFlyout`</DocLink> advanced setting. 
</DocCallOut>
...
![Right panel of the alert details flyout, 65%](../images/view-alert-details/-detections-alert-details-flyout-right-panel.png)
...
![Preview panel of the alert details flyout, 65%](../images/view-alert-details/-detections-alert-details-flyout-preview-panel.gif)
...
![Expand details button at the top of the alert details flyout, 45%](../images/view-alert-details/-detections-expand-details-button.png)

* Click one of the section titles on the **Overview** tab within the right panel. 

![Left panel of the alert details flyout, 45%](../images/view-alert-details/-detections-alert-details-flyout-left-panel.png)
...
![About section of the Overview tab, 65%](../images/view-alert-details/-detections-about-section-rp.png)
...
![Investigation section of the Overview tab, 65%](../images/view-alert-details/-detections-investigation-section-rp.png)
...
![Visualizations section of the Overview tab, 65%](../images/view-alert-details/-detections-visualizations-section-rp.png)
...
![Insights section of the Overview tab, 65%](../images/view-alert-details/-detections-insights-section-rp.png)
...
<DocCallOut title="Note">
<DocLink id="serverlessSecurityUserRiskScore">User</DocLink> and <DocLink id="serverlessSecurityHostRiskScore">host</DocLink> risk scores are technical preview features. 
</DocCallOut>

![Overview of the entity details  section in the right panel, 60%](../images/view-alert-details/-detections-entities-overview.png)
...
![Expanded view of entity details, 70%](../images/view-alert-details/-detections-expanded-entities-view.png)
...
![Overview of threat intelligence on the alert, 70%](../images/view-alert-details/-detections-threat-intelligence-overview.png)
...
![Expanded view of threat intelligence on the alert, 70%](../images/view-alert-details/-detections-expanded-threat-intelligence-view.png)
...
![Overview of available correlation data, 60%](../images/view-alert-details/-detections-correlations-overview.png)
...
![Expanded view of correlation data, 65%](../images/view-alert-details/-detections-expanded-correlations-view.png)
...
![Response section of the Overview tab, 50%](../images/view-alert-details/-detections-response-action-rp.png)
