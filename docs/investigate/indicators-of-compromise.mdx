...
* The Indicators page is an [Enterprise subscription](https://www.elastic.co/pricing) feature. {/* To be updated */}
...
1. From the ((security-app)) main menu, select one of the following:
    * **Intelligence**, then on the Indicators page, click **Add Integrations**.
