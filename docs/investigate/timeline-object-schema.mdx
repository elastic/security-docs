...
1. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-dropzone">Dropzone</DocLink> (each clause is contained in its own `dataProviders` object)
