---
id: enSecurityTimelineObjectSchema
...
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-title">Title</DocLink> (`title`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-desc">Description</DocLink> (`description`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-global-notes">Global notes</DocLink> (`globalNotes`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-daterange">Time filter</DocLink> (`dateRange`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-dropzone">Dropzone</DocLink> (each clause is contained in
    its own `dataProviders` object)

1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-kqlmode">KQL bar mode</DocLink> (`kqlMode`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-kqlquery">KQL bar query</DocLink> (`kqlQuery`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-dataViewId">Data view</DocLink> (`dataViewId`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-filters">Additional filters</DocLink> (`filters`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-columns">Column headers</DocLink> (`columns`)
1. <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-event-notes">Event-specific notes</DocLink> (`eventNotes`)
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="columns-object">columns[]</DocLink></DocCell>
    <DocCell>
      The Timeline's
      columns.
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="dataproviders-object">dataProviders[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      <DocLink id="enSecurityTimelineObjectSchema" section="eventnotes-object">eventNotes[]</DocLink>
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="favorite-object">favorite[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="filters-object">filters[]</DocLink></DocCell>
    <DocCell>
      Filters used
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="globalnotes-object">globalNotes[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema" section="kqlquery-object">kqlQuery</DocLink></DocCell>
    <DocCell>
      KQL bar
      query.
