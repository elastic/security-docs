...
To create connectors and send cases to external systems, you need the Security Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/> and the appropriate user role. For more information, refer to <DocLink id="serverlessSecurityCasePermissions">Cases prerequisites</DocLink>.
</DocCallOut>
