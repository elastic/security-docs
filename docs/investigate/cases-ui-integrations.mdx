...
[appropriate license](https://www.elastic.co/subscriptions), and your role needs **All** privileges for the **Action and Connectors** feature. For more information, refer to <DocLink id="serverlessSecurityCasePermissions">Cases prerequisites</DocLink>.
</DocCallOut>
