...
available for later review. To record and share your findings with others, attach your Timeline to a <DocLink id="serverlessSecurityCasesOverview">case</DocLink>.

<DocCallOut title="Tip">
Untitled Timelines are saved as drafts. To attach a Timeline to a
<DocLink id="serverlessSecurityCasesOverview">case</DocLink>, you must give it a title.
</DocCallOut>
...
retrieved from the alert. For more information, refer to <DocLink id="serverlessSecurityTimelineTemplatesUi">About Timeline templates</DocLink>.
...
* **Create template from timeline** (refer to <DocLink id="serverlessSecurityTimelineTemplatesUi">About Timeline templates</DocLink>)
* **Duplicate timeline**
