...
- Click the help icon (<DocIcon type="documentation" title="Click the ES|QL help icon" />) on the far right side of the query editor to open the in-product reference documentation for all ((esql)) commands and functions.  
