...
The following section provides an overview of the management tools admins can use to manage endpoints, trusted applications, event filters, and host isolation exceptions.
