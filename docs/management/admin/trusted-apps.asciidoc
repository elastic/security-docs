...
* `Per Policy`: Assign the trusted application to one or more specific integration policies. Select each policy in which you want the application to be trusted.
