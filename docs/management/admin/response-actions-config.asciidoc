...
- SentinelOne connector: Permission to ready SentinelOne data and perform actions on SentinelOne-protected hosts (for example, isolating and releasing an endpoint).
