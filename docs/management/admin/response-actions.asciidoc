...
NOTE: The default file size maximum is 25 MB, configurable in `kibana.yml` with the `maxUploadResponseActionFileBytes` setting. The value must be entered in bytes (the maximum is `104857600` bytes, or 100 MB).
