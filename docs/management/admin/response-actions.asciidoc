...
* Some response actions require specific <<endpoint-management-req,user privileges>>, indicated below. These are required to perform actions both in the response console and in other contexts (such as isolating a host from a detection alert).
--
