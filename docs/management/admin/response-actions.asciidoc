...
Quarantined files are saved in a password-protected .zip archive to prevent the file from running. Use the passcode `elastic` to open the .zip in a safe environment.
====
