...
IMPORTANT: Automatic host isolation from a detection rule execution could result in unintended consequences, such as disrupting legitimate user activities or blocking critical business processes. Be aware of this as you're configuring rules. 
