...
To access the response actions history for all hosts, go to *Manage* -> *Response actions history*. You can use the tools at the top to filter the information displayed in this view. Refer to <<response-actions-history>> for more details.
