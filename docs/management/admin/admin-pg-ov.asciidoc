...
Click any *Hostname* link to display those host details in a flyout. From the *Take Action* menu, you can also execute the same actions as those listed in the Actions context menu (view the associated policy, view the response details, and reassign the policy).
