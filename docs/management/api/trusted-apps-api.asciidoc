...
{endpoint-artifact-name} allow for at most 3 condition to be defined. No duplicates are allowed. The following entries are supported by {endpoint-artifact-name}:
