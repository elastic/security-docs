...
|`os_types` |xref:exception-{endpoint-artifact-api-doc-name}-item-os-types[os_type][] |Use this field to specify the xref:exception-{endpoint-artifact-api-doc-name}-item-os-types[operating system]. | Yes
