...
{endpoint-artifact-name} allow for an unlimited number of conditions to be defined. Each {endpoint-artifact-name-single} entry contains `type`, `value`, `field` keys and `operator`. The following operators are supported in an entry: 
