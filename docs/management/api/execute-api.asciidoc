...
|`parameters.timeout` |Integer |How long the host should wait for the command to complete in seconds.  |No
|==============================================

NOTE: The execute action will upload a text file containing the results of the execution on the Endpoint, which is rate limited.  If you are using the `endpoint_ids` field to task multiple Endpoints, you should batch your calls in groups of `10` at a time.
