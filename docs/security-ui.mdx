...
* <DocLink id="serverlessSecurityBenchmarkRules">**Benchmark Rules**</DocLink>: View, enable, or disable benchmark rules.
...
View and manage alerts to monitor activity within your network. Refer to <DocLink id="serverlessSecurityAlertsUiManage" /> for more information.

![](images/es-ui-overview/-detections-alert-page.png)

### Findings

Compare your cloud infrastructure against a variety of security benchmarks, and identify vulnerabilities. Refer to the <DocLink id="serverlessSecurityCspmFindingsPage">Findings page</DocLink> to find out how to set this up.

![Findings page](images/es-ui-overview/images/findings-page/-cloud-native-security-findings-page.png)
...
Expand this section to access the following pages:
    ...
    * <DocLink id="serverlessSecurityTimelinesUi">Timelines</DocLink>: Investigate alerts and complex threats — such as lateral movement — in your network. Timelines are interactive and allow you to share your findings with other team members.
    ...
    * <DocLink id="serverlessSecurityUseOsquery">Osquery</DocLink>: Deploy Osquery with ((agent)), then run and schedule queries.
