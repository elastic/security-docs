...
<DocLink id="serverlessSecurityIngestData">Ingest data to Elastic Security</DocLink> and <DocLink id="serverlessSecurityInstallDefend">Install and configure the ((elastic-defend)) integration</DocLink> describe how to ship security-related
data to ((es)).
