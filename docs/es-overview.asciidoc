...
({es} indices) send from your hosts for suspicious events. When a suspicious
event is discovered, a detection alert is generated. You can create your own
rules and make use of our <<prebuilt-rules, prebuilt ones>>.
