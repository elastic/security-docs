---
id: enSecurityEndpointArtifacts
...
<DocTable columns={[
  ...
  <DocRow>
    <DocCell>
      <DocLink id="enSecurityTrustedAppsOv">Trusted application</DocLink>
    ...
    <DocCell>
      ...
      * Might still generate malicious behavior alerts, if the application's process events indicate malicious behavior. To suppress alerts, create <DocLink id="enSecurityAddExceptions" section="add-((elastic-endpoint))-exceptions">Endpoint alert exceptions</DocLink>.
  ...
  <DocRow>
    <DocCell>
      <DocLink id="enSecurityEventFilters">Event filter</DocLink>
  ...
  <DocRow>
    <DocCell>
      <DocLink id="enSecurityBlocklist">Blocklist</DocLink>
  ...
  <DocRow>
    <DocCell>
      <DocLink id="enSecurityAddExceptions" section="add-((elastic-endpoint))-exceptions">Endpoint alert exception</DocLink>
