...
<DocCallOut title="Note">
The following instructions apply only to ((elastic-endpoint)) running ((stack)) version 8.0.0 and later. To see Full Disk Access requirements for the Endgame sensor, refer to <DocLink id="enSecurityEndgameSensorFullDiskAccess">Enable Full Disk Access for the Endgame sensor</DocLink>.
</DocCallOut>
