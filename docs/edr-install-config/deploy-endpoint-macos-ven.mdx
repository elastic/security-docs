---
id: serverlessSecurityDeployElasticEndpointVen
...
* <DocLink id="serverlessSecurityDeployElasticEndpointVen" section="approve-the-system-extension-for-((elastic-endpoint))">Approve the system extension</DocLink>
* <DocLink id="serverlessSecurityDeployElasticEndpointVen" section="approve-network-content-filtering-for-((elastic-endpoint))">Approve network content filtering</DocLink>
* <DocLink id="serverlessSecurityDeployElasticEndpointVen" section="enable-full-disk-access-for-((elastic-endpoint))">Enable Full Disk Access</DocLink>
...
Click **Allow** to enable content filtering for the ElasticEndpoint system extension. Without this approval, ((elastic-endpoint)) cannot receive network events and, therefore, cannot enable network-related features such as <DocLink id="serverlessSecurityHostIsolationOv">host isolation</DocLink>.
...
{/* Check whether this section should be removed or we just need to update the note. */} 
