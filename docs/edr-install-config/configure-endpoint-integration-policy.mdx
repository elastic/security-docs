...
1. On the **Policy settings** tab, review and configure the following settings as appropriate:
   ...
   * <DocLink id="serverlessSecurityConfigureEndpointIntegrationPolicy" section="register-((elastic-sec))-as-antivirus-optional">Register ((elastic-sec)) as antivirus (optional)</DocLink>
