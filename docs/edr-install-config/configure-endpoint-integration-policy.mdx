...
on protected hosts (most features require the Endpoint Essentials or Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project feature"/>). If needed, you can update the
...
Malware protection requires the Endpoint Essentials <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
...
<DocCallOut title="Tip">
Endpoint Complete customers can customize these notifications using the `Elastic Security {action} {filename}` syntax.
</DocCallOut>
...
<DocCallOut title="Note">
Response actions and the response console UI are Endpoint Complete <DocLink id="serverlessGeneralManageProject" text="project features"/>.
</DocCallOut>
...
Ransomware protection requires the Endpoint Essentials <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
...
Memory threat protection requires the Endpoint Essentials <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
...
<DocCallOut title="Tip">
Endpoint Complete customers can customize these notifications using the `Elastic Security {action} {rule}` syntax.
</DocCallOut>
...
Malicious behavior protection requires the Endpoint Essentials <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
...
Attack surface reduction requires the Endpoint Essentials <DocLink id="serverlessGeneralManageProject" text="project feature"/>.
