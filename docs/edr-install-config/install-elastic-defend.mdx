...
If you're using macOS, some versions may require you to grant Full Disk Access to different kernels, system extensions, or files. Refer to <DocLink id="enSecurityElasticEndpointDeployReqs">requirements for ((elastic-endpoint))</DocLink> if you're installing the ((elastic-endpoint)) or <DocLink id="enSecurityEndgameSensorFullDiskAccess">requirements for the Endgame sensor</DocLink> for more information.
