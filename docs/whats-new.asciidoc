...
Additionally, the new Generative AI {kibana-ref}/gen-ai-action-type.html#gen-ai-connector-token-dashboard[Token Usage dashboard] allows you to monitor your token usage with the AI provider.
