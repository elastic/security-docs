...
Enabling <<host-risk-score,host risk score>> is now easier, with enhancements that guide you through the process and pre-populate the {kib} Dev Tools Console with the required scripts.
