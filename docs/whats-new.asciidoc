...
** A new Threat Indicator Match https://www.elastic.co/guide/en/security/current/alerts-ui-manage.html#customize-the-alerts-table[event renderer] option presents details about a matched indicator of compromise in a semantic format for quick analyst comprehension.
