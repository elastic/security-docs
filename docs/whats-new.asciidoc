...
* *Use Osquery Response Action to query hosts* - Users can use the Osquery Response Action to immediately query hosts that generate alerts. Note that Osquery Response Actions are currently a technical preview feature. 
