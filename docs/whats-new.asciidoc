...
{elastic-sec} 8.10 expands its cloud security posture management (CSPM) capabilities to cover {security-guide}/cspm-get-started-gcp.html.html[Google Cloud]. You can now assess and bolster the security posture of your GCP assets right from our platform.
