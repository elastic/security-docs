...
If you {security-guide}/cases-open-manage.html#cases-ui-custom-fields[add a custom field] to a case, and set the field to be required, you cannot leave the field empty. You must set a default value for it.
