...
** A new Threat Indicator Match https://www.elastic.co/guide/en/security/current/alerts-ui-manage.html#customize-the-alerts-table[event renderer] option allows you to summarize events that matched threat indicators.
