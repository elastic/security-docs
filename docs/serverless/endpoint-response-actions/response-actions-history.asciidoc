...
To access the response actions history for all endpoints, find **Response actions history** in the main menu or use the global search field. You can also access the response actions history for an individual endpoint from these areas:
