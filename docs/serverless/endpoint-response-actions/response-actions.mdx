...
* Some response actions require either a <DocLink slug="/serverless/general/assign-user-roles">predefined Security user role</DocLink> or a <DocLink slug="/serverless/custom-roles">custom role</DocLink> with a specific feature privilege, indicated below. These are required to perform actions both in the response console and in other areas of the ((security-app)) (such as isolating a host from a detection alert).
...
Predefined role: **Tier 3 analyst**, **SOC manager**, or **Endpoint operations analyst**<br />
...
<DocCallOut title="Note">
Files retrieved from third-party-protected hosts require a different password. Refer to <DocLink slug="/serverless/security/third-party-actions" /> for your system's password.
</DocCallOut>
...
Predefined role: **SOC manager** or **Endpoint operations analyst**<br />
