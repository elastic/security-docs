...
contextual information, called **Event Renderers**. contextual information, called *Event renderers*. All event renders are turned on by default. To turn them off, use the **Event renderers** toggle at the top of the results pane. To only turn off specific event renders, click the gear (<DocIcon type="gear" title="The customize event renderer button" />) button next to the toggle, and deselect the ones you want disabled. Close the **Customize event renderers** pane when you're done. Your changes are automatically applied to Timeline.
...
* <DocLink slug="/serverless/security/timelines-ui" section="ladd-remove-timeline-fields">Add and remove fields</DocLink> from Timeline
...
To add a field, hover over the field and click the **Add field as a column** button (<DocIcon type="plusInCircle" title="The button that lets you to add a field as a column" />) or drag and drop the field into the table. To remove a field, hover over the field, and click the **Remove field as a column** button (<DocIcon type="cross" title="The button that lets you to remove a field as a column" />).

<DocImage size="m" url="../images/timelines-ui/-events-timeline-sidebar.png" alt="Shows the sidebar that allows you to configure the columns that display in Timeline" />
...
* **Create template from timeline** (refer to <DocLink slug="/serverless/security/timeline-templates-ui">Create Timeline templates</DocLink>)  <DocLink slug="/serverless/security/view-alert-details" section="left-panel">left panel</DocLink>
* **Duplicate timeline**
...
- Visualize query results using <DocLink slug="/serverless/elasticsearch/explore-your-data-discover-your-data">Discover</DocLink> functionality.
