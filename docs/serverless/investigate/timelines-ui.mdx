...
You can export and import Timelines, which enables you to share Timelines from one {/* space or */} ((elastic-sec)) instance to another. Exported Timelines are saved as [`.ndjson`](https://github.com/ndjson/ndjson-spec) files.
