...
<DocDefList>
  <DocDefTerm>Field with value</DocDefTerm>
  <DocDefDescription>
  ...
  <DocDefTerm>Field exists</DocDefTerm>
  <DocDefDescription>
  ...
  <DocDefTerm>Exclude results</DocDefTerm>
  <DocDefDescription>
  ...
  <DocDefTerm>Temporarily disable</DocDefTerm>
  <DocDefDescription>
  ...
  <DocDefTerm>Filter for field present</DocDefTerm>
  <DocDefDescription>
