...
<DocImage size="xl" url="../images/notes/-notes-new-note-alert-event" alt="Creating a new note"/>
...
<DocImage size="l" url="../images/notes/-notes-new-note-timeline-tab.png" alt="New note added to a Timeline"/>

<div id="manage-notes"></div>

## Manage notes 

Use the **Notes** page to view and interact with all existing notes. To access the page, 
