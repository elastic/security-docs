...
There are two ways to add notes to a saved and open Timeline: the **Notes** Timeline tab or the details flyout for alerts and events that you're investigating in Timeline. 
