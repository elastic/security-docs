...
* Examine the alert or event that a note is attached to (click the image:images/expand.png[Preview alert or event details action,15,15] icon to preview the alert or event)
* Open the note in Timeline (only available for notes attached to saved Timelines, and alerts or events with notes attached to saved Timelines)
