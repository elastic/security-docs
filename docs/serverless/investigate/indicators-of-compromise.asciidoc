...
[NOTE]
====
* The Indicators page requires the Security Analytics Complete https://www.elastic.co/docs/current/serverless/elasticsearch/manage-project[project feature].
...
[NOTE]
====
These troubleshooting steps also apply to the <<threat-intelligence,Threat Intelligence view>>.
====
...
[NOTE]
====
Refer to <<blocklist,Blocklist>> for more information about blocklist entries.
====
