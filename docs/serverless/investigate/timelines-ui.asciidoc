...
retrieved from the alert. For more information, refer to <<timeline-templates-ui,Create Timeline templates>>.
...
[NOTE]
====
When you convert a <<timeline-templates-ui,Timeline template>> to a
...
* **Create template from timeline** (refer to <<timeline-templates-ui,Create Timeline templates>>)
* **Duplicate timeline**
