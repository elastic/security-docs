...
You can set up CSPM for GCP either by enrolling a single project, or by enrolling an organization containing multiple projects. Either way, you need to first add the CSPM integration, then enable cloud account access. Two deployment technologies are available: agentless, and agent-based. <DocLink slug="/serverless/security/cspm-get-started-gcp" section="cspm-gcp-agentless"> Agentless deployment </DocLink> allows you to collect cloud posture data without having to manage the deployment of an agent in your cloud. <DocLink slug="/serverless/security/cspm-get-started-gcp" section="cspm-gcp-agent-based"> Agent-based deployment </DocLink> requires you to deploy and manage an agent in the cloud account you want to monitor.

<div id="cspm-gcp-agentless"></div>
...
<div id="cspm-gcp-agent-based"></div>
