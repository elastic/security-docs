...
After each evaluation, the integration sends findings to Elastic. A high-level summary of the findings appears on the <<cloud-posture-dashboard-dash,Cloud Security Posture dashboard>>, and detailed findings appear on the <<cspm-findings-page,Findings page>>.
