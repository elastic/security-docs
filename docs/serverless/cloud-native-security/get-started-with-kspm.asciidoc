...
[discrete]
[[get-started-with-kspm-name-your-integration-and-select-a-kubernetes-deployment-type]]
...
[discrete]
[[get-started-with-kspm-configure-the-kspm-integration]]
