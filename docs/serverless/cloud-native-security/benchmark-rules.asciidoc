...
The Benchmarks page lets you view the cloud security posture (CSP) benchmarks for the <<cspm,Cloud security posture management>> (CSPM) and <<kspm,Kubernetes security posture management>> (KSPM) integrations.

[role="screenshot"]
image::images/benchmark-rules/-cloud-native-security-benchmark-rules.png[Benchmark rules page]

[discrete]
[[benchmark-rules-what-are-benchmarks]]
== What are benchmarks?
...
When benchmark rules are evaluated, the resulting <<cspm-findings-page,findings>> data appears on the <<cloud-posture-dashboard-dash,Cloud Security Posture dashboard>>.
...
[discrete]
[[benchmark-rules-review-your-benchmarks]]
...
[discrete]
[[benchmark-rules-how-benchmark-rules-work]]
