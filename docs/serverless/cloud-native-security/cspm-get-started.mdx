...
1. (Optional) click **Advanced settings** to deploy the integration using agentless technology (beta). 
...
Agentless deployments (beta) support two authentication methods: 
