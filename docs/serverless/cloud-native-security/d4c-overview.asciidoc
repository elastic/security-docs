...
[discrete]
[[d4c-overview-threat-detection-and-threat-hunting]]
...
[discrete]
[[d4c-overview-drift-detection-and-prevention]]
...
[discrete]
[[d4c-overview-workload-protection-policies]]
...
[discrete]
[[d4c-overview-how-cwp-for-kubernetes-works]]
...
[IMPORTANT]
====
To learn more about D4C policies, including how to create your own, refer to the <<d4c-policy-guide,D4C policies guide>>.
====
