...
Yes. There are different sets of benchmark rules for self-managed and third party-managed deployments. Refer to <DocLink slug="/serverless/security/get-started-with-kspm">Get started with KSPM</DocLink> for more information about setting up each deployment type.
