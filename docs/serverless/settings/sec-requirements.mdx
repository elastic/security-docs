...
Provide access to ((elastic-sec)) by assigning a user the appropriate <DocLink slug="/serverless/general/assign-user-roles">prebuilt Security role</DocLink> or a <DocLink slug="/serverless/custom-roles">custom role</DocLink> with specific privileges.
