...
Like detection rule exceptions, you can add Endpoint agent exceptions either by editing the <<endpoint-protection-rules, endpoint protection rules>> or by adding exceptions as actions on alerts generated by endpoint protection rules. {elastic-endpoint} alerts have the following fields:
