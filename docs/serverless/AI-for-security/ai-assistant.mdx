...
While AI Assistant is compatible with many different models, we recommend you refer to the <DocLink slug="/serverless/security/llm-performance-matrix" text="LLM performance matrix"/> to select models that perform well with your desired use cases.
</DocCallOut>
