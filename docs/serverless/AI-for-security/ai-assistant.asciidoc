...
[NOTE]
====
* This feature requires the Security Analytics Complete https://www.elastic.co/docs/current/serverless/elasticsearch/manage-project[project feature].
...
[NOTE]
====
While AI Assistant is compatible with many different models, refer to the <<llm-performance-matrix,LLM performance matrix>> to select models that perform well with your desired use cases.
====
...
The **Knowledge base** tab of the AI Assistant settings menu allows you to enable AI Assistant to answer questions about the Elastic Search Query Language {(esql}), and about alerts in your environment. To use it, you must <<ml-requirements,enable machine learning>>,

[discrete]
[[ai-assistant-knowledge-base-for-esql]]
...
[discrete]
[[ai-assistant-knowledge-base-for-alerts]]
...
[discrete]
[[ai-assistant-get-the-most-from-your-queries]]
