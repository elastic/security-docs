...
[discrete]
[[connect-to-google-vertex-enable-the-vertex-ai-api]]
...
[discrete]
[[connect-to-google-vertex-generate-an-api-key]]
== Generate an API key
...
[discrete]
[[connect-to-google-vertex-configure-the-google-gemini-connector]]
