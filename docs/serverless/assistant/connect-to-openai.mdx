...
NOTE: We recommend GPT-4o for most use cases. For more information on how different models perform for different tasks, refer to the <DocLink id="llm-performance-matrix" text="LLM performance matrix"/>.
</DocCallOut>
