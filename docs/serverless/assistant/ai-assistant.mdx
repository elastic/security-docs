...
For more information about setting up generative AI connectors, refer to <DocLink id="serverlessSecurityConnectBedrock"/>, <DocLink id="serverlessSecurityConnectOpenAI"/>, or <DocLink id="serverlessSecurityConnectAzureOpenAI"/>.
