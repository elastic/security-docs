---
id: serverlessSecurityAssistantAlertTriage
...
3. Click **Alert (from summary)** to view which alert fields will be shared with AI Assistant. (For more information about selecting which fields to send, and to learn about anonymizing your data, refer to <DocLink id="serverlessSecurityAIAssistant" section="configure-ai-assistant">AI Assistant</DocLink>.)
