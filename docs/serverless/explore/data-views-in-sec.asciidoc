...
[discrete]
[[data-views-in-sec-switch-to-another-data-source]]
...
[discrete]
[[data-views-in-sec-create-or-modify-a-data-source]]
...
The default {data-source} is defined by the `securitySolution:defaultIndex` setting, which you can modify in your project's advanced settings. To learn more about this setting, including its default value, refer to <<advanced-settings>>).
