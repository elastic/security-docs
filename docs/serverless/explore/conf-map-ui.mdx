...
* <DocLink slug="/serverless/security/conf-map-ui" section="kibana-index-pattern">Create data views</DocLink>
* <DocLink slug="/serverless/security/conf-map-ui" section="geoip-data">Add geographical IP data to events</DocLink>
* <DocLink slug="/serverless/security/conf-map-ui" section="private-network">Map your internal network</DocLink>
