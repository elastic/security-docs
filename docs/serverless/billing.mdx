...
For <DocLink id="serverlessSecurityCspm" text="CSPM"/> the following types of assets are considered billable:
...
For <DocLink id="serverlessSecurityKspm" text="KSPM"/>, only Kubernetes nodes are considered billable.
