...
For <DocLink slug="/serverless/security/cspm" text="CSPM"/>, billing is based on how many billable resources (`resource.id`s) you monitor. The following types of assets are considered billable:
...
For <DocLink slug="/serverless/security/kspm" text="KSPM"/>, billing is based on how many Kubernetes nodes (`agent.id`s) you monitor.

For <DocLink slug="/serverless/security/vuln-management-overview" text="CNVM"/>, billing is based on how many cloud assets (`cloud.instance.id`s) you monitor.

For <DocLink slug="/serverless/security/d4c-overview" text="D4C"/>, billing is based on how many agents (`agent.id`s) you use.
