...
For <DocLink id="serverlessSecurityCspm" text="CSPM"/> billing is per monitored and billable resource (per `resource.id`). The following types of assets are considered billable:
