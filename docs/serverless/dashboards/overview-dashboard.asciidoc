...
[discrete]
[[overview-dashboard-host-and-network-events]]
...
[discrete]
[[overview-dashboard-threat-intelligence]]
== Threat Intelligence
...
[NOTE]
====
For more information about connecting to threat intelligence sources, visit <<threat-intelligence,Enable threat intelligence integrations>>.
====
