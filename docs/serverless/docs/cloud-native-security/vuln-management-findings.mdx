---
id: serverlessSecurityVulnManagementFindings
...
<div id="vuln-findings-learn-more"></div>
...
1. Click **Take action**, then **Create a detection rule**. This automatically creates a detection rule that creates alerts when the associated vulnerability is found.
