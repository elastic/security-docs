---
id: serverlessSecuritySignalsApiOverview
# slug: /serverless/security/signals-api-overview
title: Signals endpoint
description: Use the signals endpoint to retrieve, aggregate, and update alerts.
tags: ["security","alerting","reference","manage"]
status: rough content
---

<div id="signals-api-overview"></div>
...
* [Start searching indices](((ref))/getting-started-search.html)
* [Aggregations](((ref))/search-aggregations.html)
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      Array of alert tags. Alert tags are the words and phrases that help categorize alerts. 
  ...
  <DocRow>
    <DocCell>`ids`</DocCell>
    <DocCell>String[]</DocCell>
    <DocCell>Array of alert IDs.</DocCell>
    <DocCell>
      Yes
