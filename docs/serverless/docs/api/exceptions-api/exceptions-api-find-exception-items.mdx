---
id: serverlessSecurityExceptionsApiFindExceptionItems
# slug: /serverless/security/exceptions-api-find-exception-items
title: Find exception items
# description: Description to be written
tags: [ 'serverless', 'security', 'reference' ]
status: rough content
---

<div id="exceptions-api-find-exception-items"></div>
...
|---|---|---|---|
| `list_id` | String | ID of the <DocLink id="serverlessSecurityExceptionsApiCreateContainer">exception container</DocLink>. | Yes |
