---
id: serverlessSecurityListsApiUpdateContainer
# slug: /serverless/security/lists-api-update-container
title: Update list container
# description: Description to be written
tags: [ 'serverless', 'security', 'reference' ]
status: rough content
---

<div id="lists-api-update-container"></div>
