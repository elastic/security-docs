---
id: serverlessSecurityTimelineApiImport
# slug: /serverless/security/timeline-api-import
title: Import timelines and timeline templates
# description: Description to be written
tags: [ 'serverless', 'security', 'reference' ]
status: rough content
---

<div id="timeline-api-import"></div>
