...
* **Actions**: Select the context menu (*...*) to do the following:
    ...
    * **Isolate host**: <DocLink id="serverlessSecurityHostIsolationOv">Isolate the host</DocLink> from your network, blocking communication until the host is released.
