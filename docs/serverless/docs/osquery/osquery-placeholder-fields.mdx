...
* <DocLink id="serverlessSecurityAlertsRunOsquery">Live queries</DocLink>
* <DocLink id="serverlessSecurityOsqueryResponseAction">Osquery Response Actions</DocLink>
* <DocLink id="serverlessSecurityInvestGuideRunOsquery">Investigation guides using Osquery queries</DocLink> 
