...
2. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-global-notes">Global notes</DocLink> (`globalNotes`)
3. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-dataViewId">Data view</DocLink> (`dataViewId`)
4. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-kqlquery">KQL bar query</DocLink> (`kqlQuery`)
5. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-daterange">Time filter</DocLink> (`dateRange`)
6. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-filters">Additional filters</DocLink> (`filters`)
7. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-kqlmode">KQL bar mode</DocLink> (`kqlMode`)
8. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-dropzone">Dropzone</DocLink> (each clause is contained in its own `dataProviders` object)
9. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-columns">Column headers</DocLink> (`columns`)
10. <DocLink id="serverlessSecurityTimelineObjectSchema" section="timeline-object-event-notes">Event-specific notes</DocLink> (`eventNotes`)
