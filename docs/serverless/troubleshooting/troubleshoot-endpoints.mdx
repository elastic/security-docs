...
This topic covers common troubleshooting issues when using ((elastic-defend))'s <DocLink slug="/serverless/security/manage-endpoint-protection">endpoint management tools</DocLink>.
