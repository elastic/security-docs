...
Use the <DocLink id="serverlessElasticsearchExploreYourDataDiscoverYourData">Discover UI</DocLink> to filter your data or learn about its structure.  
...
Identify misconfigurations and vulnerabilities in your cloud infrastructure. For setup instructions, refer to <DocLink id="serverlessSecurityCspm" />, <DocLink id="serverlessSecurityKspm" />, or <DocLink id="serverlessSecurityVulnManagementOverview" />.
