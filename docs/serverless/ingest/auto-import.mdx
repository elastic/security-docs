...
Click [here](https://elastic.navattic.com/automatic-import) to access an interactive demo of Automatic Import, before setting it up yourself.
</DocCallOut>
