...
====
If your new integration collects CEL data, you must install it before you can edit its CEL program. After installation, you can update the CEL program and API authentication information from the new integration's integration policy.
====
+
[role="screenshot"]
...
TIP: Once you've added an integration, you can edit the ingest pipeline by going to **Project Settings → Stack Management → Ingest Pipelines**.
