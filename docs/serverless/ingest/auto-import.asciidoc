...
[NOTE]
====
* A working <<connect-to-bedrock,Amazon Bedrock connector>>. Automatic Import currently works with all variants of Claude 3. Other models are not supported in this technical preview, but will be supported in future versions.
...
[discrete]
[[automatic-import-create-a-new-custom-integration]]
...
. Select an <<connect-to-bedrock,Amazon Bedrock connector>>.
...
[TIP]
====
You can use the <<data-quality-dash,Data Quality dashboard>> to check the health of your data ingest pipelines and field mappings.
====
