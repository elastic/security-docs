[[security-invest-guide-run-osquery]]
...
. Scroll down to the Investigation guide section. In the toolbar, click the **Osquery** button ([role="screenshot"]
image:images/invest-guide-run-osquery/-osquery-osquery-button.png[Click the Osquery button]).
+
