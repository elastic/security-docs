...
* Turn on the `securitySolution:enableAssetCriticality` <<security-advanced-settings-enable-asset-criticality-workflows,advanced setting>>.

For more information, refer to <<security-ers-requirements,Entity risk scoring prerequisites>>.
====
