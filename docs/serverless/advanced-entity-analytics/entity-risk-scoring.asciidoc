...
[discrete]
[[entity-risk-scoring-risk-scoring-inputs]]
== Risk scoring inputs
...
| <<asset-criticality,Asset criticality level>>
...
* To use asset criticality, you must enable the `securitySolution:enableAssetCriticality` <<advanced-settings-enable-asset-criticality-workflows,advanced setting>>.
====

[discrete]
[[entity-risk-scoring-how-is-risk-score-calculated]]
...
Learn how to <<turn-on-risk-engine,turn on the risk scoring engine>>.
