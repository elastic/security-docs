...
[NOTE]
====
To use entity risk scoring, you must have the appropriate user role. For more information, refer to <<ers-requirements>>.
====

[discrete]
[[turn-on-risk-engine-preview-risky-entities]]
...
[discrete]
[[turn-on-risk-engine-turn-on-the-risk-engine]]
