...
Additionally, for https://www.elastic.co/docs/current/serverless/custom-roles[custom roles], to configure <<alert-suppression,alert suppression>> for {ml} rules, your role needs the following index privilege:
