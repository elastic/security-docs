...
If you're experiencing performance degradation, you can  <DocLink id="serverlessSecurityAdvancedSettings" section="exclude-cold-and-frozen-tier-data-from-analyzer-queries">exclude cold and frozen tier data</DocLink> from analyzer queries.
</DocCallOut>
