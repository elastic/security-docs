...
* **Highlighted fields**: Shows relevant fields for the alert and any <DocLink slug="/serverless/security/rules-create" section="rule-ui-advanced-params"> custom highlighted fields</DocLink> you added to the rule. Custom highlighted fields with values are added to this section. Those without values aren't added.
...
From the right panel, click **Session view preview** or **Analyzer preview** to examine the alert in the event analyzer or session view on the **Visualize** tab  
