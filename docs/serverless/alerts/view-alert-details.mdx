...
* **Highlighted fields**: Shows relevant fields for the alert and any custom highlighted fields you added to the rule. Fields with values are added to the Highlighted fields section. Fields without values aren't added.
