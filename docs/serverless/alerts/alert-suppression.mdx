...
* <DocLink slug="/serverless/security/rules-create" section="create-esql-rule" text="((esql))" />
* <DocLink slug="/serverless/security/rules-create" section="create-ml-rule" text="((ml))" />
