...
Roles and privileges are configured in **Stack Management** → **Custom Roles**. For more details on using this UI, refer to <DocLink slug="/serverless/custom-roles-test" />.
