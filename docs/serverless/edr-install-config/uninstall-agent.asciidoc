...
<div class="tabs" data-tab-group="edr-install-config-uninstall-agent">
  <div role="tablist" aria-label="edr-install-config-uninstall-agent">
    <button role="tab" aria-selected="true" aria-controls="edr-install-config-uninstall-agent-macos-or-linux-panel" id="edr-install-config-uninstall-agent-macos-or-linux-button">
      macOS or Linux
    </button>
  ...
  <div tabindex="0" role="tabpanel" id="edr-install-config-uninstall-agent-macos-or-linux-panel" aria-labelledby="edr-install-config-uninstall-agent-macos-or-linux-button">
++++
[source,shell]
----
...
<div class="tabs" data-tab-group="edr-install-config-uninstall-agent">
  <div role="tablist" aria-label="edr-install-config-uninstall-agent">
    ...
    <button role="tab" aria-selected="false" aria-controls="edr-install-config-uninstall-agent-linux-panel" id="edr-install-config-uninstall-agent-linux-button" tabindex="-1">
      Linux
    </button>
    <button role="tab" aria-selected="false" aria-controls="edr-install-config-uninstall-agent-windows-panel" id="edr-install-config-uninstall-agent-windows-button" tabindex="-1">
      Windows
