...
* Fixes a bug that prevented related alerts from closing when the *Close all alerts that match this exception* option selected on an exception ({pull}150765[#150765]).
