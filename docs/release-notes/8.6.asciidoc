...
* Fixes issue with View in Discover when checking results for long list of {agents} ({pull}148260[#148260]).
* Add an advanced option for allowing and disallowing host isolation in Linux. 
