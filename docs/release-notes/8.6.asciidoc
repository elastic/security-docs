...
[[known-issue-8.6.0]]
==== Known issues
* Osquery investigation guides may not render formatting correctly if they include an escape: `\"`. You should copy-paste affected queries directly rather than importing them to avoid breaking query syntax (https://github.com/elastic/detection-rules/pull/2447[#2447]).
