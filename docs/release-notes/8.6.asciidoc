...
* Fixes a bug that prevented related alerts from closing when an exception had the *Close all alerts that match this exception* option selected ({pull}150765[#150765]).
* Ensures {elastic-endpoint} sends intermediate certificates to the server for SSL validation (https://github.com/elastic/endpoint-dev/issues/12226[#12226]).
