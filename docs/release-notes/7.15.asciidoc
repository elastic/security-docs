...
* Adds SQL query parser logic to the Osquery query ({pull}114932[#114932]).
* Fixes a table height issue that occurs when the Alerts table only has a few alerts ({pull}114718[#114718]).
* Truncates the last failure message and the last success message for siem-detection-engine-rule-status documents ({pull}112257[#112257]).
