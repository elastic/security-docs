...
==== Breaking changes
* After upgrading to {stack} version 7.15.x from a release between 7.12.0 and 7.14.2, you need to migrate detection alerts enriched with threat intelligence data to ensure threat intelligence properly displays in {elastic-sec}. For more information, refer to <<post-upgrade-req-cti-alerts, instructions for migrating detection alerts enriched with threat intelligence data>> ({pull}1102[#1102]).
