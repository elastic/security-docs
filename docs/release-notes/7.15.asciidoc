...
* Fixes live query search doesn't return relevant results for agents ({pull}116332[#116332]).
* Fixes SQL query parser logic ({pull}114932[#114932]).
* Fixes height issue ({pull}114718[#114718]).
* Truncates lastFailureMessage for siem-detection-engine-rule-status documents ({pull}112257[#112257]).
