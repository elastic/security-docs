...
* Fixes an {elastic-defend} bug that caused the **Open Elastic Security** button in Windows Security Center to be non-functional. Now, it informs the user that {elastic-defend} is managed by their system administrator.
