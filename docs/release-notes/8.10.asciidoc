...
[[features-8.10.0]]
==== New features
* Adds the MITRE ATT&CK® coverage page, which shows how the MITRE ATT&CK® adversary tactics and techniques are covered by your installed and enabled detection rules ({pull}161556[#161556], {pull}163498[#163498], {pull}164613[#164613], {pull}164986[#164986]).
...
* A confirmation message displays on the Rules page and rule details page when users delete rules ({pull}162477[#162477]). 
