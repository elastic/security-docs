...
[[bug-fixes-8.10.4]]
==== Bug fixes
* Fixes show top modal opened inside Timeline that shows no result ({pull}168339[#168339]).
* Fixes a Timeline bug that prevented the **Top alerts by** inline action from using the Timeline query ({pull}165109[#165109]).
