...
[discrete]
[[breaking-changes-8.10.2]]
==== Breaking changes

There are no breaking changes in 8.10.2.
...
[discrete]
[[breaking-changes-8.10.1]]
==== Breaking changes

There are no breaking changes in 8.10.1.

[discrete]
[[features-8.10.1]]
==== New features

There are no user-facing changes in 8.10.1.
