...
[[release-notes-8.1.1]]
=== 8.1.1
* Updates the exception flyout edit error messages ({pull}126875[#126875]).
* Adds the missing privileges callout to exception lists page ({pull}126874[#126874]).
* Disable upload value lists if user is kibana read only ({pull}126829[#126829]).
* Removes rule selection for read only users ({pull}126827[#126827]).
