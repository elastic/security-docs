...
* Adds the Insufficient privileges callout to the **Exception lists** page ({pull}126874[#126874]).
* Turns off the **Upload value lists** option on the **Rules** page if users only have `read` Security privileges ({pull}126829[#126829]).
* Removes the option to select rules in the All Rules table if users only have `read` Security privileges ({pull}126827[#126827]).
