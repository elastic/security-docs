...
[[bug-fixes-8.8.2]]
==== Bug fixes 
* Fixes a bug that prevented users from saving Timelines if they added a `number` field type to a Timeline ({pull}159723[#159723]).
...
* Removes hover actions from table within the Detection & Response dashboard when the alert count is zero ({pull}158902[#158902]).
