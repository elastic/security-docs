...
[[bug-fixes-8.8.2]]
==== Bug fixes 
* Fixes timeline bug receiving dataProvider value as number ({pull}159723[#159723]).
...
* Fixes hover Action showing for zero Count on D&R Dashboard ({pull}158902[#158902]).
* Fixes recently installed jobs remains greyed out on EA page ({pull}158821[#158821]).
* Fixes anomalies table pagination on EA page ({pull}158739[#158739]).
