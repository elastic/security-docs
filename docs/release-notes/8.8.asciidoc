...
// THIS ALSO MEANS IF YOU USE LINKS HERE, THEY SHOULD BE HARDCODED UNLESS ANY ATTRIBUTES ARE ALSO DEFINED WHERE THE SNIPPET IS REFERENCES
...
** https://www.elastic.co/guide/en/security/current/rules-api-get.html[Get rule]
** https://www.elastic.co/guide/en/security/current/rules-api-find.html[Find rules]
** https://www.elastic.co/guide/en/security/current/rules-api-create.html[Create rule]
** https://www.elastic.co/guide/en/security/current/rules-api-update.html[Update rule]
** https://www.elastic.co/guide/en/security/current/bulk-actions-rules-api.html[Bulk rule actions]
