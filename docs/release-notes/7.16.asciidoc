...
* Removes linked policies from trusted applications when removing the endpoint integration ({pull}108347[#108347]).
...
* Updates the description in the import rules dialogue ({pull}118216[#118216]).
* Fixes a faulty status API call if the selection is the same ({pull}118115[#118115]).
* Prevents autofocus from jumping to the wrong field ({pull}117950[#117950]).
* Removes validation the requires the action ID to be a UUID ({pull}116524[#116524]).
