...
* *Upcoming changes to case feature privileges*: In 8.0.0, case feature privileges will no longer be a sub-feature under {elastic-sec}. ({pull}113172[#113172])
