...
* Fixes copy to Clipboard not working for the Non-ECS Field ({pull}162883[#162883]).
* Fixes rounding in top alerts chart on the Alerts page ({pull}162647[#162647]).
* Adds dashboard controls ({pull}162514[#162514]).
* Fixes exceptions in investigate in timeline ({pull}162190[#162190]).
* Legacy actions are deleted when user tries to save a rule and the run action interval is slower than rule run interval ({pull}160798[#160798]).
