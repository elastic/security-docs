...
* A UI bug can affect the Alerts table's height, making it difficult to view alerts. To view alerts, you can open them in Timeline or readjust the table height and width. To readjust the table do one of the following:
