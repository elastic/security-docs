...
[[enhancements-8.9.1]]
==== Enhancements
* Event correlation rules can now detect missing events within EQL sequences. 
...
* Fixes rounding issues in the *Top alerts by* table on the Alerts page ({pull}162647[#162647]).
