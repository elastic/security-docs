...
* Adds simplified bulk editing for alert suppression ({kibana-pull}223090[#223090]).
...
* Adds an {elastic-defend} advanced policy setting that allows you to enable or disable the Microsoft-Windows-Security-Auditing ETW provider for security events collecion.
...
* Limits unassigned notes to a maximum of 100 per document instead of globally.
({kibana-pull}214922[#214922]).
