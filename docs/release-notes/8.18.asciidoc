...
After upgrading to 8.18 (or one of the 8.18 patch releases) from a {stack} version earlier than 8.9, you might encounter the following issues with gap fill functionality:
