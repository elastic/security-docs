...
[[enhancements-8.18.4]]
==== Enhancements
* Improves logging of fatal exceptions.
...
* Fixes a bug where the **Rules**, **Alerts**, and **Fleet** pages would stall in air-gapped environments by ensuring API requests are sent even when offline ({kibana-pull}220510[#220510]).
