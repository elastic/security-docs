...
* Fixes an issue where detection rules that were created or edited in 8.2.x failed execution after upgrading to {stack} to 8.3.0 or 8.3.1 ({pull}135663[#135663).

====

[IMPORTANT]

If you already upgraded to 8.3.0 or 8.3.1 and noticed that rules created or updated in 8.2.x were failing with an error similar to the following message, complete the appropriate steps for restoring your rules after you upgrade to 8.3.2. Refer to the <<known-issue-8.3.1, known issue section>> of the 8.3.2 release notes for more information.
