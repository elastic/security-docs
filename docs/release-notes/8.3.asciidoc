...
+
If you're upgrading to 8.3.2 from 8.3.1 and your detection rules affected by the <<known-issue-8.3.1, bug>> in 8.3.1, follow the steps for restoring affected custom and prebuilt rules.
...
[discrete]
[[known-issue-8.3.1-restore-cpbr]]
