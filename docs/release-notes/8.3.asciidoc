...
* Adds confirmation modal with docs link when updating prebuilt {ml} rules if V1/V2 {ml} jobs are installed ({pull}128334[#128334]).
...
* Updates notification logic for importing rules ({pull}131873[#131873]).
