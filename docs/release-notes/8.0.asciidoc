...
The *Data View* option might not display in environments with legacy alerts. To resolve this, a user with elevated role privileges must visit the {elastic-sec-app}, open a page that displays alert data (such as the Overview page), then refresh the page ({pull}121390[#121390]).
