...
Before upgrading, use the {api-kibana}/operation/operation-readrule[Find rules] API to retrieve a list of enabled detection rules in your environment. You can reference this list when re-enabling rules after you upgrade.
...
Alternatively, you can use the {api-kibana}/operation/operation-performrulesbulkaction[bulk rule actions API] to re-enable rules.
