...
** To preserve the comment during the import process, only remove meta data about the comment. Meta data is stored in the `created_at`, `created_by`, `updated_at`, and `updated_by` fields.
** If you do not want to preserve the comment, remove it entirely.
