...
* Removes the ability from the UI to enable and disable machine learning rules if users don’t have the Machine Learning privilege in Kibana set to `All` ({pull}143252[#143252]).
* Fixes bug that caused the Indicators page to crash ({pull}144348[#144348], {pull}144651[#144144651348]).
