...
* Kubernetes Security Posture Management (KSPM) is now GA. You can use the integration to monitor the security posture of your self-managed and Amazon EKS clusters at scale in production. 
