...
* Enables the Osquery Response Action on detection rules and adds an *Osquery Results* tab to the Alert details flyout. You can use the Osquery Response Action to immediately query hosts that generate alerts ({pull}133279[#133279]).
