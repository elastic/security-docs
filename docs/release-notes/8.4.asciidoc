...
* Aligns the delete icon in the Add Rule Exception flyout ({pull}141365[#141365]).
* Aligns the warning message title on the Rule details page with the warning icon  ({pull}140719[#140719]).
* Fixes a bug that sometimes caused {elastic-endpoint} to stop running on Windows endpoints.
