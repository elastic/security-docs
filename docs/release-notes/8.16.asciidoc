...
* Adds a kibana advanced setting `securitySolution:maxUnassociatedNotes` that allows you to limit the maximum number of notes that are not associated with a timeline ({kibana-pull}194947[#194947]). 
