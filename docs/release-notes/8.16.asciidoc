...
====
*Details* +
On November 14, 2024, it was discovered that the Alerts page would crash and display an `Unable to load` error if you upgraded to 8.16 and accessed the page in a non-default space.
...
. Refresh the Alerts page. The Alerts table re-renders correctly.
