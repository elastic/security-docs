...
// tag::known-issue[]
[discrete]
.Installing an {elastic-defend} integration or a new agent policy upgrades all the installed prebuilt rules, overwriting user-added actions and exceptions
[%collapsible]
====
*Details* +
