...
* Creates a new advanced setting `securitySolution:excludedDataTiersForRuleExecution` that allows you to exclude cold and frozen data from rule executions. This setting does not apply to {ml} rules ({kibana-pull}186908[#186908]). 
+
