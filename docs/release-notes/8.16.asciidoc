...
* Changes the validation for API responses from SentinelOne and Crowdstrike. With this fix, non-JSON responses, such as stream, are allowed ({kibana-pull}203820[#203820]).
