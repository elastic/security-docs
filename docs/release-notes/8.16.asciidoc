...
====
*Details* +
On November 12, 2024, it was discovered that manually running a custom query rule with suppression could produce an inflated amount of suppressed alerts.
...
* Improves Automatic Import's ability to recognize events formatted as CSV ({kibana-pull}196228[#196228]).
