...
* If Endpoint's service is corrupted it will no longer unnecessarily prevent a Windows computer from booting (https://github.com/elastic/endpoint/issues/20[#20]).
