...
* Backports the bug that prevented Endpoint Security 8.1.1 from being run on Windows 8.1 and Server 2012 R2. With this change, the primary signer for `elastic-endpoint.exe` has changed from ELASTICSEARCH B.V. to Elasticsearch, Inc. (https://github.com/elastic/endpoint/issues/15[#15]).
