...
* Updates the minimum role permissions needed to import rules with actions. With this fix, a role requires at least `Read` privs for the `Actions and Connectors` feature to import rules with actions ({pull}126203[#126203]). 
