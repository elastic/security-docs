...
* Adds an action to the Alert details flyout that isolates (or releases) SentinelOne hosts ({pull}168441[#168441]).
...
* Implements Azure and Okta asset integration (user flyout) ({pull}171629[#171629]). (BEHIND FEATURE FLAG? - waiting on dev follow-up)
...
* Updates the user details flyout ({pull}169514[#169514]). (FEATURE FLAG? Waiting on dev followup)
