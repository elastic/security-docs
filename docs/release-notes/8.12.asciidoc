...
* Fixes a bug with the agent select field in Osquery bug with `-` ({pull}175134[#175134]).
...
* Ensures the current user is used when querying for threshold rule history ({pull}174723[#174723]).
...
* Fixes a bug that prevented the assignee column from displaying in Alerts table after upgrading to 8.12 ({pull}174370[#174370]).
