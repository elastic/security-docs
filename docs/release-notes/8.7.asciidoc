...
* Introduces [Cloud Security Posture Management (CSPM) feature](https://ela.st/cspm) with support for AWS, which continuously detects misconfigured cloud resources in AWS accounts. 
