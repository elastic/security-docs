...
* The **Add exceptions flyout** loads indefinitely and an out of memory error displays in the **Add exceptions flyout** if a rule's indices has a large number of fields.
