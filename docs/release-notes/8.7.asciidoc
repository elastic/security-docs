...
NOTE: This problem can occur when upgrading {agents} from versions 8.6.2 or 8.7.0 to any other version. Keep this in mind when upgrading {agents} running 8.7.0 to later versions.
