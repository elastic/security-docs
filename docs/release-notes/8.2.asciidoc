...
* Avoid using indices populated from value lists for indicator match rules. Indicator match rules cannot use the `.lists` system index and will encounter execution errors when ran ({pull}133457[#133457]).
