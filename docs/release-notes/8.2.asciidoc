...
* Enables wildcards for `file.path.text` fields within event filters with the *matches* operator ({pull}125202[#125202]).
...
* Displays a confirmation message when user modifies an event filter ({pull}128810[#128810]).
