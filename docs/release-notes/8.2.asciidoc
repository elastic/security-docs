...
[[deprecations-8.2.0]]
==== Deprecations
The following APIs are deprecated ({pull}129448[#129448]) and will be removed in a future release. They will remain active for at least the next 18 months:
...
* The *Policies* page lists all of the integration policies configured for Endpoint Security. You can use the page to quickly find and manage your Endpoint Security integration policies ({pull}123760[#123760]).
