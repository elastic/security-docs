...
[[known-issue-8.11.0]]
==== Known issues
* Duplicate rules are displayed in MITRE ATT&CK® technique cells ({issue}167929[#167929]).
* The incorrect rule count is shown in MITRE ATT&CK® technique cells ({issue}167930[#167930]).
* The incorrect MITRE ATT&CK® sub-technique is applied after saving a rule ({issue}170347[#170347]).
