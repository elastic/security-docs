...
[[bug-fixes-8.13.2]]
==== Bug fixes
* Fixes a bug that automatically checked checkboxes on the Alerts page when you selected filter labels ({kibana-pull}179610[#179610]).
...
* Allows information on the Data Quality dashboard to persist in {elastic-sec} rather than disappearing after each session ({kibana-pull}175673[#175673], {kibana-pull}173185[#173185]).
