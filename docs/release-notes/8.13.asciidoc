...
[[bug-fixes-8.13.1]]
==== Bug fixes
* Fixes a bug that automatically checked checkboxes on the Alerts page when you clicked filter labels ({pull}179610[#179610]).
* Fixes a bug that prevented the KQL bar on the Intelligence page from providing suggestions and applying filters correctly ({pull}179153[#179153]).
