...
[[bug-fixes-8.13.2]]
==== Bug fixes
* Fixes a bug that broke the Alert table filters and stopped them from retrieving correct values if you used the inline filter in or out actions. ({kibana-pull}179911[#179911]).
