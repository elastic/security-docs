...
* Display better error messages for issues with logs sample file upload in Automatic Import ({kibana-pull}191310[#191310]).

[discrete]
[[bug-fixes-8.15.2]]
==== Bug fixes
* Fixes the integrations owner type to `Community` ({kibana-pull}193002[#193002]).
