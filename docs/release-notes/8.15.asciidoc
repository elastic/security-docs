...
[[bug-fixes-8.15.2]]
==== Bug fixes
* Doesn’t allow the Google Gemini connector to accept unknown properties in responses, which resolves an error that occurred when generating Attack discoveries ({kibana-pull}192915[#192915]).
