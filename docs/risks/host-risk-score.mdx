...
This feature requires a [Platinum subscription](https://www.elastic.co/pricing) or higher.
</DocCallOut>
{/* Subscription reference to be updated in issue #30 */}
...
You can enable host risk score from the following places in the ((elastic-sec)) project:
