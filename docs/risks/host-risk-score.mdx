...
<DocCallOut title="Note">
To enable the host risk score feature, you must have alerts in your environment. If you previously enabled host risk score and are upgrading the ((stack)) to 8.5 or newer, refer to <DocLink id="serverlessSecurityHostRiskScore" section="upgrade-host-risk-score">Upgrade host risk score </DocLink>. 
</DocCallOut>
