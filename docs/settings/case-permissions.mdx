...
{/* Might want to delete this intro para. Is no longer necessary in Serverless and doesn't add value to the topic. */}
...
Certain subscriptions and roles might be required to manage case attachments. For example, to add alerts to cases, you must have a role that allows <DocLink id="serverlessSecurityDetectionsPermissionsSection" section="enable-and-access-detections">managing alerts</DocLink>. 
</DocCallOut>
