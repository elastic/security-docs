---
id: serverlessSecurityConfMapUi
...
* <DocLink id="serverlessSecurityConfMapUi" section="create-((kib))-data-views">Create ((kib)) data views</DocLink>
* <DocLink id="serverlessSecurityConfMapUi" section="add-geoip-data">Add geographical IP data to events</DocLink>
* <DocLink id="serverlessSecurityConfMapUi" section="map-your-internal-network">Map your internal network</DocLink>
...
[data view](((kibana-ref))/data-views.html) (**Project settings** -> **Management** -> **Data views**) that includes one or more of the indices specified in the `securitysolution:defaultIndex` field
(**Project settings** -> **Management** -> **Data views** -> **`securitysolution:defaultIndex`**).
...
1. In your Beats configuration files, add the pipeline to the
    ...
    <DocLink id="serverlessSecurityConfMapUi" section="geo-pipeleine">step 1</DocLink> (`geoip-info` in this example).
