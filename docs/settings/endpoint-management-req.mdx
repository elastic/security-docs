...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      Access the <DocLink id="serverlessSecurityAdminPageOv">Endpoints</DocLink> page, which lists all hosts running ((elastic-defend)), and associated integration details.
