...
+
When Knowledge base is enabled, a quick prompt for {esql} queries becomes available. It provides a good starting point for your ESQL conversations and questions.