...
AI Assistant can connect to multiple large language model (LLM) providers so you can select the best model for your needs. For information about setting up a connector, refer to <<llm-connector-guides,LLM connector setup guides>>
