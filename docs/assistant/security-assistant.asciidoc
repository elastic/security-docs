...
. Create an API key with your AI provider to authenticate requests from the AI Assistant. You'll use this in a later step. Refer to the provider's documentation for generating API keys:
+
