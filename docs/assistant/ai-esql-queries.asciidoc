...
This page describes some of the ways <<security-assistant, Elastic AI Assistant>> can help you leverage the Elasticsearch Query Language ({ref}/esql-kibana.html[{esql}]). 
