...
To get started using ES|QL, read the tutorial for {ref}/esql.html[using ES|QL in Kibana]. Much of the functionality available in Kibana is also available in Timeline.  
