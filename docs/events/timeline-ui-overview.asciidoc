...
Using the drop-down options by the KQL bar, you can select whether <<det-engine-terminology, alerts>>,
...
contextual information, called *Event Renderers*. You can see and turn them on or off
