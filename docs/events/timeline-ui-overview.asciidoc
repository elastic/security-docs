...
To get started using {esql}, read the tutorial for {ref}/esql-kibana.html[using {esql} in Kibana]. Much of the functionality available in Kibana is also available in Timeline.  
