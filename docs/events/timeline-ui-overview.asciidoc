...
[discrete]
[[timeline-inspect-alerts]]
== Inspect alert details
To further inspect a detection alert, click the *View details* button. The Alert details flyout appears with several options to view alert data. Refer to <<view-alert-details,View alert details>> for more information.
