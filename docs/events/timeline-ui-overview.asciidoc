...
* From an open Timeline, click **New** → **New Timeline template**.

To open an existing Timeline, choose one of the following: 

* Go to the Timelines page, click a Timeline's title. 
...
* From an open Timeline, click **Open**, then select the appropriate Timeline. 
