...
* *Delete selected*
* *Create query rule from timeline*
+
NOTE: This option is only available if the Timeline contains a KQL query.

* *Create EQL rule from timeline*
+
NOTE: This option is only available if the Timeline contains an EQL query.
