...
NOTE: The **{esql}** Timeline tab is available by default. To hide the tab and turn it off, toggle the {kibana-ref}/advanced-options.html#kibana-general-settings[`enableESQL`] advanced setting off.
