...
From the *ES|QL* tab, write ES|QL queries that interact with your alert data, then visualize query results using {kibana-ref}/discover.html[Discover] functionality in the tab. 

The tab's default query searches for alerts that were generated during the last 15 minutes, and returns up to 10 results. Modify any part of the query and selected time frame to display different results.
