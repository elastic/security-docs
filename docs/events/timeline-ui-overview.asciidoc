...
Accessibility features, such as keyboard focus and screen reader support, are built into the Timeline interface. These features offer additional ways for you to navigate through the interface and interact with draggable and static elements in the Timeline.

[discrete]
[[draggable-timeline-elements]]
=== Interact with draggable Timeline elements

From the *Timeline* tab, use your keyboard to do one of the following:

* Select a draggable element on the Timeline to give it keyboard focus.

[role="screenshot"]
image::images/test2.gif[width=100%][height=100%][Demo that shows how anonymous access works]
.

* Press *Enter* on an element with keyboard focus to display its menu.
* Use the spacebar to drag and drop an element with keyboard focus to a different location.


[discrete]
[[timeline-tab]]
=== Navigate the Timeline tab
From the *Timeline* tab, use your keyboard to do one of the following:
