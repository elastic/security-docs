...
IMPORTANT: As of {stack} version 8.0.0 and newer, the system index for detection alerts has been renamed from `.siem-signals-<Kibana space>` to `.alerts-security.alerts-<Kibana space>`. 
