...
Once you open a pull request, preview links are automatically added as a comment on the PR. Once the CI build is complete, the links will be live and you can follow them to preview your changes.

You also might want to add targeted links to the PR description to help reviewers find specific pages related to your PR. Preview URLs include the following pattern, based on the PR number (replace `<YOUR_PR_NUMBER_HERE>` with the PR number):
