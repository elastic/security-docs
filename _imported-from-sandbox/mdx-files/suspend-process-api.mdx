---
id: enSecuritySuspendProcessApi
...
You must have the **Process Operations** <DocLink id="enSecurityEndpointManagementReq">privilege</DocLink> and at least an Enterprise license to perform this action.
