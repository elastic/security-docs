---
id: enSecurityExceptionsApiCreateExceptionItem
...
<DocLink id="enSecurityExceptionsApiCreateContainer">exception container</DocLink>.

Refer to <DocLink id="enSecurityListsApiOverview">Lists API</DocLink> for information about creating exception items from
...
<DocLink id="enSecurityListsApiOverview">lists</DocLink> (the `list` in the `entries` array), and the
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityExceptionsApiCreateExceptionItem" section="entries-schema">entries[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell>String</DocCell>
    <DocCell>ID of the associated <DocLink id="enSecurityExceptionsApiCreateContainer">exception container</DocLink>.</DocCell>
    <DocCell>
      Yes
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      <DocLink id="enSecurityListsApiCreateContainer">list container's</DocLink> `id` and `type`. Only valid for
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      * `nested`: Array of `entries` objects. Nested conditions are required for
          excluding some Endpoint fields (<DocLink id="enSecurityExceptionsApiCreateExceptionItem" section="nested-field-ex-api">refer to example below</DocLink>).
          <DocLink id="enSecurityAddExceptions" section="exceptions-with-nested-conditions">Exceptions with nested conditions</DocLink> lists all Endpoint fields that require the `nested`
          type.
...
<DocCallOut title="Important" color="warning">
When you use <DocLink id="enSecurityListsApiCreateContainer">list containers</DocLink>
...
Associates the `external-ip-excludes` <DocLink id="enSecurityListsApiCreateContainer">list container</DocLink>
...
<DocLink id="enSecurityListsApiCreateListItem">list items</DocLink>.
