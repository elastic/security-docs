...
`Isolated` is a persistent status until the endpoint is given a release command. You must have the **Host Isolation** <DocLink id="enSecurityEndpointManagementReq">privilege</DocLink> and at least a Platinum license to perform this action.
