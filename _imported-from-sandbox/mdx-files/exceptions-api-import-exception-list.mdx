---
id: enSecurityExceptionsApiImportExceptionList
...
An exception list groups <DocLink id="enSecurityExceptionsApiCreateExceptionItem">exception items</DocLink>
...
You can assign multiple exception lists to a detection rule. For more information, refer to <DocLink id="enSecurityRulesApiCreate">Create rule</DocLink> and <DocLink id="enSecurityRulesApiUpdate">Update rule</DocLink>.
