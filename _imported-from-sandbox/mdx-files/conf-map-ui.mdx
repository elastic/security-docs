---
id: enSecurityConfMapUi
slug: /en/security/conf-map-ui
title: Configure network map data
...
* <DocLink id="enSecurityConfMapUi" section="create-((kib))-data-views">Create ((kib)) data views</DocLink>
* <DocLink id="enSecurityConfMapUi" section="add-geoip-data">Add geographical IP data to events</DocLink>
* <DocLink id="enSecurityConfMapUi" section="map-your-internal-network">Map your internal network</DocLink>
...
[data view](((kibana-ref))/data-views.html) (*Stack Management* ->
...
1. In your Beats configuration files, add the pipeline to the
    ...
    <DocLink id="enSecurityConfMapUi" section="geo-pipeleine">step 1</DocLink> (`geoip-info` in this example).
