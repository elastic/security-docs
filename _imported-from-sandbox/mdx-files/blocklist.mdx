---
id: enSecurityBlocklist
slug: /en/security/blocklist
title: Blocklist
...
* In addition to configuring specific entries on the **Blocklist** page, you must also ensure that the blocklist is enabled on the ((elastic-defend)) integration policy in the <DocLink id="enSecurityConfigureEndpointIntegrationPolicy" section="malware-protection">Malware protection settings</DocLink>. This setting is enabled by default.

* You must have the **Blocklist** <DocLink id="enSecurityEndpointManagementReq">privilege</DocLink> to access this feature.
