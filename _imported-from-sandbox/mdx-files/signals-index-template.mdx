---
id: enSecuritySignalsIndexTemplate
slug: /en/security/signals-index-template
title: Index template script
description: Description to be written
tags: []
---

<div id="signals-index-template"></div>
...
In ((stack)) version 8.0.0, the system index for detection alerts was renamed from `.siem-signals-<Kibana space>` to `.alerts-security.alerts-<Kibana space>`. 
</DocCallOut>

<DocCallOut title="Tip">
<DocLink id="enSecuritySignalsIndexTemplate" section="bottom">Click here</DocLink> to scroll to the bottom of the page and use the
...
<span id="bottom"></span>  <DocLink id="enSecuritySignalsIndexTemplate">Back to top</DocLink>
