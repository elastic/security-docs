---
id: enSecurityExceptionsApiFindExceptionItems
...
|---|---|---|---|
| `list_id` | String | ID of the <DocLink id="enSecurityExceptionsApiCreateContainer">exception container</DocLink>. | Yes |
