---
id: enSecurityRuntimeFields
slug: /en/security/runtime-fields
...
You can create a runtime field and add it to your detection alerts or events from any page that lists alerts or events in a data grid table, such as **Alerts**, **Timelines**, **Hosts**, and **Users**. Once created, the new field is added to the current <DocLink id="enSecurityDataViewsInSec">data view</DocLink> and becomes available to all ((elastic-sec)) alerts and events in the data view.
