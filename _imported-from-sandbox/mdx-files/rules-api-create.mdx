---
id: enSecurityRulesApiCreate
slug: /en/security/rules-api-create
title: Create rule
description: Create a new detection rule.
tags: ["security","alerting","reference","manage"]
---

<div id="rules-api-create"></div>
...
* **Threshold**: Searches the defined indices and creates an alert when the
    ...
    [Terms Aggregation](((ref))/search-aggregations-bucket-terms-aggregation.html) for
    more information.

* **Indicator match**: Creates an alert when fields match values defined in the
    specified [((es)) index](((ref))/indices-create-index.html). For example, you can
    ...
    mappings should be [ECS-compliant](((ecs-ref))).
...
[cloud deployment](((ess-trial))). Additionally, for the ((ml)) rule to function
correctly, the associated ((ml)) job must be running.
</DocCallOut>

To retrieve ((ml)) job IDs, which are required to create ((ml)) jobs, call the
[((es)) Get jobs API](((ref))/ml-get-job.html). ((ml-cap)) jobs that contain `siem` in
...
notifications use the ((kib)) [Alerting and Actions framework](((kibana-ref))/alerting-getting-started.html).
...
For more information on PagerDuty fields, see
[Send a v2 Event](https://developer.pagerduty.com/docs/events-api-v2/trigger-events/).
</DocCallOut>

To retrieve connector IDs, which are required to configure rule notifications,
call the ((kib)) [Find objects API](((kibana-ref))/saved-objects-api-find.html) with
...
* <DocLink id="enSecurityRulesApiCreate" section="required-fields-for-all-rule-types">Required fields for all rule types</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-field-for-query-indicator-match-and-threshold-rules">Required field for query, indicator match and threshold rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-field-for-threshold-rules">Required field for threshold rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-field-for-saved-query-rules">Required field for saved query rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-field-for-event-correlation-rules">Required field for event correlation rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-fields-for-machine-learning-rules">Required fields for machine learning rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="required-fields-for-indicator-match-rules">Required fields for indicator match rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="optional-fields-for-all-rule-types">Optional fields for all rule types</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="optional-fields-for-query-indicator-match-and-event-correlation-rules">Optional fields for query, indicator match, and event correlation rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="optional-fields-for-indicator-match-rules">Optional fields for indicator match rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="optional-fields-for-query-indicator-match-and-threshold-rules">Optional fields for query, indicator match, and threshold rules</DocLink>
* <DocLink id="enSecurityRulesApiCreate" section="optional-fields-for-event-correlation-query-and-threshold-rules">Optional fields for event correlation, query, and threshold rules</DocLink>

<div id="ref-fields-all"></div>
...
<div id="req-fields-threshold"></div>
...
<div id="req-fields-saved-query"></div>
...
| machine_learning_job_id | String[] | ((ml-cap)) job ID(s) the rule monitors for anomaly scores. |

<div id="req-fields-threat-match"></div>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      * `value`: field from the ((es)) threat index
      ...
      object use `and` logic. See <DocLink id="enSecurityRulesApiCreate" section="threat-match-example">below</DocLink> for an example that
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityRulesApiCreate" section="actions-schema">actions[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      **NOTE**: To avoid rule failures, do not set the `max_signals` value higher than the value of [`xpack.alerting.rules.run.alerts.max`](((kibana-ref))/alert-action-settings-kb.html#alert-settings). 
  ...
  <DocRow>
    <DocCell>rule_id</DocCell>
    <DocCell>String</DocCell>
    <DocCell>
      Unique ID used to identify rules. For example, when a rule
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityRulesApiCreate" section="threat-schema">threat[]</DocLink></DocCell>
    <DocCell>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      In ((elastic-sec)) 8.8 and later, you can use the (<DocLink id="enSecurityBulkActionsRulesApi" section="optional-action-fields">`frequency`</DocLink>) field to define frequencies for individual actions. Actions without frequencies will acquire a converted version of the rule's `throttle` field. In the response, the converted `throttle` setting appears in the individual actions' `frequency` field.
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>
      Array of
      <DocLink id="enSecurityExceptionsApiOverview">exception containers</DocLink>, which define
...
<div id="opt-fields-threat-match"></div>
...
<div id="opt-fields-eql-create"></div>
...
<div id="actions-object-schema"></div>
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>String</DocCell>
    <DocCell>
      The connector type used for sending notifications, can
      be:
...
<div id="optional-actions-fields-rule-create"></div>
...
<div id="action-variables-rule-create"></div>
...
<div id="response-actions-object-schema"></div>
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      * `.endpoint`
      ...
      <DocCallOut title="Note">
      To learn more about the requirements for using the isolate endpoint response action, refer to \<\<host-isolation-ov>>. 
  ...
  <DocRow>
    ...
    <DocCell>
      ...
      * `ecs_mapping` (object, required): Map Osquery results columns or static values to Elastic Common Schema (ECS) fields. Example: `"ecs_mapping": {"process.pid": {"field": "pid"}}`
      ...
      <DocCallOut title="Note">
      Refer to [Create live query API](((kibana-ref))/osquery-manager-live-queries-api-create.html) for more information about running Osquery queries and packs.
      </DocCallOut>
      ...
      * `comment` (string, optional):  Add a note that explains or describes the action. You can find your comment in the <DocLink id="enSecurityResponseActionsHistory">response actions history log</DocLink>. Example: `"comment": "Check processes"` 
...
<div id="threats-object-create"></div>
...
<div id="threat-match-example"></div>
