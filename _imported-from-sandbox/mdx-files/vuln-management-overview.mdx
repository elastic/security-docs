---
id: enSecurityVulnManagementOverview
slug: /en/security/vuln-management-overview
...
Setup uses infrastructure as code. For instructions, refer to <DocLink id="enSecurityVulnManagementGetStarted">Get started with Cloud Native Vulnerability Management</DocLink>.
...
The scanning process begins immediately upon deployment, then repeats every twenty-four hours. After each scan, the integration sends the discovered vulnerabilities to ((es)), where they appear in the **Vulnerabilities** tab of the <DocLink id="enSecurityVulnManagementFindings">Findings page</DocLink>.
