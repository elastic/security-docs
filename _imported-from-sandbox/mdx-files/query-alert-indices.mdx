---
id: enSecurityQueryAlertIndices
slug: /en/security/query-alert-indices
...
This page explains how you should query alert indices, for example, when building rule queries, custom dashboards, or visualizations. For more information about alert event field definitions, review the <DocLink id="enSecurityAlertSchema">Alert schema</DocLink>.
