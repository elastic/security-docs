---
id: enSecurityListsApiCreateListItem
...
<DocLink id="enSecurityListsApiCreateContainer">list container</DocLink>.
...
| `list_id` | String | ID of the associated <DocLink id="enSecurityListsApiCreateContainer">list container</DocLink>. | Yes |
| `meta` | Object | Placeholder for metadata about the list item. | No |
| `value` | String | The value used to evaluate exceptions. For information on how list item exceptions are evaluated, see <DocLink id="enSecurityExceptionsApiCreateExceptionItem">Create exception item</DocLink>. | Yes |
...
<DocLink id="enSecurityListsApiUpdateItem">updating a list item</DocLink>.
