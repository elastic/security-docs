---
id: enSecurityOsqueryPlaceholderFields
slug: /en/security/osquery-placeholder-fields
...
* <DocLink id="enSecurityAlertsRunOsquery">Live queries</DocLink>
* <DocLink id="enSecurityOsqueryResponseAction">Osquery Response Actions</DocLink>

* <DocLink id="enSecurityInvestGuideRunOsquery">Investigation guides using Osquery queries</DocLink> 
