...
slug: /en/security/admin-page-ov
title: Endpoints
...
The Endpoints page allows administrators to view and manage endpoints that are running the <DocLink id="enSecurityInstallEndpoint">((elastic-defend)) integration</DocLink>.
