...
`.siem-signals-<Kibana-space>` indices, see <DocLink id="enSecurityDetectionsPermissionsSection" section="enable-and-access-detections">Enable and access detections</DocLink>.
