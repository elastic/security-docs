---
id: enSecurityCspmGetStarted
slug: /en/security/cspm-get-started
...
* <DocLink id="enSecurityCspmGetStarted" section="option-1-default-instance-role">Default instance role (recommended)</DocLink>
* <DocLink id="enSecurityCspmGetStarted" section="option-2-direct-access-keys">Direct access keys</DocLink>
* <DocLink id="enSecurityCspmGetStarted" section="option-3-temporary-security-credentials">Temporary security credentials</DocLink>
* <DocLink id="enSecurityCspmGetStarted" section="option-4-shared-credentials-file">Shared credentials file</DocLink>
* <DocLink id="enSecurityCspmGetStarted" section="option-5-iam-role-amazon-resource-name-arn">IAM role Amazon Resource Name (ARN)</DocLink>
...
1. Attach your new IAM role to an EC2 instance:
    ...
    1. Return to ((kib)) and <DocLink id="enSecurityCspmGetStarted" section="finish-manual-setup">finish manual setup</DocLink>.
...
Access keys are long-term credentials for an IAM user or AWS account root user. To use access keys as credentials, you must provide the `Access key ID` and the `Secret Access Key`. After you provide credentials, <DocLink id="enSecurityCspmGetStarted" section="finish-manual-setup">finish manual setup</DocLink>.
...
After you provide credentials, <DocLink id="enSecurityCspmGetStarted" section="finish-manual-setup">finish manual setup</DocLink>.
...
After providing credentials, <DocLink id="enSecurityCspmGetStarted" section="finish-manual-setup">finish manual setup</DocLink>.
