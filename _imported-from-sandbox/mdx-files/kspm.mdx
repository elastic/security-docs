...
This integration supports Amazon EKS and unmanaged Kubernetes clusters. For setup instructions, refer to <DocLink id="enSecurityGetStartedWithKspm">Get started with KSPM</DocLink>.
...
1. After each evaluation, the integration sends findings to ((es)). Findings appear on the <DocLink id="enSecurityCloudNatSecPostureDashboard">Cloud posture dashboard</DocLink> and the <DocLink id="enSecurityFindingsPage">findings</DocLink> page.
...
1. Go to the <DocLink id="enSecurityCloudNatSecPostureDashboard">Cloud posture dashboard</DocLink>.
...
1. Go to the <DocLink id="enSecurityFindingsPage">Findings</DocLink> page.
...
1. Go to the <DocLink id="enSecurityCloudNatSecPostureDashboard">Cloud posture dashboard</DocLink> (*Dashboards -> Cloud Posture*).
