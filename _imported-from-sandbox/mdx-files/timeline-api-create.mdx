---
id: enSecurityTimelineApiCreate
...
Use the `timeline` object's <DocLink id="enSecurityTimelineObjectSchema" section="timeline-object-typeField">`timelineType`</DocLink> field
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell><DocLink id="enSecurityTimelineObjectSchema">timeline</DocLink></DocCell>
    <DocCell>
      ...
      easily <DocLink id="enSecurityTimelineApiImport">import template</DocLink> updates:
