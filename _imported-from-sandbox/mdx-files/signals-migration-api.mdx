---
id: enSecuritySignalsMigrationApi
...
1. <DocLink id="enSecuritySignalsMigrationApi" section="determine-which-indices-to-migrate">Determine which indices to migrate</DocLink>
1. <DocLink id="enSecuritySignalsMigrationApi" section="initiate-migrations">Initiate migrations</DocLink>
1. <DocLink id="enSecuritySignalsMigrationApi" section="finalize-migrations">Finalize migrations</DocLink>
1. <DocLink id="enSecuritySignalsMigrationApi" section="migration-cleanup">Migration cleanup</DocLink> (optional)
...
<DocCallOut title="Note">
The original indices are not removed as part of this step. After verifying the integrity of the migrated index, you can use the <DocLink id="enSecuritySignalsMigrationApi" section="migration-cleanup">Migration cleanup</DocLink> endpoint to apply a 30-day deletion policy to the original, outdated index.
</DocCallOut>
