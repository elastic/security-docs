---
id: enSecurityCasePermissions
slug: /en/security/case-permissions
title: Cases prerequisites
...
Certain subscriptions and privileges might be required to manage case attachments. For example, to add alerts to cases, you must have privileges for <DocLink id="enSecurityDetectionsPermissionsSection" section="enable-and-access-detections">managing alerts</DocLink>. 
</DocCallOut>
