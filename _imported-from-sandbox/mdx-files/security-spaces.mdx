---
id: enSecuritySecuritySpaces
slug: /en/security/security-spaces
title: Spaces and ((elastic-sec))
description: Description to be written
tags: []
---

<div id="security-spaces"></div>

((elastic-sec)) supports the organization of your security operations into
logical instances with the [((kib)) spaces](((kibana-ref))/xpack-spaces.html)
...
((es)) and ((kib)), refer to <DocLink id="enSecurityDetectionsPermissionsSection">Detections prerequisites and requirements</DocLink>.
