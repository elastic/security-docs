---
id: enSecurityListsApiImportListItems
...
|---|---|---|---|
| `list_id` | String | ID of the <DocLink id="enSecurityListsApiCreateContainer">list container</DocLink>. | Required when importing to an existing container. |
