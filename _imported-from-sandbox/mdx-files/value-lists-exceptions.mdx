---
id: enSecurityValueListsExceptions
slug: /en/security/value-lists-exceptions
...
After creating value lists, you can use `is in list` and `is not in list` operators to <DocLink id="enSecurityAddExceptions">define exceptions</DocLink>.

<DocCallOut title="Tip">
You can also use a value list as the <DocLink id="enSecurityRulesUiCreate" section="use-value-lists-with-indicator-match-rules">indicator match index</DocLink> when creating an indicator match rule.
</DocCallOut>
