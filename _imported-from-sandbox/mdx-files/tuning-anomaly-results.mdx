---
id: enSecurityTuningAnomalyResults
slug: /en/security/tuning-anomaly-results
...
* <DocLink id="enSecurityTuningAnomalyResults" section="filter-out-anomalies-from-rarely-used-applications-and-processes">Tune results for rare applications and processes</DocLink>
* <DocLink id="enSecurityTuningAnomalyResults" section="define-an-anomaly-threshold-for-a-job">Define an anomaly threshold for a job</DocLink>
...
1. <DocLink id="enSecurityTuningAnomalyResults" section="create-a-filter-list">Create a filter list</DocLink>
1. <DocLink id="enSecurityTuningAnomalyResults" section="add-the-filter-to-the-relevant-job">Add the filter to the relevant job</DocLink>
1. <DocLink id="enSecurityTuningAnomalyResults" section="clone-and-rerun-the-job">Clone and rerun the job</DocLink> (optional)
...
1. Select:
    ...
    1. The filter you created as part of the <DocLink id="enSecurityTuningAnomalyResults" section="create-a-filter-list">Create a filter list</DocLink> procedure.
