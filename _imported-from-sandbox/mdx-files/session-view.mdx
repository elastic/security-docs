...
To view Linux session data from your Kubernetes infrastructure, you'll need to set up the <DocLink id="enSecurityKubernetesDashboard">Kubernetes dashboard</DocLink>.
</DocCallOut>
