---
id: enSecurityVisualEventAnalyzer
slug: /en/security/visual-event-analyzer
...
You can also analyze events from <DocLink id="enSecurityTimelinesUi">Timelines</DocLink>.
</DocCallOut>
