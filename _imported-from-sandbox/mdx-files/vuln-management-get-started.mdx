---
id: enSecurityVulnManagementGetStarted
slug: /en/security/vuln-management-get-started
...
Do not add the integration to an existing ((agent)) policy. It should always be added to a new policy since it should not run on VMs with existing workloads. For more information, refer to <DocLink id="enSecurityVulnManagementOverview" section="how-cnvm-works">How CNVM works</DocLink>.
</DocCallOut>
...
1. Your data will start to appear on the **Vulnerabilities** tab of the <DocLink id="enSecurityVulnManagementFindings">Findings page</DocLink>.
